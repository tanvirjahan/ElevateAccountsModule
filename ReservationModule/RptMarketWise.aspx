<%@ Page Title="" Language="VB" MasterPageFile="~/ReservationMaster.master" AutoEventWireup="false" CodeFile="RptMarketWise.aspx.vb" Inherits="RptMarketWise" %>
                    ...
                    <tr>
                        <td valign="top" align="center" style="width: 100%;">
                            <asp:Label ID="lblHeading" runat="server" 
                                Text="Market Wise Revenue Report" CssClass="field_heading"
                                ...
                                <tr>
                                    <td style="width: 100%">
                                        <table cellpadding="7" width="100%">
                                            <tr style="display:none">
                                                <td>
                                                    <label runat="server" id="lbldatetype" class="field_caption">
                                                        Date Type</label>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddldatetype" CssClass="field_input" runat="server"
                                                        Width="90%" TabIndex="3">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlReportType" CssClass="field_input" runat="server" Width="90%"
                                                        TabIndex="5">
                                                    </asp:DropDownList>
                                                </td>
                                                <td>
                                                    Division</td>
                                                <td>
                                                    <asp:DropDownList ID="ddlDivision" runat="server" CssClass="field_input" 
                                                        TabIndex="5" Width="90%">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
