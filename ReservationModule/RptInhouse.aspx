<%@ Page Title="" Language="VB" MasterPageFile="~/ReservationMaster.master" AutoEventWireup="false" CodeFile="RptInhouse.aspx.vb" Inherits="RptInhouse" %>
        ...
        <ContentTemplate>
            <div style="margin-top: -6px; width: 100%;">
                <table style="border: gray 2px solid; width: 100%;" class="td_cell" align="left">
                    <tr>
                        <td valign="top" align="center" style="width: 100%;">
                            <asp:Label ID="lblHeading" runat="server" Text="Inhouse Report" CssClass="field_heading"
             ...
             <asp:ListItem Text="ARRIVAL" Value ="Arrival">
                    ...
                    <td>
                        <asp:Label ID="lbltodate0" runat="server" class="field_caption" text="Division"></asp:Label>
                              </td>
                             <td>    
                                 <asp:DropDownList ID="ddlDivision" runat="server" class="field_input" 
                                     TabIndex="10" Width="95%">
                                 </asp:DropDownList>
                            </td>
                            </tr>
                                ...
                                <tr>
                                    <td style="width: 15%;">
                                        <asp:label id="frmdate" runat ="server"  class="field_caption" text="From Inhouse Date"></asp:label>
                                    ...
                                    <td style="width: 15%">
                                        <asp:label class="field_caption" ID="lbltodate" runat ="server" 
                                           text=" To Inhouse Date"></asp:label>
                                    </td>
                                    <td style="width: 35%">
                                ...
                                <tr>
                                    <td>
                                        <label class="field_caption">Guest Name</label>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlGuestName" CssClass="field_input" runat="server" Width="90%" TabIndex="3">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlBookingStatus" CssClass="field_input" runat="server" Width="90%" TabIndex="4">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label class="field_caption">Group By</label>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlGroupBy" CssClass="field_input" runat="server" Width="90%" TabIndex="5">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                        <label class="field_caption">Country Group</label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtCtryGroup" CssClass="field_input" runat="server" TabIndex="6" Width="90%"></asp:TextBox>
                                ...
                                <tr>
                                    <td>
                                        <label class="field_caption">Customer Group</label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtCustGroup" CssClass="field_input" runat="server" TabIndex="7" Width="90%"></asp:TextBox>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtSourceCtry" CssClass="field_input" runat="server" TabIndex="8" Width="90%"></asp:TextBox>
                                ...
                                <tr>
                                    <td>
                                        <label class="field_caption">Customer Category</label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtCustCategory" CssClass="field_input" runat="server" TabIndex="9" Width="90%"></asp:TextBox>
                                    ...
                                    <td>
                                        <label class="field_caption">Customer</label>
                                    </td>
                                    <td>
                                 ...
                                 <tr>
                                    <td>
                                        <label class="field_caption">Hotel City</label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtHotelCity" CssClass="field_input" runat="server" TabIndex="11" Width="90%"></asp:TextBox>
                                    ...
                                    <td>
                                        <label class="field_caption">Hotel Category</label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtHotelCategory" CssClass="field_input" runat="server" TabIndex="12" Width="90%"></asp:TextBox>
                                ...
                                <tr>
                                    <td>
                                        <label class="field_caption">Hotel</label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtHotel" CssClass="field_input" runat="server" TabIndex="11" Width="90%"></asp:TextBox>
