...
Partial Class MainPageMaster
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Not Session("CompanyName") Is Nothing Then
            '*** Danny 05/04/2018>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            If Not Session("AppName") Is Nothing Then
                If CType(Session("AppName"), String).Contains("Accounts Module") Then
                    title.Text = CType(Session("divDes"), String)
                Else
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Page.IsPostBack = False Then
                ...
                If ViewState("appid") = 0 Then
                    appid = Request.Params("appid")
                    ViewState.Add("appid", appid)
                End If


                Me.Page.Title = CType(Session("DAppName"), String) + " :: " + CType(Session("CompanyName"), String)
    ...
    Private Sub CreateMainMenu(ByVal intAppId As Integer, ByVal intGroupId As Integer)
        ...
        Try
            'intAppId = objUser.GetAppId(Session("dbconnectionName"),Session("dbconnectionName"),CType(Session("AppName"), String))
