<%@ Page Language="VB" MasterPageFile="~/AccountsMaster.master" AutoEventWireup="false" CodeFile="AcctGroupsSearch.aspx.vb" Inherits="AcctGroupsSearch" %>
...
// loop through all input elements in form
    ...
    <tr>
            <td colspan="2" style="width: 100%; text-align: center">
                <asp:Label ID="lblHeading" runat="server" CssClass="field_heading" Text="Account Group"
...
ShowExpandCollapse="true" ShowCheckBoxes="All"></asp:TreeView></asp:Panel>&nbsp; 
</contenttemplate>
                </asp:UpdatePanel>&nbsp;
        </td>
        </tr>
        <tr>
            <td>
              ...
              <td style="display:none"><asp:Button ID="btnView" runat="server" CssClass="btn" Font-Bold="True" 
