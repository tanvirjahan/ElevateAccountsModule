<%@ Page Title="" Language="VB" MasterPageFile="~/AccountsMaster.master" AutoEventWireup="false" CodeFile="UpdateSupplierInvoiceSearch.aspx.vb" Inherits="UpdateSupplierInvoiceSearch" %>
...
<link rel="stylesheet" href="../Content/lib/css/reset.css" type="text/css" media="screen"
    ...
    <script type="text/javascript">
        ...
        function visualsearchbox() {
            ...
            $txtvsprocess.val('"PURINVOICE NO":" "' + '"SERVICE":" "' + '"SUPPLIER":" "' + '"CONTROL ACCOUNT":" "' + '"CURRENCY":" "' + '"SUPPLIER INVNO":" "' + 'Text:" "');
            ...
            'access'
                ...
                callbacks: {
                    ...
                    valueMatches: function (category, searchTerm, callback) {
                        switch (category) {
                            case 'PURINVOICE NO':
                                var asSqlqry = 'select distinct ltrim(rtrim(purchaseinvoiceno)) as purchaseinvoiceno from purchaseinvoiceheader';
                                glcallback = callback;
                                ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                break;
                            case 'SERVICE':
                                var asSqlqry = "select sptypename from sptypemast where active=1 ";
                                glcallback = callback;
                                ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                break;
                            
                            case 'SUPPLIER':
                                var asSqlqry = 'select distinct ltrim(rtrim(partyname)) as partyname from partymast';
                                glcallback = callback;
                                ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                break;
                            case 'CONTROL ACCOUNT':
                                var asSqlqry = 'select distinct ltrim(rtrim(acctname)) as acctname from acctmast';
                                glcallback = callback;
                                ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                break;
                               
                            case 'CURRENCY':
                                var asSqlqry = 'select distinct ltrim(rtrim(currname)) as currcode from currmast';
                                glcallback = callback;
                                ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                break;
                    ...
                    facetMatches: function (callback) {
                        callback([
                { label: 'Text' },
                { label: 'PURINVOICE NO', category: 'UpdateSupplier' },
                { label: 'SERVICE', category: 'UpdateSupplier' },
                { label: 'SUPPLIER', category: 'UpdateSupplier' },
                { label: 'CONTROL ACCOUNT', category: 'UpdateSupplier' },
               { label: 'CURRENCY', category: 'UpdateSupplier' },
                { label: 'SUPPLIERREFNO', category: 'UpdateSupplier' }
              ]);
                    }
                }
            });
                ...
                <table style="border: gray 2px solid; width: 100%" class="td_cell" align="left">
                    <tr>
                        <td valign="top" align="center" style="width: 100%;">
                            <asp:Label ID="lblHeading" runat="server" Text="Update Supplier Invoice" CssClass="field_heading"
                    ...
                    <tr>
                        <td style="width: 100%; padding: 10px 0px 12px 0px" align="center">
                            ...
                            &nbsp;&nbsp;<asp:Button ID="btnAddNew" TabIndex="2" runat="server" Text="Add New"
                                ...
                                &nbsp;&nbsp;<asp:Button ID="btnUploadExcel" TabIndex="3" runat="server" Text="Excel Upload"
                                Font-Bold="False" CssClass="btn"></asp:Button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlOrder" runat="server" TabIndex="7">
                                            <asp:ListItem Value="I">PurInvoice Date</asp:ListItem>
                    ...
                    <tr>
                     ...
                     <%--    <div id="divGrid" style="min-height: 370px; max-height: 370px; max-width:95vw; overflow: auto">--%>
                                <asp:GridView ID="gvSupplierInvoice" runat="server" AutoGenerateColumns="False" CellPadding="3"
                                    CssClass="grdstyle" Font-Bold="true" Font-Size="12px" GridLines="Vertical" ShowHeaderWhenEmpty="true"
                                     AllowPaging="true" AllowSorting="true">                                    
                                <Columns>                                        
                                        <asp:TemplateField HeaderText="PurcInvoice No" SortExpression="purchaseinvoiceno">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPInvoiceNo" runat="server" Text='<%# Bind("purchaseinvoiceno") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>                                        
                                        
                                        <asp:BoundField HtmlEncode="False" DataFormatString="{0:dd/MM/yyyy}" DataField="purchaseinvoicedate"
                                            SortExpression="purchaseinvoicedate" HeaderText="Purchase Invoice Date"></asp:BoundField>
                                        
                                        <asp:BoundField DataField="suppliertype" HeaderText="Services " SortExpression="suppliertype" ItemStyle-HorizontalAlign="Left"
                                            ItemStyle-Wrap="true"></asp:BoundField>
                                        
                             <%--           <asp:TemplateField HeaderText="Supplier Type" SortExpression="suppliertype">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBookingNumber" runat="server" Text='<%# Bind("suppliertype") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>  --%>
                                                                                
                                       <asp:BoundField DataField="partyname" HeaderText="Supplier Name" SortExpression="partyname" ItemStyle-HorizontalAlign="Left" 
                                        ItemStyle-Wrap="true"></asp:BoundField>                                                                                                                      
                                       <%--      <asp:BoundField DataField="acctname" HeaderText="Control Account" SortExpression="acctname" ItemStyle-HorizontalAlign="Left" 
                                        ItemStyle-Wrap="true"></asp:BoundField>   --%>
                                             <asp:BoundField DataField="currname" HeaderText="Currency" SortExpression="currname" ItemStyle-HorizontalAlign="Left" 
                                        ItemStyle-Wrap="true"></asp:BoundField>   
                                                 <asp:BoundField DataField="hotelinvoiceno" HeaderText="Supplier Invoice No." ItemStyle-HorizontalAlign="Left" 
                                        ItemStyle-Wrap="true"></asp:BoundField>   
                                   <asp:BoundField DataField="Bookingrefno" HeaderText="Booking Refern. No." SortExpression="Bookingrefno" ItemStyle-HorizontalAlign="Left" 
                                        ItemStyle-Wrap="true"></asp:BoundField>                                                                                                                      
 
                    <asp:BoundField DataField="total_actualamount" HeaderText="Actual Amount" SortExpression="total_actualamount" ItemStyle-HorizontalAlign="Left" 
                                        ItemStyle-Wrap="true"></asp:BoundField> 
                                              <asp:BoundField DataField="total_prices_costvatvaluebase" HeaderText="Vat Amount" SortExpression="total_prices_costvatvaluebase" ItemStyle-HorizontalAlign="Left" 
                                        ItemStyle-Wrap="true"></asp:BoundField>    
                                         <asp:TemplateField HeaderText="Narration">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblNarration" runat="server" Text='<%# Limit(Eval("Narration"), 10)%>'
                                                                    ToolTip='<%# Eval("Narration")%>'></asp:Label>
                                                                <br />
                                                                <asp:LinkButton ID="ReadMoreLinkButtonpromotion" runat="server" CommandName="moreless"
                                                                    Text="More" CommandArgument='<%# Container.DisplayIndex %>' Visible='<%# SetVisibility(Eval("Narration"), 5) %>' OnClick="ReadMoreLinkButtonnarration_Click"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                                                                                                      
                                        <asp:BoundField HtmlEncode="False" DataFormatString="{0:dd/MM/yyyy }" DataField="adddate"
                                        ...
                                        <asp:BoundField HtmlEncode="False" DataFormatString="{0:dd/MM/yyyy}" DataField="moddate"
                                        ...
                                        <asp:BoundField DataField="moduser" SortExpression="moduser" HeaderText="User Modified">
                                            ...
                                            <ItemTemplate>
                                                    ...
                                                    CommandName="EditRow" ForeColor="Blue"  ToolTip='<%# Bind("purchaseinvoiceno") %>' runat="server"></asp:LinkButton>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
                                            ...
                                            <ItemTemplate>
                                                    ...
                                                    CommandName="DeleteRow" ForeColor="Blue"  ToolTip='<%# Bind("purchaseinvoiceno") %>' runat="server"></asp:LinkButton>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" />                                            
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemTemplate>
                                                    ...
                                                    CommandName="View" ForeColor="Blue"  ToolTip='<%# Bind("purchaseinvoiceno") %>' runat="server"></asp:LinkButton>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" />                                            
                                        </asp:TemplateField>
                                      <asp:TemplateField HeaderText="Purchase Invoice Print">
                                            <ItemTemplate>
                                                    <asp:LinkButton ID="lbtnPrint" Text="Purchase Invoice" CssClass="field_input" CommandArgument='<%# Container.DisplayIndex %>'
                                                    CommandName="Print" ForeColor="Blue" runat="server" ToolTip='<%# Bind("purchaseinvoiceno") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" />                                            
                                        </asp:TemplateField>   
                                         <asp:TemplateField HeaderText="Journal Print">
                                            <ItemTemplate>
                                                    <asp:LinkButton ID="lbtnPrintJournal" Text="Journal" CssClass="field_input" CommandArgument='<%# Container.DisplayIndex %>'
                                                    CommandName="PrintJournal" ForeColor="Blue" runat="server" ToolTip='<%# Bind("purchaseinvoiceno") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" />                                            
                                        </asp:TemplateField>   
