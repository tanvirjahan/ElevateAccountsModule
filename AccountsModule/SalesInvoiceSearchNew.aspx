<%@ Page Title="" Language="VB" MasterPageFile="~/AccountsMaster.master" AutoEventWireup="false" CodeFile="SalesInvoiceSearchNew.aspx.vb" Inherits="SalesInvoiceSearchNew" %>
...
<link rel="stylesheet" href="../Content/lib/css/reset.css" type="text/css" media="screen"
    ...
    <script type="text/javascript">
        ...
        function visualsearchbox() {
            ...
            $txtvsprocess.val('"INVOICE NO":" "' + '"STATUS":" "' + '"CUSTOMER":" "' + '"BOOKING NO":" "' + 'Text:" "');
            ...
            'access'
                ...
                callbacks: {
                    ...
                    valueMatches: function (category, searchTerm, callback) {
                        switch (category) {
                            case 'INVOICE NO':
                                var asSqlqry = 'select distinct ltrim(rtrim(invoiceno)) as invoiceno from InvoiceHeader';
                                glcallback = callback;
...
//                                ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                break;                                                                
                            case 'CUSTOMER':
                                var asSqlqry = 'select distinct ltrim(rtrim(agentName)) as agentName from InvoiceHeader';
                                glcallback = callback;
                                ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                break;                                                                
                            case 'BOOKING NO':
                                var asSqlqry = 'select distinct ltrim(rtrim(requestid)) as bookingNo from InvoiceHeader';
                                glcallback = callback;
                                ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                break;                                                                
                        }
                    ...
                    facetMatches: function (callback) {
                        callback([
                { label: 'Text' },
                { label: 'INVOICE NO', category: 'SalesInvoice' },
                { label: 'STATUS', category: 'SalesInvoice' },
                { label: 'CUSTOMER', category: 'SalesInvoice' },
                { label: 'BOOKING NO', category: 'SalesInvoice' }                
              ]);
                    }
                }
            });
                ...
                <table style="border: gray 2px solid; width: 100%" class="td_cell" align="left">
                    <tr>
                        <td valign="top" align="center" style="width: 100%;">
                            <asp:Label ID="lblHeading" runat="server" Text="Sales Invoice" CssClass="field_heading"
                    ...
                    <asp:Button ID="btnDownloadAllFormat1" runat="server" CssClass="btn" Font-Bold="False" Text="Download All Invoice" />
                    <asp:Button ID="btnDownloadAllFormat2" runat="server" CssClass="btn" Font-Bold="False" Visible="false" Text="Download All Invoice - Format 2" />
                    &nbsp; &nbsp; &nbsp;
                    <asp:Button ID="btnDownloadFolder" runat="server" CssClass="btn" Font-Bold="False" Text="Download To Folder" />
                    </td>
                    </tr>
                    <tr>
                        <td>
                            <div id="divGrid" style="min-height: 370px; max-height: 370px; max-width:95vw; overflow: auto">
                                <asp:GridView ID="gvSalesInvoice" runat="server" AutoGenerateColumns="False" CellPadding="3"
                                    ...
                                    <Columns>                                        
                                       ...
                                       <%-- <asp:BoundField HtmlEncode="False" DataFormatString="{0:dd/MM/yyyy}" DataField="InvoiceDate"
                                            SortExpression="InvoiceDate" HeaderText="Invoice Date"></asp:BoundField>--%>
                                        ...
                                        <asp:TemplateField HeaderText="Booking Number" SortExpression="BookingNumber">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBookingNumber" runat="server" Text='<%# Bind("BookingNumber") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>  
                                       ...
                                       <%-- Rosalin 06/09/2023 CR point commented above line and added below line--%>
                                        ...
                                        <asp:BoundField DataField="CustomerRef" HeaderText="Customer Ref." SortExpression="CustomerRef" ItemStyle-HorizontalAlign="Left" 
                                        ItemStyle-Wrap="true"></asp:BoundField>                                                                                                                      
                                        ...
                                        <HeaderStyle CssClass="salesAmt" />
                                              ...
                                              <asp:TemplateField HeaderText="Sales Vat Amount">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSalesVatAmount" runat="server" Text='<%# Bind("salevatvaluebase") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Right" />
                                        <HeaderStyle CssClass="salesVatAmt" />
                                        </asp:TemplateField>  
                                         
                                        <asp:TemplateField HeaderText="Cost Value">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCostAmount" runat="server" Text='<%# Bind("CostValueBase") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Right" />
                                        <HeaderStyle CssClass="salesAmt" />
                                        </asp:TemplateField>    
                                        ...
                                        <asp:TemplateField HeaderText="Invoice Print">
                                            <ItemTemplate>
                                                    ...
                                                    CommandName="Print" ForeColor="Blue" runat="server" ToolTip='<%# Bind("InvoiceNo") %>'></asp:LinkButton>
                                                    <asp:LinkButton ID="lbtnPrint2" Text="Format2" CssClass="field_input" CommandArgument='<%# Container.DisplayIndex %>'
                                                    CommandName="InvoicePrint2" ForeColor="Blue" runat="server" Visible="false" ToolTip='<%# Bind("InvoiceNo") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" />                                            
                                        </asp:TemplateField>   
                                        <asp:TemplateField HeaderText="P/L Print" HeaderStyle-CssClass="plStyle">
                                            <ItemTemplate>
                                                    <asp:LinkButton ID="lbtnPrintPL" Text="P/L" CssClass="field_input" CommandArgument='<%# Container.DisplayIndex %>'
                                                    CommandName="PrintPL" ForeColor="Blue" runat="server" ToolTip='<%# Bind("InvoiceNo") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" />                                            
                                        </asp:TemplateField>              
                                         <asp:TemplateField HeaderText="Journal Print">
                                            <ItemTemplate>
                                                    ...
                                                    CommandName="PrintJournal" ForeColor="Blue" runat="server" ToolTip='<%# Bind("InvoiceNo") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" />                                            
                                        </asp:TemplateField>     
                                        <asp:TemplateField HeaderText="Proforma Print">
                                            <ItemTemplate>
                                                    <asp:LinkButton ID="lbtnPrintProforma" Text="Proforma" CssClass="field_input" CommandArgument='<%# Container.DisplayIndex %>'
                                                    CommandName="PrintProforma" ForeColor="Blue" runat="server" ToolTip='<%# Bind("InvoiceNo") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Wrap="true" />                                            
                                        </asp:TemplateField>  
                                        <asp:TemplateField HeaderText="Select">
                                            <HeaderTemplate>
                                                <asp:CheckBox ID="chkDownloadAll" runat="server" OnCheckedChanged="chkDownloadAll_Click" AutoPostBack="true" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                            ...
                            Visible="False"></asp:Label>  
                                <asp:HiddenField ID="hdnSalesInvoiceFormat" runat="server" />                                                               
                            </div> 
                        </td>
                    </tr>
                </table>
