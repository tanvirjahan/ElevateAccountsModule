<%@ Page Language="VB" MasterPageFile="~/AccountsMaster.master" AutoEventWireup="false" CodeFile="RptBalancesheet.aspx.vb" Inherits="RptBalancesheet" %>
...
<asp:Label id="lblHeading" runat="server" Text="Report Balance Sheet" CssClass="field_heading" Width="100%"></asp:Label></TD></TR>
...
<TABLE style="WIDTH: 100%" class="td_cell" align=left><TBODY><TR><TD style="WIDTH: 77px" class="td_cell" align=left>As on Date</TD>
    ...
    <asp:DropDownList  style="display:none" id="ddlselect" tabIndex=3 runat="server" CausesValidation="True" 
        CssClass="drpdown">
                            ...
                            <TR><TD  class="td_cell" align=left></TD><TD class="td_cell" 
                                    vAlign=middle align=center colSpan=5><asp:Button id="btnLoadReprt" style="display:none" onclick="btnLoadReprt_Click" runat="server" 
