<%@ Page Title="" Language="VB" MasterPageFile="~/AccountsMaster.master" AutoEventWireup="false"
    CodeFile="BankdetailsSearch.aspx.vb" Inherits="BankdetailsSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function visualsearchbox() {
            ...
            $txtvsprocess.val('BankName:" "AccountName:" " Currency:" "TEXT:" "');
            ...
            'access'
                ...
                callbacks: {
                    ...
                    valueMatches: function (category, searchTerm, callback) {
                        ...
                        switch (category) {
                            case 'BankName':
                                var asSqlqry = ''; 
                                var asSqlqry = "select distinct ltrim(rtrim(bankname)) from  BANKDETAILS_MASTER where  div_id= '" + hdndivcode.value + "' and isnull(active,1)=1 ";
                                glcallback = callback;
                ...
                { label: 'Narration', category: 'narration' },
              ]);
                    }
                }
            });
...
<Columns>
<asp:TemplateField SortExpression="bankcode" Visible="False" HeaderText="Bank Type Code"><EditItemTemplate>
<asp:TextBox id="TextBox1" runat="server" Text='<%# Bind("bankcode") %>' __designer:wfdid="w2"></asp:TextBox> 
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblCode" runat="server" Text='<%# Bind("bankcode") %>' __designer:wfdid="w1"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField="bankcode" SortExpression="bankcode" HeaderText="Bank Code"></asp:BoundField>
                 ...
                 <asp:BoundField DataField="accountcurrency" SortExpression="accountcurrency" HeaderText="Account Currency"></asp:BoundField>
 <asp:BoundField DataField="accountnumber" SortExpression="accountnumber" HeaderText="Account Number"></asp:BoundField>
