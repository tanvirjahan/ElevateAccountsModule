...
#End Region
Partial Class ReceiptsSearchnew
...
#End Region
            ...
            For i = 0 To lsMainArr.GetUpperBound(0)
                ...
                If strValue <> "" Then
                    If Trim(strWhereCond1) = "" Then
                        strWhereCond1 = "(upper(receipt_master_new.tran_type ) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(receipt_master_new.receipt_received_from) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    Else
                        strWhereCond1 = strWhereCond1 & " OR  (receipt_master_new.tran_type) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(receipt_master_new.receipt_received_from) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    End If
                End If
            Next
    ...
    End Sub
    Protected Sub btnEditDate_Click(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Try
                ...
                Else
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                                       CType(strappname, String), "AccountsModule\ReceiptsSearchnew.aspx?tran_type=" & CType(ViewState("ReceiptsSearchRVPVTranType"), String) & "", btnAddNew, btnExportToExcel, _
                ...
                ''strSqlQry = "select acctcode,acctname from acctmast ,bank_master_type where  acctmast.bank_master_type_code = bank_master_type.bank_master_type_code" & _
                ...
                ''strSqlQry = "select acctname, acctcode from acctmast ,bank_master_type where  acctmast.bank_master_type_code = bank_master_type.bank_master_type_code" & _
