<%@ Page Language="VB" MasterPageFile="~/AccountsMaster.master" AutoEventWireup="false"
    CodeFile="OtherBankMasterSearch.aspx.vb" Inherits="OtherBankMasterSearch" %>
...
<link rel="stylesheet" href="../Content/lib/css/reset.css" type="text/css" media="screen" charset="utf-8">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('BankName:" " TEXT:" "');
            ...
            'access'
              ...
              callbacks: {
                  ...
                  facetMatches: function (callback) {
                      callback([
                { label: 'TEXT', category: 'BankName' },
                { label: 'BankName', category: 'BankName' },
              ]);
                  }
              }
          });
        ...
        <td colspan="6">
            <table class="style1">
                ...
                <asp:UpdatePanel id="UpdatePanel2" runat="server">
                    <contenttemplate>
<asp:GridView ID="gv_SearchResult" TabIndex="8" runat="server" CssClass="grdstyle"
                            Width="100%" GridLines="Vertical" CellPadding="3" AutoGenerateColumns="False"
                            AllowSorting="True" AllowPaging="True">
                            <Columns>
                                <asp:TemplateField Visible="False" HeaderText="Customer Bank Code">
                                    <EditItemTemplate>
                                        <asp:TextBox runat="server" Text='<%# Bind("other_bank_master_code") %>' ID="TextBox1"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblCode" runat="server" Text='<%# Bind("other_bank_master_code") %>'
                                            __designer:wfdid="w2"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="other_bank_master_code" SortExpression="other_bank_master_code"
                                    HeaderText="Customer Bank Code"></asp:BoundField>

                                    
 <asp:TemplateField HeaderText="Customer Bank Name" SortExpression="other_bank_master_des">
                    <ItemTemplate>
                        <asp:Label ID="lblOthbBankName" runat="server" Text='<%# Bind("other_bank_master_des") %>'></asp:Label>
                    </ItemTemplate>
                    <ControlStyle   />
