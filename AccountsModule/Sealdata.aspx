<%@ Page Language="VB" MasterPageFile="~/AccountsMaster.master" AutoEventWireup="false" CodeFile="Sealdata.aspx.vb" Inherits="AccountsModule_Sealdata"  %>
            ...
            <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid; border-bottom: gray 2px solid">
                <tr>
                    <td align="center" class="field_heading" style="width: 100%; height: 21px">
                        <asp:Label ID="lblHeading" runat="server" CssClass="field_heading" Text="Seal Data"
            ...
            <table style="width: 453px">
                <tr>
                    <td style="width: 20px; height: 24px;">
                        <asp:Label ID="Label1" runat="server" Text="Enter Date to Seal data upto  :" 
                            Width="198px" CssClass="td_cell"></asp:Label></td>
                    ...
                    <td style="width: 100px">
                        ...
                        <table style="width: 444px">
                            <tr>
                                ...
                                <td style="width: 100px">
                                    <asp:Button ID="btnseal" runat="server" CssClass="btn" Text="Seal Data" 
