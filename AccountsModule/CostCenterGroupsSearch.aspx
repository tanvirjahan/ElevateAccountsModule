<%@ Page Language="VB" MasterPageFile="~/AccountsMaster.master" AutoEventWireup="false"
    CodeFile="CostCenterGroupsSearch.aspx.vb" Inherits="CostCenterGroupsSearch" Title=":: :: - Cost Center Groups List" %>
...
<TABLE style="WIDTH: 944px"><TBODY><TR><TD style="TEXT-ALIGN: center" 
        class="field_heading">Cost Center Groups List</TD></TR>
        ...
        <tr>
            <td style="width: 100%; height: 21px">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="gv_SearchResult" TabIndex="8" runat="server" Width="100%" CssClass="grdstyle"
                                GridLines="Vertical" CellPadding="3" AutoGenerateColumns="False" AllowSorting="True"
                                AllowPaging="True">
                                <Columns>
                                    <asp:TemplateField Visible="False" HeaderText="Group Code">
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" Text='<%# Bind("costcentergrp_code") %>' ID="TextBox1"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblCode" runat="server" Text='<%# Bind("costcentergrp_code") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="costcentergrp_code" SortExpression="costcentergrp_code"
                                        HeaderText="Group Code"></asp:BoundField>
