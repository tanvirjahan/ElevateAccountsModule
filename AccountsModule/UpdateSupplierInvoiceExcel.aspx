<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false"
    CodeFile="UpdateSupplierInvoiceExcel.aspx.vb" Inherits="UpdateSupplierInvoiceExcel" %>
            ...
            <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
                ...
                <tr>
                    <td class="td_cell" align="center" style="width: 100%;">
                        <asp:Label ID="lblHeading" runat="server" Text="Update Supplier Invoice - Excel Upload" Style="padding: 2px"
                ...
                <tr>
                    <td style="width: 100%">
                        ...
                        <table style="width: 100%" cellpadding="7">
                            ...
                            <tr>
                                <td><asp:FileUpload ID="fileUploadExcel" runat="server" ViewStateMode="Enabled" /></td>
                                <td><asp:Button ID="btnUpload" runat="server" Text="Upload Excel File" CssClass="btn" /></td>
                                <td>
                                    <label class="field_caption">
                                        Supplier Name</label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtSupplier" Enabled="false" CssClass="field_input" runat="server" TabIndex="4"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlCommissionType" Enabled="false" runat="server" CssClass="field_input" Style="margin-left: -267px;
                ...
                <tr id="Errtr2" runat="server">
                    <td>
                        <asp:GridView ID="gvError" runat="server" AutoGenerateColumns="False" CellPadding="3"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Booking Reference Number">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Error Message">
                                    <ItemTemplate>
                                        <asp:Label ID="lblErrMsg" runat="server" Text='<%# Bind("errordesc") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        ...
                        <asp:Label ID="lblErr" runat="server" Text="Records not found, Please redefine search criteria"
                        ...
                        <asp:GridView ID="gvUpdateSupplier" runat="server" AutoGenerateColumns="False" CellPadding="3"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Commission" HeaderStyle-CssClass="FixWidthCol" Visible="False">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtCommisionAmt" ReadOnly="true" Enabled="false" Style="text-align: right" runat="server" Width="98%"
