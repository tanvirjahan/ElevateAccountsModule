...
Partial Class AccountsModule_Sealdata
...
#End Region
    ...
    Private Sub description()
        Dim desc As String
        Try
            desc = "All data upto date given above will be sealed cannot be Edited or Deleted.Also no entry can be made prior to the given date above once sealing is done."
    ...
    Protected Sub btnseal_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            mySqlCmd.CommandText = "sp_add_sealing_master"
            ...
            parm(2) = New SqlParameter("@adduser", CType(Session("GlobalUserName"), String))
            parm(3) = New SqlParameter("@divcode", ViewState("divcode"))
            ...
            description()
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Sealing completed');", True)
...
#Region "Public Function validation() As Boolean"
    Public Function validation() As Boolean
        ...
        mySqlCmd.ExecuteNonQuery()
        mySqlCmd.CommandTimeout = 0 'Tanvir 29122023
