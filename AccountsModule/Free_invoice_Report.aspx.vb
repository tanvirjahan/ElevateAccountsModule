...
Partial Class Free_invoice_Report
    Inherits System.Web.UI.Page
    Dim rep As New ReportDocument
    Dim rptcompanyname As String
    Dim rptreportname As String
    Dim objutils As New clsUtils
    Dim frmdate, todate, custcode, reqid, invoiceno, type, poststate, repname As String
        ...
        Select Case type
            Case "0"
                If repname = "salesregister" Then
                    rptreportname = " Free Sales invoices -Summary"
                Else
                    rptreportname = " Free Sales Invoice -Summary"
                End If

                rep.Load(Server.MapPath("..\Report\free_invoice_brief.rpt"))

            Case "1"

                If repname = "salesregister" Then
                    rptreportname = " Free Sales invoices -Detailed"
                Else
                    rptreportname = " Free Invoice -Detailed"
                End If

                rep.Load(Server.MapPath("..\Report\free_invoice_detail.rpt"))
        End Select
