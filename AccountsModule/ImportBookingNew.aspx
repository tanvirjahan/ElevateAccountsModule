<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="ImportBookingNew.aspx.vb" Inherits="ImportBookingNew" %>
...
<script type="text/javascript">
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div style="height:100%">
                <table>
                        ...
                        <tr>
                            <td colspan="8">
                                <asp:TabContainer ID="TabHotelInfo" runat="server" ActiveTabIndex="0" AutoPostBack ="true">
                                        ...
                                        <ContentTemplate>
                                            <div id="divscrollBooking" style="height: 70vh; width: 95vw; padding: 4px; overflow: scroll">
                                                <asp:GridView ID="gvBookingDetails" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                    BorderColor="#999999" CssClass="td_cell" ShowHeaderWhenEmpty="true" Width="99%"  AllowPaging="true"
                                                    TabIndex="4">
                                                    <Columns>
                                    ...
                                    <asp:TabPanel ID="panReconcileSummary" runat="server" HeaderText="Reconciliation Summary">
                                        <ContentTemplate>
                                            ...
                                            <asp:GridView ID="gvReconcileSummary" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                BorderColor="#999999" CssClass="td_cell" ShowHeaderWhenEmpty="true" Width="99%"
                                                TabIndex="4" AllowPaging="true" PageSize="20">
                                                  <Columns>
                                                        <asp:TemplateField HeaderText="Booking Code" >
                                                            <ItemTemplate>                                                                
                                                                <asp:Label ID="lblBookingNo" runat="server" Text='<%# Bind("BookingCode") %>'></asp:Label>
                                     ...
                                     <asp:TabPanel ID="panPurchaseinvoiceDetails" runat="server" HeaderText="Mismatch PI">
                                      ...
                                      <asp:TabPanel ID="PanIgnoreList" runat="server" HeaderText="Ignored Bookings">
                                        <ContentTemplate>
                                            <div id="div4Ignore" style="height: 70vh; width: 95vw; padding: 4px; overflow: scroll" >
                                      
                                             <asp:GridView ID="gvIgnoreList" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                    BorderColor="#999999" CssClass="td_cell" ShowHeaderWhenEmpty="true" Width="99%"  AllowPaging="true"
                                                    TabIndex="4">
                                                    <Columns>
                                                         <asp:TemplateField HeaderText="Error Details">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblErrorDetails" Width="250" runat="server" BackColor="#ffcc66" Text='<%# Bind("errordesc") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Description">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbldescription" Width="125" runat="server" Text='<%# Bind("Description") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Product group">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Supplier name">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblsuppname" Width="125" runat="server" Text='<%# Bind("Suppname") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Cost currency">
                                                            <ItemTemplate>
           ...
           <%-- --sharfudeen 21/10/2022--%>
            ...
            <asp:ModalPopupExtender ID="mpImportResult" runat="server" BackgroundCssClass="roomtype-modalBackground"
                        CancelControlID="btnResultCancel" EnableViewState="true" PopupControlID="PnlResult" Drag="true"
                        TargetControlID="btnResultCancel">
                                    </asp:ModalPopupExtender>

                                     <asp:Panel ID="PnlResult"  runat="server" BackColor="White" BorderStyle="Ridge" BorderColor="Control" BorderWidth="10"> <%--Style="display: none;"--%>
                                     <%-- <div id="div5" style="height: 70vh; width: 95vw; padding: 4px; overflow: scroll;background-color: #ede7e1;" >--%>


                                      <div class="row-col-12" style="padding-left: 2px; max-height: 500px; overflow-y: auto;overflow-x: hidden;">
                                                        
                                                         <div class="roomtype-popup-title" style="background-color: White;text-align:right;max-height: 50px"> &nbsp;&nbsp;&nbsp;&nbsp; </div>
                                                                    <%-- <input id="btnResultCancel" runat="server" type="button" value="Cancel"  />--%>

                                                                     <div style="padding-left: 2px; max-height: 50px;text-align: center"> 
                                                         <asp:Label ID="Label2" runat="server" align="center" Text="Imported Booking details" CssClass="field_heading"
                                                                     Width="100%"></asp:Label>
                                    </div>
                                     <div class="roomtype-popup-title" style="background-color: #ede7e1;text-align:right;max-height: 50px"> &nbsp;&nbsp;&nbsp;&nbsp; </div>
                             <div class="roomtype-popup-title" style="background-color: #ede7e1;text-align:right;max-height: 50px">
                                                  
                                      <asp:Button ID="btnResultCancel" runat="server" CssClass="field_button" TabIndex="3" Text="Close" OnClientClick="getFileName(this);"/> 
                                      </div>

                                      <div class="roomtype-popup-title" style="background-color: #ede7e1;text-align:right;max-height: 50px"> &nbsp;&nbsp;&nbsp;&nbsp; </div>

                                      <asp:GridView ID="gvImportResult"  runat="server" AutoGenerateColumns="False" BorderColor="#999999" CssClass="td_cell" 
                                      Width="100%" ShowHeaderWhenEmpty="true" GridLines="Both"   TabIndex="25"  >                                
                              
                                 
                                   <Columns>
                                   <asp:TemplateField HeaderText="Details" >
                                        <ItemTemplate>
                                            <asp:Label ID="lbldetail" runat="server" Text='<%# Bind("Details") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Counts"  >
                                        <ItemTemplate>
                                            <asp:Label ID="lblCount" runat="server" Text='<%# Bind("Counts") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     ...
                                     <asp:TemplateField HeaderText="Bookingcodes" HeaderStyle-Width="18%" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblBookcode" runat="server" Text='<%# Bind("Bookingcode") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     </Columns>
                                     <%-- <RowStyle CssClass="grdRowstyle" BackColor="#EEEEEE" ForeColor="Black"></RowStyle>
                                     ...
                                     <div class="row-col-12" style="padding-left: 2px; max-height: 50px; overflow-y: auto;overflow-x: hidden;">
                                     &nbsp;   &nbsp;   &nbsp;   &nbsp;
                                      </div>
                                     </asp:Panel>
            <%--End --Rosalin 20/09/2023--%>
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="TabHotelInfo" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>