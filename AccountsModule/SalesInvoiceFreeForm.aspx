<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="SalesInvoiceFreeForm.aspx.vb" Inherits="AccountsModule_SalesInvoiceFreeForm" %>
    ...
    function custautocompleteselected(source, eventArgs) {
        ...
        if (eventArgs != null) {
            ...
            if (document.getElementById('<%=ddltype.ClientID%>').value == "Customer") {
                var sqlstr = "Select agentmast.currcode,currmast.currname,agentmast.controlacctcode,acctmast.acctname,spersoncode,trnno,agentmast.ctrycode,ctrymast.ctryname,isnull(crdays,0) crdays ,currrates.convrate  convrate,usermaster.username,agentmast.agentcode,'C',agentmast.shortname" +
                ...
                ColServices.clsServices.GetQueryReturnStringArraynew(constr, sqlstr, "14", fnFillagent, ErrorHandler, TimeOutHandler);
...
//        }
        ...
        document.getElementById('<%=txtconvrate.ClientID%>').value = parseFloat(result[9]);  //DecRound(result[9]); //changed by mohamed on 05/12/2021
        document.getElementById('<%=lblsubtotal_curr.ClientID%>').innerHTML = "SubTotal(" + result[0] + ")";
        
        document.getElementById('<%=txtAliasName.ClientID%>').value = result[13];
        

        var objGridView = document.getElementById('<%=grdServiceInvoice.ClientID%>');
        objGridView.rows[0].cells[5].innerHTML = "Value(" + result[0] + ")";
    ...
    function grdTotal() {
        ...
        for (j = 1; j <= intRows; j++) {
            var Cell = objGridView.rows[j].cells[3].getElementsByTagName("input");
            var TAval = Cell[1].value;
            var NTAval = Cell[0].value;
            var Cell = objGridView.rows[j].cells[4].getElementsByTagName("input");
            var VATamtval = Cell[1].value;

            var saleval = objGridView.rows[j].cells[5].children[0].value; //fixed
            ...
            if (objGridView.rows[j].cells[6].children[0].value == '') { objGridView.rows[j].cells[6].children[0].value = 0; }
            ...
            if (isNaN(objGridView.rows[j].cells[6].children[0].value) == true) { objGridView.rows[j].cells[6].children[0].value = 0; }
            ...
            objGridView.rows[j].cells[6].children[0].value = parseFloat(saleval) * parseFloat(exchangerate1.value);
            objGridView.rows[j].cells[6].children[0].value = DecRound(objGridView.rows[j].cells[6].children[0].value);
                ...
                <tbody>
                    <tr>
                        <td class="field_heading" align="center" colspan="1" style="height: 27px">
                            <asp:Label ID="lblHeading" runat="server" Text="Sales Invoice Free Form" Width="100%"  ></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td> 
...
<asp:TextBox ID="txtsourcectry" runat="server" CssClass="field_input" Enabled="True"
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblAliasName" runat="server" Text="Legal Name of Entity" Width="91px"
                                                                    CssClass="field_Caption"></asp:Label>
                                                            </td>
                                                            <td>
                                                                
                                                            <asp:TextBox ID="txtAliasName" runat="server" CssClass="field_input" 
                                                               TabIndex="9" Width="200px" Enabled="false"></asp:TextBox>
                                ...
                                <asp:GridView ID="grdServiceInvoice" TabIndex="13" runat="server" Font-Size="10px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Account">
                                            <ItemTemplate>
 <asp:TextBox ID="txtacct" runat="server" AutoPostBack="True" CssClass="field_input"
                                                                    MaxLength="500" TabIndex="14"  Width="97%" Height="26px"></asp:TextBox>
                                                                ...
                                                                <asp:AutoCompleteExtender ID="txtacct_AutoCompleteExtender" runat="server" CompletionInterval="10"
                                                                    ...
                                                                    CompletionListItemCssClass="autocomplete_listItem" CompletionSetCount="1" DelimiterCharacters=""
                                                                    EnableCaching="false" Enabled="True" FirstRowSelected="false" MinimumPrefixLength="-1"
                                                                    ServiceMethod="Getacctlist" TargetControlID="txtacct"  OnClientItemSelected="acctautocompleteselected">
                                                                </asp:AutoCompleteExtender>
                                              ...
                                              <br />
                                                <asp:Label ID="lblcostcenter" runat="server" Text="CostCenter:" CssClass="field_Caption"></asp:Label>
                                               <br />
                                               
                                               
                                               
                                               <asp:TextBox ID="txtcostcenter" runat="server" AutoPostBack="True" CssClass="field_input"
                                                                    MaxLength="500" TabIndex="15"  Width="97%" Height="26px"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Amount"  HeaderStyle-Width="5%" itemStyle-Width="5%">
                                            ...
                                            <asp:Label ID="Lblnontaxable" runat="server" Text="NonTaxableAmt:" CssClass="field_Caption"></asp:Label>
                                               <br /> <asp:TextBox Style="text-align: right" TabIndex="18" ID="txtnontaxableamt" runat="server" Width="96px"
                                                    CssClass="field_input"></asp:TextBox><br />
                                                    <asp:Label ID="Label1" runat="server" Text="TaxableAmt:" CssClass="field_Caption"></asp:Label>
                                               <br /> 
                                                <asp:TextBox Style="text-align: right"  TabIndex="19" ID="txttaxableamt" runat="server" Width="96px"
                                                    CssClass="field_input"></asp:TextBox><br />
                                        ...
                                        <asp:TemplateField HeaderText="VAT %"  HeaderStyle-Width="5%" itemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:TextBox Style="text-align: right" ID="txtvatperc" TabIndex="20" runat="server" Width="96px"
                                                    CssClass="field_input"></asp:TextBox><br />
                                                <asp:Label ID="lblvatamt" runat="server" Text="VATAmt:"  CssClass="field_Caption"></asp:Label>
                                                <br />
                                                <asp:TextBox Style="text-align: right" ID="txtvatamt" TabIndex="21" runat="server" Width="96px"
                                        ...
                                        <asp:TemplateField HeaderText="Value()"  HeaderStyle-Width="5%" itemStyle-Width="5%">
                                            <ItemTemplate>
                                                &nbsp;<asp:TextBox Style="text-align: right" ID="txtbaseValue" runat="server" CssClass="field_input"
                                                    Width="96px" Enabled="False"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Delete"  HeaderStyle-Width="5%" itemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chckDeletion" TabIndex="22" runat="server" Width="10px"></asp:CheckBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
