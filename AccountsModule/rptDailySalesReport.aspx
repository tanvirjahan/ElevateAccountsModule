<%@ Page Title="" Language="VB" MasterPageFile="~/AccountsMaster.master" AutoEventWireup="false" CodeFile="rptDailySalesReport.aspx.vb" Inherits="rptDailySalesReport" %>
                ...
                <table style="border: gray 2px solid; width: 100%;" class="td_cell" align="left">
                    <tr>
                        <td valign="top" align="center" style="width: 100%;">
                            <asp:Label ID="lblHeading" runat="server" Text="Daily Sales Report" CssClass="field_heading"
                                    ...
                                    <td style="width: 100%">
                                        <table cellpadding="7" width="40%">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 20%">
                                                    <asp:DropDownList ID="ddlGrpBy" CssClass="field_input" Style="visibility: visible;"
