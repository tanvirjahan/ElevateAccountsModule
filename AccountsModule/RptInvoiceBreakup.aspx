...
<%@ Page Language="VB" MasterPageFile="~/AccountsMaster.master" AutoEventWireup="false" CodeFile="RptInvoiceBreakup.aspx.vb" Inherits="AccountsModule_RptInvoiceBreakup" %>
...
<asp:Label id="lblHeading" runat="server" Text="Report Invoice Breakup" CssClass="field_heading" Width="100%"></asp:Label></TD></TR>

<TR><TD style="WIDTH: 100%" class="td_cell" align=left colSpan=5>
<TABLE style="WIDTH: 80%" class="td_cell" align=left>
<TBODY>
<TR>
<TD style="WIDTH: 77px" class="td_cell" align=left>From Date</TD>
    <TD class="td_cell" vAlign=middle align=left>
    <asp:TextBox id="txtFromDate" tabIndex=1 runat="server" CssClass="txtbox" 
        Width="96px"></asp:TextBox>&nbsp; <asp:ImageButton id="ImgBtnFrmDt" tabIndex=2 runat="server" ImageUrl="~/Images/Calendar_scheduleHS.png"></asp:ImageButton>&nbsp;<cc1:maskededitvalidator id="MskVFromDt" runat="server" controlextender="MskFromDate" controltovalidate="txtFromDate" cssclass="field_error" display="Dynamic" emptyvalueblurredtext="*" emptyvaluemessage="Date is required" errormessage="MskVFromDate" invalidvalueblurredmessage="*" invalidvaluemessage="Invalid Date" tooltipmessage="Input a date in dd/mm/yyyy format" width="1px"></cc1:maskededitvalidator>
        </TD>
