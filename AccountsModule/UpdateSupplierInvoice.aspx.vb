...
Partial Class UpdateSupplierInvoice
        ...
        Try
            If Page.IsPostBack = False Then
                If CType(Session("GlobalUserName"), String) = "" Then
                    ...
                    Exit Sub
                End If
                Session("purchase_records") = Nothing
                ...
                Session("PIAdjustedRecords") = Nothing
                'Tanvir 24102023
...
#Region "Protected Sub btnDisplay_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDisplay.Click"
    Protected Sub btnDisplay_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDisplay.Click
        Try
            ...
            sqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))          'connection open
            mySqlCmd = New SqlCommand("sp_get_supplier_provision", sqlConn)
            mySqlCmd.CommandType = CommandType.StoredProcedure
            mySqlCmd.Parameters.Add(New SqlParameter("@divcode", SqlDbType.VarChar, 20)).Value = txtDivcode.Text.Trim
            mySqlCmd.Parameters.Add(New SqlParameter("@supplierType", SqlDbType.VarChar, 20)).Value = acctType
            mySqlCmd.Parameters.Add(New SqlParameter("@supplierCode", SqlDbType.VarChar, 20)).Value = txtSupplierCode.Text.Trim
            mySqlCmd.Parameters.Add(New SqlParameter("@requestId", SqlDbType.VarChar, 20)).Value = ""
            mySqlCmd.Parameters.Add(New SqlParameter("@fromcheckout", SqlDbType.VarChar, 10)).Value = Convert.ToDateTime(txtChkFromDt.Text).ToString("yyyy/MM/dd")
            mySqlCmd.Parameters.Add(New SqlParameter("@tocheckout", SqlDbType.VarChar, 10)).Value = Convert.ToDateTime(txtChkToDt.Text).ToString("yyyy/MM/dd")
...
#End Region
    ...
    Private Sub ClearNewMode()
        ...
        txtSupplier.Enabled = True 'changed by mohamed on 08/11/2021
...
#Region "Protected Sub ddlType_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlType.SelectedIndexChanged"
...
#End Region
    ...
    'Private Sub Save_Pending_invoices(state As String, sqlconn As SqlConnection, sqltrans As SqlTransaction)



    '    If state = "Edit" Then
    '        If Not Session("Purchase_records") Is Nothing Then
    '            Dim dataTable As DataTable = DirectCast(Session("Purchase_records"), DataTable)
    '            Dim filterExpression As String = " divcode = '" & txtDivcode.Text & " '" '  against_tran_id =" & txtDocNo.Value & "  and against_tran_lineno= " & intReceiptLinNo & " and   against_tran_type='" & CType(ViewState("ReceiptsRVPVTranType"), String) & "' And  div_id = " & strdiv & " "
    ...
    '                mySqlCmd.Parameters.Add(New SqlParameter("@doclineno", SqlDbType.Int)).Value = 1
    '                mySqlCmd.Parameters.Add(New SqlParameter("@docno", SqlDbType.VarChar, 20)).Value = CType(row("purchaseinvoiceno"), String)
    '                mySqlCmd.Parameters.Add(New SqlParameter("@doctype ", SqlDbType.VarChar, 10)).Value = CType(row("purchaseinvoicetype"), String)
    '                ' End If
    '                mySqlCmd.Parameters.Add(New SqlParameter("@acc_code", SqlDbType.VarChar, 20)).Value = CType(row("partycode"), String) ' - -ddlgAccCode.Text
    '                mySqlCmd.Parameters.Add(New SqlParameter("@acc_type", SqlDbType.VarChar, 1)).Value = CType(row("suppliertype"), String) ' collectionDate("AccType" & strLineKey).ToString

    '                mySqlCmd.Parameters.Add(New SqlParameter("@debit", SqlDbType.Money)).Value = 0
    '                mySqlCmd.Parameters.Add(New SqlParameter("@credit", SqlDbType.Money)).Value = Convert.ToDecimal(CType(row("total_actualamount"), String))
    '                mySqlCmd.Parameters.Add(New SqlParameter("@basedebit", SqlDbType.Money)).Value = 0
    '                mySqlCmd.Parameters.Add(New SqlParameter("@basecredit", SqlDbType.Money)).Value = Convert.ToDecimal(row("total_actualamount")) * Convert.ToDecimal(row("convrate"))
    ...
    '    mySqlCmd.Parameters.Add(New SqlParameter("@div_id", SqlDbType.VarChar, 10)).Value = txtDivcode.Text
    '    mySqlCmd.Parameters.Add(New SqlParameter("@doclineno", SqlDbType.Int)).Value = 1
    '    mySqlCmd.Parameters.Add(New SqlParameter("@docno", SqlDbType.VarChar, 20)).Value = txtDocNo.Text
    '    mySqlCmd.Parameters.Add(New SqlParameter("@doctype ", SqlDbType.VarChar, 10)).Value = "PI" 'CType(ViewState("CNDNOpen_type"), String)
    '    mySqlCmd.Parameters.Add(New SqlParameter("@docdate", SqlDbType.DateTime)).Value = Format(CType(txtDocDate.Text, Date), "yyyy/MM/dd")

    '    mySqlCmd.Parameters.Add(New SqlParameter("@acc_code", SqlDbType.VarChar, 20)).Value = Trim(txtSupplierCode.Text)

    '    '   If ViewState("SupplierInvoiceState") = "New" Or ViewState("SupplierInvoiceState") = "Edit" Then

    '    If ddlType.SelectedValue = "Supplier" Then
    '        mySqlCmd.Parameters.Add(New SqlParameter("@acc_type", SqlDbType.VarChar, 1)).Value = "S"
    '    Else

    '        mySqlCmd.Parameters.Add(New SqlParameter("@acc_type", SqlDbType.VarChar, 1)).Value = "A"
    '    End If


    '    mySqlCmd.Parameters.Add(New SqlParameter("@against_tran_id ", SqlDbType.VarChar, 20)).Value = ""
    '    mySqlCmd.Parameters.Add(New SqlParameter("@against_tran_type", SqlDbType.VarChar, 10)).Value = ""
    '    mySqlCmd.Parameters.Add(New SqlParameter("@against_tran_lineno", SqlDbType.Int)).Value = 1
    '    mySqlCmd.Parameters.Add(New SqlParameter("@acc_gl_code", SqlDbType.VarChar, 20)).Value = txtCtrlAcctCode.Text
    '    mySqlCmd.Parameters.Add(New SqlParameter("@duedate ", SqlDbType.DateTime)).Value = Format(CType(txtDocDate.Text, Date), "yyyy/MM/dd")
    '    mySqlCmd.Parameters.Add(New SqlParameter("@currrate", SqlDbType.Decimal, 18, 12)).Value = CType(txtConvRate.Text, Decimal)
    '    mySqlCmd.Parameters.Add(New SqlParameter("@field1", SqlDbType.VarChar, 500)).Value = "" 'Trim(txtbookingno.Text)
    '    mySqlCmd.Parameters.Add(New SqlParameter("@field2", SqlDbType.VarChar, 500)).Value = txtNarration.Text
    '    mySqlCmd.Parameters.Add(New SqlParameter("@field3 ", SqlDbType.VarChar, 500)).Value = txtRequestId.Text
    '    mySqlCmd.Parameters.Add(New SqlParameter("@field4", SqlDbType.VarChar, 500)).Value = txtInvoiceNo.Text
    ...
    '        If ViewState("SupplierInvoiceState") <> "Delete" Then
    '            mySqlCmd.Parameters.Add(New SqlParameter("@debit", SqlDbType.Money)).Value = 0
    '            mySqlCmd.Parameters.Add(New SqlParameter("@credit", SqlDbType.Money)).Value = Convert.ToDecimal(lblTotalActualAmt.Text)
    '            mySqlCmd.Parameters.Add(New SqlParameter("@basedebit", SqlDbType.Money)).Value = 0
    '            mySqlCmd.Parameters.Add(New SqlParameter("@basecredit", SqlDbType.Money)).Value = Convert.ToDecimal(lblTotalActualAmt.Text) * Convert.ToDecimal(txtConvRate.Text)
    '        Else
    '            mySqlCmd.Parameters.Add(New SqlParameter("@debit", SqlDbType.Money)).Value = 0
    '            mySqlCmd.Parameters.Add(New SqlParameter("@credit", SqlDbType.Money)).Value = -Convert.ToDecimal(lblTotalActualAmt.Text)
    '            mySqlCmd.Parameters.Add(New SqlParameter("@basedebit", SqlDbType.Money)).Value = 0
    ...
    'End Sub
    Private Sub AdjustCommissionAmount(servicetype As String, dt As DataTable, decimalplaces As Integer)
    ...
    Private Sub AdjustNonTaxAmount(servicetype As String, dt As DataTable, decimalplaces As Integer)
        If servicetype.ToLower = "hotel" Or servicetype.ToLower = "specialevent" Then
            Dim AdjustFirstRowValue As Decimal
            If dt.Rows.Count > 1 Then
    ...
    Private Sub AdjustTaxAmount(servicetype As String, dt As DataTable, decimalplaces As Integer)
        If servicetype.ToLower = "hotel" Or servicetype.ToLower = "specialevent" Then
            Dim AdjustFirstRowValue As Decimal
            If dt.Rows.Count > 1 Then
    ...
    Private Sub AdjustVatAmount(servicetype As String, dt As DataTable, decimalplaces As Integer)
        If servicetype.ToLower = "hotel" Or servicetype.ToLower = "specialevent" Then
            Dim AdjustFirstRowValue As Decimal
            If dt.Rows.Count > 1 Then
...
#Region "  Private Sub CalculateGvPricelistTotals(dt As DataTable, decimalplaces As Integer)"
    Private Sub CalculateGvPricelistTotals(dt As DataTable, decimalplaces As Integer)
...
#Region "Protected Sub gvUpdateSupplier_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvUpdateSupplier.RowDataBound"
    Protected Sub gvUpdateSupplier_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvUpdateSupplier.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            ''Tanvir 11032024
            'If lblServiceType.Text.ToUpper.Trim <> "HOTEL" Then
            '    txtNonTaxAmtBase.Text = Math.Round(Val(txtNonTaxAmt.Text) * Convert.ToDecimal(txtConvRate.Text), decimalPlaces)
            '    txtTaxAmtBase.Text = Math.Round(Val(txtTaxAmt.Text) * Convert.ToDecimal(txtConvRate.Text), decimalPlaces)
            '    txtCostVatAmtBase.Text = Math.Round(Val(txtCostVatAmt.Text) * Convert.ToDecimal(txtConvRate.Text), decimalPlaces)
            'Else
            '    txtNonTaxAmtBase.Text = Math.Round(Val(txtNonTaxAmt.Text), decimalPlaces) ' * Convert.ToDecimal(txtConvRate.Text)
            '    txtTaxAmtBase.Text = Math.Round(Val(txtTaxAmt.Text), decimalPlaces) ' * Convert.ToDecimal(txtConvRate.Text)
            '    txtCostVatAmtBase.Text = Math.Round(Val(txtCostVatAmt.Text), decimalPlaces) '* Convert.ToDecimal(txtConvRate.Text)
            'End If
...
#Region "Protected Sub CalculateTotal(ByVal gvr As GridViewRow)"
    Protected Sub CalculateTotal(ByVal gvr As GridViewRow)
        ...
        'End If
        txtTotalAmt.Text = Math.Round(total, decimalPlaces).ToString()
        ...
        End If
        txtTotalAmtBase.Text = Math.Round(totalBase, decimalPlaces).ToString()
    End Sub
#End Region
            ...
            For Each gvr As GridViewRow In gvUpdateSupplier.Rows
                ...
                If chkSelection.Checked Then
                    ...
                    If CType(txtCurrencyCode.Text, String) <> baseCurrency And (CType(lblServiceType.Text.ToLower, String) = "others" Or lblServiceType.Text.ToLower = "tours") Then 'changed by mohamed on 16/06/2022 included tours with others
                        ...
                        End If
                        If IsNumeric(txtTotalAmt.Text) Then
                            NetTotalAmt = NetTotalAmt + (Convert.ToDecimal(txtTotalAmt.Text) * Convert.ToDecimal(txtConvRate.Text))
                        End If
                        If IsNumeric(txtCommisionAmt.Text) Then
                    ...
                    Else
                        ...
                        End If
                        If IsNumeric(txtTotalAmt.Text) Then
                            NetTotalAmt = NetTotalAmt + Convert.ToDecimal(txtTotalAmt.Text)
                        End If
                        If IsNumeric(txtCommisionAmt.Text) Then
...
#Region "Protected Function Validation() As Boolean"
    Protected Function Validation() As Boolean
        Try
            ...
            'Sharfudeen 09092023
            Dim baseCurrency As String = objUtils.ExecuteQueryReturnSingleValuenew(Session("dbconnectionName"), "select option_selected from reservation_parameters where param_id='457'")
            If txtCurrencyCode.Text.Trim <> baseCurrency.Trim And Val(txtConvRate.Text) = 1 Then
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Conversion Rate does not match for the selected currency');", True)
                Validation = False
                Exit Function
            End If
                ...
                If chkSelection.Checked Then
                    ...
                    If ViewState("SupplierInvoiceState") = "New" Or ViewState("SupplierInvoiceState") = "Edit" Then
                        ...
                        If IsNumeric(lbtnActualAmt.Text) And IsNumeric(txtTotalAmt.Text) Then
                            ...
                            If actualAmt <> totalAmt Then
                                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Actual Amount is not equal to Total Amount');", True)
                                txtNonTaxAmt.Focus()
                                Validation = False
                                Exit Function
                            End If
                        Else
                            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Actual Amount or Total Amount is not numeric');", True)
                            txtNonTaxAmt.Focus()
                            Validation = False
                            Exit Function
                        End If
            ...
            If ViewState("SupplierInvoiceState") = "New" And rowselected = False Then
                ...
                Exit Function
            End If
            If ViewState("SupplierInvoiceState") = "New" Or ViewState("SupplierInvoiceState") = "Edit" Then 'Tanvir 10052024
                If txtInvoiceNo.Text = "" Then
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            If (ViewState("SupplierInvoiceState") = "New" Or ViewState("SupplierInvoiceState") = "Edit") Then 'Tanvir 28092022
                ...
                End If
                mySqlCmd.Parameters.Add(New SqlParameter("@hotelinvoiceno", SqlDbType.VarChar, 20)).Value = txtInvoiceNo.Text  'add param on 09/06/2021
                ...
                Dim lblRequestId, lblCheckIn, lblCheckOut, lblPax, lblPaxType, lblService, lblServiceType, lblSupConfNo, lblProvAmt, lblVatInputProvAmount, lblGuestDetails As Label
                ...
                For Each dr As GridViewRow In gvUpdateSupplier.Rows
                    ...
                    If chkSelection.Checked = True Then
                        ...
                        txtRlineNo = CType(dr.FindControl("txtRlineNo"), TextBox)
                        txtRoomNo = CType(dr.FindControl("txtRoomNo"), TextBox)
                        lblCheckIn = CType(dr.FindControl("lblCheckIn"), Label)
                        lblCheckOut = CType(dr.FindControl("lblCheckOut"), Label)
                        lblPax = CType(dr.FindControl("lblPax"), Label)
                        lblService = CType(dr.FindControl("lblService"), Label)
                        lblServiceType = CType(dr.FindControl("lblServiceType"), Label)
                        lblSupConfNo = CType(dr.FindControl("lblSupConfNo"), Label)
                        lblProvAmt = CType(dr.FindControl("lblProvAmt"), Label)
                        lblVatInputProvAmount = CType(dr.FindControl("lblVatInputProvAmt"), Label)
                        txtNonTaxAmt = CType(dr.FindControl("txtNonTaxAmt"), TextBox)
                        txtTaxAmt = CType(dr.FindControl("txtTaxAmt"), TextBox)
                        txtVatPerc = CType(dr.FindControl("txtVatPerc"), TextBox)
                        txtCostVatAmt = CType(dr.FindControl("txtCostVatAmt"), TextBox)
                        txtTotalAmt = CType(dr.FindControl("txtTotalAmt"), TextBox)
                        txtCommisionAmt = CType(dr.FindControl("txtCommisionAmt"), TextBox)
                        lbtnActualAmt = CType(dr.FindControl("lbtnActualAmt"), LinkButton)
                        lblGuestDetails = CType(dr.FindControl("lblGuestDetails"), Label)
                        lblPaxType = CType(dr.FindControl("lblPaxType"), Label)
                        ...
                        Else
                            ...
                            mySqlCmd.Parameters.Add(New SqlParameter("@totalprice", SqlDbType.Decimal)).Value = txtTotalAmt.Text.Trim
                            If hdnCommissionFlag.Value = "true" Then
                ...
                '' Merge the rows from dt into resultDataTable
                'resultDataTable.Merge(dt)


                'For Each row1 As DataRow In prrecordsadjusted.Rows
                '    Dim matchingRows() As DataRow = resultDataTable.Select(
                '        "div_id = " & row1("div_id") &
                '        " AND doclineno = " & row1("doclineno") &
                '        " AND doctype = '" & row1("doctype") & "'" &
                '        " AND docno = '" & row1("docno") & "'"
                '    )

                '    If matchingRows.Length = 0 Then
                '        ' If the record is not in resultDataTable, take it from prrecordsadjusted
                '        resultDataTable.ImportRow(row1)
                '    End If
                'Next

                'If Not Session("PIRecords") Is Nothing Then
                '    Dim dt1 As DataTable = DirectCast(Session("PIRecords"), DataTable)

                '    'If dt1.Rows.Count > 0 Then
                '    '    Session("PIRecords") = CType(dt1, DataTable)
                '    'End If



                '    ' Clone the structure of the first DataTable (resultDataTable)
                '    Dim resultDataTable1 As DataTable = resultDataTable.Clone()

                '    ' Merge the rows from resultDataTable into the cloned DataTable
                '    resultDataTable1.Merge(resultDataTable)

                '    ' Iterate through rows in piRecords and import them into the cloned DataTable if they don't exist already
                '    For Each row1 As DataRow In dt1.Rows
                '        Dim matchingRows() As DataRow = resultDataTable1.Select(
                '            "div_id = " & row1("divcode") &
                '            " AND doclineno = " & row1("rlineno") &
                '            " AND doctype = '" & row1("purchaseinvoicetype") & "'" &
                '            " AND docno = '" & row1("purchaseinvoiceno") & "'"
                '        )

                '        If matchingRows.Length = 0 Then
                '            ' If the record is not in the cloned DataTable, take it from piRecords
                '            Dim newRow As DataRow = resultDataTable1.NewRow()

                '            newRow("div_id") = row1(" divcode")
                '            newRow("docno") = row1(" purchaseinvoiceno ")
                '            newRow("doctype ") = row1("purchaseinvoicetype")
                '            newRow("debit") = row1("totalprice")
                '            '  newRow("docno") = row1("docno")

                '            ' Add the new row to resultDataTable
                '            resultDataTable.Rows.Add(newRow)
                '            resultDataTable1.ImportRow(row1)
                '        End If
                '    Next
                '    'If Not Session("opendetail_records") Is Nothing Then
                '    '    Dim dt As DataTable = DirectCast(Session("opendetail_records"), DataTable)
                '    '    'Dim filterExpression As String = "  div_code = " & strdiv & " " ' and against_tran_lineno=1 ' against_tran_id =" & txtDocNo.Value & "  and   against_tran_type='" & CType(ViewState("ReceiptsRVPVTranType"), String) & "' And 
                'End If
                ...
                ' Save_Pending_invoices(ViewState("SupplierInvoiceState"), sqlConn, sqlTrans)
            ...
            ElseIf ViewState("SupplierInvoiceState") = "Delete" Then
                ...
                'mySqlCmd = New SqlCommand("sp_del_supplierinvoice", sqlConn, sqlTrans)
                'mySqlCmd.CommandType = CommandType.StoredProcedure
                'mySqlCmd.Parameters.Add(New SqlParameter("@div_id ", SqlDbType.VarChar, 10)).Value = txtDivcode.Text
                'mySqlCmd.Parameters.Add(New SqlParameter("@tran_id", SqlDbType.VarChar, 20)).Value = txtDocNo.Text
                'mySqlCmd.Parameters.Add(New SqlParameter("@tran_type", SqlDbType.VarChar, 10)).Value = "SIN"
                'mySqlCmd.ExecuteNonQuery()
