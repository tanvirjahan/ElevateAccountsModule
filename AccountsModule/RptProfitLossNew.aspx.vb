'------------================--------------=======================------------------================
'   Module Name    :    RptProfitLossNew.aspx
...
Partial Class RptProfitLossNew
        ...
        Try
            ...
            Else
                objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String),
                                                   CType(strappname, String), "AccountsModule\RptProfitLossNew.aspx?appid=" + strappid, btnadd, Button1, btnLoadReprt, gv_SearchResult)
            End If
...
#End Region
    ...
    Protected Sub btnLoadReprt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLoadReprt.Click
        Try
            ...
            'Session.Add("Pageame", "RptProfitLossNew")
            'Session.Add("BackPageName", "RptProfitLossNew.aspx")
        ...
        Catch ex As Exception
            ...
            objUtils.WritErrorLog("RptProfitLossNew.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        End Try
    ...
    Protected Sub btnhelp_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=RptProfitLossNew','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    End Sub
    ...
    Protected Sub btnExcelReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExcelReport.Click
        Try
            ...
            Dim strpop As String = ""
            strpop = "window.open('TransactionReports.aspx?printId=ProfitLossNew&reportsType=excel&pagetype=B&todate=" & strtodate & "&newformat=" & IIf(chknew.Checked = True, 1, 0) & "&divid=" & divcode & "&level=" & strlevel & "','RepPLSheet');"
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            'End If
        Catch ex As Exception
            If mySqlConn.State = ConnectionState.Open Then
