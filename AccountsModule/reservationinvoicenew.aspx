<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false"
    CodeFile="reservationinvoicenew.aspx.vb" Inherits="reservationinvoicenew" %>
                ...
                <tbody>
                    <tr>
                        <td style="text-align: center" colspan="6">
                            <asp:Label ID="lblHeading" runat="server" Text="Reservation Invoice" Width="100%"
                    ...
                    <tr>
                        ...
                        <td style="height: 23px">
                            <select style="width: 136px" id="ddlBookingType" class="drpdown" tabindex="13"
                                runat="server">
                    ...
                    <tr>
                        ...
                        <td style="width: 415px">
                            &nbsp;
                            <asp:Button ID="btnCancel" runat="server" Text="Return To Search" CssClass="btn"
                                Width="118px"></asp:Button>&nbsp;<asp:Button ID="btnHelp" OnClick="btnHelp_Click"
                    ...
                    <tr>
                        <td style="height: 147px" colspan="4">
                            <div id="divRes" class="container" runat="server">
                                <asp:GridView ID="gvSearchResult" DataKeyNames="customer" runat="server" CssClass="grdstyle"
