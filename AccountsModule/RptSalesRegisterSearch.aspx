<%@ Page Language="VB" MasterPageFile="~/AccountsMaster.master" AutoEventWireup="false"
    CodeFile="RptSalesRegisterSearch.aspx.vb" Inherits="RptSalesRegisterSearch" %>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <select style="width: 200px" id="ddlCustomer" class="drpdown MyDropDownListCustValue"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select style="width: 165px" id="ddlrpttype" class="field_input" tabindex="11" onchange="ChangeRepType();"
                                                                runat="server">
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblBookType" runat="server" Text="Book Type" Width="62px"></asp:Label>
                                                        </td>
