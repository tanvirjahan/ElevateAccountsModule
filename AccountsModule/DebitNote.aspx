<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DebitNote.aspx.vb" Inherits="DebitNote" MasterPageFile= "~/SubPageMaster.master" strict="true"  %>
       ...
       switch(methodType)
        {
            case "customercode":
                ...
                if (strdate != "")
                {
                    sqlstr="select crdays from view_account where div_code='" + divcode.value + "' and Code = '"+ codeid +"' and type= '"+ typ +"'";
...
function FillCustDDL(ddltp,lblcustcd,lblcustnm)
{
    ...
    sqlstr1 = "select top 10 Code,des from view_account where div_code='" + divcode.value + "'  order by code";
    sqlstr2 = "select top 10  des,Code from view_account  where div_code='" + divcode.value + "'  order by des";
    }
var connstr=document.getElementById("<%=txtconnection.ClientID%>");  
constr=connstr.value   
...
function FillCustDetails(typ,codeid) {
    ...
    var crdsqlstr="select cur,convrate,controlacctcode    from  view_account left outer join    currrates on  view_account.cur=currrates.currcode and tocurr = (select option_selected from reservation_parameters where param_id=457) where div_code='" + divcode.value + "'  and code = '"+ codeid +"' and type='"+typ  +"' ";
    var connstr = document.getElementById("<%=txtconnection.ClientID%>");
    constr = connstr.value  
    var sqlstr11
    sqlstr11 = "";
    ...
    if (typ == 'C') {
        sqlstr11 = "select '' plgrpcode,agentcode    from  agentmast  where divcode='" + divcode.value + "' and agentcode = '" + codeid + "'";
        ColServices.clsServices.GetQueryReturnStringArraynew(constr, sqlstr11, 2, Fillmarket, ErrorHandler, TimeOutHandler);
    }

}
function Fillmarket(result) {
    ddlMarketname = document.getElementById("<%=ddlSMktName.ClientID%>");
    ddlMarketcode = document.getElementById("<%=ddlSMktCode.ClientID%>");
    ddlMarketname.value = result[0];
    var codeid1 = ddlMarketname.options[ddlMarketname.selectedIndex].text;
    ddlMarketcode.value = codeid1;    
...
{   
    ...
    var sqlstr1,sqlstr2,sqlstr3,sqlstr4
    sqlstr1="";
    sqlstr2 = "";
    sqlstr3 = "";
    sqlstr4 = "";
    if (strtp=='C')
    {
        ...
        sqlstr3 = " select distinct '' plgrpcode, '' plgrpname  from agentmast where  agentmast.divcode='" + divcode.value + "'   and agentmast.agentcode='" + codeid + "' ";
        sqlstr4 = " select distinct  '' plgrpname,'' plgrpcode  from agentmast  where   agentmast.divcode='" + divcode.value + "' and  agentmast.agentcode='" + codeid + "'";
    }
     else if (strtp=='S')
    {
    ...
    sqlstr3 = " select  plgrpcode, plgrpname  from plgrpmast  order by  plgrpcode";
    sqlstr4 = " select  plgrpname,plgrpcode  from plgrpmast  order by  plgrpname";
    ...
    ColServices.clsServices.GetQueryReturnStringListnew(constr, sqlstr2, FillConAccNames, ErrorHandler, TimeOutHandler);
       ...
       ColServices.clsServices.GetQueryReturnStringListnew(constr, sqlstr3, FillMarketCodes, ErrorHandler, TimeOutHandler);
    ColServices.clsServices.GetQueryReturnStringListnew(constr, sqlstr4, FillMarketNames, ErrorHandler, TimeOutHandler);
...
function grdTotal()
{
     ...
     for(j=1;j<=intRows;j++)
    {
       ...
       var crval=objGridView.rows[j].cells[3].children[0].value;
       var kval=objGridView.rows[j].cells[4].children[0].value;
...
<TD style="HEIGHT: 18px" class="td_cell" colSpan=3><SELECT style="WIDTH: 300px" id="ddlConAccName" class="field_input" tabIndex=9 onchange="CallWebMethod('controlacname');" runat="server"> <OPTION selected></OPTION></SELECT></TD></TR>
    ...
    <tr>
       <td style="width: 74px;  height: 22px;display:none" class="td_cell">
                                            ...
                                            <td style="width: 100px;  height: 22px;display:none" class="td_cell">
...
<SELECT style="WIDTH: 278px" id="ddlAccountName" class="field_input MyDropDownListCustValue" runat="server"> <OPTION selected></OPTION></SELECT> 
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField HeaderText="Cost Center Code" Visible="False"><ItemTemplate>
&nbsp;<SELECT style="WIDTH: 108px" id="ddlCostCode" class="field_input" runat="server" > <OPTION value="Gen" selected></OPTION></SELECT> 
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField HeaderText="Cost Center Name" Visible="False" ><ItemTemplate>
...
<TR><TD class="td_cell" colSpan=6>
        ...
        <asp:Button id="btnDelLine" tabIndex=17 onclick="btnDelLine_Click" 
            ...
            CausesValidation="False"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sub Total&nbsp;&nbsp;<INPUT style="WIDTH: 96px; TEXT-ALIGN: right" id="txtCurrTotal" class="field_input" disabled type=text runat="server" /> <INPUT style="WIDTH: 96px; TEXT-ALIGN: right" id="txtKWDTotal" class="field_input" disabled type=text runat="server" /></TD></TR>
<TR><TD class="td_cell" align=left colSpan=6>
    ...
    <td class="td_cell" colspan ="6" align ="center">
     <asp:CheckBox id="chkPost" tabIndex=19 runat="server" Text="Post/UnPost" Font-Size="10px" Font-Names="Verdana" Width="103px"
      CssClass="field_caption" ForeColor="Black" Font-Bold="True" BackColor="#FFC0C0" Checked="true"></asp:CheckBox>&nbsp; 
        <asp:Button id="btnSave" tabIndex=20  runat="server" 
    ...
    <TD style="HEIGHT: 26px" class="td_cell" align=right colSpan=6>
    <input id="txtconnection" runat="server" style="visibility: hidden; width: 12px;
        height: 9px" type="text" />
        <input style="visibility: hidden; width: 29px" id="txtDivCode"
    ...
    <INPUT style="VISIBILITY: hidden; WIDTH: 29px" id="txtAdjcolno" type=text maxLength=20 runat="server" /> 
    <INPUT style="VISIBILITY: hidden; WIDTH: 9px" id="txtbasecurr" type=text maxLength=20 runat="server" />
     <INPUT style="VISIBILITY: hidden; WIDTH: 5px" id="txtConAccName" type=text maxLength=100 runat="server" />
      ...
      <INPUT style="VISIBILITY: hidden; WIDTH: 5px" id="txtcustcode" type=text maxLength=100 runat="server" /> 
      <INPUT style="VISIBILITY: hidden; WIDTH: 5px" id="txtcustname" type=text maxLength=200 runat="server" />
...
<INPUT style="VISIBILITY: hidden; WIDTH: 1px" id="txtdecimal" type=text maxLength=15 runat="server" /> 
            ...
            <cc1:CalendarExtender id="ClsExFromDate" runat="server" PopupButtonID="ImgBtnFrmDt" TargetControlID="txtDate" Format="dd/MM/yyyy">
            

            </cc1:CalendarExtender> <cc1:CalendarExtender id="ClsExRevDate" runat="server" PopupButtonID="ImgBtnRevDate" TargetControlID="txtDueDate" Format="dd/MM/yyyy">
