<%@ Page Language="VB" MasterPageFile="~/AccountsMaster.master" AutoEventWireup="false" CodeFile="BankTypesSearch.aspx.vb" Inherits="BankTypesSearch" %>
...
<script type="text/javascript" charset="utf-8">
    ...
    function ValidateChkInDate() {
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('BANKTYPE:" " TEXT:" "');
          window.visualSearch = VS.init({
            ...
            'access'
              ...
              callbacks: {
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      switch (category) {
                          case 'BANKTYPE':
                              var asSqlqry = '';
                              glcallback = callback;
                              ColServices.clsSectorServices.GetListOfBankdetailsVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                              break;
                      }
                  },
                ...
                { label: 'BANKTYPE', category: 'BANKTYPE' },
              ]);
                  }
              }
          });
...
<TABLE style="WIDTH: 944px"><TBODY><TR><TD style="TEXT-ALIGN: center" 
        class="field_heading">Bank Types List</TD></TR>
...
<Columns>
<asp:TemplateField SortExpression="bank_master_type_code" Visible="False" HeaderText="Bank Type Code"><EditItemTemplate>
<asp:TextBox id="TextBox1" runat="server" Text='<%# Bind("bank_master_type_code") %>' __designer:wfdid="w2"></asp:TextBox> 
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblCode" runat="server" Text='<%# Bind("bank_master_type_code") %>' __designer:wfdid="w1"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField="bank_master_type_code" SortExpression="bank_master_type_code" HeaderText="Bank Type Code"></asp:BoundField>

                                         <asp:TemplateField HeaderText="Bank Type Name" SortExpression="bank_master_type_des">
                    <ItemTemplate>
                        <asp:Label ID="lblbankname" runat="server" Text='<%# Bind("bank_master_type_des") %>'></asp:Label>
                    </ItemTemplate>
                    <ControlStyle  />
...
<asp:BoundField DataField="cashbanktype"  SortExpression="cashbanktype" HeaderText="Cash/Bank Type"></asp:BoundField>
