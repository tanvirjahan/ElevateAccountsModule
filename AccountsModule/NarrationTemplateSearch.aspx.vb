'------------================--------------=======================------------------================
'   Page Name       :   NarrationTemplateSearch.aspx
...
Partial Class NarrationTemplateSearch
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            Try
                ...
                Dim AppName As String = objUser.GetAppName(Session("dbconnectionName"), AppId)
                ...
                If ViewState("divcode") Is Nothing = False Then
                    strappid = AppId
                End If
                ...
                Else
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                                       CType(strappname, String), "AccountsModule\NarrationTemplateSearch.aspx?appid=" + strappid, btnAddNew, btnExportToExcel, _
                ...
                '--------end
                Session.Add("strsortExpression", "code")
            ...
            Catch ex As Exception
                ...
                objUtils.WritErrorLog("NarrationTemplateSearch.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
            End Try
        End If
        'btnClear.Attributes.Add("onclick", "javascript:if(confirm('Are you sure you want to clear search criteria?')==false)return false;")
        ClientScript.GetPostBackEventReference(Me, String.Empty)
        If (Me.IsPostBack And Me.Request("__EVENTTARGET") = "NarrationTempWindowPostBack") Then
...
#Region "Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = 'ASC')"
    Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        strSqlQry = ""
        Try
            strSqlQry = "SELECT code,narration,[Active]=case when active=1 then 'Active' when active=0 then 'In Active' end,adddate," & _
                        " adduser, moddate, moduser FROM narration"
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnAddNew.Click
        ...
        'Response.Redirect("NarrationTemplate.aspx", False)
        Dim strpop As String = ""
        'strpop = "window.open('NarrationTemplate.aspx?State=New','NarrationTemp','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
        strpop = "window.open('NarrationTemplate.aspx?State=New','NarrationTemp');"
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        ...
        Try
            ...
            If e.CommandName = "EditRow" Then
                Dim strpop As String = ""
                'strpop = "window.open('NarrationTemplate.aspx?State=Edit&RefCode=" + CType(lblId.Text.Trim, String) + "','NarrationTemp','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('NarrationTemplate.aspx?State=Edit&RefCode=" + CType(lblId.Text.Trim, String) + "','NarrationTemp');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ElseIf e.CommandName = "View" Then
                Dim strpop As String = ""
                'strpop = "window.open('NarrationTemplate.aspx?State=View&RefCode=" + CType(lblId.Text.Trim, String) + "','NarrationTemp','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('NarrationTemplate.aspx?State=View&RefCode=" + CType(lblId.Text.Trim, String) + "','NarrationTemp');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ElseIf e.CommandName = "DeleteRow" Then
                Dim strpop As String = ""
                'strpop = "window.open('NarrationTemplate.aspx?State=Delete&RefCode=" + CType(lblId.Text.Trim, String) + "','NarrationTemp','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('NarrationTemplate.aspx?State=Delete&RefCode=" + CType(lblId.Text.Trim, String) + "','NarrationTemp');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If
        Catch ex As Exception
            objUtils.WritErrorLog("NarrationTemplateSearch.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
...
#Region " Protected Sub gv_SearchResult_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gv_SearchResult.Sorting"
    ...
    Protected Sub gv_SearchResult_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gv_SearchResult.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim lblnarration As Label = e.Row.FindControl("lblnarration")
            ...
            If Session("sDtDynamic") IsNot Nothing Then
                If dtDynamics.Rows.Count > 0 Then
                    ...
                    For j = 0 To dtDynamics.Rows.Count - 1
                        ...
                        If "NARRATION" = dtDynamics.Rows(j)("code").ToString.Trim.ToUpper Then
                        ...
                        If lsCurrencyName.Trim <> "" Then
                            lblnarration.Text = Regex.Replace(lblnarration.Text.Trim, lsCurrencyName.Trim(), _
    ...
    Protected Sub btnExportToExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnExportToExcel.Click
        ...
        Try
            If gv_SearchResult.Rows.Count <> 0 Then
                ...
                strSqlQry = "SELECT code AS [Code],narration AS [Narration]," & _
...
#Region "Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click"
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnPrint.Click
        Try
            ...
            'Session.Add("Pageame", "Narration Template")
            'Session.Add("BackPageName", "NarrationTemplateSearch.aspx")

            Dim strpop As String = ""

            strpop = "window.open('rptReportNew.aspx?Pageame=Narration Template&BackPageName=NarrationTemplateSearch.aspx','ProfitCenterMast');"
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
...
#End Region
        ...
        For i = 0 To lsMainArr.GetUpperBound(0)
            Select Case lsMainArr(i).Split(":")(0).ToString.ToUpper.Trim
                Case "NARRATION"
                    ...
                    sbAddToDataTable("NARRATION", lsProcessCity, "N")
                Case "TEXT"
    ...
    Private Function BuildConditionNew(ByVal strCurrencyValue As String, ByVal strTextValue As String) As String
        ...
        If strCurrencyValue.Trim <> "" Then
            If Trim(strWhereCond) = "" Then
                strWhereCond = "upper(narration.narration) IN (" & Trim(strCurrencyValue.Trim.ToUpper) & ")"
                'Else
            ...
            For i = 0 To lsMainArr.GetUpperBound(0)
                ...
                If strValue <> "" Then
                    If Trim(strWhereCond1) = "" Then
                        strWhereCond1 = "(upper(narration.narration) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%')"
                    Else
                        strWhereCond1 = strWhereCond1 & " OR  (upper(narration.narration) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    End If
                End If
            Next
        ...
        If txtFromDate.Text.Trim <> "" And txtToDate.Text <> "" Then
            ...
            If ddlOrder.SelectedValue = "C" Then
                If Trim(strWhereCond) = "" Then
                    ...
                    strWhereCond = " (CONVERT(datetime, convert(varchar(10),narration.adddate,103),103)  between CONVERT(datetime, '" + txtFromDate.Text + "',103) and CONVERT(datetime,  '" + txtToDate.Text + "',103)) "
                Else
                    strWhereCond = strWhereCond & "  and (CONVERT(datetime, convert(varchar(10),narration.adddate,103),103)  between CONVERT(datetime, '" + txtFromDate.Text + "',103) and CONVERT(datetime,  '" + txtToDate.Text + "',103)) "
                End If
            ElseIf ddlOrder.SelectedValue = "M" Then
                If Trim(strWhereCond) = "" Then

                    strWhereCond = " (CONVERT(datetime, convert(varchar(10),narration.moddate,103),103)  between CONVERT(datetime, '" + txtFromDate.Text + "',103) and CONVERT(datetime,  '" + txtToDate.Text + "',103)) "
                Else
                    strWhereCond = strWhereCond & "  and (CONVERT(datetime, convert(varchar(10),narration.moddate,103),103)  between CONVERT(datetime, '" + txtFromDate.Text + "',103) and CONVERT(datetime,  '" + txtToDate.Text + "',103)) "
                End If
            End If
        End If
    ...
    Protected Sub btnhelp_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=NarrationTemplateSearch','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    End Sub
