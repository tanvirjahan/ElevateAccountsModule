                ...
                Select m))
                        ...
                        If amendVal.Count > 0 Then
                            ...
                            If modBooking.Count > 0 Then
                                ...
                                Else
                                    finalAmendDt = amendValDt ' finalValDt
                                End If
                                For Each row In modBooking
                                    row.Delete()
                                Next
...
#End Region
    ...
    Protected Sub btnExcelNewBooking_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExcelNewBooking.Click
        ...
        Catch ex As Exception
            ModalPopupLoading.Hide()
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            objUtils.WritErrorLog("ImportBooking.aspx :: btnExcelNewBooking_Click :: ", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        Finally
            ModalPopupLoading.Hide()
        End Try
    End Sub
