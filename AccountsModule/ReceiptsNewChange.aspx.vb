...
#End Region
Partial Class ReceiptsNewChange
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Page.IsPostBack = False Then
            Try
                ...
                createjournaldatatable() 'Tanvir 26102023
...
#End Region
        ...
        For Each gvrow In grdReceipt.Rows
            ...
            If ddlAccType.Value <> "[Select]" And ddlgAccCode.Value <> "[Select]" Then
                If Val(txtCurrRate.Value) = 0 Then
                    strQry = "select convrate from  view_account left outer join " &
    ...
    Private Sub FillCashBankDetails()
        ...
        If ddlCashBank.Value = "Bank" Then
            strSqlQry1 = "select acctcode,acctname from acctmast ,bank_master_type where acctmast.div_code='" & ViewState("divcode") & "' and  acctmast.bank_master_type_code = bank_master_type.bank_master_type_code" &
            " and bank_master_type.cashbanktype='B'  and  bankyn='Y' order by acctcode "
            strSqlQry2 = "select acctname, acctcode from acctmast ,bank_master_type where acctmast.div_code='" & ViewState("divcode") & "' and  acctmast.bank_master_type_code = bank_master_type.bank_master_type_code" &
            " and bank_master_type.cashbanktype='B'  and  bankyn='Y'  order by acctname"
            strSqlQry3 = "select  Currcode,acctcode  from acctmast ,bank_master_type where  acctmast.div_code='" & ViewState("divcode") & "' and acctmast.bank_master_type_code = bank_master_type.bank_master_type_code" &
            " and bank_master_type.cashbanktype='B'  and  bankyn='Y'  order by acctcode"
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            If Page.IsValid = True Then
                ...
                ' Rosalin 12/10/2023
                Dim newline1 As String = Environment.NewLine
                Dim grdReversePendingInvoiceXML As String = ""
                Dim newline As String = Environment.NewLine
                Dim grdReceiptXML As String = "<Root>" & newline
                Dim grdReceiptOpenDetXML As String = "<Root>" & newline
                Dim grdReceiptUpdatePendingInvXML As String = "<Root>" & newline
                Dim accTranXML As String = "<Root>" & newline
                Dim accSubTranXML As String = "<Root>" & newline
                ...
                If ViewState("ReceiptsState") = "New" Or ViewState("ReceiptsState") = "Edit" Or ViewState("ReceiptsState") = "Copy" Then
                    ...
                    'If ddlCashBank.Value = "Bank" Or (ddlCashBank.Value = "Cash" And CType(ViewState("ReceiptsRVPVTranType"), String) = "RV") Or
                    ...
                    If chkPost.Checked = True Then
                        accTranXML += "<AccTran>" & newline1
                        accTranXML += "<acc_tran_id>" & txtDocNo.Value & "</acc_tran_id>" & newline1
                        accTranXML += "<acc_tran_type>" & CType(ViewState("ReceiptsRVPVTranType"), String) & "</acc_tran_type>" & newline1
                        If ddlCashBank.Value = "Bank" Then
                            accTranXML += "<acc_tran_date>" & Format(CType(txtChequeDate.Text, Date), "yyyy/MM/dd") & "</acc_tran_date>" & newline1
                        Else
                            accTranXML += "<acc_tran_date>" & Format(CType(txtDate.Text, Date), "yyyy/MM/dd") & "</acc_tran_date>" & newline1
                        End If

                        accTranXML += "<acc_div_id>" & strdiv & "</acc_div_id>" & newline1
                        accTranXML += "<acc_code>" & TxtBankCode.Text & "</acc_code>" & newline1
                        accTranXML += "<acc_type>G</acc_type>" & newline1
                        accTranXML += "<acc_currency_id>" & txtcurrency.Value & "</acc_currency_id>" & newline1
                        accTranXML += "<acc_currency_rate>" & CType(txtConvRate.Value, Decimal) & "</acc_currency_rate>" & newline1
                        '-- divid
                        accTranXML += "<acc_narration>" & txtnarration.Text.Replace("&", "&amp; ") & "</acc_narration>" & newline1
                        '-- tran_date
                        accTranXML += "<acc_tran_lineno>0</acc_tran_lineno>" & newline1
                        '-- Acc_tran_type
                        accTranXML += "<pacc_gl_code></pacc_gl_code>" & newline1
                        accTranXML += "<acc_ref1>" & txtChequeNo.Value & "</acc_ref1>" & newline1
                        accTranXML += "<acc_ref2>" & Format(CType(txtChequeDate.Text, Date), "yyyy/MM/dd") & "</acc_ref2>" & newline1
                        accTranXML += "<acc_ref3></acc_ref3>" & newline1
                        accTranXML += "<acc_ref4></acc_ref4>" & newline1
                        accTranXML += "</AccTran>" & newline1

                        ' sub tran
                        accSubTranXML += "<AccSubTran>" & newline1
                        accSubTranXML += "<acc_against_tran_id>" & txtDocNo.Value & "</acc_against_tran_id>" & newline1
                        accSubTranXML += "<acc_against_tran_lineno>0</acc_against_tran_lineno>" & newline1
                        accSubTranXML += "<acc_against_tran_type>" & CType(ViewState("ReceiptsRVPVTranType"), String) & "</acc_against_tran_type>" & newline1

                        If CType(ViewState("ReceiptsRVPVTranType"), String) = "RV" Or CType(ViewState("ReceiptsRVPVTranType"), String) = "CV" Then
                            accSubTranXML += "<acc_debit>" & DecRound(CType(Val(txtAmount.Value), Decimal)) & "</acc_debit>" & newline1
                            accSubTranXML += "<acc_credit>0</acc_credit>" & newline1

                            accSubTranXML += "<acc_base_debit>" & DecRound(CType(Val(txtCnvAmount.Value), Decimal)) & "</acc_base_debit>" & newline1
                            accSubTranXML += "<acc_base_credit>0</acc_base_credit>" & newline1
                        Else
                            accSubTranXML += "<acc_credit>" & DecRound(CType(Val(txtAmount.Value), Decimal)) & "</acc_credit>" & newline1
                            accSubTranXML += "<acc_debit>0</acc_debit>" & newline1

                            accSubTranXML += "<acc_base_credit>" & DecRound(CType(Val(txtCnvAmount.Value), Decimal)) & "</acc_base_credit>" & newline1
                            accSubTranXML += "<acc_base_debit>0</acc_base_debit>" & newline1

                        End If


                        If ddlCashBank.Value = "Bank" Then
                            accSubTranXML += "<acc_tran_date>" & Format(CType(txtChequeDate.Text, Date), "yyyy/MM/dd") & "</acc_tran_date>" & newline1
                            accSubTranXML += "<acc_due_date>" & Format(CType(txtChequeDate.Text, Date), "yyyy/MM/dd") & "</acc_due_date>" & newline1
                        Else
                            accSubTranXML += "<acc_tran_date>" & Format(CType(txtDate.Text, Date), "yyyy/MM/dd") & "</acc_tran_date>" & newline1
                            accSubTranXML += "<acc_due_date>" & Format(CType(txtDate.Text, Date), "yyyy/MM/dd") & "</acc_due_date>" & newline1
                        End If
                        accSubTranXML += "<acc_field1></acc_field1>" & newline1
                        accSubTranXML += "<acc_field2></acc_field2>" & newline1
                        accSubTranXML += "<acc_field3></acc_field3>" & newline1
                        accSubTranXML += "<acc_field4></acc_field4>" & newline1
                        accSubTranXML += "<acc_field5></acc_field5>" & newline1
                        accSubTranXML += "<acc_tran_id>" & txtDocNo.Value & "</acc_tran_id>" & newline1
                        accSubTranXML += "<acc_tran_lineno>0</acc_tran_lineno>" & newline1
                        accSubTranXML += "<acc_tran_type>" & CType(ViewState("ReceiptsRVPVTranType"), String) & "</acc_tran_type>" & newline1
                        accSubTranXML += "<acc_narration>" & txtnarration.Text.Replace("&", "&amp; ") & "</acc_narration>" & newline1
                        accSubTranXML += "<acc_type>G</acc_type>" & newline1
                        accSubTranXML += "<currate>" & CType(txtConvRate.Value, Decimal) & "</currate>" & newline1
                        accSubTranXML += "<costcentercode></costcentercode>" & newline1
                        accSubTranXML += "<acc_code>" & TxtBankCode.Text & "</acc_code>" & newline1
                        accSubTranXML += "<pacc_gl_code></pacc_gl_code>" & newline1
                        accSubTranXML += "</AccSubTran>" & newline1
                    ...
                    If ViewState("ReceiptsState") = "Edit" Then
                        ...
                        If Not Session("opendetail_records") Is Nothing Then
                            grdReversePendingInvoiceXML = "<Root>" & newline1
                            Dim dataTable As DataTable = DirectCast(Session("opendetail_records"), DataTable)
                            Dim filterExpression As String = "  against_tran_id =" & txtDocNo.Value & "  and   against_tran_type='" & CType(ViewState("ReceiptsRVPVTranType"), String) & "' And  div_id = " & strdiv & " " ' and against_tran_lineno=1
                            Dim filteredRows() As DataRow = dataTable.Select(filterExpression)
                            Dim advpayment As Integer = 0
                            If ViewState("ReceiptsState") = "Edit" Then
                                For Each row As DataRow In filteredRows
                                    grdReversePendingInvoiceXML += "<ReversePending>" & newline1
                                    grdReversePendingInvoiceXML += "<div_id>" & strdiv & "</div_id>" & newline1
                                    grdReversePendingInvoiceXML += "<doclineno> " & CType(row("TRAN_LINENO"), String) & "</doclineno>" & newline1
                                    grdReversePendingInvoiceXML += "<docno>" & CType(row("tran_id"), String) & "</docno>" & newline1
                                    grdReversePendingInvoiceXML += "<doctype>" & CType(row("tran_type"), String) & "</doctype>" & newline1
                                    grdReversePendingInvoiceXML += "<acc_code>" & CType(row("ACC_CODE"), String) & "</acc_code>" & newline1
                                    grdReversePendingInvoiceXML += "<acc_type>" & CType(row("ACC_TYPE"), String) & "</acc_type>" & newline1
                                    grdReversePendingInvoiceXML += "<debit>" & DecRound(CType(row("open_Debit"), Decimal)) & "</debit>" & newline1
                                    grdReversePendingInvoiceXML += "<credit>" & DecRound(CType(row("open_credit"), Decimal)) & "</credit>" & newline1
                                    grdReversePendingInvoiceXML += "<basedebit>" & DecRound(CType(row("base_Debit"), Decimal)) & "</basedebit>" & newline1
                                    grdReversePendingInvoiceXML += "<basecredit>" & DecRound(CType(row("base_credit"), Decimal)) & "</basecredit>" & newline1
                                    grdReversePendingInvoiceXML += "</ReversePending>" & newline1
                                    ...
                                    'advpayment = 1
                                    ''Else
                                    ''myCommand.Parameters.Add(New SqlParameter("@docno", SqlDbType.VarChar, 20)).Value = collectionDate("TranId" & strLineKey).ToString
                                    ''myCommand.Parameters.Add(New SqlParameter("@doctype ", SqlDbType.VarChar, 10)).Value = collectionDate("TranType" & strLineKey).ToString
                                    ' ''End If
                            ...
                            End If
                            grdReversePendingInvoiceXML += "</Root>"
                        End If
                        ' Tanvir 02/10/2023 Point 6
                    End If
                    ...
                    For Each gvRow In grdReceipt.Rows
                        ...
                        ' Rosalin commented
                        '  If ddlCCCode.Value <> "[Select]" Then  'control code type check



                        If ddlAccType.Value <> "[Select]" And ddlgAccCode.Text <> "" Then
                            grdReceiptXML += "<Receipts>" & newline

                            grdReceiptXML += "<tran_lineno>" & lblno.Value & "</tran_lineno>" & newline
                            grdReceiptXML += "<tran_id>" & txtDocNo.Value & "</tran_id>" & newline
                            grdReceiptXML += "<tran_type>" & CType(ViewState("ReceiptsRVPVTranType"), String) & "</tran_type>" & newline
                            grdReceiptXML += "<receipt_acc_type>" & ddlAccType.Value & "</receipt_acc_type>" & newline
                            grdReceiptXML += "<receipt_acc_code>" & ddlgAccCode.Text & "</receipt_acc_code>" & newline
                            grdReceiptXML += "<receipt_gl_code>" & ddlConAccCode.Text & "</receipt_gl_code>" & newline
                            grdReceiptXML += "<receipt_narration>" & Trim(txtNarr.Value).Replace("&", "&amp; ") & "</receipt_narration>" & newline
                            grdReceiptXML += "<receipt_currency_id>" & txtCurrCodegrid.Value.Trim & "</receipt_currency_id>" & newline
                            grdReceiptXML += "<receipt_currency_rate>" & CType(txtCurrRate.Value, Decimal) & "</receipt_currency_rate>" & newline
                            grdReceiptXML += "<receipt_debit>" & DecRound(CType(Val(txtDebit.Value), Decimal)) & "</receipt_debit>" & newline
                            grdReceiptXML += "<receipt_credit>" & DecRound(CType(Val(txtCredit.Value), Decimal)) & "</receipt_credit>" & newline
                            grdReceiptXML += "<base_debit>" & DecRound(CType(Val(txtBaseDebit.Value), Decimal)) & "</base_debit>" & newline
                            grdReceiptXML += "<base_credit>" & DecRound(CType(Val(txtBaseCredit.Value), Decimal)) & "</base_credit>" & newline
                            grdReceiptXML += "<receipt_group>" & DBNull.Value & "</receipt_group>" & newline
                            grdReceiptXML += "<receipt_contra_ref_no>" & DBNull.Value & "</receipt_contra_ref_no>" & newline
                            grdReceiptXML += "<div_id>" & strdiv & "</div_id>" & newline
                            'grdReceiptXML += "<ddlAccType>" & ddlAccType.Value & "</ddlAccType>" & newline

                            Dim costcenter_code As String = ""
                            If ddlAccType.Value = "G" Then
                                If ddlCCCode.Value <> "[Select]" Then
                                    costcenter_code = ddlCCCode.Items(ddlCCCode.SelectedIndex).Text
                                Else
                                    costcenter_code = strcostcentercode
                                End If
                            Else
                                costcenter_code = DBNull.Value.ToString()
                            End If

                            grdReceiptXML += "<costcenter_code>" & costcenter_code & "</costcenter_code>" & newline
                            grdReceiptXML += "<requestid>" & IIf(txtrequestid.Value.Trim() <> "", txtrequestid.Value, "") & "</requestid>" & newline
                            grdReceiptXML += "<dept>" & IIf(txtsrcctrycode.Text.Trim() <> "", txtsrcctrycode.Text, "") & "</dept>" & newline
                            ...
                            If chkPost.Checked = True Then
                                ...
                                accTranXML += "<acc_div_id>" & strdiv & "</acc_div_id>" & newline1
                                accTranXML += "<acc_code>" & ddlgAccCode.Text & "</acc_code>" & newline1
                                accTranXML += "<acc_type>" & ddlAccType.Value & "</acc_type>" & newline1
                                accTranXML += "<acc_currency_id>" & txtCurrCodegrid.Value.Trim & "</acc_currency_id>" & newline1
                                accTranXML += "<acc_currency_rate>" & CType(txtCurrRate.Value, Decimal) & "</acc_currency_rate>" & newline1
                                '-- divid
                                accTranXML += "<acc_narration>" & Left(txtNarr.Value, 200).Replace("&", "&amp; ") & "</acc_narration>" & newline1
                                '-- tran_date
                                accTranXML += "<acc_tran_lineno>" & lblno.Value & "</acc_tran_lineno>" & newline1
                                '-- Acc_tran_type
                                If ddlAccType.Value <> "G" Then
                                    If ddlConAccCode.Text <> " " Then

                                        accTranXML += "<pacc_gl_code>" & ddlConAccCode.Text & "</pacc_gl_code>" & newline1
                                    Else
                                        accTranXML += "<pacc_gl_code></pacc_gl_code>" & newline1
                                    End If
                                Else
                                ...
                                If ddlAccType.Value = "G" Then
                                    accSubTranXML += "<AccSubTran>" & newline1
                                    accSubTranXML += "<acc_against_tran_id>" & txtDocNo.Value & "</acc_against_tran_id>" & newline1
                                    accSubTranXML += "<acc_against_tran_lineno>" & lblno.Value & "</acc_against_tran_lineno>" & newline1
                                    accSubTranXML += "<acc_against_tran_type>" & CType(ViewState("ReceiptsRVPVTranType"), String) & "</acc_against_tran_type>" & newline1

                                    If CType(ViewState("ReceiptsRVPVTranType"), String) = "RV" Or CType(ViewState("ReceiptsRVPVTranType"), String) = "CV" Then
                                        accSubTranXML += "<acc_debit>" & CType(Val(txtDebit.Value), Decimal) & "</acc_debit>" & newline1
                                        accSubTranXML += "<acc_credit>" & CType(Val(txtCredit.Value), Decimal) & "</acc_credit>" & newline1

                                        accSubTranXML += "<acc_base_debit>" & CType(Val(txtBaseDebit.Value), Decimal) & "</acc_base_debit>" & newline1
                                        accSubTranXML += "<acc_base_credit>" & CType(Val(txtBaseCredit.Value), Decimal) & "</acc_base_credit>" & newline1
                                    Else
                                        accSubTranXML += "<acc_debit>" & CType(Val(txtDebit.Value), Decimal) & "</acc_debit>" & newline1
                                        accSubTranXML += "<acc_credit>" & CType(Val(txtCredit.Value), Decimal) & "</acc_credit>" & newline1
                                    ...
                                    accSubTranXML += "<acc_field5></acc_field5>" & newline1
                                    accSubTranXML += "<acc_tran_id>" & txtDocNo.Value & "</acc_tran_id>" & newline1
                                    accSubTranXML += "<acc_tran_lineno>" & lblno.Value & "</acc_tran_lineno>" & newline1
                                    accSubTranXML += "<acc_tran_type>" & CType(ViewState("ReceiptsRVPVTranType"), String) & "</acc_tran_type>" & newline1
                                    accSubTranXML += "<acc_narration>" & Trim(txtNarr.Value).Replace("&", "&amp; ") & "</acc_narration>" & newline1
                                    accSubTranXML += "<acc_type>" & ddlAccType.Value & "</acc_type>" & newline1
                                    accSubTranXML += "<currate>" & CType(txtCurrRate.Value, Decimal) & "</currate>" & newline1
                                    If ddlCCCode.Value <> "[Select]" Then
                                        ' csubtran.costcentercode = ddlCCCode.Items(ddlCCCode.SelectedIndex).Text
                                        accSubTranXML += "<costcentercode>" & ddlCCCode.Items(ddlCCCode.SelectedIndex).Text & "</costcentercode>" & newline1
                                    Else
                                        ' csubtran.costcentercode = strcostcentercode
                                        accSubTranXML += "<costcentercode>" & strcostcentercode & "</costcentercode>" & newline1
                                    End If

                                    accSubTranXML += "<acc_code></acc_code>" & newline1
                                    accSubTranXML += "<pacc_gl_code></pacc_gl_code>" & newline1
                                    accSubTranXML += "</AccSubTran>" & newline1
                            ...
                            Save_Open_detail(lblno.Value, ddlgAccCode.Text, ddlAccType.Value, ddlConAccCode.Text, SqlConn, sqlTrans, txtCurrCodegrid.Value.Trim, grdReceiptOpenDetXML, grdReceiptUpdatePendingInvXML)
                            ...
                            'grdReceiptXML += "<ReceiptsRVPVTranType>" & CType(ViewState("ReceiptsRVPVTranType"), String) & "</ReceiptsRVPVTranType>" & newline
                            grdReceiptXML += "<against_tran_id>" & txtDocNo.Value & "</against_tran_id>" & newline
                            grdReceiptXML += "<against_tran_lineno>" & lblno.Value & "</against_tran_lineno>" & newline
                            'grdReceiptXML += "<tran_type>" & CType(ViewState("ReceiptsRVPVTranType"), String) & "</tran_type>" & newline
                            ' grdReceiptXML += "<div_id>" & strdiv & "</div_id>" & newline
                            grdReceiptXML += "</Receipts>" & newline
                        End If

                        ' End If 'control code type check
                    Next

                    grdReceiptXML += "</Root>"
                    grdReceiptOpenDetXML += "</Root>"
                    accTranXML += "</Root>"
                    accSubTranXML += "</Root>"
                    ' grdReceiptUpdatePendingInvXML += "</Root>"
                    ...
                    If chkPost.Checked = True Then
                        ...
                        If dataTable.Rows.Count > 0 Then
                            For Each row As DataRow In dataTable.Rows
                                grdReceiptUpdatePendingInvXML += "<Pending_Invoices>" & newline
                                grdReceiptUpdatePendingInvXML += "<div_id>" & strdiv & "</div_id>" & newline
                                grdReceiptUpdatePendingInvXML += "<doclineno>" & CType(row("tran_lineno"), Integer) & "</doclineno>" & newline
                                grdReceiptUpdatePendingInvXML += "<docno>" & CType(row("TRANID"), String) & "</docno>" & newline
                                grdReceiptUpdatePendingInvXML += "<doctype>" & CType(row("tran_type"), String) & "</doctype>" & newline
                                If ddlCashBank.Value = "Bank" Then
                                    grdReceiptUpdatePendingInvXML += "<docdate>" & Format(CType(txtChequeDate.Text, Date), "yyyy/MM/dd") & "</docdate>" & newline
                                Else
                                    grdReceiptUpdatePendingInvXML += "<docdate>" & Format(CType(txtDate.Text, Date), "yyyy/MM/dd") & "</docdate>" & newline
                                End If
                                grdReceiptUpdatePendingInvXML += "<acc_code>" & CType(row("Acc_Code"), String) & "</acc_code>" & newline
                                grdReceiptUpdatePendingInvXML += "<acc_type>" & CType(row("acc_type"), String) & "</acc_type>" & newline
                                If UCase(CType(row("tran_type"), String).ToString) = "RV" Then
                                    grdReceiptUpdatePendingInvXML += "<against_tran_id>" & txtDocNo.Value & "</against_tran_id>" & newline
                                    grdReceiptUpdatePendingInvXML += "<against_tran_type>" & CType(ViewState("ReceiptsRVPVTranType"), String) & "</against_tran_type>" & newline
                                    grdReceiptUpdatePendingInvXML += "<against_tran_lineno>" & CType(row("against_tran_lineno"), Integer) & "</against_tran_lineno>" & newline
                                Else
                                    grdReceiptUpdatePendingInvXML += "<against_tran_id>" & txtDocNo.Value & "</against_tran_id>" & newline
                                    grdReceiptUpdatePendingInvXML += "<against_tran_type>" & "" & "</against_tran_type>" & newline
                                    grdReceiptUpdatePendingInvXML += "<against_tran_lineno>" & DBNull.Value & "</against_tran_lineno>" & newline
                                End If

                                grdReceiptUpdatePendingInvXML += "<acc_gl_code>" & CType(row("acc_gl_code"), String) & "</acc_gl_code>" & newline
                                If CType(row("Acc_Code"), String).ToString = "" Then
                                    grdReceiptUpdatePendingInvXML += "<duedate>" & Format(CType(txtDate.Text, Date), "yyyy/MM/dd") & "</duedate>" & newline
                                Else
                                    grdReceiptUpdatePendingInvXML += "<duedate>" & CType(row("open_due_date"), String) & "</duedate>" & newline
                                End If

                                grdReceiptUpdatePendingInvXML += "<currrate>" & CType(row("currency_rate"), Decimal) & "</currrate>" & newline
                                If CType(row("open_field1"), String) = "&nbsp;" Then
                                    grdReceiptUpdatePendingInvXML += "<field1>" & "" & "</field1>" & newline
                                Else
                                    grdReceiptUpdatePendingInvXML += "<field1>" & CType(row("open_field1"), String).Replace("&", "&amp; ") & "</field1>" & newline
                                End If
                                If CType(row("open_field2"), String) = "&nbsp;" Then
                                    grdReceiptUpdatePendingInvXML += "<field2>" & "" & "</field2>" & newline
                                Else
                                    grdReceiptUpdatePendingInvXML += "<field2>" & CType(row("open_field2"), String).Replace("&", "&amp; ") & "</field2>" & newline
                                End If
                                If CType(row("open_field3"), String) = "&nbsp;" Then
                                    grdReceiptUpdatePendingInvXML += "<field3>" & "" & "</field3>" & newline
                                Else

                                    grdReceiptUpdatePendingInvXML += "<field3>" & CType(row("open_field3"), String).Replace("&", "&amp; ") & "</field3>" & newline
                                End If
                                If CType(row("open_field4"), String) = "&nbsp;" Then
                                    grdReceiptUpdatePendingInvXML += "<field4>" & "" & "</field4>" & newline
                                Else
                                    grdReceiptUpdatePendingInvXML += "<field4>" & CType(row("open_field4"), String).Replace("&", "&amp; ") & "</field4>" & newline
                                End If
                                If CType(row("open_field5"), String) = "&nbsp;" Then
                                    grdReceiptUpdatePendingInvXML += "<field5>" & "" & "</field5>" & newline
                                Else
                                    grdReceiptUpdatePendingInvXML += "<field5>" & CType(row("open_field5"), String).Replace("&", "&amp; ") & "</field5>" & newline
                                End If
                                If UCase(CType(row("Tran_Type"), String).ToString) = "RV" Then
                                    grdReceiptUpdatePendingInvXML += "<accmode>" & CType(row("open_mode"), String) & "</accmode>" & newline
                                Else
                                    grdReceiptUpdatePendingInvXML += "<accmode>" & "B" & "</accmode>" & newline
                                End If

                                grdReceiptUpdatePendingInvXML += "<open_field3>" & txtnarration.Text.Replace("&", "&amp; ") & "</open_field3>" & newline
                                grdReceiptUpdatePendingInvXML += "<currcode>" & CType(row("currcode"), String) & "</currcode>" & newline
                                grdReceiptUpdatePendingInvXML += "<acc_State>" & "P" & "</acc_State>" & newline
                                grdReceiptUpdatePendingInvXML += "<debit>" & DecRound(CType(row("open_debit"), Decimal)) & "</debit>" & newline
                                grdReceiptUpdatePendingInvXML += "<credit>" & DecRound(CType(row("open_credit"), Decimal)) & "</credit>" & newline
                                grdReceiptUpdatePendingInvXML += "<basedebit>" & DecRound(CType(row("base_debit"), Decimal)) & "</basedebit>" & newline
                                grdReceiptUpdatePendingInvXML += "<basecredit>" & DecRound(CType(row("base_credit"), Decimal)) & "</basecredit>" & newline
                                grdReceiptUpdatePendingInvXML += "</Pending_Invoices>" & newline
                    ...
                    If chkPost.Checked = True Then
                        ...
                        If Not Session("opendetail_records") Is Nothing Then
                            ...
                            For Each row As DataRow In filteredRows
                                ...
                                'If collectionDate("TranType" & strLineKey).ToString = "RV" Then
                                '    myCommand.Parameters.Add(New SqlParameter("@docno", SqlDbType.VarChar, 20)).Value = CType(row("tran_id"), String) ' collectionDate("TranId" & strLineKey).ToString
                                '    myCommand.Parameters.Add(New SqlParameter("@doctype ", SqlDbType.VarChar, 10)).Value = CType(row("tran_type"), String) 'collectionDate("TranType" & strLineKey).ToString
                                '    advpayment = 1
                                'Else
                        ...
                        'Dim dataTable As DataTable = DirectCast(Session("opendetail_records"), DataTable)
                        'Dim filterExpression As String = "  against_tran_id =" & txtDocNo.Value & "   and   against_tran_type='" & CType(ViewState("ReceiptsRVPVTranType"), String) & "' And  div_id = " & strdiv & " " 'and against_tran_lineno= " & intReceiptLinNo & " 
                        'Dim filteredRows() As DataRow = dataTable.Select(filterExpression)
                        ...
                        '        myCommand.Parameters.Add(New SqlParameter("@div_id", SqlDbType.VarChar, 10)).Value = strdiv
                        '        myCommand.Parameters.Add(New SqlParameter("@doclineno", SqlDbType.Int)).Value = 1
                        '        myCommand.Parameters.Add(New SqlParameter("@docno", SqlDbType.VarChar, 20)).Value = txtDocNo.Value
                        '        myCommand.Parameters.Add(New SqlParameter("@doctype ", SqlDbType.VarChar, 10)).Value = CType(ViewState("ReceiptsRVPVTranType"), String)
                        '        myCommand.Parameters.Add(New SqlParameter("@acc_code", SqlDbType.VarChar, 20)).Value = collectionDate("AccCode" & strLineKey).ToString '--ddlgAccCode.Text
                        '        myCommand.Parameters.Add(New SqlParameter("@acc_type", SqlDbType.VarChar, 1)).Value = collectionDate("AccType" & strLineKey).ToString
                        '        myCommand.Parameters.Add(New SqlParameter("@debit", SqlDbType.Money)).Value = DecRound(CType(row("open_Debit"), Decimal)) ' DecRound(CType(objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select sum(isnull(open_debit,0))open_debit  from open_detail od(nolock)  where od.against_tran_id =" & txtDocNo.Value & "  and od.against_tran_lineno= " & intReceiptLinNo & " and  od.against_tran_type='" & CType(ViewState("ReceiptsRVPVTranType"), String) & "' And od.div_id = " & strdiv & " "), Decimal))
                        '        myCommand.Parameters.Add(New SqlParameter("@credit", SqlDbType.Money)).Value = DecRound(CType(row("open_credit"), Decimal)) 'DecRound(CType(objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select sum(isnull(open_credit,0))open_credit from open_detail od(nolock)  where od.against_tran_id =" & txtDocNo.Value & "  and od.against_tran_lineno= " & intReceiptLinNo & " and  od.against_tran_type='" & CType(ViewState("ReceiptsRVPVTranType"), String) & "' And od.div_id = " & strdiv & " "), Decimal))
                        '        myCommand.Parameters.Add(New SqlParameter("@basedebit", SqlDbType.Money)).Value = DecRound(CType(row("base_Debit"), Decimal)) ' DecRound(CType(objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select sum(isnull(base_debit,0))basedebit from open_detail od(nolock)  where od.against_tran_id =" & txtDocNo.Value & "  and od.against_tran_lineno= " & intReceiptLinNo & " and  od.against_tran_type='" & CType(ViewState("ReceiptsRVPVTranType"), String) & "' And od.div_id = " & strdiv & " "), Decimal))
                        '        myCommand.Parameters.Add(New SqlParameter("@basecredit", SqlDbType.Money)).Value = DecRound(CType(row("base_credit"), Decimal)) 'DecRound(CType(objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select sum(isnull(base_credit,0))basecredit from open_detail od(nolock)  where od.against_tran_id =" & txtDocNo.Value & "  and od.against_tran_lineno= " & intReceiptLinNo & " and  od.against_tran_type='" & CType(ViewState("ReceiptsRVPVTranType"), String) & "' And od.div_id = " & strdiv & " "), Decimal))
                ...
                '##rosalin 20/10/2023
                sqlTrans = SqlConn.BeginTransaction
                myCommand = New SqlCommand("sp_receiptsNewPage_save", SqlConn, sqlTrans)
                myCommand.CommandType = CommandType.StoredProcedure
                myCommand.Parameters.Add(New SqlParameter("@receipt_div_id ", SqlDbType.VarChar, 10)).Value = strdiv
                myCommand.Parameters.Add(New SqlParameter("@tran_id", SqlDbType.VarChar, 20)).Value = txtDocNo.Value
                myCommand.Parameters.Add(New SqlParameter("@tran_type", SqlDbType.VarChar, 10)).Value = CType(ViewState("ReceiptsRVPVTranType"), String)
                ...
                myCommand.Parameters.Add(New SqlParameter("@ReceiptsState", SqlDbType.VarChar, 20)).Value = ViewState("ReceiptsState")
                myCommand.Parameters.Add(New SqlParameter("@Chkpost", SqlDbType.Int)).Value = intChkPost
                myCommand.Parameters.Add(New SqlParameter("@tablename", SqlDbType.VarChar, 20)).Value = ViewState("ReceiptsState")
                myCommand.Parameters.Add(New SqlParameter("@grdReversePendingInvoiceXML", SqlDbType.Xml)).Value = grdReversePendingInvoiceXML
                myCommand.Parameters.Add(New SqlParameter("@receiptsxml", SqlDbType.Xml)).Value = grdReceiptXML
                myCommand.Parameters.Add(New SqlParameter("@OpenDetailsxml", SqlDbType.Xml)).Value = grdReceiptOpenDetXML
                myCommand.Parameters.Add(New SqlParameter("@grdReceiptUpdatePendingInvxml", SqlDbType.Xml)).Value = grdReceiptUpdatePendingInvXML
                myCommand.Parameters.Add(New SqlParameter("@accTranXML", SqlDbType.Xml)).Value = accTranXML
                myCommand.Parameters.Add(New SqlParameter("@accSubTranXML", SqlDbType.Xml)).Value = accSubTranXML
                myCommand.Parameters.Add(New SqlParameter("@ResultCode", SqlDbType.Int)).Direction = ParameterDirection.Output
                myCommand.Parameters.Add(New SqlParameter("@output_tranid", SqlDbType.VarChar, 20)).Direction = ParameterDirection.Output 'Tanvir/Rosalin 08112023
                ...
                If myCommand.Parameters("@ResultCode").Value.ToString() = "0" Then
                    sqlTrans.Commit()
                Else
                    ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Record not Saved...');", True)
                    sqlTrans.Rollback()
                End If
                '## end
                clsDBConnect.dbCommandClose(myCommand)
                clsDBConnect.dbConnectionClose(SqlConn)
                'Tanvir/Rosalin 08112023
                Dim tranid As String = myCommand.Parameters("@output_tranid").Value.ToString()
                If ViewState("ReceiptsState") = "New" And tranid <> "" Then
                    txtDocNo.Value = tranid
                End If
                'Tanvir/Rosalin 08112023
...
#Region "Public Sub Save_Open_detail(ByVal intReceiptLinNo As String, ByVal SqlConn As SqlConnection, ByVal sqlTrans As SqlTransaction)"
    Public Sub Save_Open_detail(ByVal intReceiptLinNo As String, ByVal strAccCode As String, ByVal strAccType As String, ByVal strGlCode As String, ByVal SqlConn As SqlConnection, ByVal sqlTrans As SqlTransaction, ByVal currcode As String, Optional ByRef grdReceiptOpenDetXML As String = "", Optional ByRef grdReceiptUpdatePendingInvXML As String = "")
                    ...
                    For intLinNo = 1 To intcount
                        ...
                        If colexists(collectionDate, "AgainstTranLineNo" & strLineKey) = True Then
                            If collectionDate("AccCode" & strLineKey).ToString = strAccCode And collectionDate("AccType" & strLineKey).ToString = strAccType And collectionDate("AccGLCode" & strLineKey).ToString = strGlCode Then
                                ...
                                grdReceiptOpenDetXML += "<OpenDetails>" & newline
                                grdReceiptOpenDetXML += "<Maintran_lineno>" & intReceiptLinNo & "</Maintran_lineno>" & newline
                                grdReceiptOpenDetXML += "<tran_id>" & collectionDate("TranId" & strLineKey).ToString & "</tran_id>" & newline
                                grdReceiptOpenDetXML += "<tran_type>" & collectionDate("TranType" & strLineKey).ToString & "</tran_type>" & newline
                                grdReceiptOpenDetXML += "<tran_date>" & Format(CType(collectionDate("TranDate" & strLineKey).ToString, Date), "yyyy/MM/dd") & "</tran_date>" & newline
                                grdReceiptOpenDetXML += "<tran_lineno>" & collectionDate("AccTranLineNo" & strLineKey) & "</tran_lineno>" & newline
                                grdReceiptOpenDetXML += "<against_tran_id>" & txtDocNo.Value & "</against_tran_id>" & newline
                                grdReceiptOpenDetXML += "<against_tran_lineno>" & intReceiptLinNo & "</against_tran_lineno>" & newline
                                grdReceiptOpenDetXML += "<against_tran_type>" & CType(ViewState("ReceiptsRVPVTranType"), String) & "</against_tran_type>" & newline
                                grdReceiptOpenDetXML += "<against_tran_date>" & Format(CType(txtDate.Text, Date), "yyyy/MM/dd") & "</against_tran_date>" & newline

                                If collectionDate("DueDate" & strLineKey).ToString = "" Then
                                    grdReceiptOpenDetXML += "<open_due_date>" & Format(CType(txtDate.Text, Date), "yyyy/MM/dd") & "</open_due_date>" & newline
                                Else
                                    grdReceiptOpenDetXML += "<open_due_date>" & Format(CType(collectionDate("DueDate" & strLineKey).ToString, Date), "yyyy/MM/dd") & "</open_due_date>" & newline
                                End If
                                ...
                                If strAccType = "C" Then
                                    ...
                                    grdReceiptOpenDetXML += "<open_sales_code>" & spersoncode & "</open_sales_code>" & newline
                                    'myCommand.Parameters.Add(New SqlParameter("@open_sales_code", SqlDbType.VarChar, 10)).Value = spersoncode
                                Else
                                    grdReceiptOpenDetXML += "<open_sales_code>" & "" & "</open_sales_code>" & newline
                                End If
                                ...
                                grdReceiptOpenDetXML += "<open_debit>" & DecRound(CType(collectionDate("Debit" & strLineKey), Decimal)) & "</open_debit>" & newline
                                grdReceiptOpenDetXML += "<open_credit>" & DecRound(CType(collectionDate("Credit" & strLineKey), Decimal)) & "</open_credit>" & newline
                                If Trim(collectionDate("Field4" & strLineKey).ToString) = "&nbsp;" Then
                                    grdReceiptOpenDetXML += "<open_field1>" & "" & "</open_field1>" & newline
                                Else
                                    grdReceiptOpenDetXML += "<open_field1>" & Trim(collectionDate("RefNo" & strLineKey).ToString).Replace("&", "&amp; ") & "</open_field1>" & newline
                                End If
                                grdReceiptOpenDetXML += "<open_field2>" & IIf(Trim(collectionDate("Field2" & strLineKey).ToString) = "&nbsp;", "", Trim(collectionDate("Field2" & strLineKey).ToString).Replace("&", "&amp; ")) & "</open_field2>" & newline

                                grdReceiptOpenDetXML += "<open_field3>" & IIf(Trim(collectionDate("Field3" & strLineKey).ToString) = "&nbsp;", "", Trim(collectionDate("Field3" & strLineKey).ToString).Replace("&", "&amp; ")) & "</open_field3>" & newline


                                grdReceiptOpenDetXML += "<open_field4>" & IIf(Trim(collectionDate("Field4" & strLineKey).ToString) = "&nbsp;", "", Trim(collectionDate("Field4" & strLineKey).ToString).Replace("&", "&amp; ")) & "</open_field4>" & newline

                                If Trim(collectionDate("Field4" & strLineKey).ToString) = "&nbsp;" Then
                                    grdReceiptOpenDetXML += "<open_field5>" & "" & "</open_field5>" & newline
                                Else
                                    grdReceiptOpenDetXML += "<open_field5>" & Trim(collectionDate("Field5" & strLineKey).ToString).Replace("&", "&amp; ") & "</open_field5>" & newline
                                End If

                                grdReceiptOpenDetXML += "<open_mode>" & collectionDate("OpenMode" & strLineKey).ToString & "</open_mode>" & newline
                                grdReceiptOpenDetXML += "<open_exchg_diff>" & 0 & "</open_exchg_diff>" & newline
                                grdReceiptOpenDetXML += "<dr_cr>" & "" & "</dr_cr>" & newline
                                grdReceiptOpenDetXML += "<div_id>" & strdiv & "</div_id>" & newline
                                grdReceiptOpenDetXML += "<currency_rate>" & CType(collectionDate("CurrRate" & strLineKey), Decimal) & "</currency_rate>" & newline
                                grdReceiptOpenDetXML += "<base_debit>" & DecRound(CType(collectionDate("BaseDebit" & strLineKey), Decimal)) & "</base_debit>" & newline
                                grdReceiptOpenDetXML += "<base_credit>" & DecRound(CType(collectionDate("BaseCredit" & strLineKey), Decimal)) & "</base_credit>" & newline
                                grdReceiptOpenDetXML += "<acc_type>" & collectionDate("AccType" & strLineKey).ToString & "</acc_type>" & newline
                                grdReceiptOpenDetXML += "<acc_code>" & collectionDate("AccCode" & strLineKey).ToString & "</acc_code>" & newline
                                grdReceiptOpenDetXML += "<acc_gl_code>" & collectionDate("AccGLCode" & strLineKey).ToString & "</acc_gl_code>" & newline
                                grdReceiptOpenDetXML += "</OpenDetails>" & newline
                                ...
                                ''If Not Session("opendetail_records") Is Nothing Then
                                ''    Dim dataTable As DataTable = DirectCast(Session("opendetail_records"), DataTable)
                                ''    Dim filterExpression As String = "  against_tran_id =" & txtDocNo.Value & "  and against_tran_lineno= " & intReceiptLinNo & " and   against_tran_type='" & CType(ViewState("ReceiptsRVPVTranType"), String) & "' And  div_id = " & strdiv & " "
                                ''    Dim filteredRows() As DataRow = dataTable.Select(filterExpression)
                                ''    Dim advpayment As Integer = 0
                                ''    If ViewState("ReceiptsState") = "Edit" Then
                                ''        For Each row As DataRow In filteredRows
                                ...
                                ''            ''End If
                                ''            myCommand.Parameters.Add(New SqlParameter("@acc_code", SqlDbType.VarChar, 20)).Value = CType(row("ACC_CODE"), String) ' collectionDate("AccCode" & strLineKey).ToString '--ddlgAccCode.Text
                                ''            myCommand.Parameters.Add(New SqlParameter("@acc_type", SqlDbType.VarChar, 1)).Value = CType(row("ACC_CODE"), String) 'collectionDate("AccType" & strLineKey).ToString
                                ''            'If collectionDate("TranId" & strLineKey).ToString <> CType(row("against_Tran_id"), String) And collectionDate("TranType" & strLineKey).ToString <> CType(row("against_Tran_type"), String) And advpayment = 0 Then
                                ''            '    myCommand.Parameters.Add(New SqlParameter("@debit", SqlDbType.Money)).Value = 0  ' DecRound(CType(objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select sum(isnull(open_debit,0))open_debit  from open_detail od(nolock)  where od.against_tran_id =" & txtDocNo.Value & "  and od.against_tran_lineno= " & intReceiptLinNo & " and  od.against_tran_type='" & CType(ViewState("ReceiptsRVPVTranType"), String) & "' And od.div_id = " & strdiv & " "), Decimal))
                                ''            '    myCommand.Parameters.Add(New SqlParameter("@credit", SqlDbType.Money)).Value = 0 'DecRound(CType(objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select sum(isnull(open_credit,0))open_credit from open_detail od(nolock)  where od.against_tran_id =" & txtDocNo.Value & "  and od.against_tran_lineno= " & intReceiptLinNo & " and  od.against_tran_type='" & CType(ViewState("ReceiptsRVPVTranType"), String) & "' And od.div_id = " & strdiv & " "), Decimal))
                                ''            '    myCommand.Parameters.Add(New SqlParameter("@basedebit", SqlDbType.Money)).Value = 0 ' DecRound(CType(objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select sum(isnull(base_debit,0))basedebit from open_detail od(nolock)  where od.against_tran_id =" & txtDocNo.Value & "  and od.against_tran_lineno= " & intReceiptLinNo & " and  od.against_tran_type='" & CType(ViewState("ReceiptsRVPVTranType"), String) & "' And od.div_id = " & strdiv & " "), Decimal))
    ...
    End Sub
#End Region
#Region "Public Function validateaccount() As Boolean"
    Function validateaccount(ByRef acc_tran_id As String, ByRef acc_code As String, ByRef acc_Type As String, ByRef pacc_gl_code As String) As Boolean
        validateaccount = True
        mvalid_controlacct = True
        Dim i As Integer
        Dim objutils As New clsUtils
        Dim acc_name, controlyn, acctcode As String
        If acc_tran_id <> "" Then
            If Left(acc_tran_id, 5) = "CLOSE" Then
                ' objutils.MessageBox("Document Number cannot start with CLOSE", accpage)
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Document Number cannot start with CLOSE');", True)
                validateaccount = False
                Exit Function
            End If
        End If
        If acc_code <> "" And acc_Type <> "" Then
            acc_name = objutils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select code from view_account where code='" & acc_code & "'and type='" & acc_Type & "'")
            If acc_name = "" Then
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Select the proper Account Code & Type');", True)
                validateaccount = False
                Exit Function
            End If
            ...
            If mvalid_controlacct = True Then 'nv 15/2/2004
                controlyn = objutils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select controlyn from view_account where code='" & Trim(acc_code) & "' and type='" & Trim(acc_Type) & "'")
                If controlyn = "Y" Then
                    ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Select the proper Account Code & Type');", True)
                    validateaccount = False
                    Exit Function
            ...
            acc_name = Nothing
            If Trim(acc_Type) <> "G" Then
                acctcode = objutils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select acctcode from acctmast where acctcode='" & Trim(pacc_gl_code) & "'")
                '     temp_rec = getdatatable("select acctcode from acctmast where acctcode='" & Trim(Acctrans(i).pacc_gl_code) & "'")
                If acctcode = "" Then
    ...
    Public Function validate_page() As Boolean
        ...
        For Each gvRow In grdReceipt.Rows
            ...
            If ddlAccType.Value.Trim <> "" And txtCurrRate.Value.Trim <> "" And ddlgAccName.Text.Trim <> "" Then
                ...
                'Tanvir 26102023
                If validateaccount(txtDocNo.Value, ddlgAccCode.Text, ddlAccType.Value, ddlConAccCode.Text) = False Then
                    SetFocus(ddlAccType)
                    validate_page = False
                    Exit Function
                End If
                ...
                If ddlAccType.Value <> "G" Then
                    ...
                    If validate_AdjustBill(lblno.Value, ddlgAccCode.Text, ddlAccType.Value, ddlConAccCode.Text, AdjVal) = False Then 'ddlgAccName.Text
