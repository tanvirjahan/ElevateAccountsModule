<%@ Page Language="VB" MasterPageFile="~/AccountsMaster.master" AutoEventWireup="false" CodeFile="unSealdata.aspx.vb" Inherits="AccountsModule_unSealdata"  %>
            ...
            <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid; border-bottom: gray 2px solid">
                <tr>
                    <td align="center" class="field_heading" style="width: 100px; height: 21px">
                        <asp:Label ID="lblHeading" runat="server" CssClass="field_heading" Text="UnSeal Data"
            ...
            <table style="width: 453px">
                <tr>
                    <td style="width: 20px; height: 24px;">
                        <asp:Label ID="Label1" runat="server" Text="Enter Date to Unseal data upto  :" 
