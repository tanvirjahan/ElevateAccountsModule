<%@ Page Language="VB" MasterPageFile="~/AccountsMaster.master" AutoEventWireup="false"
    EnableEventValidation="true" CodeFile="ReceiptsSearchnew.aspx.vb" Inherits="ReceiptsSearchnew" %>
            ...
            'access'
              ...
              callbacks: {
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      ...
                      switch (category) {
                          case 'DocumentNo':
                              var asSqlqry = "select ltrim(rtrim(tran_id)) tranid  from receipt_master_new (nolock) where tran_type='RV' order by tranid   ";
                              glcallback = callback;
                              ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                              break;
                          case 'BankName':
                              var asSqlqry = "select ltrim(rtrim(acctname)) from acctmast ,bank_master_type where  acctmast.bank_master_type_code = bank_master_type.bank_master_type_code and bank_master_type.cashbanktype='B'  and  bankyn='Y'  order by acctcode  ";
                              glcallback = callback;
                              ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                              break;
                          case 'AccountName':
...
<script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <table class="td_cell" style="border-right: gray 2px solid; border-top: gray 2px solid;
                border-left: gray 2px solid; border-bottom: gray 2px solid">
                <tbody>
                    <tr>
                        <td class="field_heading" align="center">
                            <asp:Label ID="lblHeading" runat="server" CssClass="field_heading" Text="Receipt List"
                                Width="665px"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="td_cell" align="center" style="color: blue">
                ...
                <tr>
                    <td class="td_cell">
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gv_SearchResult" runat="server" AllowPaging="True" 
                                    AllowSorting="True" AutoGenerateColumns="false" CellPadding="3" 
                                    GridLines="Vertical" TabIndex="19" Width="950px">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="tran_type" HeaderText="Tran. Type" 
                                            SortExpression="tran_type"></asp:BoundField>
                                        <asp:BoundField DataField="post_state" HeaderText="Status"></asp:BoundField>
                                        <asp:BoundField DataField="receipt_tran_date" DataFormatString="{0:dd/MM/yyyy}" 
                                            HeaderText="Transaction Date" HtmlEncode="False" 
                                            SortExpression="receipt_tran_date"></asp:BoundField>
                                        <asp:BoundField DataField="receipt_date" DataFormatString="{0:dd/MM/yyyy}" 
                                            HeaderText="Receipt Date" HtmlEncode="False" SortExpression="receipt_date">
                                        </asp:BoundField>
                                        <asp:BoundField DataField="receipt_credit" HeaderText="Amount Received" 
                                            SortExpression="receipt_credit"></asp:BoundField>
                                        <asp:BoundField DataField="receipt_currency_id" HeaderText="Currency" 
                                            SortExpression="receipt_currency_id"></asp:BoundField>
                                        <asp:TemplateField HeaderText="Received From">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRecievedFrom" runat="server" 
                                                    OnDataBinding="TemplateFieldBind"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="receipt_cheque_number" HeaderText="Cheque Number" 
                                            SortExpression="receipt_cheque_number"></asp:BoundField>
                                        <asp:BoundField DataField="receipt_cashbank_code" HeaderText="Cash/Bank Code" 
                                            SortExpression="receipt_cashbank_code"></asp:BoundField>
                                        <asp:BoundField DataField="other_bank_master_des" HeaderText="Cash/Bank Name" 
                                            SortExpression="other_bank_master_des"></asp:BoundField>
                                        <asp:BoundField DataField="adddate" 
                                            DataFormatString="{0:dd/MM/yyyy hh:mm:ss tt} " HeaderText="Date Created" 
                                            HtmlEncode="False" SortExpression="adddate"></asp:BoundField>
                                        <asp:BoundField DataField="adduser" HeaderText="User Created" 
                                            SortExpression="adduser"></asp:BoundField>
                                        <asp:BoundField DataField="moddate" 
                                            DataFormatString="{0:dd/MM/yyyy hh:mm:ss tt} " HeaderText="Date Modified" 
                                            SortExpression="moddate"></asp:BoundField>
                                        <asp:BoundField DataField="moduser" HeaderText="User Modified" 
                                            SortExpression="moduser"></asp:BoundField>
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkEdit" runat="server" 
                                                    CommandArgument='<%# Bind("tranidcomarg") %>' CommandName="EditRow" Text="Edit"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemStyle ForeColor="Blue" />
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkView" runat="server" 
                                                    CommandArgument='<%# Bind("tranidcomarg") %>' CommandName="View" 
                                                    OnDataBinding="TemplateFieldBind" Text="View"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemStyle ForeColor="Blue" />
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkDeleteRow" runat="server" 
                                                    CommandArgument='<%# Bind("tranidcomarg") %>' CommandName="DeleteRow" 
                                                    Text="DeleteRow"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemStyle ForeColor="Blue" />
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkCopy" runat="server" 
                                                    CommandArgument='<%# Bind("tranidcomarg") %>' CommandName="Copy" Text="Copy"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemStyle ForeColor="Blue" />
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkViewLog" runat="server" 
                                                    CommandArgument='<%# Bind("tranidcomarg") %>' CommandName="ViewLog" 
                                                    Text="View Log"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemStyle ForeColor="Blue" />
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkChkPrint" runat="server" 
                                                    CommandArgument='<%# Bind("tranidcomarg") %>' CommandName="lnkChkPrint" 
                                                    OnDataBinding="TemplateFieldBind" Text="Cheque Print"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                ...
                                <asp:Label ID="lblMsg" runat="server" CssClass="lblmsg" Font-Bold="True" 
