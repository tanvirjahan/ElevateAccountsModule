...
Partial Class RptmonthwiseSalesreportSearch
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            Try
                ...
                'ddlCurrencyType.SelectedIndex = 1
    ...
    Protected Sub btnLoadreport_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If ValidatePage() = True Then
            Try
                ...
                Dim strfromdate, strtodate, strcustcode, strcustname, poststate As String
                ...
                If ddlCustomer.Items(ddlCustomer.SelectedIndex).Text <> "[Select]" Then
                    strcustcode = ddlCustomer.Value
                    strcustname = ddlCustomer.Items(ddlCustomer.SelectedIndex).Text
                Else
                    strcustcode = ""
                    strcustname = ""
                End If
                ...
                strpop = "window.open('../AccountsModule/reserv_monthwise_Reportsales.aspx?fromdate=" & strfromdate & "&todate=" & strtodate & "&custcode=" & strcustcode & "&custname=" & strcustname & "&fromctrycode=" & strfromctrycode & "&toctrycode=" & strtoctrycode & "&currtype=" & currtype & "&poststate=" & poststate & "&repname=salesreport  ','SalesreportSearch','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
