<%@ Page Language="VB" MasterPageFile="~/TransferMaster.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="OthServicesCostPricelistSearch.aspx.vb" Inherits="OthServicesCostPricelistSearch"  %>
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      ...
                      switch (category) {
                          case 'PRICELIST':
                              ...
                              var asSqlqry = "select ltrim(rtrim(ocplistcode)) PRICELIST  from oplist_costh(nolock) where othgrpcode not in (select othgrpcode from view_system_othgrp)     order by ocplistcode";
                              glcallback = callback;
                          ...
                          case 'SUPPLIER':
                              var asSqlqry = '';
                                  ...
                                  asSqlqry = "select partyname    from  partymast where active=1  and sptypecode='Other Serv' order by partyname ";
                          ...
                          case 'SERVICEGROUP':
                              ...
                              var asSqlqry = "select othgrpname  SERVICEGROUP  from  othgrpmast where active=1  and othgrpcode not in (select othgrpcode from view_system_othgrp)  order by othgrpname ";
                              glcallback = callback;
                              //fnTestCallback();
                              ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                    ...
                    <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
                        ...
                        <tr>
                            <td style="text-align: center; width: 100%;" align="center" class="field_heading">
                                <asp:label id="Label1" runat="server" cssclass="field_heading" text="OtherServices Cost Pricelist Search">
                                </asp:label>
                            </td>
                        </tr>
                        <tr>
