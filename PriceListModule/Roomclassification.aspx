<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="Roomclassification.aspx.vb" Inherits="PriceListModule_Roomclassification" %>
...
<script language="javascript" type="text/javascript">
    ...
    function FormValidation(state) {
        if ((document.getElementById("<%=txtName.ClientID%>").value == "")) {
            ...
            if (state == 'New') { if (confirm('Are you sure you want to save roomclassification Type?') == false) return false; }
            if (state == 'Edit') { if (confirm('Are you sure you want to update roomclassification Type?') == false) return false; }
            if (state == 'Delete') { if (confirm('Are you sure you want to delete roomclassification Type?') == false) return false; }
        }
    }
...
<asp:Label id="lblHeading" runat="server" Text="Add New Room Classification"  Width="560px" CssClass="field_heading"></asp:Label></TD>
</TR>
<TR>
    <TD style="WIDTH: 130px" class="td_cell">
    <SPAN style="COLOR: black">Roomclass Code</SPAN> <SPAN style="COLOR: red" class="td_cell">*</SPAN></TD>
    ...
    <TR>
    <TD style="WIDTH: 130px; HEIGHT: 24px" class="td_cell">Roomclass Name <SPAN style="COLOR: red" class="td_cell">*</SPAN></TD>
