<%@ Page Language="VB" MasterPageFile="~/TransferMaster.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="OthPricelistSearch.aspx.vb" Inherits="OthPricelistSearch"  %>
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      ...
                      switch (category) {
                          case 'PRICELIST':
                              ...
                              var asSqlqry = "select ltrim(rtrim(oplistcode)) PRICELIST  from othplisth(nolock) where othgrpcode='" + hdngroup.value + "'     order by oplistcode";
                              glcallback = callback;
                    ...
                    <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
                        ...
                        <tr>
                            <td style="text-align: center; width: 100%;" align="center" class="field_heading">
                                <asp:label id="Label1" runat="server" cssclass="field_heading" text="Airport Meet Pricelist Search">
                                </asp:label>
                            </td>
                        </tr>
                        <tr>
