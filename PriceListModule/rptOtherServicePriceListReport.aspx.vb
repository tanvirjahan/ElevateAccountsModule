...
Partial Class rptOtherServicePriceListReport
    ...
    Private Sub BindReport()
        ...
        strparam = objutils.GetDBFieldFromStringnew(Session("dbconnectionName"), "reservation_parameters", "param_id", "option_selected", ViewState("reportoption"))

        If ViewState("reportoption") = "TRFS" Then
            strparam = "1001"
        End If
        ...
        Select Case strparam
            ...
            Case 1025, 1037
                strtitle = "Jeepwadi "
            Case 1001
                strtitle = "Transportation"
            Case 1028, 1042
                strtitle = "Airport Meet and Assist"
            Case 1027, 1041
                strtitle = "Handling Fees"
            Case 1026
                strtitle = "Other Services"
        End Select

        'reportoption = Session("reportoption")
        If ViewState("rtptype") = "Cost" And strparam = "1001" Then
            rep.Load(Server.MapPath("~\Report\rptcostplist_trfs.rpt"))
            rptreportname = "Report - Transfer Price List - Cost Sheet"
        ElseIf ViewState("rtptype") = "Cost" And (strparam = "1031" Or strparam = "1032" Or strparam = "1033" Or strparam = "1034" Or strparam = "1035" Or strparam = "1036" Or strparam = "1002" Or strparam = "1003" Or strparam = "1021" Or strparam = "1022" Or strparam = "1023" Or strparam = "1024" Or strparam = "1025" Or strparam = "1028" Or strparam = "1027" Or strparam = "1041" Or strparam = "1042" Or strparam = "1026") Then
            rep.Load(Server.MapPath("~\Report\rptcostplist_all.rpt"))
            rptreportname = "Report -" + strtitle + " Price List - Cost Sheet"
        End If

        If ViewState("rtptype") = "Sales" And strparam = "1001" Then
            rep.Load(Server.MapPath("~\Report\rptcostplist_trfs.rpt"))
            rptreportname = "Report - Transfer Price List - Sales Sheet"
        ElseIf ViewState("rtptype") = "Sales" And (strparam = "1031" Or strparam = "1032" Or strparam = "1033" Or strparam = "1034" Or strparam = "1035" Or strparam = "1036" Or strparam = "1002" Or strparam = "1003" Or strparam = "1021" Or strparam = "1022" Or strparam = "1023" Or strparam = "1024" Or strparam = "1025" Or strparam = "1028" Or strparam = "1027" Or strparam = "1041" Or strparam = "1042" Or strparam = "1026") Then
            rep.Load(Server.MapPath("~\Report\rptothplist_all.rpt"))
            rptreportname = "Report -" + strtitle + " Price List - Sales Sheet"
        End If

        'If ViewState("reportoption") = "" Then
        '    rep.Load(Server.MapPath("~\Report\rptothplist.rpt"))
        '    rptreportname = "Report - Other Service Selling Price List"
        'ElseIf ViewState("reportoption") = "TRFS" Then
        '    rep.Load(Server.MapPath("~\Report\rptcostplist_trfs.rpt"))
        '    rptreportname = "Report - Transfer Price List - Cost Sheet"
        'Else
        '    rep.Load(Server.MapPath("~\Report\rptOcostplist.rpt"))
        '    rptreportname = "Report - Other Service Price List - Cost Sheet"
        'End If
