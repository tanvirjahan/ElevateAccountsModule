...
Partial Class PriceListModule_OtherPriceList1
        ...
        Try
            ...
            If cnt > 0 Then
                ...
                strSqlQry = "select  * from (select  h.othtypcode,h.othtypname,0 Unit  from othtypmast h (nolock) where active=1 and othgrpcode='" & txtothgroupcode.Text & "' and othtypcode " _
                        & " not in (select othtypcode from   othplist_selld where  oplistcode='" & RefCode & "') union all " _
                      & "  select  d.othtypcode,h.othtypname,  d.tprice  Unit from othplist_selld d, othtypmast h   where d.othtypcode=h.othtypcode and d.othgrpcode=h.othgrpcode and h.othgrpcode='" & txtothgroupcode.Text & "'    and " _
                      & "   d.oplistcode='" & RefCode & "' group by d.othtypcode,h.othtypname,d.tprice) rs  order by  rs.othtypname "
                ...
                While mySqlReader.Read
                    For Each gvrow In grdtransferrates.Rows
                        ...
                        If txttrftypecode Is Nothing = False Then
                            ...
                            StrQryTemp = "select oplistcode  ,othtypcode,othcatcode,tprice, " & _
              " pkgnights from  othplist_selld  " & _
              " where   " & _
              " oplistcode= '" & RefCode & "' and othtypcode = '" & txttrftypecode.Text & "'"
...
go1:                            End While
        ...
        Try
            ...
            For Each GVRow In grdDates.Rows
                ...
                If txtfromdate.Text <> "" And txttodate.Text <> "" Then
                    ...
                    parm3(0) = New SqlParameter("@groupcode", CType(txtothgroup.Text, String))
                    ...
                    If ds1.Tables.Count > 0 Then
                        If ds1.Tables(0).Rows.Count > 0 Then
                            If IsDBNull(ds1.Tables(0).Rows(0)("oplistcode")) = False Then
                                    ...
                                    strMsg = "In this Group Pricelist already exists For this   " + ds1.Tables(0).Rows(0)("oplistcode") + " - Country " + ds1.Tables(0).Rows(0)("ctryname") + " - Agent - " + ds1.Tables(0).Rows(0)("agentname")
                ...
                If ViewState("pricelistState") = "New" Or ViewState("pricelistState") = "Edit" Or ViewState("pricelistState") = "Copy" Then
                    ...
                    For Each GvRow In grdtransferrates.Rows
                        ...
                        If txtunit.Text <> "" Then
                            ...
                            mySqlCmd.Parameters.Add(New SqlParameter("@tprice", SqlDbType.Decimal, 18, 3)).Value = CType(Val(txtunit.Text.Trim), Decimal)
    ...
    Protected Sub btnhelp_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=otherpricelist','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    ...
    Protected Sub grdtransferrates_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles grdtransferrates.DataBound
