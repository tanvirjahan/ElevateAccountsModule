<%@ Page Language="VB" MasterPageFile="~/MainPageMaster.master" AutoEventWireup="false" EnableEventValidation="false"  CodeFile="SectorGroupSearch.aspx.vb" Inherits="SectorSearch"  %>
...
<link rel="stylesheet" href="../Content/lib/css/reset.css" type="text/css" media="screen" charset="utf-8">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('GROUPNAME:" " COUNTRYNAME:" "CITYNAME:" " TEXT:" "');
          window.visualSearch = VS.init({
            ...
            'access'
              ...
              callbacks: {
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      switch (category) {
                          ...
                          case 'GROUPNAME':
                              var asSqlqry = '';
                              glcallback = callback;
                              ColServices.clsSectorServices.GetListOfSectGrpNameVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                              break;
                          case 'COUNTRYNAME':
                              var asSqlqry = '';
                              glcallback = callback;
                ...
                { label: 'GROUPNAME', category: 'Name' },
                { label: 'COUNTRYNAME', category: 'Name' },
                { label: 'CITYNAME', category: 'Name' },
              ]);
                  }
              }
          });
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtFromDate" runat="server" onchange="filltodate(this);" 
                                                        TabIndex="6" Width="75px"></asp:TextBox>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtToDate" runat="server" onchange="ValidateChkInDate();" 
                                                        TabIndex="7" Width="75px"></asp:TextBox>
...
<asp:TemplateField Visible="False" HeaderText="Sector Code"><EditItemTemplate>
 <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("othtypcode") %>' __designer:wfdid="w7"></asp:TextBox>
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblSectorCode" runat="server" Text='<%# Bind("othtypcode") %>' __designer:wfdid="w6"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>



<asp:BoundField DataField="othtypcode" SortExpression="othtypcode" HeaderText="Group  Code">

</asp:BoundField>
 

 
                                <asp:TemplateField HeaderText="Group Name" SortExpression="othtypname">
                    <ItemTemplate>
                        <asp:Label ID="lblothtypname" runat="server" Text='<%# Bind("othtypname") %>'></asp:Label>
                    </ItemTemplate>
          
                    <HeaderStyle HorizontalAlign="Left" Width="20%" />
                    <ItemStyle CssClass="othtypname" HorizontalAlign="Left" />
                </asp:TemplateField>
                <asp:BoundField DataField="ctrycode" SortExpression="ctrycode" HeaderText="Country Code"  Visible ="false" >
                    ...
                    <ItemStyle CssClass="ctryname" HorizontalAlign="Left"  />
                </asp:TemplateField>

<asp:BoundField HtmlEncode="False" DataField="citycode" SortExpression="citycode" HeaderText="City Code" Visible ="false">
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                    ...
                    <ItemStyle CssClass="cityname" HorizontalAlign="Left" />
                </asp:TemplateField>
