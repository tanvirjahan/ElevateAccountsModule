<%@ Page Language="VB" MasterPageFile="~/TransferMaster.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="OtherPricelistSearch.aspx.vb" Inherits="OtherPricelistSearch"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('PRICELIST:" " SERVICEGROUP:"  " APPROVEDSTATUS:" " TEXT:" "');
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      ...
                      switch (category) {
                          case 'PRICELIST':
                              ...
                              var asSqlqry = "select ltrim(rtrim(oplistcode)) PRICELIST  from othplisth(nolock) where othgrpcode not in (select othgrpcode from view_system_othgrp)    order by oplistcode";
                              glcallback = callback;
                    ...
                    <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
                        ...
                        <tr>
                            <td style="text-align: center; width: 100%;" align="center" class="field_heading">
                                <asp:label id="Label1" runat="server" cssclass="field_heading" text="OtherService Pricelist Search">
                                </asp:label>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <contenttemplate>
                                        ...
                                        BorderStyle="Solid">
                                            <FooterStyle CssClass="grdfooter"></FooterStyle>
                                                        ...
                                                        <ItemTemplate>
                                                        <asp:Label id="lblplistcode" runat="server" Text='<%# Bind("oplistcode") %>'></asp:Label> 
                                                        </ItemTemplate>
                                                        </asp:TemplateField >
