<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="TrfSellingRatePaxSlab.aspx.vb" Inherits="PriceListModule_TrfSellingRatePaxSlab" %>
 ...
 <table style="width: 936px">
                    <tr>
                        <td class="field_heading" colspan="5" style="text-align: center" align="center">
                            <asp:Label ID="Label2" runat="server" CssClass="field_heading" Text="Transfer Price List - Selling Rates Pax Slab"
