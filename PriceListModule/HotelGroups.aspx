<%@ Page Language="VB" MasterPageFile="~/MainPageMaster.master" AutoEventWireup="false" CodeFile="HotelGroups.aspx.vb" Inherits="HotelGroups"  %>
    ...
    <tr>
        <td align="center" colspan="4" style="HEIGHT: 3px; text-align: center;">
            ...
            &nbsp;<asp:Button ID="btnHotelReport" runat="server" CssClass="btn" 
                Font-Bold="False" tabIndex="4"  style="display:none" Text="Hotel Report" />
        </td>
    </tr>
            ...
            <table class="style1">
                ...
                <tr runat="server" id="trNameAndCode">
                    ...
                    <td colspan="2">
                       ...
                       <td colspan="2">
                        <asp:Label ID="Label7" runat="server" Text="Hotel Group"></asp:Label>
                        &nbsp;&nbsp;<asp:TextBox ID="txtGroupTagName" runat="server" AutoPostBack="True" 
                            ...
                            FirstRowSelected="false" MinimumPrefixLength="0" ServiceMethod="GetHotelGroup" 
