<%@ Page Language="VB"  MasterPageFile="~/PriceListMaster.master"  AutoEventWireup="false" CodeFile="OtherServicesPLTypesSearch.aspx.vb" Inherits="OtherServicesPLTypesSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" Runat="Server">
 ...
 <script type="text/javascript" charset="utf-8">
     ...
     function visualsearchbox() {
         ...
         $txtvsprocess.val('TYPE:" "GROUP:" "SUPPLIER:" "TEXT:" "');
            ...
            'access'
             ...
             callbacks: {
                 ...
                 valueMatches: function (category, searchTerm, callback) {
                     ...
                     switch (category) {
                         case 'TYPE':
                             var asSqlqry = '';
                             glcallback = callback;
                             ColServices.clsSectorServices.GetListOfOthgrpTypeNameVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                             break;
                         case 'GROUP':
                           
                             var asSqlqry = '';
                             glcallback = callback;
                             ColServices.clsSectorServices.GetListOfOthgrpsNameVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                             break;
                         case 'SUPPLIER':

                             var asSqlqry = '';
                             glcallback = callback;
                             ColServices.clsSectorServices.GetListOfOthSupplierVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                             break;
                 ...
                 facetMatches: function (callback) {
                     callback([
                { label: 'TYPE', category: 'OTHTYPES' },
                 { label: 'GROUP', category: 'OTHTYPES' },
                 { label: 'SUPPLIER', category: 'OTHTYPES' },


  { label: 'TEXT', category: 'OTHTYPES' },
              ]);
                 }
             }
         });
...
<table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
        ...
        <tr>
            <td align="center" class="field_heading" colspan="4" style=" height: 7px">
        ...
        <tr>
            <td class="td_cell" colspan="4" style=" color: red;">
                <asp:UpdatePanel id="UpdatePanel1" runat="server">
                    <contenttemplate>
<TABLE style="WIDTH: 1066px"><TBODY>
...
<TD style="WIDTH: 54px; HEIGHT: 16px" class=" "><SPAN style="COLOR: black">
    ...
    <tr>
        ...
        <tr>
            <td class="td_cell"  style="color: red;">
        ...
        <tr>
            <td class="td_cell" colspan="4"  >
                <asp:UpdatePanel id="UpdatePanel2" runat="server">
                    <contenttemplate>
<asp:GridView id="gv_SearchResult" tabIndex=10 runat="server" Font-Size="10px"  CssClass="grdstyle" GridLines="Vertical" CellPadding="3" BorderWidth="1px" BorderStyle="None" BorderColor="#999999" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True">
...
<asp:BoundField DataField="othgrpcode" SortExpression="othgrpcode"  VISIBLE="false" HeaderText="Group Code">
<ItemStyle HorizontalAlign="Left"></ItemStyle>

<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
</asp:BoundField>
                      <asp:TemplateField HeaderText="Group Name" SortExpression="othgrpname">
                    <ItemTemplate>
                        <asp:Label ID="lblothgrpname" runat="server" Text='<%# Bind("othgrpname") %>'></asp:Label>
                    </ItemTemplate>
                    <ControlStyle  />
                    <HeaderStyle HorizontalAlign="Left"   />
                    <ItemStyle  HorizontalAlign="Left"  />
...
<asp:BoundField  DataFormatString="{0:dd/MM/yyyy hh:mm:ss tt} " DataField="adddate" SortExpression="adddate" HeaderText="Date Created">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
...
<asp:BoundField  DataFormatString="{0:dd/MM/yyyy hh:mm:ss tt} " DataField="moddate" SortExpression="moddate" HeaderText="Date Modified">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
