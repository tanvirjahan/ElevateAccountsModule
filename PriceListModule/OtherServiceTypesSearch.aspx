<%@ Page Language="VB" MasterPageFile="~/PriceListMaster.master" AutoEventWireup="false" EnableEventValidation="false"  CodeFile="OtherServiceTypesSearch.aspx.vb" Inherits="OtherServiceTypesSearch" %>
...
<asp:RadioButton id="rbtnadsearch" runat="server" Text="Advance Search" ForeColor="Black" __designer:dtid="2814749767106576" CssClass="td_cell" OnCheckedChanged="rbtnadsearch_CheckedChanged" GroupName="GrSearch" AutoPostBack="True" __designer:wfdid="w7"></asp:RadioButton> 
...
<TD style="WIDTH: 151px" class="td_cell" colSpan=1><asp:Button id="btnAddNew" 
        ...
        __designer:dtid="10977524091715597" CssClass="btn" __designer:wfdid="w13"></asp:Button></TD><TD style="WIDTH: 137px" class="td_cell" colSpan=1><asp:Button id="btnPrint" tabIndex=9 runat="server" Text="Report" __designer:dtid="10977524091715599" CssClass="btn" __designer:wfdid="w14"></asp:Button></TD></TR><TR><TD style="WIDTH: 76px; HEIGHT: 24px" class="td_cell"><SPAN style="COLOR: black">Type&nbsp;Code&nbsp;&nbsp; </SPAN></TD>
<TD style="WIDTH: 11px">
    <INPUT style="WIDTH: 163px" id="txtCode" tabIndex=1 type=text maxLength=20 runat="server" class="field_input" /></TD><TD style="WIDTH: 54px; HEIGHT: 24px" class="td_cell"><SPAN style="COLOR: black"><asp:Label id="Label1" runat="server" Text="Type Name" Width="100px" __designer:wfdid="w1"></asp:Label></SPAN></TD><TD style="WIDTH: 118px" class="td_cell">
...
<asp:BoundField DataField="paxcheckreq" SortExpression="paxcheckreq" HeaderText="Pax Check Required"></asp:BoundField>
