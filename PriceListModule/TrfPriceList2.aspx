<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="TrfPriceList2.aspx.vb" Inherits="PriceListModule_TrfPriceList2" %>
...
<script language="javascript" type="text/javascript" >
    ...
    var chkmu=document.getElementById("<%=chkConsdierForMarkUp.ClientID%>");

   
    if (chkmu.checked == true) {
        var x = confirm("Are you sure to consider this supplier for markup??");
        return x;
    }
    else {
        var x = confirm("Are you sure not to calculate markup for this supplier???");
        return x;
    }
   ...
   <TABLE style="BORDER-RIGHT: gray 2pt solid; BORDER-TOP: gray 2pt solid; BORDER-LEFT: gray 2pt solid; BORDER-BOTTOM: gray 2pt solid">
     <TBODY><TR><TD style="HEIGHT: 18px; TEXT-ALIGN: center" class="field_heading" align=left colSpan=4>
          <asp:Label id="lblHeading" runat="server" Text="Add New Transfer price List" CssClass="field_heading" Width="744px"></asp:Label></TD></TR>
