<%@ Page Title="" Language="VB" MasterPageFile="~/PriceListMaster.master" AutoEventWireup="false" CodeFile="OthSellingFormulaSearch.aspx.vb" Inherits="PriceListModule_OthSellingFormulaSearch" %>
...
<table  style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid; border-bottom: gray 2px solid; width: 898px;">
  <tr><td align="center" class="field_heading">
           <asp:Label id="lblheading" runat="server" Text="Other Selling Formulas List" CssClass="field_heading" __designer:wfdid="w30"></asp:Label></td></tr>
...
<tr><td class="td_cell" align=center colSpan=6>
    ...
    <TR><TD class="td_cell" colSpan=1><asp:Label id="lblcurrcode" runat="server" 
            Text="Currency Code" ForeColor="Black" CssClass="td_cell" 
            __designer:wfdid="w17" Visible="False" ></asp:Label></TD>
    <TD class="td_cell" colSpan=1>
    <SELECT onchange="GetValueFromName()" style="WIDTH: 148px" id="ddlCurrencyCode" class="drpdown" tabIndex=3 runat="server" Visible="false"></SELECT></TD>
    <TD class="td_cell" colSpan=1><asp:Label id="lblcurrname" runat="server" 
            Text="Currency Name" ForeColor="Black" Width="100px" CssClass="td_cell" 
            __designer:wfdid="w17" Visible="False"></asp:Label></TD>
    <TD class="td_cell" colSpan=1>
    <SELECT onchange="GetValueFromCode()" style="WIDTH: 205px" id="ddlCurrencyName" class="drpdown" tabIndex=4 runat="server" Visible="false"></SELECT></TD>
    ...
    <asp:UpdatePanel id="UpdatePanel2" runat="server">
        <contenttemplate>
<asp:GridView id="gv_SearchResult" tabIndex=10 runat="server" Font-Size="10px" Width="942px" CssClass="grdstyle" 
__designer:wfdid="w121" AllowPaging="True" AllowSorting="True"
 AutoGenerateColumns="False" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
 GridLines="Vertical" DataKeyNames="sellcode,othgrpcode">
<FooterStyle CssClass="grdfooter"></FooterStyle>
<Columns>
<asp:TemplateField SortExpression="sellcode" Visible="False" HeaderText="Selling Code"><EditItemTemplate>
<asp:TextBox runat="server" Text='<%# Bind("sellcode") %>' id="TextBox1"></asp:TextBox>
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblCode" runat="server" Text='<%# Bind("sellcode") %>'></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField="sellcode" SortExpression="sellcode" HeaderText="Selling Code"></asp:BoundField>
<asp:BoundField DataField="sellname" SortExpression="sellname" HeaderText="Selling Name"></asp:BoundField>
