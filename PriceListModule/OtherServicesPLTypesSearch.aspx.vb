...
Partial Class OtherServicesPLTypesSearch
            ...
            Try
                ...
                Else
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                                       CType(strappname, String), "PriceListModule\OtherServicesPLTypesSearch.aspx?appid=" + strappid + "&Type=" + Session("OthTypeFilter"), btnAddNew, btnExportToExcel, _
                                                       btnPrint, gv_SearchResult, GridCol.Edit, GridCol.Delete, GridCol.View)

                End If
                Session.Add("strsortExpressiontype", "othtypmast.othtypcode")
                Session.Add("strsortdirectiontype", SortDirection.Ascending)

                Session("sDtDynamicOthPLTypes") = Nothing
                ...
                Session("sDtDynamicOthPLTypes") = dtDynamic
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        strpop = "window.open('OtherServicesPLTypes.aspx?State=New','OtherServices');"  ','width='+screen.availWidth+' height='+screen.availHeight+' left=0,top=0 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            If e.CommandName = "EditRow" Then
                Dim strpop As String = ""
                strpop = "window.open('OtherServicesPLTypes.aspx?State=Edit&RefCode=" + CType(lblId.Text.Trim, String) + "&GrpCode=" + strGrpCode + "','CarRental');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)

            ElseIf e.CommandName = "View" Then
                Dim strpop As String = ""
                strpop = "window.open('OtherServicesPLTypes.aspx?State=View&RefCode=" + CType(lblId.Text.Trim, String) + "&GrpCode=" + strGrpCode + "','CarRental');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)

            ElseIf e.CommandName = "DeleteRow" Then
                Dim strpop As String = ""
                strpop = "window.open('OtherServicesPLTypes.aspx?State=Delete&RefCode=" + CType(lblId.Text.Trim, String) + "&GrpCode=" + strGrpCode + "','CarRental');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            objUtils.WritErrorLog("OtherServicesPLTypesSearch.aspx?Type=" + Session("OthTypeFilter"), Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        End Try
    End Sub
#End Region
...
#Region " Protected Sub gv_SearchResult_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gv_SearchResult.Sorting"
    ...
    Protected Sub gv_SearchResult_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gv_SearchResult.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            dtDynamics = Session("sDtDynamicOthPLTypes")
            If Session("sDtDynamicOthPLTypes") IsNot Nothing Then
...
#Region "Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click"
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Dim strpop As String = ""
            strpop = "window.open('rptReportNew.aspx?Pageame=Other service Type&BackPageName=OtherServicesPLTypesSearch.aspx&OthtypeCode=""','RepOthGrp');"
...
#End Region
    ...
    Private Sub FillGridNew()
        ...
        dtt = Session("sDtDynamicOthPLTypes")
        ...
        Try
            ...
            strBindCondition = BuildConditionNew(strCarValue, strGroupValue, strSupplierValue, strTextValue)
            Dim myDS As New DataSet
    ...
    Private Function BuildConditionNew(ByVal strCarValue As String, ByVal strgroupvalue As String, ByVal strsuppliervalue As String, ByVal strTextValue As String) As String
        strWhereCond = ""
            ...
            For i = 0 To lsMainArr.GetUpperBound(0)
                ...
                If strValue <> "" Then
                    If Trim(strWhereCond1) = "" Then
                        ...
                        strWhereCond1 = " (upper(othtypmast.othtypname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or upper(othtypmast.othtypcode) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%')"
                    Else
                        strWhereCond1 = strWhereCond1 & " OR  (upper(othtypmast.othtypname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(othtypmast.othtypcode) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%') "
                    End If
                End If
    ...
    Protected Sub lbClose_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            If dtDynamics.Rows.Count > 0 Then
                ...
                Next
            End If
            Session("sDtDynamicOthPLTypes") = dtDynamics
        ...
        For i = 0 To lsMainArr.GetUpperBound(0)
            Select Case lsMainArr(i).Split(":")(0).ToString.ToUpper.Trim
                Case "TYPE"
                    ...
                    sbAddToDataTable("TYPE", lsProcessCity, "TYPE")
                Case "GROUP"
    ...
    Function sbAddToDataTable(ByVal lsName As String, ByVal lsValue As String, ByVal lsShortCode As String) As Boolean
        ...
        If dtt.Rows.Count >= 0 Then
            ...
            If iFlag = 0 Then
                ...
                Session("sDtDynamicOthPLTypes") = dtt
            End If
        End If
        Return True
    End Function
