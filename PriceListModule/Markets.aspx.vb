        ...
        If Page.IsPostBack = False Then
            Try
                ...
                If ViewState("MarketsState") = "New" Then
                    SetFocus(txtCode)
                    lblHeading.Text = "Add New Region"
                    Page.Title = Page.Title + " " + "New Region Master"
                    btnSave.Text = "Save"
                    btnSave.Attributes.Add("onclick", "return FormValidation('New')")
                ElseIf ViewState("MarketsState") = "Edit" Then
                    SetFocus(txtName)
                    lblHeading.Text = "Edit Region"
                    Page.Title = Page.Title + " " + "Edit Region Master"
                    btnSave.Text = "Update"
                    DisableControl()
                ...
                ElseIf ViewState("MarketsState") = "View" Then
                    SetFocus(btnCancel)
                    lblHeading.Text = "View Region"
                    Page.Title = Page.Title + " " + "View Region Master"
                ...
                ElseIf ViewState("MarketsState") = "Delete" Then
                    SetFocus(btnSave)
                    lblHeading.Text = "Delete Region"
                    Page.Title = Page.Title + " " + "Delete Region Master"
                    btnSave.Text = "Delete"
                    DisableControl()
...
#Region "Private Sub ShowRecord(ByVal RefCode As String)"
    Private Sub ShowRecord(ByVal RefCode As String)
        Try
            ...
            mySqlCmd = New SqlCommand("Select * from plgrpmast Where plgrpcode='" & RefCode & "'", mySqlConn)
            mySqlReader = mySqlCmd.ExecuteReader(CommandBehavior.CloseConnection)
            If mySqlReader.HasRows Then
                If mySqlReader.Read() = True Then
                    If IsDBNull(mySqlReader("plgrpcode")) = False Then
                        Me.txtCode.Value = CType(mySqlReader("plgrpcode"), String)
                    Else
                        Me.txtCode.Value = ""
                    End If
                    If IsDBNull(mySqlReader("plgrpname")) = False Then
                        Me.txtName.Value = CType(mySqlReader("plgrpname"), String)
                    Else
                        Me.txtName.Value = ""
                    End If
            ...
            If Page.IsValid = True Then
                If ViewState("MarketsState") = "New" Or ViewState("MarketsState") = "Edit" Then
                    ...
                    If ViewState("MarketsState") = "New" Then
                        ...
                        optionval = objUtils.GetAutoDocNo("REGION", mySqlConn, sqlTrans)
                        txtCode.Value = optionval.Trim
                    End If

                    If ViewState("MarketsState") = "New" Then
                        mySqlCmd = New SqlCommand("sp_add_plgrp", mySqlConn, sqlTrans)
                        frmmode = 1
                    ElseIf ViewState("MarketsState") = "Edit" Then
                        mySqlCmd = New SqlCommand("sp_mod_plgrp", mySqlConn, sqlTrans)
                        frmmode = 2
                    End If
                    mySqlCmd.CommandType = CommandType.StoredProcedure

                    mySqlCmd.Parameters.Add(New SqlParameter("@plgrpcode", SqlDbType.VarChar, 20)).Value = CType(txtCode.Value.Trim, String)
                    mySqlCmd.Parameters.Add(New SqlParameter("@plgrpname", SqlDbType.VarChar, 100)).Value = CType(txtName.Value.Trim, String)
                    ...
                    mySqlCmd.Parameters.Add(New SqlParameter("@hod", SqlDbType.VarChar, 10)).Value = DBNull.Value
                    '@hod
                ...
                ElseIf ViewState("MarketsState") = "Delete" Then
                    ...
                    mySqlCmd = New SqlCommand("sp_del_plgrp", mySqlConn, sqlTrans)
                    mySqlCmd.CommandType = CommandType.StoredProcedure
                    mySqlCmd.Parameters.Add(New SqlParameter("@plgrpcode", SqlDbType.VarChar, 20)).Value = CType(txtCode.Value.Trim, String)
                    mySqlCmd.Parameters.Add(New SqlParameter("@userlogged", SqlDbType.VarChar, 10)).Value = CType(Session("GlobalUserName"), String)
                    mySqlCmd.ExecuteNonQuery()
