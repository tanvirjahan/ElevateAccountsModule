<%@ Page Title="" Language="VB" MasterPageFile="~/PriceListMaster.master" AutoEventWireup="false" CodeFile="HotelChainSearch.aspx.vb" Inherits="PriceListModule_HotelChainSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('HOTELCHAINNAME:" " TEXT:" "');
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      switch (category) {
                          case 'HOTELCHAINNAME':
                              var asSqlqry = '';
                              glcallback = callback;
                              ColServices.clsSectorServices.GetListOfHotelChainNameVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                              break;
                      }
                  },
                  facetMatches: function (callback) {
                      callback([
                { label: 'TEXT', category: 'HOTEL CHAIN' },
                { label: 'HOTELCHAINNAME', category: 'HOTEL CHAIN' },
              ]);
                  }
              }
          });
...
<tr>
<TD style="WIDTH: 37px" class="td_cell">
<SPAN style="COLOR: black">Hotelchain&nbsp;Code</SPAN></TD><TD style="WIDTH: 46px">
    <asp:TextBox id="txtHotelchainCode" tabIndex=1 runat="server" CssClass="field_input" MaxLength="20"></asp:TextBox></TD>
    <TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell">
    <SPAN style="COLOR: black">Hotelchain&nbsp;Name</SPAN></TD>
    <TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell">
    <asp:TextBox id="txtHotelchainName" tabIndex=2 runat="server" Width="300px" CssClass="field_input" MaxLength="100"></asp:TextBox></TD>
    <TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell">
...
<TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell">
<asp:Button id="btnHe" tabIndex=8 runat="server" Text="Help" CssClass="search_button"></asp:Button></TD>
<td class="td_cell" style="width: 42px; height: 10px">
<asp:Button ID="btnyAddNew" runat="server" CssClass="btn" Font-Bold="False" Text="Add New" TabIndex="5" style="position: relative; top: 0px; left: 0px;" /></td>
<td class="td_cell" style="width: 42px; height: 10px">
<asp:Button ID="btnPfrint" runat="server" CssClass="btn" Text="Report" TabIndex="7" style="position: relative; top: 0px; left: 0px;" /></td>

<TD style="WIDTH: 37px; HEIGHT: 10px" class="td_cell">
<asp:Label id="Label3" runat="server" Text="Order By" Width="72px" CssClass="field_caption"></asp:Label>
</TD>
<TD style="WIDTH: 46px; HEIGHT: 10px">
...
<TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell"></TD>
<TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell"></TD>
<TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell"></TD>
<TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell"></TD>
<TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell"></TD>
                    ...
                    <td>
                        ...
                        &nbsp;<asp:Button ID="btnClearDate" runat="server" CssClass="btn" Font-Bold="False" 
                            tabIndex="4" Text="Reset Dates" />
                               ...
                               <td>  <asp:Label ID="RowSelectshc" runat="server" CssClass="field_caption" 
                            Text="Rows Selected "></asp:Label>
                     <asp:DropDownList ID="RowsPerPageHC" runat="server" AutoPostBack="true">
...
<Columns>
<asp:TemplateField Visible="False" HeaderText="Hotelchain Code"><EditItemTemplate>
<asp:TextBox ID="txtHotelchainCode" runat="server" Text='<%# Bind("hotelchaincode") %>'></asp:TextBox>
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblCode" runat="server" Text='<%# Bind("hotelchaincode") %>'></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField="Hotelchaincode" SortExpression="Hotelchaincode" HeaderText="Hotel Chain Code">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
</asp:BoundField>
<asp:TemplateField HeaderText="Hotel Chain Name" SortExpression="hotelchainname">
                    <ItemTemplate>
                        <asp:Label ID="lblHotelchainname" runat="server" Text='<%# Bind("hotelchainname") %>'></asp:Label>
                    </ItemTemplate>
                    <ControlStyle Width="8%" />
                    <HeaderStyle HorizontalAlign="Left" Width="8%" />
                    <ItemStyle CssClass="hotelchainname" HorizontalAlign="Left" Width="8%" />
          </asp:TemplateField>
...
<asp:ButtonField HeaderText="Action" Text="Edit" Visible="true" CommandName="EditRow">
