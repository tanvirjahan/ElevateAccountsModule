    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            Try
                ...
                ViewState.Add("visaServiceSelltypeState", Request.QueryString("State"))
                ViewState.Add("visaServiceSelltypeRefCode", Request.QueryString("RefCode"))




                If ViewState("visaServiceSelltypeState") = "New" Then
                    ...
                    'End If
                    lblHeading.Text = "Add New - Visa  Selling Types"
                    Page.Title = Page.Title + " " + "New Visa Services Selling Types"
                    btnSave.Text = "Save"
                ...
                ElseIf ViewState("visaServiceSelltypeState") = "Edit" Then
                    ...
                    'End If
                    lblHeading.Text = "Edit -Visa Selling Types"
                    Page.Title = Page.Title + " " + "Edit Visa Service Selling Types"
                    btnSave.Text = "Update"
                    DisableControl()

                    ShowRecord(CType(ViewState("visaServiceSelltypeRefCode"), String))
                ...
                ElseIf ViewState("visaServiceSelltypeState") = "View" Then
                    SetFocus(btnCancel)
                    ...
                    'End If
                    lblHeading.Text = "View - Visa Selling Types"
                    Page.Title = Page.Title + " " + "View Visa Services  Selling Types"
                ...
                ElseIf ViewState("visaServiceSelltypeState") = "Delete" Then
                    SetFocus(btnSave)
...
#Region "Private Sub DisableControl()"
    Private Sub DisableControl()
        If ViewState("visaServiceSelltypeState") = "View" Or ViewState("visaServiceSelltypeState") = "Delete" Then
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            If Page.IsValid = True Then
                If ViewState("visaServiceSelltypeState") = "New" Or ViewState("visaServiceSelltypeState") = "Edit" Then
                    ...
                    If ViewState("visaServiceSelltypeState") = "New" Then
                        mySqlCmd = New SqlCommand("sp_add_visasell", mySqlConn, sqlTrans)
                        frmmode = 1
                    ElseIf ViewState("visaServiceSelltypeState") = "Edit" Then
                        mySqlCmd = New SqlCommand("sp_mod_visasell", mySqlConn, sqlTrans)
                        frmmode = 2
                    End If
                    mySqlCmd.CommandType = CommandType.StoredProcedure

                    mySqlCmd.Parameters.Add(New SqlParameter("@visasellcode", SqlDbType.VarChar, 20)).Value = CType(TxtOtherServiceCode.Value.Trim, String)
                    mySqlCmd.Parameters.Add(New SqlParameter("@visasellname", SqlDbType.VarChar, 100)).Value = CType(txtOtherServiceSelling.Value.Trim, String)
                ...
                ElseIf ViewState("visaServiceSelltypeState") = "Delete" Then
                    ...
                    sqlTrans = mySqlConn.BeginTransaction           'SQL  Trans start
                    frmmode = 3
                    mySqlCmd = New SqlCommand("sp_del_visasell", mySqlConn, sqlTrans)
                    mySqlCmd.CommandType = CommandType.StoredProcedure
                    mySqlCmd.Parameters.Add(New SqlParameter("@visasellcode", SqlDbType.VarChar, 20)).Value = CType(TxtOtherServiceCode.Value.Trim, String)
                    mySqlCmd.ExecuteNonQuery()
                End If
...
#Region " Private Sub ShowRecord(ByVal RefCode As String)"
    Private Sub ShowRecord(ByVal RefCode As String)
        Try
            mySqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))           'connection open
            mySqlCmd = New SqlCommand("Select * from visasellmast Where visasellcode='" & RefCode & "'", mySqlConn)
            mySqlReader = mySqlCmd.ExecuteReader(CommandBehavior.CloseConnection)
            If mySqlReader.HasRows Then
                If mySqlReader.Read() = True Then
                    If IsDBNull(mySqlReader("visasellcode")) = False Then
                        Me.TxtOtherServiceCode.Value = CType(mySqlReader("visasellcode"), String)
                    Else
                        Me.TxtOtherServiceCode.Value = ""
                    End If
                    If IsDBNull(mySqlReader("visasellname")) = False Then
                        Me.txtOtherServiceSelling.Value = CType(mySqlReader("visasellname"), String)
                    Else
...
#Region "Public Function checkForDuplicate() As Boolean"
    Public Function checkForDuplicate() As Boolean
        If ViewState("visaServiceSelltypeState") = "New" Then
            If objUtils.isDuplicatenew(Session("dbconnectionName"), "visasellmast ", "visasellcode", CType(TxtOtherServiceCode.Value.Trim, String)) Then
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('This Selling Types code is already present.');", True)
                SetFocus(TxtOtherServiceCode)
                checkForDuplicate = False
                Exit Function
            End If
            If objUtils.isDuplicatenew(Session("dbconnectionName"), "visasellmast", "visasellname", txtOtherServiceSelling.Value.Trim) Then
