<%@ Page Language="VB" MasterPageFile="~/PriceListMaster.master" AutoEventWireup="false" CodeFile="FlightSectormasterSearch.aspx.vb" Inherits="FlightSectormasterSearch"  %>
        ...
        <tr>
            <td style="width: 673px;">
                <asp:UpdatePanel id="UpdatePanel2" runat="server">
                    <contenttemplate>
<TABLE style="WIDTH: 784px"><TBODY><TR><TD style="WIDTH: 158px" class="td_cell"><SPAN style="COLOR: black">Flight&nbsp;Sector&nbsp;Code</SPAN></TD><TD>
    <asp:TextBox id="TxtFlightSectorCode" tabIndex=1 runat="server" Width="179px" 
        CssClass="field_input" MaxLength="20" __designer:wfdid="w23"></asp:TextBox></TD><TD style="WIDTH: 195px" class="td_cell"><SPAN style="COLOR: black">Flight&nbsp;Sector&nbsp;Name</SPAN></TD><TD style="WIDTH: 188px" class="td_cell">
    <asp:TextBox id="TxtFlightSectorName" tabIndex=2 runat="server" Width="179px" 
        CssClass="field_input" __designer:wfdid="w35"></asp:TextBox></TD><TD style="WIDTH: 90px" class="td_cell">
        <asp:Button id="btnSearch" tabIndex=3 runat="server" Text="Search" 
            Font-Bold="False" CssClass="search_button" __designer:wfdid="w36"></asp:Button>
    ...
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
<asp:GridView id="gv_SearchResult" tabIndex=8 runat="server" Font-Size="10px" Width="924px" CssClass="grdstyle" __designer:wfdid="w39" GridLines="Vertical" CellPadding="3" BorderWidth="1px" BorderStyle="None" BorderColor="#999999" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True">
<FooterStyle CssClass="grdfooter"></FooterStyle>
<Columns>
<asp:TemplateField Visible="False" HeaderText="Flight Sector Code"><EditItemTemplate>
<asp:TextBox id="TextBox1" runat="server" Text='<%# Bind("flightsectorcode") %>' __designer:wfdid="w2"></asp:TextBox> 
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblflightclscode" runat="server" Text='<%# Bind("flightsectorcode") %>' __designer:wfdid="w1"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField="flightsectorcode" SortExpression="flightsectorcode" HeaderText="Flight Sector Code">
<ItemStyle HorizontalAlign="Left"></ItemStyle>

<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
</asp:BoundField>
<asp:BoundField DataField="flightsectorname" SortExpression="flightsectorname" HeaderText="Flight Sector Name">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
