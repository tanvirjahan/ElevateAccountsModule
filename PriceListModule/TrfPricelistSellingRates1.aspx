<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="TrfPricelistSellingRates1.aspx.vb" Inherits="PriceListModule_TrfPricelistSellingRates1" %>
...
<TABLE style="WIDTH: 843px"><TBODY><TR><TD style="TEXT-ALIGN: center" class="field_heading" align=center colSpan=4>
    ...
    <asp:Label id="Label1" runat="server" Text="Selling Codes & Names" 
        ...
        <TD class="td_cell" vAlign=top align=left rowSpan=10>&nbsp;
