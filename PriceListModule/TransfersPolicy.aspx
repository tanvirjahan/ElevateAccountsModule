<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="TransfersPolicy.aspx.vb" Inherits="PriceListModule_TransfersPolicy" %>
...
<script language="javascript" type="text/javascript" >
    ...
    function FormValidation(state) {
        if ((document.getElementById("<%=ddlGroupCode.ClientID%>").value == "[Select]") ) {
            ...
            if (state == 'New') { if (confirm('Are you sure you want to save Transfers Policy?') == false) return false; }
            if (state == 'Edit') { if (confirm('Are you sure you want to update Transfers Policy?') == false) return false; }
            if (state == 'Delete') { if (confirm('Are you sure you want to delete Transfers Policy?') == false) return false; }
        }
    }
...
<TBODY>
    <TR>
        <TD style="WIDTH: 774px; TEXT-ALIGN: center" class="field_heading">
            <asp:Label id="lblCustCatHead" runat="server" Text="Transfers Policy" Width="742px"></asp:Label>
        </TD>
    </TR>
    <TR>
