<%@ Page Title="" Language="VB" MasterPageFile="~/VisaMaster.master" AutoEventWireup="false" CodeFile="OthPolicySearch.aspx.vb" Inherits="PriceListModule_OthPolicySearch" %>
...
<table style="height: 1px; border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid; border-bottom: gray 2px solid;" id="TABLE1" >
        <tr>
            <td align="center" class="field_heading">
              <asp:Label id="lblHeading" runat="server" Text="Policy List" CssClass="field_heading" Width="100%"></asp:Label> </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="td_cell" align="left" style="height: 16px">
                <asp:UpdatePanel id="UpdatePanel2" runat="server">
                    <contenttemplate>
<asp:GridView id="gv_SearchResult" tabIndex=11 runat="server" Font-Size="10px" Width="100%" CssClass="grdstyle" __designer:wfdid="w15" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
