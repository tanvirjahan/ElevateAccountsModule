<%@ Page Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="FlightSectormaster.aspx.vb" Inherits="FlightSectormaster"  %>
...
if ((document.getElementById("<%=txtCode.ClientID%>").value=="")||(document.getElementById("<%=txtName.ClientID%>").value==""))
{
 if (document.getElementById("<%=txtCode.ClientID%>").value=="")
 {
       ...
       {
       if (state=='New'){if(confirm('Are you sure you want to save Flight Sector Master?')==false)return false;}
       if (state=='Edit'){if(confirm('Are you sure you want to update Flight Sector Master?')==false)return false;}
       if (state=='Delete'){if(confirm('Are you sure you want to delete Flight Sector Master?')==false)return false;}
       }
}  
...
<TABLE style="BORDER-RIGHT: gray 2px solid; BORDER-TOP: gray 2px solid; BORDER-LEFT: gray 2px solid; BORDER-BOTTOM: gray 2px solid"><TBODY><TR><TD style="HEIGHT: 18px" class="td_cell" align=center colSpan=2>
    <asp:Label id="lblHeading" runat="server" Text="Add New Flight Sector" 
        CssClass="field_heading" Width="450px"></asp:Label></TD></TR><TR style="COLOR: #ff0000"><TD style="WIDTH: 145px" class="td_cell"><SPAN style="COLOR: black">Code</SPAN> <SPAN style="COLOR: #ff0000" class="td_cell">*</SPAN></TD><TD style="COLOR: #000000">
