<%@ Page Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="ContractValidatenew.aspx.vb" Inherits="ContractValidatenew" %>
...
<script language="javascript" type="text/javascript" >
    ...
    function Checkoffers(contractid) {
        var hdnpromotionid = document.getElementById("<%=hdnpromotionid.ClientID%>");

        if ((hdnpromotionid.value == '')) {
            alert('Please Save Offer Main details to continue');
            return false;
        }
                ...
                <tbody>
                    <tr>
                        <td valign="top" align="center" width="150px" colspan="4">
                            <asp:Label ID="lblHeading" runat="server" Text="Validate For Approval" CssClass="field_heading"
                            ...
                            <table style="width: 100%">
                                <tr>
                                    <td align="left" class="td_cell" valign="top">
                                        <asp:Panel ID="Panelsearch" runat="server" Font-Bold="true" GroupingText="Validate Details"
                                            Width="100%">
                                            <table style="width: 100%">
                                                <tr>
                                                    <td >
                                                    ...
                                                    <td>
                                                    <asp:Button ID="btnrefresh" runat="server" Text="Refresh" Font-Bold="False" CssClass="btn">
                                                        </asp:Button>
                                                    </td>
                                                    <td>
                                                    <asp:Button ID="btnContractPrint" runat="server" CssClass="btn" 
                                                            Font-Bold="False" Text="Contract Print" OnClientClick="ShowProgess();"  />
                                                    </td>
                                                    <td>
                                                    <asp:Button ID="btnOfferPrint" runat="server" CssClass="btn" 
                                                            Font-Bold="False" Text="Offer Print" OnClientClick="ShowProgess();"  />
                                                    </td>
                                                    <td>
                                                     <asp:Button ID="btnReport" runat="server" Text="Print Error List" Font-Bold="False" CssClass="btn">
                                                        </asp:Button>
                                                    </td>
                                                    <td>
                                                    <asp:Button ID="btnofferrates" runat="server" Text="Final Base MealRate" Font-Bold="False" CssClass="btn" OnClientClick="ShowProgess();">
                                                        </asp:Button>
                                                    </td>
                                                    <td>
                                                    <asp:Button ID="btnothmealofferrates" runat="server" Text="Final Other MealRate" Font-Bold="False" CssClass="btn" OnClientClick="ShowProgess();">
                                                        </asp:Button>
                                                    </td>
                                                    </tr>
                                                    </table>
                                                                                    ...
                                                                                    <asp:GridView ID="gv_SearchResult" runat="server" Font-Size="10px" Width="100%"
                                                                                        ...
                                                                                        <Columns>
                                                                                             ...
                                                                                             <asp:TemplateField  HeaderText="Error Message">
                                                                                                <ItemTemplate>
                                                                                                <asp:Label ID="lblerrormsg" runat="server"    Text='<%# Eval("errormsg")%>' Tooltip='<%# Eval("errormsg")%>' ></asp:Label>
                                                                                             <%--   <br />
