...
Partial Class OthPricelistSearch
...
#Region "Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            Try
                ...
                Else
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                             CType(strappname, String), "PriceListModule\OthPriceListSearch.aspx?appid=" + strappid + "&Type=" + Session("OthPListFilter"), btnAddNew, btnExportToExcel, _
        ...
        If (Me.IsPostBack And Me.Request("__EVENTTARGET") = "AirportPriceListWindowPostBack") Then
    ...
    Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        Try
            ...
            strSqlQry = "select  h.oplistcode,  h.othgrpcode,o.othgrpname,h.currcode,h.applicableto,  min(d.frmdate) frmdate ,max(d.todate)todate ,h.adddate,h.adduser,h.moddate,h.moduser,  " _
                ...
                & " where h.othgrpcode='" & hdDefault_Group.Value & "'  group by  h.oplistcode,  h.othgrpcode,o.othgrpname,h.currcode,h.applicableto ,h.approve,h.adddate,h.adduser,h.moddate,h.moduser "
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        strpop = "window.open('Othpricelist1.aspx?State=New&Group=" + CType(hdDefault_Group.Value, String) + "','Othpricelist1');"
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            If e.CommandName = "Editrow" Then
                ...
                strpop = "window.open('Othpricelist1.aspx?State=Edit&Group=" + CType(hdDefault_Group.Value, String) + "&RefCode=" + CType(lblId.Text.Trim, String) + "','Othpricelist1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ElseIf e.CommandName = "View" Then
                ...
                strpop = "window.open('Othpricelist1.aspx?State=View&Group=" + CType(hdDefault_Group.Value, String) + "&RefCode=" + CType(lblId.Text.Trim, String) + "','Othpricelist1');"
            ...
            ElseIf e.CommandName = "Deleterow" Then
                ...
                strpop = "window.open('Othpricelist1.aspx?State=Delete&Group=" + CType(hdDefault_Group.Value, String) + "&RefCode=" + CType(lblId.Text.Trim, String) + "','Othpricelist1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ...
            ElseIf e.CommandName = "Copy" Then
                ...
                strpop = "window.open('Othpricelist1.aspx?State=Copy&Group=" + CType(hdDefault_Group.Value, String) + "&RefCode=" + CType(lblId.Text.Trim, String) + "','Othpricelist1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If
        Catch ex As Exception
            ' ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
