<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" EnableEventValidation="false"  AutoEventWireup="false"
    CodeFile="MealMarkupFormula.aspx.vb" Inherits="MealMarkupFormula" %>
                ...
                <tbody>
                    <tr>
                        <td class="td_cell" align="center">
                            <asp:Label ID="lblHeading" runat="server" Text="Add New MealMarkup Formula" Width="100%"
                    ...
                    <tr>
                        ...
                        <tr>
                            <td align="left" class="td_cell">
                                <span style="color: black">MealMarkup Formula Code</span> <span class="td_cell" 
                    ...
                    <tr>
                        <td style="height:24px;width:28%" class="td_cell" align="left">
                            MealMarkup Formula Name<span style="color: red" class="td_cell">*</span>
                        </td>
                        <td style="width:72%">
                                       ...
                                       <td style="width:100% " valign="top">
                                           <asp:GridView ID="grdCommFormula" runat="server" AllowSorting="True" 
                                               ...
                                               <Columns>
                                                   ...
                                                   <asp:TemplateField HeaderText="Operator for Unit">
                                                       <ItemTemplate>
                                                   ...
                                                   <asp:TemplateField HeaderText="Unit">
                                                       ...
                                                       <asp:TemplateField HeaderText="Operator for ACI">
                                                    <ItemTemplate>
                                                   ...
                                                   <asp:TemplateField HeaderText="Child">
                                                     ...
                                                     <asp:TemplateField HeaderText="Room Category">
                                                        <FooterTemplate>
                                                            &nbsp;
                                                        </FooterTemplate>
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtrmcatcode" runat="server"  Enabled="false" CssClass="field_input" 
                                                                Width="70px" Text=""></asp:TextBox>
                                                            <asp:Button ID="btnrmcat" runat="server" CssClass="btn"  OnClick="btnrmcat_Click" TabIndex="14"
                                                                Text=".." Width="20px" />
                                                        </ItemTemplate>
                                   ...
                                   <tr align="center">
                                       <td style="height: 22px">
                                           <asp:Button ID="btnAddRow" runat="server" CssClass="btn" 
                                               OnClick="btnAddRow_Click" TabIndex="25" Text="Add Row" />
                                           &nbsp;
                                           <asp:Button ID="btnDeleteRow" runat="server" CssClass="btn" 
                                               OnClick="btnDeleteRow_Click" TabIndex="26" Text="Delete Row" />
