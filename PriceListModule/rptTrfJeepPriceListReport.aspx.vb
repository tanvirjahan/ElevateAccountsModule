...
Partial Class PriceListModule_rptTrfJeepPriceListReport
    ...
    Private Sub BindReport()
        ...
        If ViewState("othergroupcode") = "TRFS" Then
            strparam = "1001"
        Else
            strparam = "1025"
        End If
        ...
        ElseIf ViewState("rtptype") = "Sales" And (strparam = "1025") Then

            rptreportname = "Report -Jeepwadi Price List - Sales Sheet"
        End If
        rep.Load(Server.MapPath("~\Report\rptjeeptrfsplist.rpt"))
