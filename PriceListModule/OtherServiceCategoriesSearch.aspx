<%@ Page Language="VB" MasterPageFile="~/PriceListMaster.master" EnableEventValidation="false"  AutoEventWireup="false" CodeFile="OtherServiceCategoriesSearch.aspx.vb" Inherits="OtherServiceCategoriesSearch" %>
    ...
    <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
        ...
        <tr>
            <td align="center" class="field_heading" colspan="4" >
                <asp:Label ID="lblHead" runat="server" Text="Other Service Categories List"></asp:Label>     </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="td_cell" colspan="4" >
                ...
                <asp:UpdatePanel id="UpdatePanel1" runat="server">
                    <contenttemplate>
<TABLE><TBODY><TR><TD style="TEXT-ALIGN: center" class="td_cell" colSpan=4>
<asp:RadioButton id="rbtnsearch" runat="server" Text="Search" ForeColor="Black" CssClass="td_cell" AutoPostBack="True" GroupName="GrSearch" OnCheckedChanged="rbtnsearch_CheckedChanged" Checked="True"></asp:RadioButton>&nbsp; <asp:RadioButton id="rbtnadsearch" runat="server" Text="AdvanceSearch" ForeColor="Black" CssClass="td_cell" AutoPostBack="True" GroupName="GrSearch" OnCheckedChanged="rbtnadsearch_CheckedChanged"></asp:RadioButton>&nbsp;
<asp:Button id="btnSearch" tabIndex=5 runat="server" Text="Search" 
    ...
    <asp:Button id="btnClear" tabIndex=6 runat="server" Text="Clear" 
        Font-Bold="False" CssClass="search_button"></asp:Button>&nbsp;
<asp:Button id="btnHelp" tabIndex=10 onclick="btnHelp_Click" runat="server" Text="Help" CssClass="search_button">
</asp:Button>&nbsp;
...
<TR><TD style="WIDTH: 86px; HEIGHT: 26px" class="td_cell"><SPAN style="COLOR: black">
    Category&nbsp;Code</SPAN></TD><TD style="HEIGHT: 26px"><INPUT style="WIDTH: 179px" id="txtCode" tabIndex=1 type=text maxLength=20 runat="server" /></TD>
<TD style="HEIGHT: 26px" class="td_cell"><SPAN style="COLOR: black">Category Name</SPAN></TD><TD style="HEIGHT: 26px" class="td_cell"><INPUT style="WIDTH: 350px" id="txtName" tabIndex=2 type=text maxLength=100 runat="server" /></TD>
...
<TR><TD style="WIDTH: 86px; HEIGHT: 22px" class="td_cell"><asp:Label id="lblgrpcode" runat="server" Text="Group Code" Width="72px" Visible="False"></asp:Label></TD>
<TD style="HEIGHT: 22px"><SELECT onchange="GetOtherGrpValueFrom()" style="WIDTH: 187px" id="ddlOtherGrpCode" class="drpdown" tabIndex=3 runat="server" Visible="false"> <OPTION selected></OPTION></SELECT></TD>
...
<TD style="HEIGHT: 22px" class="td_cell"><SELECT onchange="GetOtherGrpValueCode()" style="WIDTH: 356px" id="ddlOtherGrpName" class="drpdown" tabIndex=4 runat="server" Visible="false"> <OPTION selected></OPTION></SELECT></TD>
<TD style="HEIGHT: 22px" class="td_cell"></TD><TD style="HEIGHT: 22px" class="td_cell"></TD></TR></TBODY></TABLE>
</contenttemplate>
                </asp:UpdatePanel></td>
                    </tr>
                </table>
        ...
        <tr>
            <td class="td_cell" colspan="4" style="color: red; width: 100%;">
                &nbsp;<asp:Button ID="btnExportToExcel" runat="server" CssClass="btn" TabIndex="8"
                    Text="Export To Excel" Width="108px" />
                </td>
        </tr>
        <tr>
            <td class="td_cell" colspan="4" style="color: red; width: 100%;">
                <asp:UpdatePanel id="UpdatePanel2" runat="server">
                    <contenttemplate>
<asp:GridView id="gv_SearchResult" tabIndex=10 runat="server" Font-Size="10px" BackColor="White" Width="100%" CssClass="td_cell" GridLines="Vertical" CellPadding="3" BorderWidth="1px" BorderStyle="None" BorderColor="#999999" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True">
...
<asp:BoundField DataField="othcatcode" SortExpression="othcatcode" HeaderText="Category Code">
<ItemStyle HorizontalAlign="Left"></ItemStyle>

<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
</asp:BoundField>
<asp:BoundField DataField="othcatname" SortExpression="othcatname" HeaderText="Category Name">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
...
<asp:BoundField DataField="minpax" SortExpression="minpax" HeaderText="Min Pax"></asp:BoundField>
<asp:BoundField DataField="maxpax" SortExpression="maxpax" HeaderText="Max. Pax"></asp:BoundField>
...
<asp:BoundField DataField="paxcheckreqd" SortExpression="paxcheckreqd" HeaderText="Pax Check Required"></asp:BoundField>
<asp:BoundField DataField="active" SortExpression="active" HeaderText="Active"></asp:BoundField>
<asp:BoundField DataField="calcyn" SortExpression="calcyn" 
        HeaderText="Calculate By Pax/Units" Visible="False"></asp:BoundField>
