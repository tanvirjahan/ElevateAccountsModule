    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            Try
                ...
                mySqlCmd = New SqlCommand("select * from confirmation_text ", mySqlConn, sqlTrans)
                ...
                If mySqlReader.Read Then
                    ...
                    If IsDBNull(mySqlReader("remarks")) = False Then
                        Editor1.Content = mySqlReader("remarks")
                    End If
                    btnSave.Text = "Update"
                Else
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            If CType(Session("State"), String) = "Add" Then
                mySqlCmd = New SqlCommand("sp_add_confirmation_text", mySqlConn, sqlTrans)
            ElseIf CType(Session("State"), String) = "Edit" Then
                mySqlCmd = New SqlCommand("sp_mod_confirmation_text", mySqlConn, sqlTrans)
            End If
            mySqlCmd.CommandType = CommandType.StoredProcedure

            'mySqlCmd.Parameters.Add(New SqlParameter("@webdetailid", SqlDbType.Int, 9)).Value = txtWebDetailId.Text
            mySqlCmd.Parameters.Add(New SqlParameter("@remarks", SqlDbType.VarChar)).Value = Editor1.Content 'strfilenm txttest.Value 
