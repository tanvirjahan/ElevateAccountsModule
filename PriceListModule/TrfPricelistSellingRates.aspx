<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="TrfPricelistSellingRates.aspx.vb" Inherits="PriceListModule_TrfPricelistSellingRates" %>
 ...
 <table style="width: 936px">
                    <tr>
                        <td class="field_heading" colspan="5" style="text-align: center" align="center">
                            <asp:Label ID="Label2" runat="server" CssClass="field_heading" Text="Price List - Selling Rates"
