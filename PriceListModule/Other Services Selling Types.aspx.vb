    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            Try
                ...
                Session("filter") = Request.QueryString("Type")
                ...
                ViewState.Add("OtherServiceSelltypeState", Request.QueryString("State"))
                ViewState.Add("OtherServiceSelltypeRefCode", Request.QueryString("RefCode"))

            


                If ViewState("OtherServiceSelltypeState") = "New" Then
                ...
                ElseIf ViewState("OtherServiceSelltypeState") = "Edit" Then
                    ...
                    ShowRecord(CType(ViewState("OtherServiceSelltypeRefCode"), String))
                ...
                ElseIf ViewState("OtherServiceSelltypeState") = "View" Then
                    SetFocus(btnCancel)
                ...
                ElseIf ViewState("OtherServiceSelltypeState") = "Delete" Then
                    SetFocus(btnSave)
                    ...
                    btnSave.Attributes.Add("onclick", "javascript:if(confirm('Are you sure you want to delete Handling Fees Selling Types?')==false)return false;")
                End If
...
#Region "Private Sub DisableControl()"
    Private Sub DisableControl()
        If ViewState("OtherServiceSelltypeState") = "View" Or ViewState("OtherServiceSelltypeState") = "Delete" Then
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            If Page.IsValid = True Then
                If ViewState("OtherServiceSelltypeState") = "New" Or ViewState("OtherServiceSelltypeState") = "Edit" Then
                    ...
                    If ViewState("OtherServiceSelltypeState") = "New" Then
                        mySqlCmd = New SqlCommand("sp_add_othsell", mySqlConn, sqlTrans)
                        frmmode = 1
                    ElseIf ViewState("OtherServiceSelltypeState") = "Edit" Then
                        mySqlCmd = New SqlCommand("sp_mod_othsell", mySqlConn, sqlTrans)
                        frmmode = 2
                    End If
                    mySqlCmd.CommandType = CommandType.StoredProcedure

                    mySqlCmd.Parameters.Add(New SqlParameter("@othsellcode", SqlDbType.VarChar, 20)).Value = CType(TxtOtherServiceCode.Value.Trim, String)
                    mySqlCmd.Parameters.Add(New SqlParameter("@othsellname", SqlDbType.VarChar, 100)).Value = CType(txtOtherServiceSelling.Value.Trim, String)
                    mySqlCmd.Parameters.Add(New SqlParameter("@currcode", SqlDbType.VarChar, 20)).Value = CType(ddlCurrencyNm.Value, String)
                    mySqlCmd.Parameters.Add(New SqlParameter("@othertype", SqlDbType.VarChar, 20)).Value = CType(Session("filter"), String)
                    ...
                    'Changed on 19.06.2014

                    'If chkHandlingFees.Checked = True Then
                    'mySqlCmd.Parameters.Add(New SqlParameter("@costyesno", SqlDbType.Int)).Value = 1
                    'ElseIf chkHandlingFees.Checked = False Then
                    mySqlCmd.Parameters.Add(New SqlParameter("@costyesno", SqlDbType.Int)).Value = 0
                    ' End If
                ...
                ElseIf ViewState("OtherServiceSelltypeState") = "Delete" Then
                    ...
                    mySqlCmd = New SqlCommand("sp_del_othsell", mySqlConn, sqlTrans)
                    mySqlCmd.CommandType = CommandType.StoredProcedure
                    mySqlCmd.Parameters.Add(New SqlParameter("@othsellcode", SqlDbType.VarChar, 20)).Value = CType(TxtOtherServiceCode.Value.Trim, String)
                    mySqlCmd.ExecuteNonQuery()
                    frmmode = 3
        ...
        Catch ex As Exception
            ...
            End If
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            objUtils.WritErrorLog("Other Services Selling Types.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        End Try
...
#Region " Private Sub ShowRecord(ByVal RefCode As String)"
    Private Sub ShowRecord(ByVal RefCode As String)
        Try
            mySqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))           'connection open
            mySqlCmd = New SqlCommand("Select * from othsellmast Where othsellcode='" & RefCode & "'", mySqlConn)
            mySqlReader = mySqlCmd.ExecuteReader(CommandBehavior.CloseConnection)
            If mySqlReader.HasRows Then
                If mySqlReader.Read() = True Then
                    If IsDBNull(mySqlReader("othsellcode")) = False Then
                        Me.TxtOtherServiceCode.Value = CType(mySqlReader("othsellcode"), String)
                    Else
                        Me.TxtOtherServiceCode.Value = ""
                    End If
                    If IsDBNull(mySqlReader("othsellname")) = False Then
                        Me.txtOtherServiceSelling.Value = CType(mySqlReader("othsellname"), String)
                    Else
...
#Region "Public Function checkForDuplicate() As Boolean"
    Public Function checkForDuplicate() As Boolean
        If ViewState("OtherServiceSelltypeState") = "New" Then
            If objUtils.isDuplicatenew(Session("dbconnectionName"), "othsellmast ", "othsellcode", CType(TxtOtherServiceCode.Value.Trim, String)) Then
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('This Selling Types code is already present.');", True)
                SetFocus(TxtOtherServiceCode)
                checkForDuplicate = False
                Exit Function
            End If
            If objUtils.isDuplicatenew(Session("dbconnectionName"), "othsellmast", "othsellname", txtOtherServiceSelling.Value.Trim) Then
...
#Region "Public Function checkForDeletion() As Boolean"
    Public Function checkForDeletion() As Boolean
        ...
        ElseIf objUtils.GetDBFieldValueExistnew(Session("dbconnectionName"), "othplisth", "othsellcode", CType(TxtOtherServiceCode.Value.Trim, String)) = True Then
