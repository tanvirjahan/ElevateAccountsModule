...
Partial Class rptPLprint
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Try
            If Request.QueryString("PLCode") <> "" Then
                'sptypecode = Request.QueryString("sptypecode")
                ViewState.Add("PLCode", Request.QueryString("PLCode"))
                Page.Title = Page.Title + " " + "Pricelist Print - " + Request.QueryString("PLCode")
            Else
                ViewState.Add("PLCode", String.Empty)
            End If
    ...
    Private Sub BindReport()
        ...
        rptreportname = "Report - Price List"
        ...
        rep.Load(Server.MapPath("~\Report\rptpricelistsinglenew.rpt"))
        ...
        paramvalue.Value = " Price List of : " + Trim(ViewState("PLCode"))
        param = pname.CurrentValues
        param.Add(paramvalue)
        pname.ApplyCurrentValues(param)

        pname = pnames.Item("@plistcode")
        'paramvalue.Value = Session("skip")
        paramvalue.Value = ViewState("PLCode")
        param = pname.CurrentValues
        param.Add(paramvalue)
        pname.ApplyCurrentValues(param)
