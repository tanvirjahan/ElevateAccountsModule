<%@ Page Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="SupSplEvents.aspx.vb" Inherits="SupSplEvents"  %>
...
<TABLE style="WIDTH: 656px"><TBODY><TR><TD style="WIDTH: 80px" class="td_cell" colSpan=2><asp:Panel id="PanelSpEvent" runat="server" Width="743px" GroupingText="Special Events / Extras"><TABLE><TBODY><TR><TD style="WIDTH: 100px; HEIGHT: 4px"></TD></TR><TR><TD style="WIDTH: 100px"><asp:GridView id="GV_SpecialEvent" tabIndex=97 runat="server" Width="607px" AutoGenerateColumns="False">
                        <Columns>
                            <asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Spevent Code">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtspcode" runat="server" CssClass="field_input" Height="16px" 
                                        Text='<%# Bind("spleventcode") %>' Width="143px"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Spevent Name">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtspname" runat="server" CssClass="field_input" Height="16px" 
                                        Text='<%# Bind("spleventname") %>' Width="329px"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView> </TD></TR><TR><TD style="HEIGHT: 22px" align=left>
