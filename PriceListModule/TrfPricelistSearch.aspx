<%@ Page Title="" Language="VB" MasterPageFile="~/PriceListMaster.master" AutoEventWireup="false" CodeFile="TrfPricelistSearch.aspx.vb" Inherits="PriceListModule_TrfPricelistSearch" %>
...
<tr>
  <td align="center" class="field_heading"  >Transfer Price List   </td>
</tr>
<tr>
...
<tr>
  <td>
   ...
   <tr><td style="WIDTH: 141px" class="td_cell" align=left><SPAN class="td_cell">Supplier Code</SPAN></TD><TD style="WIDTH: 200px"><SELECT style="WIDTH: 200px" id="ddlSupplierCode" class="drpdown" tabIndex=4 onchange="CallWebMethod('PartyCode');" runat="server"> <OPTION selected></OPTION></SELECT></TD>
   <td style="WIDTH: 156px" class="td_cell" align=left WIDT: 686px?><SPAN class="td_cell">Supplier Name</SPAN></TD>
   <td><SELECT style="WIDTH: 300px" id="ddlSupplierName" class="drpdown" tabIndex=5 onchange="CallWebMethod('PartyName');" runat="server"> <OPTION selected></OPTION></SELECT></TD></TR>
    <tr>
