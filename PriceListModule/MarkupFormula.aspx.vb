            ...
            If mySqlReader.HasRows Then
                While mySqlReader.Read()
                    ...
                    If n <= grdCommFormula.Rows.Count Then
                        ...
                        '   txtValue.Text = CType(mySqlReader("value"), String).Replace(".00", "")

                        'If IsNumeric(CType(mySqlReader("value"), String)) Then
                        '    txtValue.Text = CType(mySqlReader("value"), Integer)
                        'Else
                        '    txtValue.Text = CType(mySqlReader("value"), String)
                        'End If
                        ...
                        '    txtValue.Text = ""
                        'If IsNumeric(CType(mySqlReader("adultvalue"), String)) Then
                        '    txtAdult.Text = CType(mySqlReader("adultvalue"), Integer)
                        'Else
                        ' txtAdult.Text = CType(mySqlReader("adultvalue"), String).Replace(".00", "")
                        'End If
                        'If IsNumeric(CType(mySqlReader("childvalue"), String)) Then
                        '    txtChild.Text = CType(mySqlReader("childvalue"), Integer)
                        'Else
                        '   txtChild.Text = CType(mySqlReader("childvalue"), String).Replace(".00", "")
                        'End If
                        'If IsNumeric(CType(mySqlReader("ExtraBed"), String)) Then
                        '    txtExtraBed.Text = CType(mySqlReader("ExtraBed"), Integer)
                        'Else
                        ' txtExtraBed.Text = CType(mySqlReader("ExtraBed"), String).Replace(".00", "")
                        'End If
