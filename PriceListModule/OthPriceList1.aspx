<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="OthPriceList1.aspx.vb" Inherits="PriceListModule_OthPriceList1" %>
...
<link rel="stylesheet" href="../Content/lib/css/reset.css" type="text/css" media="screen"
    ...
    function CalculateTax() {
        var VatPerc = document.getElementById("<%=Txt_VAT_Per.ClientID%>").value;
        if ($.trim(VatPerc) == "") {
        ...
        var txtVat = document.getElementById(arguments[3]);
        if ($.trim(txt.value) == "") {
            txtTax.value = "";
            txtVat.value = "";
        }
        else {
            var cal = parseFloat(txt.value).toPrecision() - parseFloat(txtNonTax.value).toPrecision();
            var TaxAndVat = (100 + parseFloat(VatPerc)).toPrecision() / 100;
            cal = cal / TaxAndVat;
            txtTax.value = cal.toFixed(2);
            cal = cal * VatPerc / 100;
            txtVat.value = cal.toFixed(2);
        }
    }   
           ...
           <tbody>
               <tr>
                   <td style="height: 18px; text-align: center" class="field_heading" align="left" colspan="4">
                       <asp:Label ID="lblHeading" runat="server" Text="Add Airport Meet price List" CssClass="field_heading"
               ...
               <tr>
                ...
                <td style="width: 190px" class="td_cell" align="right">
                   ...
                   <td>
                       <asp:TextBox ID="Txt_VAT_Per" runat="server" onkeypress="return  validateDecimalOnly(event,this)" CssClass="field_input" TabIndex="3" Text="5" MaxLength="5" AutoPostBack="true"
               ...
               <tr>
                   <td style="width: 100%" valign="top" colspan="20">
               ...
               <tr style="font-size: 8pt">
                   ...
                   <td align="left" class="td_cell" colspan="50" style="font-size: 10pt" 
                       valign="top">
                       <asp:GridView ID="grdtransferrates" runat="server" AutoGenerateColumns="False" 
                           ...
                           <Columns>
                               ...
                               <asp:TemplateField HeaderText="Service Type Code" Visible="false">
                                   <ItemTemplate>
                                       <asp:TextBox ID="txttrftypecode" runat="server" CssClass="field_input" 
                                           ReadOnly="True" Text='<%# Bind("Service_Type_Code") %>' Width="40px"></asp:TextBox>
                                   </ItemTemplate>
                               </asp:TemplateField>
                               <asp:TemplateField HeaderText="Service Type Name">
                                   <ItemTemplate>
                                       <asp:Label ID="lblservicename" runat="server" 
                                           Text='<%# Bind("Service_Type_Name") %>' Width="350px"></asp:Label>
                                   </ItemTemplate>
                               </asp:TemplateField>
                                <asp:TemplateField HeaderText="Ratebasis" >
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtratebasis" runat="server" Text='<%# Bind("Ratebasis") %>' Width="70px"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Additionalpaxyesno" >
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtadditionalpaxyesno" runat="server" Text='<%# Bind("Additionalpaxyesno") %>' Width="50"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
