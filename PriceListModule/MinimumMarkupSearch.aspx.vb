...
Partial Class MinimumMarkupSearch
...
#End Region
    ...
    Protected Sub btnHelp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnHelp.Click
        ...
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=Minimum Markup','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            Try
                ...
                Else
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                                       CType(strappname, String), "PriceListModule\MinimumMarkupSearch.aspx?appid=" + strappid, btnAddNew, btnExportToExcel, _
            ...
            Catch ex As Exception
                ...
                objUtils.WritErrorLog("MinimumMarkupSearch.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
            End Try
        End If
        ...
        If (Me.IsPostBack And Me.Request("__EVENTTARGET") = "MinMarkupWindowPostBack") Then
            FillGridNew()
            ' FillTerms()

        End If
        Page.Title = "Minimum Markup and Discount"
    End Sub
        ...
        Try
            If dtt.Rows.Count > 0 Then
                For i As Integer = 0 To dtt.Rows.Count - 1
                    If dtt.Rows(i)("Code").ToString = "FORMULA NAME" Then
            ...
            strBindCondition = BuildConditionNew(strMarkupFormulaValue, strTextValue)
            ...
            ' strSqlQry = "SELECT * from V_GET_MINIMUM_MARKUP_POLICY "

            strSqlQry = "select v.formulaid,v.formulaname,v.applicableto,v.adultwithvisa,v.adultwithoutvisa, v.childwithvisa,v.childwithoutvisa,v.active IsActive,v.currencyname,min(convert(varchar(10),d.fromdate,103)) fromdate,max(convert(varchar(10),d.todate,103)) todate, " _
                      & " v.adddate,v.adduser,v.moddate,v.moduser   from V_GET_MINIMUM_MARKUP_POLICY v left join Minimum_Markup_Dates d on v.formulaid=d.formulaid   group by v.formulaid,v.formulaname,v.applicableto,v.adultwithvisa,v.adultwithoutvisa, " _
                      & " v.childwithvisa,v.childwithoutvisa,v.active,v.currencyname,v.adddate,v.adduser,v.moddate,v.moduser  "
    ...
    Private Function BuildConditionNew(ByVal strMarkupValue As String, ByVal strTextValue As String) As String
        strWhereCond = ""
        If strMarkupValue.Trim <> "" Then
            If Trim(strWhereCond) = "" Then
                strWhereCond = "upper(V_GET_MINIMUM_MARKUP_POLICY.FormulaName) IN (" & Trim(strMarkupValue.Trim.ToUpper) & ")"
            Else
                strWhereCond = strWhereCond & " AND upper(V_GET_MINIMUM_MARKUP_POLICY.FormulaName) IN (" & Trim(strMarkupValue.Trim.ToUpper) & ")"
            End If
        End If
        If strTextValue <> "" Then
            ...
            For i = 0 To lsMainArr.GetUpperBound(0)
                ...
                If strValue <> "" Then
                    If Trim(strWhereCond1) = "" Then
                        strWhereCond1 = "(upper(V_GET_MINIMUM_MARKUP_POLICY.FormulaName) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or upper(formulaid) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(IsActive) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%')"
                    Else
                        strWhereCond1 = strWhereCond1 & " or (upper(V_GET_MINIMUM_MARKUP_POLICY.FormulaName) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'or upper(formulaid) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or   upper(IsActive) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%')"
                    End If
                End If
            Next
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            If e.CommandName = "EditRow" Then
                ...
                strpop = "window.open('MinimumMarkupPolicy.aspx?State=Edit&FormulaID=" + CType(lblId.Text.Trim, String) + "','MinMarkup');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup1", strpop, True)
            ElseIf e.CommandName = "View" Then
                Dim strpop As String = ""
                strpop = "window.open('MinimumMarkupPolicy.aspx?State=View&FormulaID=" + CType(lblId.Text.Trim, String) + "','MinMarkup');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup1", strpop, True)
            ElseIf e.CommandName = "DeleteRow" Then
                Dim strpop As String = ""
                strpop = "window.open('MinimumMarkupPolicy.aspx?State=Delete&FormulaID=" + CType(lblId.Text.Trim, String) + "','MinMarkup');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup1", strpop, True)
            ElseIf e.CommandName = "CopyRow" Then
                Dim strpop As String = ""
                strpop = "window.open('MinimumMarkupPolicy.aspx?State=Copy&FormulaID=" + CType(lblId.Text.Trim, String) + "','MinMarkup');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup1", strpop, True)
            End If
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            ...
            If Session("sDtDynamic") IsNot Nothing Then
                If dtDynamics.Rows.Count > 0 Then
                    ...
                    For j = 0 To dtDynamics.Rows.Count - 1
                        ...
                        If "FORMULA NAME" = dtDynamics.Rows(j)("code").ToString.Trim.ToUpper Then
    ...
    Protected Sub btnExportToExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExportToExcel.Click
        ...
        Try
            If gv_SearchResult.Rows.Count <> 0 Then
                ...
                strSqlQry = "SELECT FormulaId,FormulaName as 'Formula Name',ApplicableTo 'Applicable To',AdultWithVisa 'Adult With Visa',AdultWithoutVisa 'Adult Without Visa',ChildWithVisa 'Child With Visa',ChildWithoutVisa 'Child Without Visa',CurrencyName 'Currency Name',IsActive Active,convert(varchar(10),AddDate,103)'Add Date',AddUser 'Add User',convert(varchar(10),ModDate,103) 'Mod Date',ModUser ModUser FROM V_GET_MINIMUM_MARKUP_POLICY "
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        Dim strpop As String = ""
        strpop = "window.open('MinimumMarkupPolicy.aspx?State=New','MinMarkup');"
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup1", strpop, True)
    End Sub
#End Region
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        Try
            ...
            Dim strpop As String = ""
            strpop = "window.open('rptReportNew.aspx?Pageame=MinMarkup&BackPageName=MinimumMarkupSearch.aspx','RepMarkup');"
