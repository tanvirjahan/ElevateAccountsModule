...
Partial Class OthServicesCostPricelistSearch
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            Try
                ...
                hdDefault_Group.Value = objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select option_selected from reservation_parameters where  param_id=1501")
                ...
                Else
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                             CType(strappname, String), "PriceListModule\OthServicesCostPricelistSearch.aspx?appid=" + strappid + "&Type=" + Session("OthPListFilter"), btnAddNew, btnExportToExcel, _
        ...
        If (Me.IsPostBack And Me.Request("__EVENTTARGET") = "OtherserviceCostPriceListWindowPostBack") Then
    ...
    Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        Try
            ...
            strSqlQry = "select  h.ocplistcode,  h.othgrpcode,o.othgrpname,h.currcode,p.partyname ,  min(d.frmdate) frmdate ,max(d.todate)todate ,h.adddate,h.adduser,h.moddate,h.moduser,  " _
                ...
                & " where h.othgrpcode not in (select othgrpcode from view_system_othgrp)  group by  h.ocplistcode,  h.othgrpcode,o.othgrpname,p.partyname,h.currcode,h.approve,h.adddate,h.adduser,h.moddate,h.moduser "
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        strpop = "window.open('Othercostpricelist1.aspx?State=New&Group=" + CType(hdDefault_Group.Value, String) + "','Othercostpricelist1');"
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            If e.CommandName = "Editrow" Then
                ...
                strpop = "window.open('Othercostpricelist1.aspx?State=Edit&Group=" + CType(hdDefault_Group.Value, String) + "&RefCode=" + CType(lblId.Text.Trim, String) + "','Othercostpricelist1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ElseIf e.CommandName = "View" Then
                ...
                strpop = "window.open('Othercostpricelist1.aspx?State=View&Group=" + CType(hdDefault_Group.Value, String) + "&RefCode=" + CType(lblId.Text.Trim, String) + "','Othercostpricelist1');"
            ...
            ElseIf e.CommandName = "Deleterow" Then
                ...
                strpop = "window.open('Othercostpricelist1.aspx?State=Delete&Group=" + CType(hdDefault_Group.Value, String) + "&RefCode=" + CType(lblId.Text.Trim, String) + "','Othercostpricelist1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ...
            ElseIf e.CommandName = "Copy" Then
                ...
                strpop = "window.open('Othercostpricelist1.aspx?State=Copy&Group=" + CType(hdDefault_Group.Value, String) + "&RefCode=" + CType(lblId.Text.Trim, String) + "','Othercostpricelist1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If
        Catch ex As Exception
            ' ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
...
#End Region
    ...
    Protected Sub btnHelp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnhelp.Click
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=AMCostPriceSearch','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    End Sub
