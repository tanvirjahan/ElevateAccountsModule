    <%@ Page Language="VB" MasterPageFile="~/MainPageMaster.master" AutoEventWireup="false"  EnableEventValidation="false" CodeFile="PropertyTypeSearch.aspx.vb" Inherits="PropertyTypeSearch"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
 ...
 <script type="text/javascript" charset="utf-8">
     ...
     function visualsearchbox() {
         ...
         $txtvsprocess.val('PropertyType:" "  TEXT:" "');
            ...
            'access'
             ...
             callbacks: {
                 ...
                 valueMatches: function (category, searchTerm, callback) {
                     ...
                     switch (category) {
                         ...
                         case 'PropertyType':
                             var asSqlqry = '';
                             glcallback = callback;
                             ColServices.clsSectorServices.GetListOfArrayPropertyTypeVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                             break;
                 ...
                 facetMatches: function (callback) {
                     callback([
                { label: 'Property Type', category: 'Property' },

                { label: 'Text', category: 'Property' },
              ]);
                 }
             }
         });
                ...
                Property Type</td>
                    ...
                    <tr style="display:none" >
                        <td align="center" class="td_cell" style="color: blue">
                            Type few characters of code or name  
                        </td>
                    </tr>
                    <tr>
                ...
                <tr>
                 ...
                 <tr>
			                    ...
			                    <asp:GridView id="gv_SearchResult" tabIndex=10 runat="server" Font-Size="10px" Width="100%" CssClass="grdstyle" __designer:wfdid="w50" GridLines="Vertical" CellPadding="3" BorderWidth="1px" BorderStyle="None" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True">
				                    ...
				                    <Columns>
					                    <asp:TemplateField Visible="False" HeaderText="City Code">
						                    <EditItemTemplate>
							                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("propertytypecode") %>' CssClass="field_input">
							                    </asp:TextBox>
						                    </EditItemTemplate>
						                    <ItemTemplate>
							                    <asp:Label id="lblCityCode" runat="server" Text='<%# Bind("propertytypecode") %>'>
							                    </asp:Label>
						                    </ItemTemplate>
					                    </asp:TemplateField>
					                    <asp:BoundField DataField="propertytypecode" SortExpression="propertytypecode" HeaderText="PropertyType Code">
						                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
						                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
					                    </asp:BoundField>
					                     <asp:TemplateField HeaderText="PropertyType Name" SortExpression="propertytypename">
                    <ItemTemplate>
                        <asp:Label ID="lblPropertyName" runat="server" Text='<%# Bind("propertytypename") %>'></asp:Label>
                    </ItemTemplate>
                    ...
                    <ItemStyle CssClass="cityname" HorizontalAlign="Left" Width="7%" />
					                    ...
					                    <asp:BoundField HtmlEncode="False" DataField="active" SortExpression="active" HeaderText="Active">
						                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
						                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
					                    </asp:BoundField>
					                    ...
					                    <asp:BoundField DataField="modddate" SortExpression="modddate" HeaderText="Date Modified">
						                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
						                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
					                    </asp:BoundField>
