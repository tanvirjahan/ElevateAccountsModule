...
#Region "Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init"
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Try
            ...
            If IsPostBack = False Then
                ...
                Dim strSPType As String = "select sptypecode,sptypename from sptypemast where active=1 and sptypecode in (select option_selected  from " & _
                                        " reservation_parameters where param_id in (564))  order by sptypecode"
                ...
                If ViewState("TrfpricelistState2") = "New" Or ViewState("TrfpricelistState2") = "Edit" Or ViewState("TrfpricelistState2") = "Copy" Then
                    ...
                    lblHeading.Text = "Add New Shuttle Price List"
        ...
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & ex.Message & " ');", True)
            objUtils.WritErrorLog("ShuPriceList2.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        End Try
    End Sub
#End Region
...
#Region "Private Sub createdatatable()"
    Private Sub createdatatable()
        Try
            ...
            strSqlQry = "SELECT  count( distinct dbo.othcatmast.othcatcode) FROM dbo.partyothcat INNER JOIN  dbo.othcatmast ON dbo.partyothcat.othcatcode = dbo.othcatmast.othcatcode WHERE (dbo.othcatmast.othgrpcode = '" & ddlGroupCode.Items(ddlGroupCode.SelectedIndex).Text & "') and othcatmast.active=1 and othcatmast.shuttle=1 "
            ...
            strSqlQry = "SELECT  distinct dbo.othcatmast.othcatcode, dbo.othcatmast.othgrpcode,othcatmast.grporder FROM dbo.partyothcat INNER JOIN  dbo.othcatmast ON dbo.partyothcat.othcatcode = dbo.othcatmast.othcatcode WHERE (dbo.othcatmast.othgrpcode = '" & ddlGroupCode.Items(ddlGroupCode.SelectedIndex).Text & "') and othcatmast.active=1  and othcatmast.shuttle = 1 Order by othcatmast.grporder"
        ...
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            objUtils.WritErrorLog("ShuPricesList2.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        Finally
            clsDBConnect.dbCommandClose(mySqlCmd)
            clsDBConnect.dbReaderClose(mySqlReader)
            clsDBConnect.dbConnectionClose(mySqlConn)
    ...
    Private Sub createdatarows()
        ...
        Try
            ...
            If ddlServerType.SelectedValue = "[Select]" Then
                strSqlQry = "SELECT  count(distinct othtypmast.othtypcode) FROM partyothtyp INNER JOIN othtypmast ON partyothtyp.othtypcode = othtypmast.othtypcode WHERE (othtypmast.othgrpcode = '" & ddlGroupCode.Items(ddlGroupCode.SelectedIndex).Text & "')  and othtypmast.active=1 and othtypmast.shuttle=1"
            Else
                strSqlQry = "SELECT  count(distinct othtypmast.othtypcode) FROM partyothtyp INNER JOIN othtypmast ON partyothtyp.othtypcode = othtypmast.othtypcode WHERE (othtypmast.othgrpcode = '" & ddlGroupCode.Items(ddlGroupCode.SelectedIndex).Text & "') and othtypmast.transfertype='" + CType(ddlServerType.SelectedIndex, String) + "' and othtypmast.active=1 and othtypmast.shuttle=1"
            End If
            ...
            mySqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))
            If ddlServerType.SelectedValue = "[Select]" Then
                strSqlQry = "SELECT distinct othtypmast.othtypcode, othtypmast.othtypname,othtypmast.othgrpcode,rankorder FROM partyothtyp INNER JOIN othtypmast ON partyothtyp.othtypcode = othtypmast.othtypcode WHERE (othtypmast.othgrpcode = '" & ddlGroupCode.Items(ddlGroupCode.SelectedIndex).Text & "') and othtypmast.active=1 and othtypmast.shuttle=1 order by  rankorder"
            Else
                strSqlQry = "SELECT distinct othtypmast.othtypcode, othtypmast.othtypname,othtypmast.othgrpcode,rankorder FROM partyothtyp INNER JOIN othtypmast ON partyothtyp.othtypcode = othtypmast.othtypcode WHERE (othtypmast.othgrpcode = '" & ddlGroupCode.Items(ddlGroupCode.SelectedIndex).Text & "') and othtypmast.transfertype='" + CType(ddlServerType.SelectedIndex, String) + "' and othtypmast.active=1 and othtypmast.shuttle=1 order by  rankorder"
            End If
        ...
        Try
            ...
            Try
                ...
                strSqlQry = "select sellmast.sellcode,sellmast.currcode,isnull((select currrates.convrate from currrates " _
                            ...
                            & " where sellmast.plgrpcode in (" & market & ") and sellmast.active='1' and sellmast.currcode ='" & txtCurrCode.Text & "'"
    ...
    Private Function chksellingTypes() As String
        ...
        For Each Me.gvRow1 In gv_Market.Rows
            ...
            If chksel.Checked = True Then
                    ...
                    strSqlQry = "select sellmast.sellcode,sellmast.currcode,isnull((select currrates.convrate from currrates " _
                                        & " where currrates.tocurr=sellmast.currcode and currrates.currcode='" & txtCurrCode.Text & "'),0) convrate from sellmast " _
                                        & " where sellmast.plgrpcode in ('" & lblcode.Text.Trim & "') and sellmast.active='1' and sellmast.currcode ='" & txtCurrCode.Text & "'"
...
#Region "Protected Sub BtnClearFormula_Click(ByVal sender As Object, ByVal e As System.EventArgs)"
    Protected Sub BtnClearFormula_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnClearFormula.Click
        ...
        Try
            ...
            Response.Redirect("ShuPriceList1.aspx?&State=" & ViewState("TrfpricelistState2") & "&RefCode=" & ViewState("TrfpricelistRefCode2") & "&SptypeCode=" & SptypeCode &
                              "&SptypeName=" & SptypeName & "&SupplierCode=" & "" & "&SupplierName=" & "" & "&SupplierAgentCode=" & "" &
                              "&SupplierAgentName=" & "" & "&PlcCode=" & PlcCode & "&GroupCode=" & GroupCode & "&Market=" & marketstr &
...
#Region "Protected Sub btnCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs)"
    Protected Sub btnCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        ...
        strscript = "window.opener.__doPostBack('ShuPriceListWindowPostBack', '');window.opener.focus();window.close();"
                ...
                If Page.IsValid = True Then
                    If ViewState("TrfpricelistState2") = "New" Or ViewState("TrfpricelistState2") = "Edit" Or ViewState("TrfpricelistState2") = "Copy" Then
                        ...
                        If CheckDecimalInGrid() = False Then
                            Exit Sub
                        End If
                        ViewState("Partycode") = objUtils.GetString(Session("dbconnectionName"), "select option_selected from reservation_parameters where param_id=1083")
                        ViewState("supagentcode") = objUtils.ExecuteQueryReturnSingleValuenew(Session("dbconnectionName"), "select option_selected from reservation_parameters where param_id='520'")
                        'If chkConsdierForMarkUp.Checked = True Then
                        ...
                        mySqlCmd.Parameters.Add(New SqlParameter("@shuttle", SqlDbType.VarChar, 20)).Value = 1
                        ...
                        mySqlCmd.Parameters.Add(New SqlParameter("@partycode", SqlDbType.VarChar, 20)).Value = ViewState("Partycode")
                        'Else
                        ...
                        mySqlCmd.Parameters.Add(New SqlParameter("@supagentcode", SqlDbType.VarChar, 20)).Value = ViewState("supagentcode")
                        'Else
                        ...
                        For Each GvRow In grdSelling.Rows
                            ...
                            If grdSelling.DataKeys(GvRow.RowIndex).Item("convrate") Is Nothing Then
                                mySqlCmd.Parameters.Add(New SqlParameter("@sellcurrcode", SqlDbType.VarChar, 20)).Value = System.DBNull.Value
                            Else
                                mySqlCmd.Parameters.Add(New SqlParameter("@sellcurrcode", SqlDbType.VarChar, 20)).Value = CType(GvRow.Cells(1).Text, String)
                            End If

                            mySqlCmd.Parameters.Add(New SqlParameter("@convrate", SqlDbType.Decimal, 18, 12)).Value = grdSelling.DataKeys(GvRow.RowIndex).Item("convrate")
                        ...
                        For Each Me.gvRow1 In gv_Market.Rows
                            ...
                            lblcode = gvRow1.FindControl("lblcode")
                            If chksel.Checked = True Then
                                mySqlCmd = New SqlCommand("sp_calculate_Shusellingprices", mySqlConn, sqlTrans)
                                mySqlCmd.CommandType = CommandType.StoredProcedure
                                mySqlCmd.Parameters.Add(New SqlParameter("@tplistcode", SqlDbType.VarChar, 20)).Value = CType(txtPlcCode.Value.Trim, String)
                                If ViewState("TrfpricelistState2") = "New" Or ViewState("TrfpricelistState2") = "Copy" Then
                    ...
                    If ViewState("TrfpricelistState2") <> "Delete" Then
                        ViewState("TrfpricelistRefCode2") = Nothing
                        ViewState("TrfpricelistState2") = Nothing
                        Response.Redirect("ShuPriceListSearch.aspx", False)

                    Else
                        If ViewState("TrfpricelistState2") = "Delete" Then
                            'Response.Redirect("PriceList.aspx", False)
                            Dim strscript1 As String = ""
                            strscript1 = "window.opener.__doPostBack('ShuPriceListWindowPostBack', '');window.opener.focus();window.close();"
                            ...
                            '                      "&RefCode=" & CType(ViewState("TrfpricelistRefCode2"), String) & "&supplier=" & "" &
                            '                      "&suppliername=" & "" & "&SupplierType=" & ddlSPType.Items(ddlSPType.SelectedIndex).Text &
                                            ...
                                            Else
                                                If txt.Text <> "" Then
                                                    If CType(Val(txt.Text), String) <> "0" Then
                                                        ...
                                                        '    mySqlCmd = New SqlCommand("sp_chkplwkdatenew", mySqlConn)
                                                        'Else
                                                        mySqlCmd = New SqlCommand("sp_chkShupldatenew", mySqlConn)
                                                        'End If
                                                        mySqlCmd.CommandType = CommandType.StoredProcedure
                                                        ...
                                                        'mySqlCmd.Parameters.Add(New SqlParameter("@mealcode", SqlDbType.VarChar, 20)).Value = CType(gv_SearchResult.Rows(GvRowRMType.RowIndex).Cells(3).Text.Trim, String)
                                                        'mySqlCmd.Parameters.Add(New SqlParameter("@rmcatcode", SqlDbType.VarChar, 20)).Value = CType(dtValidate.Columns(cntCol).ColumnName.Trim, String)
                                                        mySqlCmd.Parameters.Add(New SqlParameter("@frmdate", SqlDbType.DateTime)).Value = Format(CType(ObjDate.ConvertDateromTextBoxToDatabase(dpFDate.Text.Trim), Date), "yyyy/MM/dd")
                                                        mySqlCmd.Parameters.Add(New SqlParameter("@todate", SqlDbType.DateTime)).Value = Format(CType(ObjDate.ConvertDateromTextBoxToDatabase(dpTDate.Text.Trim), Date), "yyyy/MM/dd")
                                                        If ViewState("TrfpricelistState2") = "New" Or ViewState("TrfpricelistState2") = "Copy" Then
                                                        ...
                                                        'mySqlCmd.Parameters.Add(New SqlParameter("@supagentcode", SqlDbType.VarChar, 20)).Value =''
                                                        'Else
        ...
        For Each GvRow In grdDates.Rows
            ...
            If dpFDate.Text <> "" And dpTDate.Text <> "" Then
                For Each gvMarketRow In gv_Market.Rows
                    ...
                    If chksel.Checked = True Then
                        mySqlCmd = New SqlCommand("sp_chkExistShuMarkUpSuplier", mySqlConn)
                        mySqlCmd.CommandType = CommandType.StoredProcedure
                        mySqlCmd.Parameters.Add(New SqlParameter("@frmdate", SqlDbType.DateTime)).Value = CType(ObjDate.ConvertDateromTextBoxToDatabase(dpFDate.Text.Trim), Date)
                        mySqlCmd.Parameters.Add(New SqlParameter("@todate", SqlDbType.DateTime)).Value = CType(ObjDate.ConvertDateromTextBoxToDatabase(dpTDate.Text.Trim), Date)
...
#End Region
    ...
    Protected Sub btnhelp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnhelp.Click
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=ShuPriceList2','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    End Sub
