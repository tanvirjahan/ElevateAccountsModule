    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Try
            If Request.QueryString("State") = "New" Then
                Page.Title = Page.Title + " " + "New Shuttle Price List"
            ElseIf Request.QueryString("State") = "Copy" Then
                Page.Title = Page.Title + " " + "Copy Shuttle Price List"
            ElseIf Request.QueryString("State") = "Edit" Then
                Page.Title = Page.Title + " " + "Edit Shuttle Price List"
            ElseIf Request.QueryString("State") = "View" Then
                Page.Title = Page.Title + " " + "View Shuttle Price List"
            ElseIf Request.QueryString("State") = "Delete" Then
                Page.Title = Page.Title + " " + "Delete Shuttle Price List"
            End If
            ...
            If IsPostBack = False Then
                ...
                objUtils.FillDropDownListHTMLNEW(Session("dbconnectionName"), ddlSPType, "sptypecode", "sptypename", "select sptypecode,sptypename from sptypemast where active=1 and sptypecode  in (Select Option_Selected From Reservation_ParaMeters Where Param_Id in (564)) order by sptypecode ", True)
                objUtils.FillDropDownListHTMLNEW(Session("dbconnectionName"), ddlSPTypeName, "sptypename", "sptypecode", "select sptypename,sptypecode from sptypemast where active=1 and sptypecode  in (Select Option_Selected From Reservation_ParaMeters Where Param_Id in (564)) order by sptypename ", True)
                ...
                ElseIf ViewState("TransferpricelistState") = "Edit" Or ViewState("TransferpricelistState") = "Copy" Then
                    ...
                    lblHeading.Text = "Edit Shuttle Price List"
            ...
            If mySqlReader.HasRows Then
                If mySqlReader.Read() = True Then
                    ...
                    If IsDBNull(mySqlReader("currcode")) = False Then
                        ...
                        ddlcurname.Value = mySqlReader("currcode")
                        ddlcurcode.Value = objUtils.GetDBFieldFromStringnew(Session("dbconnectionName"), "currmast", "currname", "currcode", mySqlReader("currcode"))
                    End If
...
#Region "Protected Sub btnGenerate_Click(ByVal sender As Object, ByVal e As System.EventArgs)"
    Protected Sub btnGenerate_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            Dim currcode As String = obj.Encrypt(CType(ddlcurcode.Items(ddlcurcode.SelectedIndex).Text, String), "&%#@?,:*")
            Dim currname As String = obj.Encrypt(CType(ddlcurname.Items(ddlcurname.SelectedIndex).Text, String), "&%#@?,:*")
            ...
            Response.Redirect("ShuPriceList2.aspx?&State=" & ViewState("TransferpricelistState") & "&RefCode=" & ViewState("TransferpricelistRefCode") &
                               "&SptypeCode=" & SptypeCode & "&SptypeName=" & SptypeName & "&SupplierCode=" & "" &
                              "&SupplierName=" & "" & "&SupplierAgentCode=" & "" & "&SupplierAgentName=" & "" & "&PlcCode=" & PlcCode &
...
#End Region
    ...
    Protected Sub btnhelp_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=ShuPriceList1','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    End Sub
