<%@ Page Language="VB"  MasterPageFile="~/MainPageMaster.master" AutoEventWireup="false" CodeFile="AlternativeBookingSectorGroups.aspx.vb" Inherits="AlternativeBookingSectorGroups" %>
                      ...
                      if (ValueRetrieval.value != "S") {
                          switch (category) {
                              ...
                              case 'Sector':
                                  ...
                                  glcallback = callback;
                                  //fnTestCallback();
                                  ColServices.clsHotelGroupServices.GetListOfArrayAltSectorsVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                  break;
                              case 'SectorGroup':
                                  var asSqlqry = '';
                                  glcallback = callback;
                                  ColServices.clsHotelGroupServices.GetListOfAlternativeSectorGrpsNameVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                  break;
                          }
                      }
                      if (ValueRetrieval.value == "S") {
      ...
      <script type="text/javascript" charset="utf-8">
          ...
          function txtNameautocompleteselected(source, eventArgs) {
              if (eventArgs != null) {
                 ...
                 document.getElementById('<%=btnGroupName.ClientID%>').click();
        ...
        <ContentTemplate>
            <table class="style1">
               ...
               <tr runat="server" id="trNameAndCode">
                ...
                <tr>
                    ...
                    <td class="style16">
                          ...
                          <asp:TextBox   ID="TxtCityCode" runat="server"  style="display:none" ></asp:TextBox>
                            <asp:TextBox   ID="txtGroupTagCode" runat="server"  style="display:none" ></asp:TextBox>
                          <asp:TextBox ID="txtGroupTagName" runat="server" 
                ...
                <asp:Button ID="btnGroupName"  style="display:none"  runat="server" />
                </tr>
...
<asp:BoundField DataField="sectorcode" SortExpression="sectorcode" HeaderText="Sector Code">
  ...
  <asp:TemplateField HeaderText="Sector Name" SortExpression="sectorname">
                ...
                <asp:TemplateField HeaderText="Sector Group Name" SortExpression="othtypname">
                    <ItemTemplate>
                        <asp:Label ID="lblSectorGroupName" runat="server" Text='<%# Bind("sectorgroupname") %>'></asp:Label>
                    </ItemTemplate>
                                   </asp:TemplateField>
