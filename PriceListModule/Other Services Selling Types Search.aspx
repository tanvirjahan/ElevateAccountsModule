<%@ Page Language="VB" MasterPageFile="~/PriceListMaster.master" AutoEventWireup="false" CodeFile="Other Services Selling Types Search.aspx.vb" Inherits="Other_Services_Selling_Types_Search"  %>
                ...
                <table id="TABLE1"  style="border-right: gray 2px solid;
                    ...
                    <tr>
                        <td class="td_cell" colspan="1" >
                            <table >
                                <tr align=center>
                                    <td align="center" class="field_heading" ><asp:Label runat="server" ID="Lblselltypes" Text="Other Services Selling Types List"></asp:Label>
                                        &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp; &nbsp;</td>
                                </tr>
                                <tr align=center >
...
<TABLE><TBODY><TR><TD style="TEXT-ALIGN: center" class="td_cell" align=center colSpan=7>&nbsp; &nbsp;&nbsp;
 ...
 <asp:Button id="btnHelp" tabIndex=10 onclick="btnHelp_Click" runat="server" Text="Help" __designer:dtid="1688858450198528" CssClass="search_button" __designer:wfdid="w19"></asp:Button>&nbsp;<asp:Button 
        ...
        __designer:dtid="6192449487634451" CssClass="btn" __designer:wfdid="w5"></asp:Button>&nbsp;<asp:Button id="btnPrint" tabIndex=9 runat="server" Text="Report" __designer:dtid="6192449487634453" CssClass="btn" __designer:wfdid="w6"></asp:Button></TD></TR>
...
<asp:TemplateField Visible="False" HeaderText="Selling Code"><EditItemTemplate>
      <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("othsellcode") %>'></asp:TextBox>
                                        
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblothsellcode" runat="server" Text='<%# Bind("othsellcode") %>' __designer:wfdid="w1"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField="othsellcode" SortExpression="othsellcode" HeaderText="Selling Code">
<ItemStyle HorizontalAlign="Left"></ItemStyle>

<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
</asp:BoundField>
<asp:BoundField DataField="othsellname" SortExpression="othsellname" HeaderText="Selling Name">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
...
<%--<asp:BoundField DataField="costyesno" SortExpression="costyesno" HeaderText="Cost of Handling Fee required">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
...
<AlternatingRowStyle CssClass="grdAternaterow"></AlternatingRowStyle>
                ...
                Font-Names="Verdana" Font-Bold="True" Width="100%" __designer:wfdid="w62" 
