<%@ Page Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="ContractValidate.aspx.vb" Inherits="ContractValidate" %>
...
--%>
             ...
             <center>
                        ...
                        <input id="btnClose1" type="button" value="Cancel" style="display: none" />
                        <input id="btnInvisibleGuest1" runat="server" type="button" value="Cancel" style="display: none" />
