<%@ Page Language="VB" MasterPageFile="~/MainPageMaster.master" AutoEventWireup="false" CodeFile="TransferSellingTypesSearch.aspx.vb" Inherits="Other_Services_Selling_Types_Search"  %>
                ...
                <table id="TABLE1"  style="border-right: gray 2px solid;
                    ...
                    <tr>
                        <td class="td_cell" colspan="1" >
                            <table >
                                <tr align=center>
                                    <td align="center" class="field_heading"   ><asp:Label runat="server" ID="Lblselltypes" Text="Transfer  Selling Types List"></asp:Label>
                                        &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp; &nbsp;</td>
                                </tr>
                                <tr align=center >
...
<asp:TemplateField Visible="False" HeaderText="Selling Code"><EditItemTemplate>
      <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("trfsellcode") %>'></asp:TextBox>
                                        
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblothsellcode" runat="server" Text='<%# Bind("trfsellcode") %>' __designer:wfdid="w1"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField="trfsellcode" SortExpression="trfsellcode" HeaderText="Transfer Selling Code">
<ItemStyle HorizontalAlign="Left"></ItemStyle>

<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
</asp:BoundField>
<asp:BoundField DataField="trfsellname" SortExpression="trfsellname" HeaderText="Transfer Selling Name">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
...
<asp:Label id="lblMsg" runat="server" Text="Records not found. Please redefine search criteria" Font-Size="8pt" Font-Names="Verdana" Font-Bold="True" Width="905px" __designer:wfdid="w62" 
