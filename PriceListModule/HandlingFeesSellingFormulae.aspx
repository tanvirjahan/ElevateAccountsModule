<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="HandlingFeesSellingFormulae.aspx.vb" Inherits="PriceListModule_HandlingFeesSellingFormulae" %>
...
<script language="javascript" type="text/javascript" >
    ...
    function CallWebMethod(methodType) {
        switch (methodType) {
            case "sellcode":
                ...
                var sqlstr = "select Distinct  currmast.currcode from  currmast inner join othsellmast on currmast.currcode=othsellmast.currcode   where currmast.active=1 and othsellmast.othsellcode='" + codeid + "'";
                ColServices.clsServices.GetQueryReturnStringValuenew(constr, sqlstr, FillCurrCodes, ErrorHandler, TimeOutHandler);
                sqlstr = "select Distinct  currmast.currname from  currmast inner join othsellmast on currmast.currcode=othsellmast.currcode   where currmast.active=1 and othsellmast.othsellcode='" + codeid + "'";
    ...
    function ddlCalculateFrm_onclick() {
...
<asp:Label id="lblHeading" runat="server" Text="Add New Handling Fees Selling Formula" CssClass="field_heading" Width="889px"></asp:Label></TD></TR>
...
<TD class="td_cell" align=left><SELECT style="WIDTH: 200px" id="ddlSellCode" class="field_input" tabIndex=1 onchange="CallWebMethod('sellcode')" runat="server">
 ...
 <TD><SELECT style="WIDTH: 200px" id="ddlCalculateFrm" class="field_input" tabIndex=5 onchange="CallWebMethod('calcode')" runat="server" onclick="return ddlCalculateFrm_onclick()"> <OPTION selected></OPTION></SELECT></TD>
 <TD class="td_cell">
