<%@ Page Title="" Language="VB" MasterPageFile="~/MainPageMaster.master" AutoEventWireup="false" EnableEventValidation="false"
    CodeFile="DiscountFormulaSearch.aspx.vb" Inherits="DiscountFormulaSearch" %>
                    ...
                    valueMatches: function (category, searchTerm, callback) {
                        switch (category) {
                            case 'Formula Name':
                                var asSqlqry = '';
                                glcallback = callback;
                                ColServices.clsVisualSearchService.GetListOfDiscountFormulaVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                break;
                        }
                    },
