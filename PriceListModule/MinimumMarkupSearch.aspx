<%@ Page Title="" Language="VB" MasterPageFile="~/MainPageMaster.master" AutoEventWireup="false" EnableEventValidation="false"
    CodeFile="MinimumMarkupSearch.aspx.vb" Inherits="MinimumMarkupSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function visualsearchbox() {
            ...
            $txtvsprocess.val('"Formula Name":" " TEXT:" "');
                    ...
                    valueMatches: function (category, searchTerm, callback) {
                        switch (category) {
                            case 'Formula Name':
                                var asSqlqry = '';
                                glcallback = callback;
                                ColServices.clsVisualSearchService.GetListOfMinimumMarkupFormulaVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                break;
                        }
                    },
                    facetMatches: function (callback) {
                        callback([
                { label: 'TEXT', category: 'Minimum Markup Formula' },
                { label: 'Formula Name', category: 'Minimum Markup Formula' },
              ]);
                    }
                }
            });
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gv_SearchResult" TabIndex="9" runat="server" Font-Size="10px" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="FormulaID"  HeaderText="Formula ID">
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    <HeaderStyle HorizontalAlign="Left" Font-Underline="False"></HeaderStyle>
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="Formula Name" ControlStyle-Font-Underline="false" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblFormulaName" Font-Underline="false" runat="server" Text='<%# Bind("FormulaName") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ControlStyle />
                                ...
                                <asp:BoundField DataField="AdultWithVisa" HeaderText="Adult with Visa" />
                                <asp:BoundField DataField="AdultWithoutVisa" HeaderText="Adult without Visa" />
                                <asp:BoundField DataField="ChildWithVisa" HeaderText="Child with Visa" />
                                <asp:BoundField DataField="ChildWithoutVisa" HeaderText="Child without Visa" />
                                 <asp:BoundField DataField="CurrencyName" HeaderText="Currency" />
                                 <asp:BoundField DataField="IsActive"  HeaderText="Active">
                                  </asp:BoundField>
                                  <asp:BoundField HtmlEncode="False" DataFormatString="{0:dd/MM/yyyy HH:mm:ss }" DataField="fromdate"
                                   HeaderText="From Date"></asp:BoundField>
                                    <asp:BoundField HtmlEncode="False" DataFormatString="{0:dd/MM/yyyy HH:mm:ss }" DataField="todate"
                                   HeaderText="To Date"></asp:BoundField>
                                ...
                                <ItemStyle ForeColor="Blue"></ItemStyle>
                                 ...
                                 <asp:ButtonField CommandName="CopyRow" HeaderText="Action" Text="Copy" />
                            </Columns>
