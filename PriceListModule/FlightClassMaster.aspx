<%@ Page Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="FlightClassMaster.aspx.vb" Inherits="FlightClassMaster"  %>
...
if ((document.getElementById("<%=txtCode.ClientID%>").value=="")||(document.getElementById("<%=txtName.ClientID%>").value==""))
{
 if (document.getElementById("<%=txtCode.ClientID%>").value=="")
 {
       ...
       {
       if (state=='New'){if(confirm('Are you sure you want to save Flight Class Master?')==false)return false;}
       if (state=='Edit'){if(confirm('Are you sure you want to update Flight Class Master?')==false)return false;}
       if (state=='Delete'){if(confirm('Are you sure you want to delete Flight Class Master?')==false)return false;}
       }
}  
