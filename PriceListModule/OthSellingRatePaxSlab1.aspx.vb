...
Partial Class PriceListModule_OthSellingRatePaxSlab1
...
#Region " Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init"
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        ViewState.Add("OthPLSRPaxSlabState1", Request.QueryString("State"))
        ViewState.Add("OthPLSRPaxSlabCode1", Request.QueryString("RefCode"))
        ...
        If IsPostBack = False Then
            ...
            ElseIf Session("OthPListFilter") = "OTH" Then
                ...
                strqry = "select othgrpcode,othgrpname from othgrpmast where active=1 And othgrpcode not in (Select Option_Selected From Reservation_ParaMeters" & _
                    " Where Param_Id in (1001,1002,1003,1021,1022,1023,1024,1025,1027)) order by othgrpcode"
            End If
            ...
            ShowSellingRadioBtns(ViewState("OthPLSRPaxSlabCode1"))
            createdatatable()
            dt = Session("OthPSGridData")
            Dim fld2 As String = ""
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            Try
                ...
                ShowDates(ViewState("OthPLSRPaxSlabCode1"))
                ...
                Try
                    ...
                    If ViewState("OthPLSRPaxSlabState1") = "New" Then
                    ...
                    ElseIf ViewState("OthPLSRPaxSlabState1") = "Edit" Then
                        lblHeading.Text = strtitle + " Price List - Selling Rates Pax Slab"
                        Page.Title = Page.Title + " " + strtitle + "  Price List - Selling Rates Pax Slab"
                        
                        ShowDynamicGrid()
                        gv_SearchResult.Enabled = False
                    ElseIf ViewState("OthPLSRPaxSlabState1") = "View" Then
                        lblHeading.Text = strtitle + " Price List - Selling Rates Pax Slab"
                        Page.Title = Page.Title + " " + strtitle + " Price List - Selling Rates Pax Slab"
                        ShowDynamicGrid()
                        btnSave.Visible = False
                        gv_SearchResult.Enabled = False
                    ElseIf ViewState("OthPLSRPaxSlabState1") = "Copy" Then
                        lblHeading.Text = strtitle + " Price List - Selling Rates Pax Slab"
                        Page.Title = Page.Title + " " + strtitle + " Price List - Selling Rates Pax Slab"
...
#End Region
    ...
    Private Sub ShowDynamicGrid()
        ...
        Try
            ...
            'Else
            StrQry = "select distinct oclineno from othplist_othcat_slabs where oplistcode='" & txtPLCode.Text & "' and selltype='" & lblSellingCode.Text.Trim & "'"
            'End If
            mySqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))
                ...
                While mySqlReader.Read
                    For Each gvrow In gv_SearchResult.Rows
                        ...
                        If gvrow.Cells(0).Text = Linno Then
                            ...
                            'Else
                            StrQryTemp = "select * from othplist_othcat_slabs where oplistcode='" & txtPLCode.Text & "' and selltype='" & lblSellingCode.Text.Trim & "'and oclineno='" & Linno & "'"
                            'End If
...
go1:                            End While
            ...
            For header = 0 To cnt - 4
                ...
                If txt.Text <> Nothing Then
                    ...
                    StrQry = "select top 1 othcatcode from othplist_othcat_slabs where oplistcode='" & txtPLCode.Text & "' and selltype='" & lblSellingCode.Text.Trim & "' and slabno='" + CType(txt.Text, String) + "'"
                    mySqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))
                    mySqlCmd = New SqlCommand(StrQry, mySqlConn)
                    mySqlReader = mySqlCmd.ExecuteReader()
                    If mySqlReader.HasRows Then
        ...
        Catch ex As Exception
            'ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            objUtils.WritErrorLog("OthSellingRatesPaxSlab1.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
            clsDBConnect.dbConnectionClose(mySqlConn)
        End Try
    End Sub
...
#End Region
    ...
    Protected Sub btnClear_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnClear.Click
        ...
        Response.Redirect("OthSellingRatePaxSlab.aspx?State=" & CType(ViewState("OthPLSRPaxSlabState1"), String) & "&RefCode=" & CType(ViewState("OthPLSRPaxSlabCode1"), String) &
    ...
    Private Sub ShowDates(ByVal RefCode As String)
        ...
        Catch ex As Exception
            objUtils.WritErrorLog("OthPricelistSellingRate.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        Finally
            clsDBConnect.dbCommandClose(mySqlCmd)               'sql command disposed
    ...
    Public Sub fillDategrd(ByVal grd As GridView, Optional ByVal blnload As Boolean = False, Optional ByVal count As Integer = 1)
        Dim lngcnt As Long
        If ViewState("OthPLSRPaxSlabCode1") <> Nothing Then
            mySqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))
            strSqlQry = "select count(*) from othplisth_dates where oplistcode='" + ViewState("OthPLSRPaxSlabCode1") + "'"
            mySqlCmd = New SqlCommand(strSqlQry, mySqlConn)
...
#Region "Private Sub FillGridMarket(ByVal strorderby As String, Optional ByVal strsortorder As String = 'ASC')"
    Private Sub FillGridMarket(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            objUtils.WritErrorLog("OthPricelistSellingRates.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        Finally
        End Try
    End Sub
#End Region
