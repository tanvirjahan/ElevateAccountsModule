...
Partial Class DiscountFormulaSearch
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            Try
                ...
                Else
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                                       CType(strappname, String), "PriceListModule\DiscountFormulaSearch.aspx?appid=" + strappid, btnAddNew, btnExportToExcel, _
            ...
            Catch ex As Exception
                ...
                objUtils.WritErrorLog("DiscountFormulaSearch.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
            End Try
        End If
        ...
        If (Me.IsPostBack And Me.Request("__EVENTTARGET") = "MarkupWindowPostBack") Then
            FillGridNew()
            ' FillTerms()

        End If
        Page.Title = "Discount Formula"
    End Sub
    ...
    Private Sub FillGridNew()
        ...
        Dim strDiscountFormulaValue As String = ""
        ...
        Try
            If dtt.Rows.Count > 0 Then
                For i As Integer = 0 To dtt.Rows.Count - 1
                    If dtt.Rows(i)("Code").ToString = "FORMULA NAME" Then
                        If strDiscountFormulaValue <> "" Then
                            strDiscountFormulaValue = strDiscountFormulaValue + ",'" + dtt.Rows(i)("Value").ToString + "'"
                        Else
                            strDiscountFormulaValue = "'" + dtt.Rows(i)("Value").ToString + "'"
                        End If
                    End If
            ...
            strBindCondition = BuildConditionNew(strDiscountFormulaValue, strTextValue)
            ...
            strSqlQry = "SELECT * from V_GET_DISCOUNT_FORMULA "
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            If e.CommandName = "EditRow" Then
                ...
                strpop = "window.open('DiscountFormula.aspx?State=Edit&FormulaID=" + CType(lblId.Text.Trim, String) + "','DiscountFormula');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup1", strpop, True)
            ElseIf e.CommandName = "View" Then
                Dim strpop As String = ""
                strpop = "window.open('DiscountFormula.aspx?State=View&FormulaID=" + CType(lblId.Text.Trim, String) + "','DiscountFormula');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup1", strpop, True)
            ElseIf e.CommandName = "DeleteRow" Then
                Dim strpop As String = ""
                strpop = "window.open('DiscountFormula.aspx?State=Delete&FormulaID=" + CType(lblId.Text.Trim, String) + "','DiscountFormula');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup1", strpop, True)
            ElseIf e.CommandName = "CopyRow" Then
                Dim strpop As String = ""
                strpop = "window.open('DiscountFormula.aspx?State=Copy&FormulaID=" + CType(lblId.Text.Trim, String) + "','DiscountFormula');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup1", strpop, True)
            End If
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        Dim strpop As String = ""
        strpop = "window.open('DiscountFormula.aspx?State=New','DiscountFormula');"
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup1", strpop, True)
    End Sub
#End Region
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        Try
            ...
            Dim strpop As String = ""
            strpop = "window.open('rptReportNew.aspx?Pageame=DiscountFormula&BackPageName=DiscountFormulaSearch.aspx','RepMarkup');"
