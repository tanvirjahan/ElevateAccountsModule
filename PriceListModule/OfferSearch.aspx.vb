    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            Try
                ...
                Else
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                                               CType(strappname, String), "PriceListModule\OfferSearch.aspx?appid=1", btnAddNew, btnExportToExcel, btnPrint, gv_SearchResult, GridCol.Edit, GridCol.Delete, GridCol.View, 0, GridCol.Copy)
                End If
                ...
                FillGrid("case when activestate='Active' then 1 else 2 end, promotionid", "DESC") 'FillGrid("promotionid", "DESC") 'changed by mohamed on 02/04/2018
            ...
            Catch ex As Exception
                ...
                objUtils.WritErrorLog("OfferSearch.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
            End Try
        Else
        ...
        If (Me.IsPostBack And Me.Request("__EVENTTARGET") = "OfferMainWindowPostBack") Then
    ...
    Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        Try
            ...
            If chkshowall.checked = True Then
                strSqlQry = "select * from view_Offer_search(nolock) "
            Else
            ...
            If pliststr <> "" Then
                strSqlQry = strSqlQry & " WHERE promotionid='" & pliststr & "'"
...
#Region "Protected Sub gv_SearchResult_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles gv_SearchResult.PageIndexChanging"
    Protected Sub gv_SearchResult_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles gv_SearchResult.PageIndexChanging
        ...
        Select Case ddlOrderBy.SelectedIndex
            ...
            Case 1
                FillGrid("case when activestate='Active' then 1 else 2 end, Promotionid", "ASC") 'FillGrid("promotionid", "ASC") 'changed by mohamed on 02/04/2018
        ...
        Try
            If gv_SearchResult.Rows.Count <> 0 Then
                ...
                If Trim(BuildCondition) <> "" Then
                    strSqlQry = strSqlQry & " WHERE " & BuildCondition() & ""
                Else
                    strSqlQry = strSqlQry & " ORDER BY case when activestate='Active' then 1 else 2 end, promotionid" 'strSqlQry = strSqlQry & " ORDER BY promotionid" 'changed by mohamed on 02/04/2018
                End If
...
#End Region
    ...
    Private Function BuildConditionNew(ByVal strCountryValue As String, ByVal strCityValue As String, ByVal strSectorValue As String, ByVal strSectorGroupValue As String, ByVal strTextValue As String) As String
        ...
        If strCountryValue <> "" Then
            If Trim(strWhereCond) = "" Then
                strWhereCond = " upper(promotionid) IN (" & Trim(strCountryValue.Trim.ToUpper) & ")"
            Else
                strWhereCond = strWhereCond & " AND  upper(promotionid) IN (" & Trim(strCountryValue.Trim.ToUpper) & ")"
            End If
        End If
            ...
            For i = 0 To lsMainArr.GetUpperBound(0)
                ...
                If strValue <> "" Then
                    If Trim(strWhereCond1) = "" Then
                        strWhereCond1 = " (upper(promotionid) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(promotionname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(partyname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(status) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    Else
                        strWhereCond1 = strWhereCond1 & " OR  (upper(promotionid) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(promotionname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(partyname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(status) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    End If
                End If
            Next
            If Trim(strWhereCond) = "" Then
