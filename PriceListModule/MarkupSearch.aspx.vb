...
#End Region
    ...
    Private Sub FillGridNew()
        ...
        Try
            ...
            '    strSqlQry = "select *, [IsActive]=case when active=1 then 'Active' when active=0 then 'InActive'end,(select currmast.currname from currmast where currmast.currcode=markupformula_header.currcode)currname   from markupformula_header(noloack) "
            'Else
            '    strSqlQry = "SELECT * from V_GET_MARKUP_FORMULA "
            'End If

            strSqlQry = "select *, [IsActive]=case when active=1 then 'Active' when active=0 then 'InActive'end,(select currmast.currname from currmast where currmast.currcode=markupformula_header.currcode)currname   from markupformula_header(nolock) "
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            If e.CommandName = "EditRow" Then
                ...
                Else
                    strpop = "window.open('MarkupFormula.aspx?State=Edit&FormulaID=" + CType(lblId.Text.Trim, String) + "','MarkupFormula');"
                End If
            ...
            ElseIf e.CommandName = "View" Then
                ...
                Else
                    strpop = "window.open('MarkupFormula.aspx?State=View&FormulaID=" + CType(lblId.Text.Trim, String) + "','MarkupFormula');"
                End If
            ...
            ElseIf e.CommandName = "DeleteRow" Then
                ...
                Else
                    strpop = "window.open('MarkupFormula.aspx?State=Delete&FormulaID=" + CType(lblId.Text.Trim, String) + "','MarkupFormula');"
                End If
            ...
            ElseIf e.CommandName = "CopyRow" Then
                ...
                Else
                    strpop = "window.open('MarkupFormula.aspx?State=Copy&FormulaID=" + CType(lblId.Text.Trim, String) + "','MarkupFormula');"
                End If
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        Else
            strpop = "window.open('MarkupFormula.aspx?State=New','MarkupFormula');"
        End If
