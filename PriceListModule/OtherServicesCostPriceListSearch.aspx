<%@ Page Language="VB" MasterPageFile="~/TransferMaster.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="OtherServicesCostPricelistSearch.aspx.vb" Inherits="OtherServicesCostPricelistSearch"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('PRICELIST:" " SUPPLIER:" " SERVICEGROUP:"  " APPROVEDSTATUS:" " TEXT:" "');
            ...
            'access'
              ...
              callbacks: {
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      ...
                      var hdngroup = document.getElementById("<%=hdDefault_Group.ClientID%>");
                      switch (category) {
                          case 'PRICELIST':

                              var asSqlqry = "select ltrim(rtrim(ocplistcode)) PRICELIST  from oplist_costh(nolock) where othgrpcode='" + hdngroup.value + "'     order by ocplistcode";
                              glcallback = callback;
                          ...
                          case 'SUPPLIER':
                              ...
                              if (hdngroup.value !='VISA') {
                               asSqlqry = "select partyname    from  partymast where active=1  and sptypecode in (select option_selected from reservation_parameters where param_id=564) order by partyname ";
                              }
                              else{
                               asSqlqry = "select partyname    from  partymast where active=1  and sptypecode='" + hdngroup.value + "' order by partyname ";
                              }
                          ...
                          case 'SERVICEGROUP':
                              ...
                              var asSqlqry = "select othgrpname  SERVICEGROUP  from  othgrpmast where active=1  and othmaingrpcode='" + hdngroup.value + "'  order by othgrpname ";
                              glcallback = callback;
                              //fnTestCallback();
                              ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                ...
                { label: 'SUPPLIER', category: 'Sector' },
                 { label: 'SERVICEGROUP', category: 'Sector' },
                    ...
                    <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
                        ...
                        <tr>
                            <td style="text-align: center; width: 100%;" align="center" class="field_heading">
                                <asp:label id="Label1" runat="server" cssclass="field_heading" text="Airport Meet Cost Pricelist Search">
                                </asp:label>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <contenttemplate>
                                        ...
                                        BorderStyle="Solid">
                                            <FooterStyle CssClass="grdfooter"></FooterStyle>
                                                        ...
                                                        <ItemTemplate>
                                                        <asp:Label id="lblplistcode" runat="server" Text='<%# Bind("ocplistcode") %>'></asp:Label> 
                                                        </ItemTemplate>
                                                        </asp:TemplateField >

                                                        <asp:TemplateField HeaderText="othgrpcode" visible="false" >
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblgrpcode" runat="server" Text='<%# Bind("othgrpcode") %>'></asp:Label>
