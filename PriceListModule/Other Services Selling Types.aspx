<%@ Page Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="Other Services Selling Types.aspx.vb" Inherits="Other_Services_Selling_Types"  %>
...
function  GetValueCode()
{
    ...
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
<TABLE style="BORDER-RIGHT: gray 2px solid; BORDER-TOP: gray 2px solid; BORDER-LEFT: gray 2px solid; WIDTH: 656px; BORDER-BOTTOM: gray 2px solid"><TBODY><TR><TD class="td_cell" align=center colSpan=2><asp:Label id="lblHeading" runat="server" Text="Add New Other Services Selling Types" CssClass="field_heading" Width="645px"></asp:Label></TD></TR><TR style="COLOR: #ff0000">
    <TD style="WIDTH: 135px" class="td_cell"><SPAN style="COLOR: #000000">Code </SPAN><SPAN style="COLOR: #ff0000" class="td_cell">*</SPAN></TD><TD style="COLOR: #000000"><INPUT style="WIDTH: 196px" id="TxtOtherServiceCode" class="txtbox" tabIndex=1 type=text maxLength=150 runat="server" /></TD></TR><TR>
    <TD style="WIDTH: 135px; HEIGHT: 24px" class="td_cell">
    Name <SPAN style="COLOR: #ff0000" class="td_cell">*</SPAN></TD><TD style="COLOR: #000000"><INPUT style="WIDTH: 196px" id="txtOtherServiceSelling" class="txtbox" tabIndex=2 type=text maxLength=150 runat="server" /> </TD></TR>
    <TR>
    <TD style="WIDTH: 135px; HEIGHT: 25px" class="td_cell">Currency</TD>
    <TD style="HEIGHT: 26px"><SELECT onchange="GetValueFrom()" style="WIDTH: 197px" id="ddlCurrencyCd" class="drpdown" tabIndex=3 align=left runat="server">
     <OPTION selected></OPTION></SELECT><SELECT onchange="GetValueCode()" style="WIDTH: 201px" id="ddlCurrencyNm" class="drpdown" tabIndex=4 runat="server"> 
     <OPTION selected></OPTION>
     </SELECT>
     </TD>
     </TR>
    <tr>
    <td class="td_cell" style="width: 135px">
    <asp:Label runat="server" ID="LblcstHF" Text="Cost of Handling Fee Required" Visible ="false"></asp:Label></td><td>
        <INPUT id="chkHandlingFees" tabIndex=5 type=checkbox CHECKED runat="server" visible="false" />
    </td></tr><TR><TD style="WIDTH: 135px; HEIGHT: 24px" class="td_cell">Active</TD><TD style="HEIGHT: 24px">
        <INPUT id="chkActive" tabIndex=5 type=checkbox CHECKED runat="server" /></TD></TR><TR>
        <TD style="WIDTH: 135px"><asp:Button id="btnSave" tabIndex=6 runat="server" Text="Save" CssClass="btn" Width="46px"></asp:Button></TD><TD><asp:Button id="btnCancel" tabIndex=7 onclick="btnCancel_Click" runat="server" Text="Return To Search" CssClass="btn"></asp:Button>&nbsp;&nbsp; 
