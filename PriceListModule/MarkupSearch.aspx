<%@ Page Title="" Language="VB" MasterPageFile="~/MainPageMaster.master" AutoEventWireup="false" EnableEventValidation="false"
    CodeFile="MarkupSearch.aspx.vb" Inherits="MarkupSearch" %>
                    ...
                    valueMatches: function (category, searchTerm, callback) {
                        switch (category) {
                            case 'Markup Formula Name':
                                var asSqlqry = '';
                                glcallback = callback;
                                ColServices.clsVisualSearchService.GetListOfMarkupFormulaVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                break;
                            case 'Formula Type':
                                var asSqlqry = '';
                                glcallback = callback;
