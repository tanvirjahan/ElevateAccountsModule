<%@ Page Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="MealPlans.aspx.vb" Inherits ="MealPlans"  Strict ="true"  %>
...
function  GetValueCode()
{
    ...
    function FormValidation(state) {
        ...
        var txtmainmealval = document.getElementById("<%=txtmainmeal.ClientID%>");
        ...
        if (txtmainmealval.value == '') {
            alert('Please enter Main Meal');
            return false;
        }
...
function txtmainmealAutoCompleteExtenderKeyUp() {
    $("#<%=txtmainmeal.ClientID %>").bind("change", function () {
        document.getElementById('<%=tCode.ClientID%>').value = '';
    });
}
                ...
                <tbody>
                    <tr>
                        <td style="height: 18px" class="field_heading" align="center" colspan="4">
                            <asp:Label ID="lblHeading" runat="server" Text="Add New Meals" Width="301px" CssClass="field_heading"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 57px; color: #000000; height: 24px">
                            <input style="width: 200px" id="txtCode" class="txtbox" tabindex="1" type="text"
                                maxlength="20" runat="server" />
                        </td>
                        <td style="width: 105px; height: 24px" class="td_cell">
                            <span style="color: black">Main&nbsp;Meal</span>
                        </td>
                        <td style="width: 318px; height: 24px">
                            <asp:TextBox ID="txtmainmeal" runat="server" AutoPostBack="True" CssClass="field_input"
                                MaxLength="500" TabIndex="3" Width="176px"></asp:TextBox>
                            <asp:TextBox ID="tCode" runat="server" Style="display: none"></asp:TextBox>
                            <asp:HiddenField ID="hdntcode" runat="server" />
                            <asp:AutoCompleteExtender ID="txtmainmeal_AutoCompleteExtender" runat="server" CompletionInterval="10"
                                CompletionListCssClass="autocomplete_completionListElement" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                                CompletionListItemCssClass="autocomplete_listItem" CompletionSetCount="1" DelimiterCharacters=""
                                EnableCaching="false" Enabled="True" FirstRowSelected="false" MinimumPrefixLength="0"
                                ServiceMethod="GetMainMeals" TargetControlID="txtmainmeal">
