...
Partial Class PriceListModule_TrfPricelistSearch
...
#Region "Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Me.IsPostBack And Me.Request("__EVENTTARGET") = "TrfPriceListWindowPostBack") Then
...
#Region "Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = 'ASC')"
    Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        strSqlQry = ""
        Try
            strSqlQry = "select trfplisth.tplistcode, partymast.partyname, supplier_agents.supagentname ," & _
                " othgrpmast.othgrpname,dbo.fn_get_trfplist_market(trfplisth.tplistcode) plgrpcode,trfplisth.currcode, trfplisth.subseascode, " & _
                "  min(trfplisth_dates.frmdate) frmdate,max(trfplisth_dates.todate) todate, " & _
                "  case when isnull(trfplisth.active,0)=1 then 'Active' when isnull(trfplisth.active,0)=0 then 'InActive' end active, " & _
                " case when isnull(trfplisth.transfertype,0)=0 then 'All' when   isnull(trfplisth.transfertype,0)=1 then 'Arrival Borders' when  isnull(trfplisth.transfertype,0)=2 then 'Departure Borders'  " & _
                " when isnull(trfplisth.transfertype,0)=3 then 'Internal Transfer/Excursion' when isnull(trfplisth.transfertype,0)=4 then 'Arrival/Departure Transfer Borders' end transfertype," & _
                "  trfplisth.adddate,  trfplisth.adduser, trfplisth.moddate, trfplisth.moduser,case isnull(trfplisth.approve,0) when 0 then 'Unapproved' else 'Approved' end approve  " & _
            ...
            If Trim(BuildCondition) <> "" Then
                ...
                strSqlQry = strSqlQry & " and  trfplisth.shuttle=0 group by  trfplisth.tplistcode, partymast.partyname, supplier_agents.supagentname , othgrpmast.othgrpname,trfplisth.currcode," & _
            ...
            Else
                ...
                strSqlQry = strSqlQry & " where  trfplisth.shuttle=0 group by  trfplisth.tplistcode, partymast.partyname, supplier_agents.supagentname , othgrpmast.othgrpname,trfplisth.currcode," & _
                  " trfplisth.subseascode,  trfplisth.active,trfplisth.adddate, trfplisth.adduser, trfplisth.moddate, trfplisth.moduser, trfplisth.approve,trfplisth.transfertype"
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        strpop = "window.open('TrfPriceList1.aspx?State=New','TrfPriceList1','width='+screen.availWidth+' height='+screen.availHeight+' left=0,top=0 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            If e.CommandName = "Editrow" Then
                ...
                End If
                Dim strpop As String = ""
                strpop = "window.open('TrfPriceList1.aspx?State=Edit&RefCode=" + CType(lblId.Text.Trim, String) + "','TrfPriceList1','width='+screen.availWidth+' height='+screen.availHeight+' left=0,top=0 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ElseIf e.CommandName = "View" Then
                ...
                Dim strpop As String = ""
                strpop = "window.open('TrfPriceList2.aspx?State=View&RefCode=" + CType(lblId.Text.Trim, String) + "','TrfPriceList2','width='+screen.availWidth+' height='+screen.availHeight+' left=0,top=0 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ...
            ElseIf e.CommandName = "Deleterow" Then
                ...
                Dim strpop As String = ""
                strpop = "window.open('TrfPriceList2.aspx?State=Delete&RefCode=" + CType(lblId.Text.Trim, String) + "','TrfPriceList2','width='+screen.availWidth+' height='+screen.availHeight+' left=0,top=0 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ...
            ElseIf e.CommandName = "Copy" Then
                ...
                Dim strpop As String = ""
                strpop = "window.open('TrfPriceList1.aspx?State=Copy&RefCode=" + CType(lblId.Text.Trim, String) + "','TrfPriceList1','width='+screen.availWidth+' height='+screen.availHeight+' left=0,top=0 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
        ...
        Try
            If gv_SearchResult.Rows.Count <> 0 Then
                ...
                If Trim(BuildCondition) <> "" Then
                    strSqlQry = strSqlQry & " WHERE " & BuildCondition()
                    strSqlQry = strSqlQry & " and trfplisth.shuttle=0  group by  trfplisth.tplistcode, partymast.partyname, supplier_agents.supagentname , othgrpmast.othgrpname,trfplisth.currcode," & _
                        " trfplisth.subseascode,  trfplisth.active,trfplisth.adddate, trfplisth.adduser, trfplisth.moddate, trfplisth.moduser, trfplisth.approve"
...
#End Region
    ...
    Private Sub fillcombo()
        ...
        '------------------
        sqlstr = "select othgrpmast.othgrpcode,othgrpmast.othgrpname  from  othgrpmast left outer join  partyothgrp on othgrpmast.othgrpcode=partyothgrp.othgrpcode  where active=1 " & _
         "and partyothgrp.partycode='" & ddlSupplierCode.Items(ddlSupplierCode.SelectedIndex).Text & "' order by  othgrpmast.othgrpcode"
        objUtils.FillDropDownListHTMLNEW(Session("dbconnectionName"), ddlGroupCode, "othgrpcode", "othgrpname", sqlstr, True)

        sqlstr = "select othgrpmast.othgrpname othgrpmast.othgrpcode, from  othgrpmast left outer join  partyothgrp on othgrpmast.othgrpcode=partyothgrp.othgrpcode  where active=1 " & _
        "and partyothgrp.partycode='" & ddlSupplierCode.Items(ddlSupplierCode.SelectedIndex).Text & "' order by  othgrpmast.othgrpcode"
