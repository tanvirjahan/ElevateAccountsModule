<%@ Page Title="" Language="VB" MasterPageFile="~/PriceListMaster.master" AutoEventWireup="false" CodeFile="RoomclassificationSearch.aspx.vb" Inherits="PriceListModule_RoomclassificationSearch" %>
...
<link rel="stylesheet" href="../Content/lib/css/reset.css" type="text/css" media="screen" charset="utf-8">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('ROOMCLASSNAME:" " TEXT:" "');
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      switch (category) {
                          case 'ROOMCLASSNAME':
                              var asSqlqry = '';
                              glcallback = callback;
                              ColServices.clsSectorServices.GetListOfRoomClassificationVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                              break;
                      }
                  },
                  facetMatches: function (callback) {
                      callback([
                { label: 'TEXT', category: 'Room Classification' },
                { label: 'ROOMCLASSNAME', category: 'Room Classification' },
              ]);
                  }
              }
          });
...
<SPAN style="COLOR: black">Roomclass&nbsp;Code</SPAN></TD><TD style="WIDTH: 46px">
    <asp:TextBox id="txtRoomclassCode" tabIndex=1 runat="server" CssClass="field_input" MaxLength="20"></asp:TextBox></TD>
    <TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell">
    <SPAN style="COLOR: black">Roomclass&nbsp;Name</SPAN></TD>
    <TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell">
    <asp:TextBox id="txtRoomclassName" tabIndex=2 runat="server" Width="300px" CssClass="field_input" MaxLength="100"></asp:TextBox></TD>
    <TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell">
...
<td class="td_cell" style="width: 42px; height: 10px">
<asp:Button ID="btnPint1" runat="server" CssClass="btn" Text="Report" TabIndex="7" style="position: relative; top: 0px; left: 0px;" /></td>
                    ...
                    <td>
                        ...
                        &nbsp;<asp:Button ID="btnClearDate" runat="server" CssClass="btn" Font-Bold="False" 
                            tabIndex="4" Text="Reset Dates" />
                               ...
                               <td>  <asp:Label ID="RowSelectsrc" runat="server" CssClass="field_caption" 
                            Text="Rows Selected "></asp:Label>
                     <asp:DropDownList ID="RowsPerPageRC" runat="server" AutoPostBack="true">
...
<Columns>
<asp:TemplateField Visible="False" HeaderText="RoomClass Code"><EditItemTemplate>
<asp:TextBox ID="txtRoomclassCode" runat="server" Text='<%# Bind("roomclasscode") %>'></asp:TextBox>
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblCode" runat="server" Text='<%# Bind("roomclasscode") %>'></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField="roomclasscode" SortExpression="roomclasscode" HeaderText="Room Class Code">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
</asp:BoundField>
<asp:TemplateField HeaderText="Room Class Name" SortExpression="roomclassname">
                    <ItemTemplate>
                        <asp:Label ID="lblRoomClassName" runat="server" Text='<%# Bind("roomclassname") %>'></asp:Label>
                    </ItemTemplate>
                    <ControlStyle Width="8%" />
                    <HeaderStyle HorizontalAlign="Left" Width="8%" />
                    <ItemStyle CssClass="roomclassname" HorizontalAlign="Left" Width="8%" />
                </asp:TemplateField>
