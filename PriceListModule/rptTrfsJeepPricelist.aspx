<%@ Page Title="" Language="VB" MasterPageFile="~/PriceListMaster.master" AutoEventWireup="false" CodeFile="rptTrfsJeepPricelist.aspx.vb" Inherits="PriceListModule_rptTrfsJeepPricelist" %>
...
<script language="javascript" type="text/javascript" >
    function CallWebMethod(methodType) {
        switch (methodType) {
            case "othergroupcode":
                ...
                ColServices.clsServices.GetTrfJeepCatnew(constr, party, FillList, ErrorHandler, TimeOutHandler);
                break;
            case "othergroupname":
 ...
 <asp:UpdatePanel id="UpdatePanel1" runat="server">
   <contenttemplate>
        ...
        <TR>
            <TD>
                <asp:Label id="Label2" runat="server"  Text="Group Code" CssClass="td_cell" Width="154px"></asp:Label></TD>
            <TD>
                <SELECT style="WIDTH: 170px" id="ddlOtherGroupCode" class="drpdown" tabIndex=1 onchange="CallWebMethod('othergroupcode')" runat="server" Visible="true"> <OPTION selected></OPTION></SELECT>
           </TD>
           <TD>
                <asp:Label id="Label3" runat="server" Text="Group Name" CssClass="td_cell" Width="165px"></asp:Label>
           </TD>
           <TD>
                <SELECT style="WIDTH: 237px" id="ddlOtherGroupName" class="drpdown" tabIndex=2 onchange="CallWebMethod('othergroupname')" runat="server" Visible="true"> <OPTION selected></OPTION></SELECT>
           </TD>
      </TR>
      
      <TR>
         <TD>
            <asp:Label id="lblMarketCode" runat="server" Text="Market Code" CssClass="td_cell"></asp:Label></TD>
         <TD>
            <SELECT style="WIDTH: 170px" id="ddlMarketCode" class="drpdown" tabIndex=3 onchange="CallWebMethod('marketcode')" runat="server" Visible="true"> <OPTION selected></OPTION></SELECT> </TD>
         <TD dir="ltr">
            <asp:Label id="lblMarketName" runat="server" Text="Market Name" CssClass="td_cell"></asp:Label></TD>
         <TD><SELECT style="WIDTH: 237px" id="ddlMarketName" class="drpdown" tabIndex=4 onchange="CallWebMethod('marketname')" runat="server" Visible="true"> <OPTION selected></OPTION></SELECT> </TD>
    </TR>
    
    <TR>
        <TD><asp:Label id="lblSellingCategoryCode" runat="server" Text="Selling Type Code" CssClass="td_cell" Width="123px"></asp:Label></TD>
        <TD><SELECT style="WIDTH: 170px" id="ddlSellingCode" class="drpdown" tabIndex=5 onchange="CallWebMethod('sellcode')" runat="server" Visible="true"> <OPTION selected></OPTION></SELECT> </TD>
        <TD><asp:Label id="lblsellingcategoryname" runat="server" Text="Selling Type Name" CssClass="td_cell" Width="124px"></asp:Label></TD>
        <TD><SELECT style="WIDTH: 237px" id="ddlSellingName" class="drpdown" tabIndex=6 onchange="CallWebMethod('sellname')" runat="server" Visible="true"> <OPTION selected></OPTION></SELECT> </TD>
   </TR>
    <TR>
        <TD><asp:Label id="Label4" runat="server" Text="Season Code" CssClass="td_cell"></asp:Label></TD>
        <TD><asp:DropDownList id="ddlseas1code" tabIndex=7 runat="server" CssClass="drpdown" Width="170px" OnSelectedIndexChanged="ddlseas1code_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList></TD>
        <TD><asp:Label id="Label5" runat="server" Text="Season Name" CssClass="td_cell" Width="124px"></asp:Label></TD>
        <TD><asp:DropDownList id="ddlseas1name" tabIndex=8 runat="server" CssClass="drpdown" Width="237px" OnSelectedIndexChanged="ddlseas1name_SelectedIndexChanged"></asp:DropDownList></TD>
   </TR>
   <tr>
        <td>
    ...
    <TR>
       <TD><asp:Label id="lblFromDate" runat="server" Text="From Date" CssClass="td_cell"></asp:Label></TD>
       <TD><asp:TextBox id="txtFromDate" runat="server" CssClass="fiel_input" Width="80px" TabIndex="9"></asp:TextBox>
           <asp:ImageButton id="ImgBtnFrmDt" runat="server" ImageUrl="~/Images/Calendar_scheduleHS.png"></asp:ImageButton>
           <cc1:MaskedEditValidator id="MEVFromDate" runat="server" CssClass="field_error" Display="Dynamic" ControlToValidate="txtFromDate" ControlExtender="MEFromDate" EmptyValueMessage="Date is required" EmptyValueBlurredText="Date is required" InvalidValueBlurredMessage="Invalid Date" InvalidValueMessage="Invalid Date" TooltipMessage="Input a date in dd/mm/yyyy format"></cc1:MaskedEditValidator></TD>
       <TD><asp:Label id="lblTodate" runat="server" Text="To Date" CssClass="td_cell"></asp:Label></TD>
       <TD><asp:TextBox id="txtToDate" runat="server" CssClass="fiel_input" Width="80px" TabIndex="10"></asp:TextBox>
