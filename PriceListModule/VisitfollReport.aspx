<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VisitfollReport.aspx.vb" Inherits="VisitfollReport"  MasterPageFile="~/SubPageMaster.master" Strict="true"  %>
...
<script language="javascript" type="text/javascript" >
    ...
    <asp:Button ID="btnBack" runat="server" CssClass="field_button" Text="Back To New Clients Query"
