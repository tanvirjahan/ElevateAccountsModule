...
Partial Class PriceListModule_Download
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Dim filePath As String = "~\\Attachment\\" + strFile
        ...
        Catch ex As Exception
            objUtils.WritErrorLog("Download.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        End Try
    End Sub
