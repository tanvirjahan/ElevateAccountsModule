<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptPriceExpiryReport.aspx.vb" Inherits="rptPriceExpiryReport"  MasterPageFile="~/SubPageMaster.master" Strict="true"  %>
...
<script language="javascript" type="text/javascript" >
    ...
    <asp:Button ID="btnBack" runat="server" CssClass="field_button" 
                    Text="Back To Price Expiry Report" />&nbsp;
