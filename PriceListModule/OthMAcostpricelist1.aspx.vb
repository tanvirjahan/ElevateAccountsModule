...
Partial Class PriceListModule_OthMAcostpricelist1
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            If Page.IsValid = True Then
                If ViewState("pricelistState") = "New" Or ViewState("pricelistState") = "Edit" Or ViewState("pricelistState") = "Copy" Then
                    ...
                    If ViewState("pricelistState") = "New" Or ViewState("pricelistState") = "Copy" Then
                        ...
                        If hdngroup.Value = "VISA" Then
                            optionName = "VISACPLIST"
                        Else
                            optionName = "AIRMCPLIST"
                        End If
                    ...
                    dt_InsertData.Columns.Add("ocplistcode")
                    dt_InsertData.Columns.Add("othgrpcode")
                    dt_InsertData.Columns.Add("oclineno")
                    dt_InsertData.Columns.Add("othtypcode")
                    dt_InsertData.Columns.Add("othcatcode")
                    dt_InsertData.Columns.Add("ocostprice")
                    dt_InsertData.Columns.Add("pkgnights")
                    dt_InsertData.Columns.Add("TaxableValue")
                    dt_InsertData.Columns.Add("NonTaxableValue")
                    dt_InsertData.Columns.Add("VATValue")
                        ...
                        If n = 0 Then
                            For j = 0 To cnt - 6
                                ...
                                If txt.Text <> "" Then
                                    ...
                                    NewRow("ocplistcode") = CType(txtPlcCode.Value.Trim, String)
                                    NewRow("othgrpcode") = CType(hdngroup.Value, String)
                                    ...
                                    NewRow("othtypcode") = CType(txttrftypecode.Text, String)
                                    NewRow("othcatcode") = CType(heading(j), String)
                                    NewRow("ocostprice") = CType(txt.Text.Trim, Decimal)
                                    NewRow("pkgnights") = 1
                                    ...
                                    Else
                                        If Chk_PriceIncludeVAT.Checked = True Then
                                            ...
                                            NewRow("TaxableValue") = DecRound(PriceTaxableValue)
                                            PriceTaxableValue = CType(txt.Text.Trim, Decimal) - PriceTaxableValue
                                            NewRow("VATValue") = DecRound(PriceTaxableValue)

                                        Else
                                            Dim PriceTaxableValue As Decimal = CType(txt.Text.Trim, Decimal) * ((CType(Txt_VAT_Per.Text.Trim, Decimal) / 100))
                                            NewRow("TaxableValue") = DecRound(CType(txt.Text.Trim, Decimal))
                                            NewRow("VATValue") = DecRound(PriceTaxableValue)

                                        End If
                                        NewRow("NonTaxableValue") = 0
                                    End If
                        ...
                        Else
                            ...
                            For j = n To (m + n) - 1
                                ...
                                If txt.Text <> "" Then
                                    ...
                                    NewRow("othtypcode") = CType(txttrftypecode.Text, String)
                                    NewRow("othcatcode") = CType(heading(k), String)
                                    NewRow("ocostprice") = CType(txt.Text.Trim, Decimal)
                                    NewRow("pkgnights") = 1
                                    ...
                                    Else
                                        ...
                                        End If
                                        NewRow("NonTaxableValue") = Txt_VAT_Per.Text.Trim
                    ...
                    Using bulkCopy As SqlBulkCopy = New SqlBulkCopy(mySqlConn, SqlBulkCopyOptions.Default, sqlTrans)
                        ...
                        bulkCopy.DestinationTableName = "dbo.oplist_costd"
                ...
                strscript = "window.opener.__doPostBack('AirportCostPriceListWindowPostBack', '');window.opener.focus();window.close();"
        ...
        Catch ex As Exception
            ...
            objUtils.WritErrorLog("OthMAcostPriceList1.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        End Try
    End Sub
                ...
                For Each vr As DataRow In dt.Rows
                    For Each gr As GridViewRow In grdtransferrates.Rows
                        ...
                        If vr("Service_Type_Code") = code.Text.Trim Then
                            ...
                            nonTax.Text = vr("NonTaxableValue")
                            nonTaxCh = CType(gr.FindControl("txtNonTax1"), TextBox)
                            nonTaxCh.Text = vr("NonTaxableValue")
                            Exit For
                        End If
                    Next
                Next
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If IsPostBack() = False Then
                ...
                Else
                    heading = "Airport Meet Cost Price List"
                End If

                If hdngroup.Value <> "VISA" Then

                    Session("OthGroup") = objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select option_selected from reservation_parameters(nolock) where param_id=564")
                End If
        ...
        Try
            ...
            If mySqlReader.HasRows Then
                While mySqlReader.Read
                  ...
                  " pkgnights,TaxableValue,NonTaxableValue,VatValue from  oplist_costd  " & _
                  " where   " & _
                  " ocplistcode= '" & RefCode & "' and othtypcode = '" & txttrftypecode.Text & "'"
                            Else

                                StrQryTemp = "select ocplistcode  ,oplist_costd.othtypcode,othcatcode,ocostprice, " & _
                            " pkgnights,a.ratebasis,a.additionalpaxyesno from  oplist_costd,airportmatypes a   " & _
                            " where oplist_costd.othtypcode=a.othtypcode and  " & _
                            " ocplistcode= '" & RefCode & "' and oplist_costd.othtypcode = '" & txttrftypecode.Text & "'"
...
<System.Web.Services.WebMethod()> _
                    ...
                    If ds1.Tables.Count > 0 Then
                        If ds1.Tables(0).Rows.Count > 0 Then
                            If IsDBNull(ds1.Tables(0).Rows(0)("ocplistcode")) = False Then
                                If hdngroup.Value = "VISA" Then
                                    strMsg = "Visa Cost Pricelist already exists For this   " + ds1.Tables(0).Rows(0)("ocplistcode")
                                Else
                                    strMsg = "AirportMeet Cost Pricelist already exists For this   " + ds1.Tables(0).Rows(0)("ocplistcode")
                                End If
    ...
    Protected Sub btnhelp_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If hdngroup.Value = "VISA" Then
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=visacostpricelist','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)

        Else
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=AMCostPriceEntry','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
            ...
            For Each row As GridViewRow In grdtransferrates.Rows
                For i = 0 To grdtransferrates.Columns.Count - 6
                    ...
                    If txt1.Text <> "" Then
                        ...
                        If i = 1 Then
                            Dim txtTax As TextBox = CType(row.FindControl("txtTax1"), TextBox)
                            Dim txtNonTax As TextBox = CType(row.FindControl("txtNonTax1"), TextBox)
                            Dim txtVat As TextBox = CType(row.FindControl("txtVat1"), TextBox)
                            Dim cal As Decimal = Convert.ToDecimal(txt1.Text) - Convert.ToDecimal(txtNonTax.Text)
                            Dim TaxAndVat As Decimal = (100 + vatPerc) / 100
                            cal = cal / TaxAndVat
                            txtTax.Text = Math.Round(cal, 2)
