<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MarketsSearch.aspx.vb" Inherits="MarketsSearch" MasterPageFile="~/MainPageMaster.master" Strict="true" enableEventValidation ="false" %>
...
<TBODY><TR style="display:none"><TD style="WIDTH: 99px; HEIGHT: 24px" class="td_cell"><SPAN style="COLOR: black">Region Code</SPAN></TD>
<TD style="WIDTH: 46px; HEIGHT: 24px"><asp:TextBox id="txtMarketCode" tabIndex=1 runat="server" CssClass="txtbox" MaxLength="20"></asp:TextBox></TD><TD style="WIDTH: 118px; HEIGHT: 24px" class="td_cell"><SPAN style="COLOR: black">Region Name</SPAN></TD><TD style="WIDTH: 30px; HEIGHT: 24px" class="td_cell"><asp:TextBox id="txtMarketName" tabIndex=2 runat="server" Width="300px" CssClass="txtbox" MaxLength="100"></asp:TextBox></TD><TD style="WIDTH: 42px; HEIGHT: 24px" class="td_cell">
...
<Columns>
<asp:TemplateField Visible="False" HeaderText="Region Code"><EditItemTemplate>
...
<asp:BoundField DataField="plgrpcode" SortExpression="plgrpcode" HeaderText="Region Code"></asp:BoundField>
 ...
 <asp:TemplateField HeaderText="Region Name" SortExpression="plgrpname">
                    ...
                    <ItemStyle CssClass="plgrpname" HorizontalAlign="Left" Width="8%" />
                </asp:TemplateField>
