<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptOtherServicePricelist.aspx.vb" Inherits="rptOtherServicePricelist"  MasterPageFile="~/PriceListMaster.master" Strict="true"  %>
                ...
                <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
                    ...
                    <tr>
                        <td class="field_heading" style="text-align: center">
                            Other Service Price List Report</td>
                    </tr>
                    <tr>
...
<TABLE style="WIDTH: 100%"><TBODY><TR><TD><asp:Label id="Label2" runat="server" 
        Text="Other Service Group Code" CssClass="td_cell" Width="154px"></asp:Label></TD><TD>
