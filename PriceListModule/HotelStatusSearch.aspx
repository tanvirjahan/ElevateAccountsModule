<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HotelStatusSearch.aspx.vb"  Inherits="PriceListModule_Default" MasterPageFile="~/MainPageMaster.master" Strict="true" enableEventValidation ="false" %>
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          if (ValueRetrieval.value == "S")
           {
              $txtvsprocess.val('Hotels:" " City:" " Sector:" " Category:" " HotelStatus:" " Text:" "');
          }
                      ...
                      if (ValueRetrieval.value !== "S") {
                          switch (category) {
                              ...
                              case 'Hotels':
                                  ...
                                  glcallback = callback;
                                  //fnTestCallback();
                                  ColServices.clsHotelGroupServices.GetListOfArrayHotelStatusNameVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                  break;
                              case 'City':
                                  var asSqlqry = '';
                                  glcallback = callback;
...
<TABLE style="BORDER-RIGHT: gray 2px solid; BORDER-TOP: gray 2px solid; BORDER-LEFT: gray 2px solid; WIDTH: 100%px; BORDER-BOTTOM: gray 2px solid;margin-left:35px;vertical-align:top;"  ><TBODY><TR>
            ...
            <table class="style1">
                ...
                <tr runat="server" id="trNameAndCode">
                    ...
                    <td colspan="2">
                       ...
                       <td colspan="2">
                        <asp:Label ID="Label7" runat="server" Text="Hotel Status"></asp:Label>
                        &nbsp;&nbsp;<asp:TextBox ID="txtGroupTagName" runat="server" AutoPostBack="True" 
                            ...
                            FirstRowSelected="false" MinimumPrefixLength="0" ServiceMethod="GetHotelStatus" 
    ...
    CssClass="btn" Font-Bold="False" 
                ...
                <tr style="display:none;" >
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="txtName" runat="server" AutoPostBack="True" Width="300px"  CssClass="field_input"></asp:TextBox>
                        <asp:AutoCompleteExtender ID="txtName_AutoCompleteExtender" runat="server" 
                            ...
                            CompletionListItemCssClass="autocomplete_listItem" CompletionSetCount="1" 
                            DelimiterCharacters="" EnableCaching="false" Enabled="True" 
                            FirstRowSelected="false" MinimumPrefixLength="1" ServiceMethod="GetHotelStatus" 
                            TargetControlID="txtName"  OnClientItemSelected="txtNameautocompleteselected">
                        </asp:AutoCompleteExtender>
            ...
            <asp:GridView ID="gv_SearchResult" runat="server" 
                ...
                <asp:BoundField DataField="partycode" HeaderText="Hotel Code">
                                            ...
                                            <asp:TemplateField HeaderText="Hotel Status">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblHotelGroup" runat="server" Text='<%# Bind("hotelstatusname") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
