...
Partial Class PriceListModule_TrfSellingRatePaxSlab
...
#Region "Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ViewState.Add("TrfPLSRPaxSlabState", Request.QueryString("State"))
        ViewState.Add("TrfPLSRPaxSlabRefCode", Request.QueryString("RefCode"))
        ...
        If Page.IsPostBack = False Then
            Try
                ...
                If ViewState("TrfPLSRPaxSlabRefCode") <> Nothing Then
                    'txtBlockCode.Value = Request.QueryString("PListCode")
                    txtPLCode.Text = ViewState("TrfPLSRPaxSlabRefCode") 'Request.QueryString("PListCode")
                End If
        ...
        End If
        ShowSellingRadioBtns(ViewState("TrfPLSRPaxSlabRefCode"))
        fillDategrd(grdDates, True)
        ShowDates(ViewState("TrfPLSRPaxSlabRefCode"))
    End Sub
...
#End Region
    ...
    Protected Sub btnGenerate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        Try
            ...
            Response.Redirect("TrSellingRatesPaxSlab1.aspx?State=" & CType(ViewState("TrfPLSRPaxSlabState"), String) & "&PListCode=" & txtPLCode.Text & "&sellcode=" & lblselling.Text &
                              "&RefCode=" & CType(ViewState("TrfPLSRPaxSlabRefCode"), String) & "&supplier=" & ddlSupplierCode.Items(ddlSupplierCode.SelectedIndex).Text &
    ...
    Protected Sub btnBack_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBack.Click
        ...
        Response.Redirect("TrfPriceList2.aspx?State=Edit&RefCode=" & CType(ViewState("TrfPLSRPaxSlabRefCode"), String) & "&supplier=" & ddlSupplierCode.Items(ddlSupplierCode.SelectedIndex).Text &
                          "&suppliername=" & ddlSupplierName.Items(ddlSupplierName.SelectedIndex).Text & "&SupplierType=" & ddlSPCode.Items(ddlSPCode.SelectedIndex).Text &
                          "&SupplierTypeName=" & ddlSPName.Items(ddlSPName.SelectedIndex).Text & "&Market=" & marketstr & "&SuppierAgent=" & ddlSupplierACode.Items(ddlSupplierACode.SelectedIndex).Text &
                          "&SupplierAgentName=" & ddlSupplierAName.Items(ddlSupplierAName.SelectedIndex).Text & "&CurrencyCode=" & ddlCurrencyCode.Value &
                          "&CurrencyName=" & ddlCurrencyCode.Value & "&SubSeasonCode=" & ddlSubSeasonCode.Items(ddlSubSeasonCode.SelectedIndex).Text &
    ...
    Private Sub ShowDates(ByVal RefCode As String)
        ...
        Catch ex As Exception
            objUtils.WritErrorLog("TrfSellingRatesPaxSlab.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        Finally
    ...
    Public Sub fillDategrd(ByVal grd As GridView, Optional ByVal blnload As Boolean = False, Optional ByVal count As Integer = 1)
        ...
        If ViewState("TrfPLSRPaxSlabRefCode") <> Nothing Then
            ...
            strSqlQry = "select count(*) from trfplisth_dates where tplistcode='" + ViewState("TrfPLSRPaxSlabRefCode") + "'"
