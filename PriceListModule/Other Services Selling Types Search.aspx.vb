        ...
        If Page.IsPostBack = False Then
            Try
                ...
                If CType(Session("GlobalUserName"), String) = Nothing Or CType(Session("Userpwd"), String) = Nothing Then
                    ...
                    Exit Sub
                Else
                    If Session("OthTypeFilter") = "H" Then
                        Lblselltypes.Text = "HandlingFees Selling Types List"

                        objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                                    CType(strappname, String), "PriceListModule\Other Services Selling Types Search.aspx?Type=H", btnAddNew, btnExportToExcel, _
                                                              btnPrint, gv_SearchResult, GridCol.Edit, GridCol.Delete, GridCol.View)

                    Else
                        Lblselltypes.Text = "Other Services Selling Types List"
                        objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                                    CType(strappname, String), "PriceListModule\Other Services Selling Types Search.aspx?Type=O", btnAddNew, btnExportToExcel, _
                                                    btnPrint, gv_SearchResult, GridCol.Edit, GridCol.Delete, GridCol.View)
                ...
                Session.Add("strsortExpression", "othsellcode")
            ...
            Catch ex As Exception
                ...
                objUtils.WritErrorLog("Other Services Selling Types Search.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
            End Try
        End If
    ...
    Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        Try
            ...
            strSqlQry = "SELECT othsellmast.othsellcode,case othsellmast.costyesno  when 1 then 'Yes' else 'No' end costyesno,othsellmast.othsellname, othsellmast.currcode, currmast.currname, othsellmast.active, " & _
                        ...
                        "othsellmast ON currmast.currcode = othsellmast.currcode  WHERE dbo.othsellmast.othertype='" & Session("OthTypeFilter") & "' "
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    ...
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        'strpop = "window.open('Other Services Selling Types.aspx?State=New&Type=" + Session("OthTypeFilter") + "','OtherServicesSellingTypes','width='+screen.availWidth+' height='+screen.availHeight+' left=0,top=0 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
        strpop = "window.open('Other Services Selling Types.aspx?State=New&Type=" + Session("OthTypeFilter") + "','OtherServicesSellingTypes');"
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        ...
        Try
            ...
            If e.CommandName = "Editrow" Then
                ...
                Dim strpop As String = ""
                'strpop = "window.open('Other Services Selling Types.aspx?State=Edit&RefCode=" + CType(lblId.Text.Trim, String) + "&Type=" + Session("OthTypeFilter") + "','OtherServicesSellingTypes','width='+screen.availWidth+' height='+screen.availHeight+' left=0,top=0 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('Other Services Selling Types.aspx?State=Edit&RefCode=" + CType(lblId.Text.Trim, String) + "&Type=" + Session("OthTypeFilter") + "','OtherServicesSellingTypes');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ElseIf e.CommandName = "View" Then
                ...
                Dim strpop As String = ""
                'strpop = "window.open('Other Services Selling Types.aspx?State=View&RefCode=" + CType(lblId.Text.Trim, String) + "&Type=" + Session("OthTypeFilter") + "','OtherServicesSellingTypes','width='+screen.availWidth+' height='+screen.availHeight+' left=0,top=0 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('Other Services Selling Types.aspx?State=View&RefCode=" + CType(lblId.Text.Trim, String) + "&Type=" + Session("OthTypeFilter") + "','OtherServicesSellingTypes');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ElseIf e.CommandName = "Deleterow" Then
                ...
                Dim strpop As String = ""
                'strpop = "window.open('Other Services Selling Types.aspx?State=Delete&RefCode=" + CType(lblId.Text.Trim, String) + "&Type=" + Session("OthTypeFilter") + "','OtherServicesSellingTypes','width='+screen.availWidth+' height='+screen.availHeight+' left=0,top=0 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('Other Services Selling Types.aspx?State=Delete&RefCode=" + CType(lblId.Text.Trim, String) + "&Type=" + Session("OthTypeFilter") + "','OtherServicesSellingTypes');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
...
#Region "Protected Sub btnExportToExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExportToExcel.Click"
   ...
   "(Convert(Varchar, Datepart(DD,othsellmast.adddate))+'/'+ Convert(Varchar, Datepart(MM,othsellmast.adddate))+ '/'+ Convert(Varchar, Datepart(YY,othsellmast.adddate)) + ' ' + Convert(Varchar, Datepart(hh,othsellmast.adddate))+ ':' + Convert(Varchar, Datepart(m,othsellmast.adddate))+ ':'+ Convert(Varchar, Datepart(ss,othsellmast.adddate))) as [Date Created],othsellmast.adduser as [User Created],(Convert(Varchar, Datepart(DD,othsellmast.moddate))+ '/' + Convert(Varchar, Datepart(MM,othsellmast.moddate))+ '/'+ Convert(Varchar, Datepart(YY,othsellmast.moddate)) + ' ' + Convert(Varchar, Datepart(hh,othsellmast.moddate))+ ':'+ Convert(Varchar, Datepart(hh,othsellmast.moddate))+ ':' + Convert(Varchar, Datepart(ss,othsellmast.moddate))) as [Date Modified],othsellmast.moduser as [User Modified]  " & _
    "FROM currmast INNER JOIN othsellmast ON currmast.currcode = othsellmast.currcode WHERE dbo.othsellmast.othertype='" & Session("OthTypeFilter") & "' "


                If Trim(BuildCondition) <> "" Then
                    strSqlQry = strSqlQry & " and " & BuildCondition() & " ORDER BY othsellcode "
                Else
                    strSqlQry = strSqlQry & " ORDER BY othsellcode"
                End If
                SqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))

                myDataAdapter = New SqlDataAdapter(strSqlQry, SqlConn)
                myDataAdapter.Fill(DS, "othsellmast")
...
#Region "Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click"
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        Try
            ...
            Dim strpop As String = ""
            If Session("OthTypeFilter") = "H" Then
                'strpop = "window.open('rptReportNew.aspx?Pageame=Handling Fees Selling Type&BackPageName=Other Services Selling Types Search.aspx?TypeValue=" + Session("OthTypeFilter") + ",&SellCode=" & txtSellingCode.Text.Trim & "&SellName=" & txtSellingName.Text.Trim & "&CurrCode=" & Trim(ddlCurCode.Items(ddlCurCode.SelectedIndex).Text) & "&CurrName=" & Trim(ddlCurName.Items(ddlCurName.SelectedIndex).Text) & "','OthSellType','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                'strpop = "window.open('rptReportNew.aspx?Pageame=Handling Fees Selling Type&BackPageName=Other Services Selling Types Search.aspx?TypeValue=H &SellCode=" & txtSellingCode.Text.Trim & "&SellName=" & txtSellingName.Text.Trim & "&CurrCode=" & Trim(ddlCurCode.Items(ddlCurCode.SelectedIndex).Text) & "&CurrName=" & Trim(ddlCurName.Items(ddlCurName.SelectedIndex).Text) & "','OthSellType','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('rptReportNew.aspx?Pageame=Handling Fees Selling Type&BackPageName=Other Services Selling Types Search.aspx?TypeValue=H &SellCode=" & txtSellingCode.Text.Trim & "&SellName=" & txtSellingName.Text.Trim & "&CurrCode=" & Trim(ddlCurCode.Items(ddlCurCode.SelectedIndex).Text) & "&CurrName=" & Trim(ddlCurName.Items(ddlCurName.SelectedIndex).Text) & "','OthSellType');"
            Else
                'strpop = "window.open('rptReportNew.aspx?Pageame=Other Service Selling Type&BackPageName=Other Services Selling Types Search.aspx?TypeValue=" + Session("OthTypeFilter") + ",&SellCode=" & txtSellingCode.Text.Trim & "&SellName=" & txtSellingName.Text.Trim & "&CurrCode=" & Trim(ddlCurCode.Items(ddlCurCode.SelectedIndex).Text) & "&CurrName=" & Trim(ddlCurName.Items(ddlCurName.SelectedIndex).Text) & "','OthSellType','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('rptReportNew.aspx?Pageame=Other Service Selling Type&BackPageName=Other Services Selling Types Search.aspx?TypeValue=" + Session("OthTypeFilter") + ",&SellCode=" & txtSellingCode.Text.Trim & "&SellName=" & txtSellingName.Text.Trim & "&CurrCode=" & Trim(ddlCurCode.Items(ddlCurCode.SelectedIndex).Text) & "&CurrName=" & Trim(ddlCurName.Items(ddlCurName.SelectedIndex).Text) & "','OthSellType');"
