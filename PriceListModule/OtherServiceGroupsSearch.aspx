<%@ Page Language="VB" MasterPageFile="~/PriceListMaster.master" AutoEventWireup="false"  EnableEventValidation="false"   CodeFile="OtherServiceGroupsSearch.aspx.vb" Inherits="OtherServiceGroupsSearch" %>
            ...
            'access'
                ...
                callbacks: {
                    ...
                    facetMatches: function (callback) {
                        callback([
                { label: 'TEXT', category: 'othergrps' },
                { label: 'GROUP', category: 'othergrps' },
              ]);
                    }
                }
            });
                ...
                <table>
                    <tr>
                        <td style="width: 100%; height: 11px" align="center" class="field_heading">
                         <asp:Label runat="server" ID="Lblselltypes" Text="Other Services Group"></asp:Label></td>
                        </td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td style="width: 100%">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                   <asp:GridView id="gv_SearchResult" tabIndex=15 runat="server" Font-Size="10px" Width="100%" 
                            CssClass="grdstyle"  GridLines="Vertical" CellPadding="3" 
                            BorderWidth="1px" BorderStyle="None" AutoGenerateColumns="False" 
                            AllowSorting="True" AllowPaging="True">
<FooterStyle CssClass="grdfooter"></FooterStyle>
<Columns>
<asp:TemplateField Visible="False" HeaderText="Group Code"><EditItemTemplate>
                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("othgrpcode") %>'></asp:TextBox>
                                        
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblOtherCode" runat="server" Text='<%# Bind("othgrpcode") %>'></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
...
<asp:BoundField DataField="ratesbasedonpax" HeaderText="Pax" Visible="False"></asp:BoundField>

<asp:BoundField DataField="printgrp" SortExpression="printgrp" 
        HeaderText="Print Group" Visible="False">
<ItemStyle HorizontalAlign="Left"></ItemStyle>

<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
</asp:BoundField>
<asp:BoundField DataField="printtype" SortExpression="printtype" 
        HeaderText="Print Type" Visible="False"></asp:BoundField>
<asp:BoundField DataField="printcat" SortExpression="printcat" 
        HeaderText="Print Category" Visible="False"></asp:BoundField>
