<%@ Page Title="" Language="VB" MasterPageFile="~/PriceListMaster.master" AutoEventWireup="false" CodeFile="VisaTypesSearch.aspx.vb" Inherits="PriceListModule_VisaTypesSearch" %>
            ...
            'access'
             ...
             callbacks: {
                 ...
                 valueMatches: function (category, searchTerm, callback) {
                     ...
                     switch (category) {
                         case 'TYPENAME':
                             var asSqlqry = '';
                             glcallback = callback;
                             ColServices.clsSectorServices.GetListOfVisaTypeNameVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                             break;
                 ...
                 facetMatches: function (callback) {
                     callback([
                { label: 'TYPENAME', category: 'VISA' },
  { label: 'TEXT', category: 'VISA' },
              ]);
                 }
             }
         });
...
<table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
        ...
        <tr>
            <td align="center" class="field_heading" colspan="4" style="width: 791px; height: 7px">
                <asp:Label id="lblHeading" runat="server" Text="Car Rental Types List" ForeColor="White" __designer:wfdid="w17" Width="100%" CssClass="field_heading"></asp:Label></td>
        </tr>
        <tr>
...
<TD style="display:none"> <asp:RadioButton id="rbtnsearch" runat="server" Text="Search" ForeColor="Black" __designer:dtid="2814749767106575" CssClass="td_cell" Checked="True" OnCheckedChanged="rbtnsearch_CheckedChanged" GroupName="GrSearch" AutoPostBack="True" __designer:wfdid="w6"></asp:RadioButton>&nbsp;
<asp:RadioButton id="rbtnadsearch" runat="server" Text="Advance Search" Visible ="false"  ForeColor="Black" __designer:dtid="2814749767106576" CssClass="td_cell" OnCheckedChanged="rbtnadsearch_CheckedChanged" GroupName="GrSearch" AutoPostBack="True" __designer:wfdid="w7"></asp:RadioButton> 
...
&nbsp;<asp:Button id="btnClear" tabIndex=6 runat="server" Text="Clear" 
        Font-Bold="False" CssClass="search_button"></asp:Button>&nbsp  </TD>
     
<TD  style="display:none">
    <INPUT style="WIDTH: 163px" id="txtCode" tabIndex=1 type=text maxLength=20 runat="server" class="field_input" /><asp:Label id="Label1" runat="server" Text="Type Name" Width="100px" __designer:wfdid="w1"></asp:Label>
    <INPUT style="WIDTH: 241px" id="txtName" tabIndex=2 type=text maxLength=100 runat="server" class="field_input" />
<asp:Label id="Label3" runat="server" Text="Order By" ForeColor="Black" Width="50px" CssClass="field_caption" __designer:wfdid="w1"></asp:Label><asp:DropDownList id="ddlOrderBy" runat="server" Width="130px" CssClass="drpdown" AutoPostBack="True" __designer:wfdid="w23" OnSelectedIndexChanged="ddlOrderBy_SelectedIndexChanged"></asp:DropDownList></TD></TR>

<tr>
<TD style="display:none"><asp:Label id="lblgrpcode" runat="server" Text="Group Code" ForeColor="Black" CssClass="td_cell" __designer:wfdid="w17" Visible="False"></asp:Label>
   <SELECT onchange="GetValueFromGrpName()" style="WIDTH: 148px" id="ddlGrpCode" class="drpdown" tabIndex=5 runat="server" Visible="false"> <OPTION selected></OPTION></SELECT>
   <asp:Label id="lblgrpname" runat="server" Text="Group Name" ForeColor="Black" Width="100px" CssClass="td_cell" __designer:wfdid="w17" Visible="False"></asp:Label>
   <SELECT onchange="GetValueFromGrpCode()" style="WIDTH: 205px" id="ddlGrpName" class="drpdown" tabIndex=6 runat="server" Visible="false"> <OPTION selected></OPTION></SELECT>
  </TD></TR>
