<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HotelRemarksTemplateSearch.aspx.vb"
    Inherits="HotelRemarksTemplateSearch" MasterPageFile="~/MainPageMaster.master"
...
<link rel="stylesheet" href="../Content/lib/css/reset.css" type="text/css" media="screen" charset="utf-8">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('Description:" " TEXT:" "');
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      switch (category) {
                          ...
                          case 'Description':
                              var asSqlqry = '';
                              glcallback = callback;
                              ColServices.clsSectorServices.GetListOfHotelTempNamesVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                              break;
                      }
                  },
                  facetMatches: function (callback) {
                      callback([
                { label: 'TEXT', category: 'Remarks' },
                { label: 'Description', category: 'Remarks' },
              ]);
                  }
              }
          });
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gv_SearchResult" TabIndex="12" runat="server" Font-Size="10px"
                            ...
                            <Columns>
                                <asp:TemplateField    HeaderText="Remarks Code">
                                    <EditItemTemplate>
                                        <asp:TextBox runat="server" Text='<%# Bind("remarkscode") %>' ID="TextBox1" CssClass="field_input"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblRemarksCode" runat="server" Text='<%# Bind("remarkscode") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                               

                                                         <asp:TemplateField HeaderText="Remarks Description">
                                                             <ItemTemplate>
                                                           
                                                            
                                                             <asp:Label ID="lblRemarksDesc" runat="server" Text='<%# Bind("RemarksDesc") %>'></asp:Label>
                                ...
                                <asp:BoundField DataFormatString="{0:dd/MM/yyyy HH:mm:ss }" DataField="adddate" 
                                    HeaderText="Date Created"></asp:BoundField>
                                <asp:BoundField DataField="adduser" HeaderText="User Created">
                                </asp:BoundField>
                                <asp:BoundField DataFormatString="{0:dd/MM/yyyy HH:mm:ss }" DataField="moddate" 
