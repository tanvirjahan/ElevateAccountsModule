<%@ Page Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="OfferSearch.aspx.vb" Inherits="OfferSearch"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('Promotionid:" " PromotionName:" " Hotel:" " Approvedstatus:" " TEXT:" "');
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      ...
                      switch (category) {
                          case 'PromotionName':
                              ...
                              var asSqlqry = "select ltrim(rtrim(PromotionName)) PromotionName  from View_offers_header(nolock) where active=1 and partycode= '" + hdnparty.value + "'  order by PromotionName ";
                              glcallback = callback;
                          ...
                          case 'Promotionid':
                              ...
                              if (chkshow.checked == true) {
                                  asSqlqry = "select ltrim(rtrim(Promotionid)) Promotionid  from view_offer_search(nolock)  order by Promotionid";
                              }
                              else {
                                  asSqlqry = "select ltrim(rtrim(Promotionid)) Promotionid  from view_offer_search(nolock) where  partycode= '" + hdnparty.value + "' order by Promotionid";
                              }
                    ...
                    <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
                        ...
                        <tr>
                            <td style="text-align: center; width: 100%;" align="center" class="field_heading">
                                <asp:label id="Label1" runat="server" cssclass="field_heading" text="Offers Search">
                                </asp:label>
                            </td>
                        </tr>
                        <tr>
                          ...
                          <table class="style1">
                             <tr>
                              ...
                              <tr>
                                  ...
                                  <td>
                                  <asp:CheckBox ID="chkshowall" runat="server" AutoPostBack="true"  Text ="Show All Promotions" OnCheckedChanged ="chkshowall_CheckedChanged" />
                                  </td>
