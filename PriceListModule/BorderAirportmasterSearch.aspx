<%@ Page Title="" Language="VB" MasterPageFile="~/PriceListMaster.master" AutoEventWireup="false" CodeFile="BorderAirportmasterSearch.aspx.vb" Inherits="PriceListModule_BorderAirportmasterSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
 ...
 <script type="text/javascript" charset="utf-8">
     ...
     function visualsearchbox() {
         ...
         $txtvsprocess.val('AIRPORTBORDERNAME:" " TEXT:" "');
            ...
            'access'
             ...
             callbacks: {
                 ...
                 valueMatches: function (category, searchTerm, callback) {
                     ...
                     switch (category) {
                         case 'AIRPORTBORDERNAME':
                             ...
                             ColServices.clsSectorServices.GetListOfAirportBorderNameVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                             break;
                 ...
                 facetMatches: function (callback) {
                     callback([
                { label: 'AIRPORTBORDERNAME', category: 'AIRPORT' },
                  { label: 'TEXT', category: 'AIRPORT' },
              ]);
                 }
             }
         });
        ...
        <tr>
            <td style="width: 800px">
                <asp:UpdatePanel id="UpdatePanel2" runat="server">
                    <contenttemplate>
<TABLE style="WIDTH: 800px; HEIGHT: 16px"><TBODY>
                          <TR>

                         
                              <td  style="display:none">
                                  Border/Airport<span style="COLOR: black">&nbsp;Code</span>
                              
                      
                              
                                  <asp:TextBox ID="TxtAirportBorderCode" runat="server" __designer:wfdid="w23" 
                                      CssClass="field_input" MaxLength="20" tabIndex="1" Width="160px"></asp:TextBox>
                                                         
                                  Border/Airport<span style="COLOR: black">&nbsp;Name</span>
                           
                                                               <asp:TextBox ID="TxtAirportBorderName" runat="server" __designer:wfdid="w35" 
                                      CssClass="field_input" tabIndex="2" Width="160px"></asp:TextBox>
                              </td>
                        <tr>
                            <td align="center" class="td_cell" style="WIDTH: 56px">
                                <asp:Button ID="cmdhelp" runat="server" __designer:wfdid="w18" 
                                    CssClass="search_button" Font-Bold="False" onclick="cmdhelp_Click" tabIndex="8" 
                                    Text="Help" />
                                <asp:Button ID="btnAddNew" runat="server" __designer:dtid="8725724278030351" 
                                    __designer:wfdid="w7" CssClass="btn" Font-Bold="False" tabIndex="5" 
                                    Text="Add New" />
                                <asp:Button ID="btnPrint" runat="server" __designer:dtid="8725724278030353" 
                                    __designer:wfdid="w8" CssClass="btn" tabIndex="7" Text="Report" />
                            </td>
...
<asp:TemplateField Visible="False" HeaderText="Flight Class Code"><EditItemTemplate>
                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("airportbordercode") %>'></asp:TextBox>
                                        
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblairportbordercode" runat="server" Text='<%# Bind("airportbordercode") %>' __designer:wfdid="w45"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField="airportbordercode" SortExpression="airportbordercode" HeaderText="Airport Border Code">
<ItemStyle HorizontalAlign="Left"></ItemStyle>

<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
</asp:BoundField>
<asp:BoundField DataField="airportbordername" SortExpression="airportbordername" HeaderText="Airport Border Name">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
