<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SupplierTypeSearch.aspx.vb" Inherits="SupplierTypeSearch" MasterPageFile="~/MainPageMaster.master" Strict="true" enableEventValidation ="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('TYPENAME:" " TEXT:" "');
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      switch (category) {
                          case 'TYPENAME':
                              var asSqlqry = '';
                              glcallback = callback;
                              ColServices.clsSectorServices.GetListOfSupplierVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                              break;
                      }
                  },
                  facetMatches: function (callback) {
                      callback([
                { label: 'TEXT', category: 'Supplier Type' },
                { label: 'TYPENAME', category: 'Supplier Type' },
              ]);
                  }
              }
          });
    ...
    <script type="text/javascript">
        ...
        <tr>
            <td style="width: 100%; height: 21px">
                <table>
                    <tr>
                        <td style="height: 17px;" align="center" class="field_heading">
                            Supplier Type List</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width: 100%">
                            ...
                            <asp:UpdatePanel id="UpdatePanel1" runat="server">
                                <contenttemplate>
<TABLE style="WIDTH: 811px"><TBODY><TR>
...
<TD style="WIDTH: 99px; HEIGHT: 17px" class="td_cell"><SPAN style="COLOR: black">SupplierType&nbsp;Code</SPAN></TD><TD style="WIDTH: 46px; HEIGHT: 17px"><asp:TextBox id="txtSupplierTypeCode" tabIndex=1 runat="server" CssClass="txtbox" MaxLength="20" __designer:wfdid="w156"></asp:TextBox></TD>
<TD style="WIDTH: 124px; HEIGHT: 17px" class="td_cell"><SPAN style="COLOR: black">SupplierType&nbsp;Name</SPAN>
</TD>
<TD style="WIDTH: 36px; HEIGHT: 17px" class="td_cell"><asp:TextBox id="txtSupplierTypeName" tabIndex=2 runat="server" Width="300px" CssClass="txtbox" MaxLength="100" __designer:wfdid="w157"></asp:TextBox></TD><TD style="WIDTH: 42px; HEIGHT: 17px" class="td_cell">
    <asp:Button id="btnSearch" tabIndex=3 onclick="btnSearch_Click" runat="server" 
        Text="Search" Font-Bold="False" CssClass="search_button" 
        __designer:wfdid="w158"></asp:Button></TD><TD style="WIDTH: 42px; HEIGHT: 17px" class="td_cell">
        <asp:Button id="btnClear" tabIndex=4 onclick="btnClear_Click" runat="server" 
            Text="Clear" Font-Bold="False" CssClass="search_button" __designer:wfdid="w159"></asp:Button></TD><TD style="WIDTH: 42px; HEIGHT: 17px" class="td_cell">
        <asp:Button id="btnhelp1" tabIndex=8 onclick="btnhelp_Click" runat="server" 
            Text="Help" Font-Bold="False" CssClass="search_button" __designer:wfdid="w11"></asp:Button></TD><TD style="WIDTH: 42px; HEIGHT: 17px" class="td_cell">
        <asp:Button id="btnAddNew1" tabIndex=5 onclick="btnAddNew_Click" runat="server" 
            Text="Add New" Font-Bold="False" __designer:dtid="2251799813685263" 
            CssClass="btn" __designer:wfdid="w1"></asp:Button></TD><TD style="WIDTH: 42px; HEIGHT: 17px" class="td_cell"><asp:Button id="btnPrint1" tabIndex=7 runat="server" Text="Report" __designer:dtid="2251799813685265" CssClass="btn" __designer:wfdid="w2"></asp:Button></TD>
            <TD style="WIDTH: 99px; HEIGHT: 17px" class="td_cell"><asp:Label id="Label3" runat="server" Text="Order By" Width="62px" CssClass="field_caption" __designer:wfdid="w1"></asp:Label></TD><TD style="WIDTH: 46px; HEIGHT: 17px"><asp:DropDownList id="ddlOrderBy" runat="server" Width="130px" CssClass="drpdown" __designer:wfdid="w11" AutoPostBack="True" OnSelectedIndexChanged="ddlOrderBy_SelectedIndexChanged"></asp:DropDownList></TD><TD style="WIDTH: 124px; HEIGHT: 17px" class="td_cell"></TD><TD style="WIDTH: 36px; HEIGHT: 17px" class="td_cell"></TD>
            <TD style="WIDTH: 42px; HEIGHT: 17px" class="td_cell"></TD><TD style="WIDTH: 42px; HEIGHT: 17px" class="td_cell">
        ...
        <td colspan="6">
            <table class="style1">
                    ...
                    <td>
                        ...
                        &nbsp;<asp:Button ID="btnClearDate" runat="server" CssClass="btn" Font-Bold="False" 
                            tabIndex="4" Text="Reset Dates" />
                               ...
                               <td>  <asp:Label ID="RowSelectsts" runat="server" CssClass="field_caption" 
                            Text="Rows Selected "></asp:Label>
                     <asp:DropDownList ID="RowsPerPageSTS" runat="server" AutoPostBack="true">
                ...
                <asp:UpdatePanel id="UpdatePanel2" runat="server">
                    <contenttemplate>
<asp:GridView id="gv_SearchResult" tabIndex=8 runat="server" Font-Size="10px" Width="100%" CssClass="grdstyle" __designer:wfdid="w162" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
<FooterStyle CssClass="grdfooter"></FooterStyle>
<Columns>
<asp:TemplateField Visible="False" HeaderText="S.Prov Type Code"><EditItemTemplate>
<asp:TextBox id="TextBox1" runat="server" Text='<%# Bind("sptypecode") %>' __designer:wfdid="w13"></asp:TextBox>
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblCode" runat="server" Text='<%# Bind("sptypecode") %>' __designer:wfdid="w12"></asp:Label>
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField  DataField="sptypecode" SortExpression="sptypecode" HeaderText="Supplier Type Code"></asp:BoundField>

<asp:TemplateField HeaderText="Supplier Type Name" SortExpression="sptypename">
                    <ItemTemplate>
                        <asp:Label ID="lblTypeName" runat="server" Text='<%# Bind("sptypename") %>'></asp:Label>
                    </ItemTemplate>
                    <ControlStyle Width="8%" />
                    <HeaderStyle HorizontalAlign="Left" Width="8%" />
                    <ItemStyle CssClass="sptypename" HorizontalAlign="Left" Width="8%" />
                </asp:TemplateField>
...
<AlternatingRowStyle CssClass="grdAternaterow"></AlternatingRowStyle>
                            ...
                            Font-Names="Verdana" Font-Bold="True" __designer:dtid="8444249301319702" 
                            Width="357px" __designer:wfdid="w164" Visible="False" CssClass="lblmsg"></asp:Label> 
