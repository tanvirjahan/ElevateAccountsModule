<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="HandlingFeesPricelistSellingRates1.aspx.vb" Inherits="PriceListModule_HandlingFeesPricelistSellingRates1" %>
 ...
 <table style="width: 936px">
                    <tr>
                        <td class="field_heading" colspan="5" style="text-align: center" align="center">
                            <asp:Label ID="lblheading" runat="server" CssClass="field_heading" Text="Price List - Selling Rates"
