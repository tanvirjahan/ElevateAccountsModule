<%@ Page Language="VB" MasterPageFile="~/PriceListMaster.master" AutoEventWireup="false" CodeFile="MealPlansSearch.aspx.vb" Inherits="MealPlansSearch" EnableEventValidation="false" %>
...
<link rel="stylesheet" href="../Content/lib/css/reset.css" type="text/css" media="screen" charset="utf-8">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('MEALPLANNAME:" " TEXT:" "');
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      switch (category) {
                          case 'MEALPLANNAME':
                              var asSqlqry = '';
                              glcallback = callback;
                              ColServices.clsSectorServices.GetListOfMealVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                              break;
                      }
                  },
                  facetMatches: function (callback) {
                      callback([
                { label: 'TEXT', category: 'MEAL PLAN' },
                { label: 'MEALPLANNAME', category: 'MEAL PLAN' },
              ]);
                  }
              }
          });
...
<TD style="HEIGHT: 13px; TEXT-ALIGN: center" class="td_cell" colSpan=4>
 ...
 <asp:Button id="btnSearch" tabIndex=5 runat="server" Text="Search" 
        Font-Bold="False" Width="50px" CssClass="search_button"></asp:Button>
 &nbsp; <asp:Button id="btnClear" tabIndex=6 runat="server" Text="Clear" Font-Bold="False" Width="39px" CssClass="search_button"></asp:Button>&nbsp;
<asp:Button id="btnHelp1" tabIndex=10 onclick="btnHelp_Click" runat="server" Text="Help" __designer:dtid="1688858450198528" CssClass="search_button" __designer:wfdid="w34"></asp:Button>&nbsp;
 <asp:Button id="btnAddNew1" tabIndex=7 runat="server" Text="Add New" 
        Font-Bold="False" __designer:dtid="5348024557502480" Width="68px" 
        CssClass="btn" __designer:wfdid="w5"></asp:Button>&nbsp;
  <asp:Button id="btnPrinCt" tabIndex=9 runat="server" Text="Report" __designer:dtid="5348024557502482" CssClass="btn" __designer:wfdid="w6"></asp:Button></TD>
  <TD style="WIDTH: 322px; HEIGHT: 13px; TEXT-ALIGN: center" class="td_cell" colSpan=1></TD>
  <TD style="WIDTH: 322px; HEIGHT: 13px; TEXT-ALIGN: center" class="td_cell" colSpan=1></TD>
  </tr> <TR style="display:none"><TD style="WIDTH: 55px; HEIGHT: 4px" class="td_cell"><SPAN style="COLOR: black">Meal&nbsp;Code</SPAN></TD><TD style="WIDTH: 46px; HEIGHT: 4px"><asp:TextBox id="txtmealcode" tabIndex=1 runat="server" Width="178px" CssClass="txtbox" __designer:wfdid="w147" MaxLength="20"></asp:TextBox></TD>
  <TD style="WIDTH: 58px; HEIGHT: 4px" class="td_cell"><SPAN style="COLOR: black">&nbsp;Meal&nbsp;Name</SPAN></TD><TD style="WIDTH: 40px; HEIGHT: 4px" class="td_cell">
  ...
  <asp:TextBox id="txtmealname" tabIndex=2 runat="server" Width="348px" 
         CssClass="field_input" __designer:wfdid="w148" MaxLength="100" 
         AutoPostBack="True"></asp:TextBox>
  </TD><TD style="WIDTH: 42px; HEIGHT: 4px" class="td_cell"><asp:Label id="Label3" runat="server" Text="Order By" Width="50px" CssClass="field_caption" __designer:wfdid="w1"></asp:Label></TD><TD style="WIDTH: 42px; HEIGHT: 4px" class="td_cell"><asp:DropDownList id="ddlOrderBy" runat="server" Width="130px" CssClass="drpdown" AutoPostBack="True" __designer:wfdid="w19" OnSelectedIndexChanged="ddlOrderBy_SelectedIndexChanged"></asp:DropDownList></TD>
  </TR>
  <TR style="display:none">
  <TD style="WIDTH: 55px; HEIGHT: 4px;display:none" class="td_cell">
  <asp:Label id="lblSupTypeCode" runat="server" Text="Supplier Type Code" Height="19px" Width="110px" CssClass="field_caption" __designer:wfdid="w1" Visible="False"></asp:Label></TD>
  <TD style="WIDTH: 46px; HEIGHT: 4px;display:none">
  <SELECT onchange="GetValueFrom()" style="WIDTH: 185px;display:none" id="ddlSSPTypeCode" class="drpdown" tabIndex=3 runat="server" Visible="false"> 
  <OPTION selected></OPTION></SELECT>
  </TD>
  <TD style="WIDTH: 58px; HEIGHT: 4px;display:none" class="td_cell">
  <asp:Label id="lblSupTypeName" runat="server" Text="Supplier Type Name" Height="19px" Width="110px" CssClass="field_caption" __designer:wfdid="w2" Visible="False"></asp:Label></TD><TD style="WIDTH: 40px; HEIGHT: 4px" class="td_cell"><SELECT onchange="GetValueCode()" style="WIDTH: 354px;display:none" id="ddlSSPTypeName" class="drpdown" tabIndex=4 runat="server" Visible="false"> <OPTION selected></OPTION></SELECT></TD><TD style="WIDTH: 42px; HEIGHT: 4px" class="td_cell"></TD><TD style="WIDTH: 42px; HEIGHT: 4px" class="td_cell"></TD>
  </TR></TBODY></TABLE>
</ContentTemplate>
                            </asp:UpdatePanel></td>
                    </tr>
    ...
    <tr>
        <td colspan="6">
            <table class="style1">
                    ...
                    <td>
                        ...
                        &nbsp;<asp:Button ID="btnClearDate" runat="server" CssClass="btn" Font-Bold="False" 
                            tabIndex="4" Text="Reset Dates" />
                               ...
                               <td>  <asp:Label ID="RowSelectsmps" runat="server" CssClass="field_caption" 
                ...
                <contenttemplate>
<asp:GridView id="gv_SearchResult" tabIndex=8 runat="server" Font-Size="10px" Width="100%" CssClass="td_cell" __designer:wfdid="w153" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
<FooterStyle CssClass="grdfooter"></FooterStyle>
<Columns>
<asp:TemplateField Visible="False" HeaderText="mealplancode"><EditItemTemplate>
<asp:TextBox runat="server" Text='<%# Bind("mealcode") %>' id="TextBox1"></asp:TextBox>
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblCode" runat="server" Text='<%# Bind("mealcode") %>'></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField="mealcode" SortExpression="mealcode" HeaderText="Meal Plan Code"></asp:BoundField>

<asp:TemplateField HeaderText="Meal Plan Name" SortExpression="mealname">
                    <ItemTemplate>
                        <asp:Label ID="lblMealName" runat="server" Text='<%# Bind("mealname") %>'></asp:Label>
                    </ItemTemplate>
                    <ControlStyle Width="8%" />
                    <HeaderStyle HorizontalAlign="Left" Width="8%" />
                    <ItemStyle CssClass="mealname" HorizontalAlign="Left" Width="8%" />
                </asp:TemplateField>

<%--<asp:BoundField DataField="sptypecode" SortExpression="sptypecode" HeaderText="Supplier Type "></asp:BoundField>
...
<asp:BoundField DataField="rankorder" HeaderText="Rank Order" />
...
</asp:GridView> <asp:Label id="lblMsg" runat="server" Text="Records not found. Please redefine search criteria" Font-Size="8pt" Font-Names="Verdana" ForeColor="#084573" Font-Bold="True" Width="357px" __designer:wfdid="w154" Visible="False"></asp:Label> 
</contenttemplate>
