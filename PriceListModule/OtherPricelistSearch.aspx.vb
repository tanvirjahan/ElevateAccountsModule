...
Partial Class OtherPricelistSearch
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            Try
                ...
                hdDefault_Group.Value = objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select option_selected from reservation_parameters where param_id='1026'")
                ...
                Else
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                             CType(strappname, String), "PriceListModule\OtherPriceListSearch.aspx?appid=" + strappid + "&Type=" + Session("OthPListFilter"), btnAddNew, btnExportToExcel, _
                ...
                ViewState("strMAsortExpression") = "h.oplistcode"
                Session.Add("strMAsortExpression", "h.oplistcode")
                Session.Add("strMAsortdirection", SortDirection.Ascending)
                '  charcters(TxtPLCD)
    ...
    Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        Try
            ...
            strSqlQry = "select  h.oplistcode,  h.othgrpcode,o.othgrpname,h.currcode,h.applicableto,  min(d.frmdate) frmdate ,max(d.todate)todate ,h.adddate,h.adduser,h.moddate,h.moduser,  " _
                ...
                & " where h.othgrpcode not in (select othgrpcode from view_system_othgrp)  group by  h.oplistcode,  h.othgrpcode,o.othgrpname,h.currcode,h.applicableto ,h.approve,h.adddate,h.adduser,h.moddate,h.moduser "
            ...
            If pliststr <> "" Then
                strSqlQry = strSqlQry & " WHERE oplistcode='" & pliststr & "'"
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        strpop = "window.open('Otherpricelist1.aspx?State=New&Group=" + CType(hdDefault_Group.Value, String) + "','Othpricelist1');"
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            If e.CommandName = "Editrow" Then
                ...
                strpop = "window.open('Otherpricelist1.aspx?State=Edit&Group=" + CType(hdDefault_Group.Value, String) + "&RefCode=" + CType(lblId.Text.Trim, String) + "','Othpricelist1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ElseIf e.CommandName = "View" Then
                ...
                strpop = "window.open('Otherpricelist1.aspx?State=View&Group=" + CType(hdDefault_Group.Value, String) + "&RefCode=" + CType(lblId.Text.Trim, String) + "','Othpricelist1');"
            ...
            ElseIf e.CommandName = "Deleterow" Then
                ...
                strpop = "window.open('Otherpricelist1.aspx?State=Delete&Group=" + CType(hdDefault_Group.Value, String) + "&RefCode=" + CType(lblId.Text.Trim, String) + "','Othpricelist1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ...
            ElseIf e.CommandName = "Copy" Then
                ...
                strpop = "window.open('Otherpricelist1.aspx?State=Copy&Group=" + CType(hdDefault_Group.Value, String) + "&RefCode=" + CType(lblId.Text.Trim, String) + "','Othpricelist1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If
        Catch ex As Exception
            ' ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
...
#Region " Protected Sub gv_SearchResult_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gv_SearchResult.Sorting"
    ...
    Protected Sub gv_SearchResult_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gv_SearchResult.Sorting
        ...
        Session.Add("strMAsortExpression", e.SortExpression)
...
#Region "Public Sub SortGridColoumn_click()"
    Public Sub SortGridColoumn_click()
        ...
        Dim myDS As New DataSet
        FillGrid(ViewState("strMAsortExpression"), "")

        myDS = gv_SearchResult.DataSource
        DataTable = myDS.Tables(0)
        If IsDBNull(DataTable) = False Then
            Dim dataView As DataView = DataTable.DefaultView
            Session.Add("strMAsortdirection", objUtils.SwapSortDirection(Session("strMAsortdirection")))
            dataView.Sort = ViewState("strMAsortExpression") & " " & objUtils.ConvertSortDirectionToSql(Session("strMAsortdirection"))
...
#End Region
        ...
        For i = 0 To lsMainArr.GetUpperBound(0)
            Select Case lsMainArr(i).Split(":")(0).ToString.ToUpper.Trim
                ...
                Case "AIRPORT"
                    ...
                    sbAddToDataTable("AIRPORT", lsProcesssupplier, "AIRPORT")
                Case "SECTOR"
    ...
    Private Sub FillGridNew()
        ...
        Try
            ...
            End If
            strSqlQry = ""
            Dim strorderby As String = ViewState("strMAsortExpression") 'Session("strMAsortExpression")
            ...
            '    & " trfplist_header h2 cross apply dbo.splitallotmkt(h2.sectorcode,',') ah2 left join othtypmast u2 on ah2.mktcode= u2.othtypcode    where h2.tplistcode=h.tplistcode for xml path('')),1,1,'')),h.currcode,isnull(h.applicableto,'') applicableto,status=	case when isnull(approved,0)=1 then 'Yes' else 'No' End, " _
            '& " h.frmdate,h.todate,h.adddate,h.adduser,h.moddate,h.moduser from trfplist_header h cross apply dbo.splitallotmkt(h.airportcode,',') ah left join airportbordersmaster  a on ah.mktcode= a.airportbordercode cross apply dbo.splitallotmkt(h.sectorcode,',') s   " _
            '& " left join othtypmast t on  t.othtypcode=s.mktcode where h.othgrpcode='" & hdDefault_Group.Value & "'  "



            strSqlQry = "select  h.oplistcode,  h.othgrpcode,o.othgrpname,h.currcode,h.applicableto,  min(d.frmdate) frmdate ,max(d.todate)todate ,h.adddate,h.adduser,h.moddate,h.moduser,  " _
                & " status=	case when isnull(h.approve,0)=1 then 'Yes' else 'No' End from othplisth h inner join othgrpmast o on h.othgrpcode=o.othgrpcode  inner join othplisth_dates d  on h.oplistcode= d.oplistcode " _
                & " where h.othgrpcode not in (select othgrpcode from view_system_othgrp)  "



            If strBindCondition <> "" Then
                strSqlQry = strSqlQry & "  and " & strBindCondition & "  group by  h.oplistcode,  h.othgrpcode,o.othgrpname,h.currcode,h.applicableto ,h.approve,h.adddate,h.adduser,h.moddate,h.moduser ORDER BY " & strorderby & " " & strsortorder
            Else
                strSqlQry = strSqlQry & " group by  h.oplistcode,  h.othgrpcode,o.othgrpname,h.currcode,h.applicableto ,h.approve,h.adddate,h.adduser,h.moddate,h.moduser ORDER BY " & strorderby & " " & strsortorder
            End If
    ...
    Private Function BuildConditionNew(ByVal strCountryValue As String, ByVal strCityValue As String, ByVal strSectorValue As String, ByVal strSectorGroupValue As String, ByVal strTextValue As String, ByVal strSuppvalue As String) As String
        ...
        If strSectorValue.Trim <> "" Then
            If Trim(strWhereCond) = "" Then
                ...
                strWhereCond = " upper(airportbordername) IN (" & Trim(strSectorValue.Trim.ToUpper) & ")"
            Else
                strWhereCond = strWhereCond & " AND upper(airportbordername) IN (" & Trim(strSectorValue.Trim.ToUpper) & ")"
            End If
        End If
        ...
        If strCountryValue <> "" Then
            If Trim(strWhereCond) = "" Then
                strWhereCond = " upper(airportbordername) IN (" & Trim(strCountryValue.Trim.ToUpper) & ")"
            Else
                strWhereCond = strWhereCond & " AND  upper(airportbordername) IN (" & Trim(strCountryValue.Trim.ToUpper) & ")"
            End If
        End If
        ...
        If strCityValue <> "" Then
            If Trim(strWhereCond) = "" Then
                strWhereCond = " upper(h.oplistcode) IN ( " & Trim(strCityValue.Trim.ToUpper) & ")"
            Else
                strWhereCond = strWhereCond & " AND upper(h.oplistcode) IN (" & Trim(strCityValue.Trim.ToUpper) & ")"
            End If
        End If
            ...
            For i = 0 To lsMainArr.GetUpperBound(0)
                ...
                If strValue <> "" Then
                    If Trim(strWhereCond1) = "" Then
                        strWhereCond1 = " (upper(h.oplistcode) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(othgrpname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(approve) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    Else
                        strWhereCond1 = strWhereCond1 & " OR  (upper(h.oplistcode) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(othgrpname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(approve) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    End If
                End If
            Next
            If Trim(strWhereCond) = "" Then
