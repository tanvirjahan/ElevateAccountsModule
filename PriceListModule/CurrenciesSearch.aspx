<%@ Page Language="VB" AutoEventWireup="false"  CodeFile="CurrenciesSearch.aspx.vb" Inherits="CurrenciesSearch"  MasterPageFile="~/MainPageMaster.master" Strict="true" EnableEventValidation="false"   %>
...
<link rel="stylesheet" href="../Content/lib/css/reset.css" type="text/css" media="screen" charset="utf-8">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('Currency:" " TEXT:" "');
...
<TD style="WIDTH: 37px" class="td_cell"><SPAN style="COLOR: black">Currency&nbsp;Code</SPAN></TD>
<TD style="WIDTH: 46px">
<asp:TextBox id="txtCurrenciesCode" tabIndex=1 runat="server" CssClass="field_input" MaxLength="20"></asp:TextBox></TD>
<TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell"><SPAN style="COLOR: black">Currency&nbsp;Name</SPAN></TD>
<TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell">
<asp:TextBox id="txtCurrenciesName" tabIndex=2 runat="server" Width="300px" CssClass="field_input" MaxLength="100"></asp:TextBox></TD>
<TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell">
<asp:Button id="btnSearch" tabIndex=3 runat="server" Text="Search" 
Font-Bold="False" CssClass="search_button"></asp:Button></TD><TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell">
        <asp:Button id="btnClear" tabIndex=4 runat="server" Text="Clear" 
            Font-Bold="False" CssClass="search_button"></asp:Button></TD>
            <TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell"><asp:Button id="btnHelp1" tabIndex=8 runat="server" Text="Help" CssClass="search_button"></asp:Button></TD>
    <td class="td_cell" style="width: 42px; height: 10px"><asp:Button ID="btnAddNew1" runat="server" CssClass="btn" Font-Bold="False" Text="Add New" TabIndex="5" 
                                style="position: relative; top: 0px; left: 0px;" /></td>
    <td class="td_cell" style="width: 42px; height: 10px">
                                        <asp:Button ID="btnPrint1" runat="server" CssClass="btn" Text="Report" 
                                            TabIndex="7" style="position: relative; top: 0px; left: 0px;" /></td>
</TR>
<TR style="display:none">
...
<TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell"></TD>
<TD style="WIDTH: 42px; HEIGHT: 10px" class="td_cell"></TD>
<td class="td_cell" style="width: 42px; height: 10px"></td>
<td class="td_cell" style="width: 42px; height: 10px"></td>
 </TR>
</TBODY>
</TABLE> &nbsp;
...
<asp:TemplateField Visible="False" HeaderText="Currency Code"><EditItemTemplate>
                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("currcode") %>'></asp:TextBox>
                                        
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblCode" runat="server" Text='<%# Bind("currcode") %>'></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField="currcode" SortExpression="currcode" HeaderText="Currency Code">
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
 ...
 <asp:TemplateField HeaderText="Currency Name" SortExpression="currname">
                    ...
                    <ItemStyle CssClass="currname" HorizontalAlign="Left" Width="8%" />
                </asp:TemplateField>
...
<asp:BoundField DataField="currcoin" SortExpression="currcoin" HeaderText="Currency Coin">
<ItemStyle HorizontalAlign="Left"></ItemStyle>

<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
</asp:BoundField>
<asp:BoundField HtmlEncode="False" DataFormatString="{0:N6}" DataField="convrate" SortExpression="convrate" HeaderText="Exch.Rate">
