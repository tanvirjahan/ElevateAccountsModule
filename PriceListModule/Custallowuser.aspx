<%@ Page Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="Custallowuser.aspx.vb" Inherits="Custallowuser" %>
...
function Validateamendments() {
    ...
    var ddlamendment = document.getElementById("<%=ddluserCode.ClientID%>");

    if (ddlamendment.value == '[Select]') {
        ...
        <table style="width: 507%">
            <tr>
                <td style="width: 133px"><strong>
                    <asp:Label ID="Label1" runat="server" Text="Authorize User"></asp:Label></strong>
                </td>
                <td>
                    <span style="COLOR: #ff0000">
                    <select ID="ddluserCode" runat="server" class="field_input" name="D1" 
                        ...
                        <Columns>
                          <asp:BoundField DataField="Sno" HeaderText="Sno" 
                            ...
                            <asp:BoundField DataField="usercode" HeaderText="usercode" 
                                SortExpression="allowuser">
                                <ItemStyle Width="2000px" Wrap="True" />
                                <HeaderStyle Width="2000px" Wrap="True" />
                            </asp:BoundField>
                            <asp:BoundField DataField="adate" DataFormatString="{00:dd/MM/yyyy}" 
                                HeaderText="Allowed Date" HtmlEncode="False" SortExpression="adate">
                                <ItemStyle Width="500px" />
                                <HeaderStyle Width="500px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="requestid" HeaderText="Booking" 
