<%@ Page Title="" Language="VB" MasterPageFile="~/MainPageMaster.master" AutoEventWireup="false" EnableEventValidation="false"
    CodeFile="MealMarkupSearch.aspx.vb" Inherits="MealMarkupSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function visualsearchbox() {
            ...
            $txtvsprocess.val('"Markup Formula Name":" "'+ '"Formula Type":" " TEXT:" "');
                    ...
                    valueMatches: function (category, searchTerm, callback) {
                        switch (category) {
                            case 'Markup Formula Name':
                                var asSqlqry = '';
                                glcallback = callback;
                                ColServices.clsVisualSearchService.GetListOfMealMarkupFormulaVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                break;
                            case 'Formula Type':
                                var asSqlqry = '';
                                glcallback = callback;
                                
                                ColServices.clsVisualSearchService.GetListOfFormulaTypeVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                break;
                        }
                    },
                    facetMatches: function (callback) {
                        callback([
                { label: 'TEXT', category: 'Markup Formula' },
                { label: 'Markup Formula Name', category: 'Markup Formula' },
                 { label: 'Formula Type', category: 'Markup Formula' },
              ]);
                    }
                }
            });
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gv_SearchResult" TabIndex="9" runat="server" Font-Size="10px" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Markup Formula" SortExpression="MarkupFormula">
                                    <ItemTemplate>
                                        <asp:Label ID="lblFormula" runat="server" Text='<%# Bind("MarkupFormulaString") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ControlStyle />
                                    <HeaderStyle HorizontalAlign="Center"  />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:TemplateField>      
                                    <asp:TemplateField HeaderText="Formula Type" SortExpression="FormulaType">
                                    <ItemTemplate>
                                        <asp:Label ID="lblFormulaType" runat="server" Text='<%# Bind("FormulaType") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ControlStyle />
                                    <HeaderStyle HorizontalAlign="Center"  />
                                    <ItemStyle HorizontalAlign="Left" />
                                ...
                                <ItemStyle ForeColor="Blue"></ItemStyle>
                                 ...
                                 <asp:ButtonField HeaderText="Action" Text="Print" visible="false" CommandName="PrintRow">
                                <ItemStyle ForeColor="Blue"></ItemStyle>
                                </asp:ButtonField>
