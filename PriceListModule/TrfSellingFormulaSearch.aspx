<%@ Page Title="" Language="VB" MasterPageFile="~/PriceListMaster.master" AutoEventWireup="false" CodeFile="TrfSellingFormulaSearch.aspx.vb" Inherits="PriceListModule_TrfSellingFormulaSearch" %>
...
<table  style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid; border-bottom: gray 2px solid; width: 898px;">
  <tr><td align="center" class="field_heading">
          Transfer Selling Formulas List</td></tr>
...
<tr><td class="td_cell" align=center colSpan=6>
    ...
    <TD class="td_cell" colSpan=1><SELECT onblur="GetValueFromName()" style="WIDTH: 148px" id="ddlCurrencyCode" class="drpdown" tabIndex=3 runat="server" Visible="false"> <OPTION selected></OPTION></SELECT></TD>
    ...
    <TD class="td_cell" colSpan=1><SELECT onblur="GetValueFromCode()" style="WIDTH: 205px" id="ddlCurrencyName" class="drpdown" tabIndex=4 runat="server" Visible="false"> <OPTION selected></OPTION></SELECT></TD>
    <TD class="td_cell" colSpan=1></TD><TD class="td_cell" colSpan=1></TD></TR></TBODY></TABLE>
</contenttemplate>
    </asp:UpdatePanel>
            </td>
        </tr>
