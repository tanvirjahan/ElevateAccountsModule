...
Partial Class HotelChainMaster
        ...
        If Page.IsPostBack = False Then
            Try
                ...
                If hdOPMode.Value = "N" Then
                    lblHeading.Text = "Add Hotel Chain"
                ...
                ElseIf hdOPMode.Value = "E" Then
                    SetFocus(txtName)
                    lblHeading.Text = "Edit Hotel Chain"
                    Page.Title = Page.Title + " " + "Edit Hotel Chain"
                    btnSave.Text = "Update"
                ...
                ElseIf hdOPMode.Value = "D" Then
                    SetFocus(btnSave)
                    lblHeading.Text = "Delete Hotel Chain"
                    Page.Title = Page.Title + " " + "Delete Hotel Chain"
                    btnSave.Text = "Delete"
                ...
                ElseIf hdOPMode.Value = "S" Then
                    lblHeading.Text = "Hotel Chain"
                    Page.Title = Page.Title + " " + "Hotel Chain"
                    ' btnSave.Text = "Delete"
                End If
                ...
                Else
                    ...
                    objUser.CheckNewFormatUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                                      CType(strappname, String), "PriceListModule\HotelChainMaster.aspx?appid=" + strappid, btnNew, btnEdit, _
        ...
        Try
            ...
            If Page.IsValid = True Then
                ...
                If dtsHotelGroupDetails.Rows.Count > 0 Then
                    ...
                    strBuffer.Append("<HotelChains>")
                    For i = 0 To dtsHotelGroupDetails.Rows.Count - 1
                        strBuffer.Append("<HotelChain>")
                        strBuffer.Append(" <HotelChainCode>" & txtGroupCode.Text.Trim & "</HotelChainCode>")
                ...
                If hdOPMode.Value = "N" Or hdOPMode.Value = "E" Then
                    ...
                    If txtGroupTagName.Text = "" Then
                        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Please enter  chain name.');", True)
                        Exit Sub
                    End If
                    ...
                    If hdOPMode.Value = "N" Then
                        mySqlCmd = New SqlCommand("sp_add_hotelchain", mySqlConn, sqlTrans)

                        lastno = objUtils.ExecuteQueryReturnSingleValuenew(CType(Session("dbconnectionName"), String), "select lastno from docgen where optionname='HOTELCHAIN'")
                        optionval = objUtils.GetAutoDocNo("HOTELCHAIN", mySqlConn, sqlTrans)
                        txtGroupCode.Text = optionval.Trim

                    ElseIf hdOPMode.Value = "E" Then
                        mySqlCmd = New SqlCommand("sp_mod_hotelchain", mySqlConn, sqlTrans)
                    ...
                    mySqlCmd.Parameters.Add(New SqlParameter("@hotelchaincode", SqlDbType.VarChar, 20)).Value = CType(txtGroupCode.Text.Trim, String)
                    mySqlCmd.Parameters.Add(New SqlParameter("@hotelchainname", SqlDbType.VarChar, 100)).Value = CType((((Trim(txtGroupTagName.Text.Trim).Replace("(C)", "")).Replace("(R)", "")).Replace("(G)", "")).Replace("(T)", "").Replace("(HC)", ""), String)
                ...
                ElseIf hdOPMode.Value = "D" Then
                    ...
                    If txtGroupTagName.Text = "" Then
                        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Please select chain name.');", True)
                    ...
                    mySqlCmd = New SqlCommand("sp_del_hotelchaincode", mySqlConn, sqlTrans)
                    mySqlCmd.CommandType = CommandType.StoredProcedure
                    mySqlCmd.Parameters.Add(New SqlParameter("@hotelchaincode", SqlDbType.VarChar, 20)).Value = CType(txtGroupCode.Text.Trim, String)
                    mySqlCmd.Parameters.Add(New SqlParameter("@ValidXMLInput", SqlDbType.Xml)).Value = strBuffer.ToString
                    mySqlCmd.Parameters.Add(New SqlParameter("@userlogged", SqlDbType.VarChar, 10)).Value = CType(Session("GlobalUserName"), String)
                ...
                If hdOPMode.Value = "N" Then
                    ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Hotel Chain Created Successfully..');", True)
                ElseIf hdOPMode.Value = "E" Then
                    ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Hotel Chain Modified Successfully..');", True)
                ElseIf hdOPMode.Value = "D" Then
                    ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Hotel Chain  Deleted Successfully..');", True)
                End If
                ClearFields()
                hdOPMode.Value = "S"
...
#End Region
    ...
    '                Dim hotelchaincode As String


    '                Dim strmessage As String
    '                hotelchaincode = objUtils.GetDBFieldFromStringnew(Session("dbconnectionName"), "partymast", "hotelchaincode", "partycode", LblPartycode.Text)

    '                If hdOPMode.Value = "N" Then
    '                    If hotelchaincode <> "" Then

    '                        strmessage = " " + LblPartyname.Text + " is already assigned to another hotel chain "
    ...
    '                '        If hotelchaincode <> "" And hotelchaincode <> txtGroupCode.Text Then
...
#Region "Public Function checkForDuplicate() As Boolean"
    Public Function checkForDuplicate() As Boolean
        ...
        If hdOPMode.Value = "N" Then
            ...
            '    Exit Function
            'End If
            If objUtils.isDuplicatenew(Session("dbconnectionName"), "hotelchainmaster", "hotelchainname", ((Trim(txtGroupTagName.Text.Trim).Replace("(G)", "")).Replace("(R)", "")).Replace("(HC)", "")) Then
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('This Chain name is already present.');", True)
                checkForDuplicate = False
                Exit Function
            End If
        ElseIf hdOPMode.Value = "E" Then
            If objUtils.isDuplicateForModifynew(Session("dbconnectionName"), "hotelchainmaster", "hotelchaincode", "hotelchainname", CType(((Trim(txtGroupTagName.Text.Trim).Replace("(G)", "")).Replace("(R)", "")).Replace("(HC)", ""), String), txtGroupCode.Text.Trim) Then
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('This chain name is already present.');", True)
                checkForDuplicate = False
                Exit Function
            End If
...
#End Region
    ...
    Protected Sub btnHelp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnhelp.Click
        ...
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=Hotel chain','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    End Sub
    ...
    Public Shared Function GetHotelChain(ByVal prefixText As String) As List(Of String)
        ...
        Try
            ...
            strSqlQry = "select rtrim(ltrim(hotelchainname))+'(HC)' name from hotelchainmaster where  hotelchainname like  " & "'" & prefixText & "%'  order by name"
            'and grouptype<>'C'
    ...
    Protected Sub chkSelect_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            objUtils.WritErrorLog("HotelChainMasterSearch.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        End Try
    End Sub
    ''' <summary>
    ''' FillGridByLinkButton
    ...
    Private Sub FillGridByLinkButton()
        ...
        'strSqlQry = "SELECT partymast.partycode, partymast.partyname,catmast.catname,citymast.cityname,sectormaster.sectorname,hotelchainmaster.hotelchaincode,partymast.tel1, partymast.contact1,0 sortorder FROM partymast INNER JOIN  citymast ON partymast.citycode = citymast.citycode INNER JOIN  catmast ON partymast.catcode = catmast.catcode INNER JOIN  ctrymast ON partymast.ctrycode = ctrymast.ctrycode INNER  JOIN  sectormaster ON partymast.sectorcode = sectormaster.sectorcode INNER  JOIN  hotelchainmaster ON partymast.hotelchaincode = hotelchainmaster.hotelchaincode where partymast.sptypecode='HOT' "
        '  strSqlQry = "select partymast.partycode, partymast.partyname,(select catname from catmast where catmast.catcode=partymast.catcode)catname,(select cityname from citymast where citymast.citycode=partymast.citycode)cityname, (select sectorname from sectormaster where sectormaster.sectorcode=partymast.sectorcode)sectorname, hotelchainmaster.hotelchainname,partymast.tel1, partymast.contact1,0 sortorder  from hotelchainmaster,hotelchain_detail,partymast  where  partymast.partycode=hotelchain_detail.partycode and hotelchainmaster.hotelchaincode = hotelchain_detail.hotelchaincode "
        strSqlQry = " SELECT distinct partymast.partycode, partymast.partyname,catmast.catname,citymast.cityname,sectormaster.sectorname,  hotelchainmaster.hotelchainname,partymast.tel1, partymast.contact1,'0' sortorder  FROM partymast INNER JOIN  citymast ON partymast.citycode = citymast.citycode   INNER JOIN  catmast ON partymast.catcode = catmast.catcode  INNER  JOIN  sectormaster ON partymast.sectorcode = sectormaster.sectorcode left outer  JOIN  hotelchainmaster ON partymast.hotelchaincode =hotelchainmaster.hotelchaincode   where partymast.sptypecode='HOT'  and (hotelchainname is null or hotelchainname='" & txtGroupTagName.Text.Trim.Replace("(HC)", "") & "')"
        ...
        If strlbValue.Trim <> "" Then
            ...
            ''    strlbValue = (((((((Trim(strlbValue.Trim).Replace("(C)", "")).Replace("(S)", "")).Replace("(G)", "")).Replace("(T)", "")).Replace("(CT)", "")).Replace("(HC)", "")).Replace("(H)", "")).Replace("(CTG)", "")
            ...
            If strlbValue.Contains("(HC)") Then
                ...
                strlbValue = "'" & strlbValue & "'"
                If Trim(strWhereCond) = "" Then
                    ' strWhereCond = "  partymast.partycode in (select hotelchain_detail.partycode   from hotelchainmaster ,hotelchain_detail   where hotelchainmaster.hotelchaincode = hotelchain_detail.hotelchaincode and upper(hotelchainmaster.hotelchainname) IN  (" & Trim(strlbValue).ToUpper.Replace("(HC)", "")) & ")
                ...
                For i = 0 To lsMainArr.GetUpperBound(0)
                    ...
                    If strValue <> "" Then
                        If Trim(strWhereCond1) = "" Then
                            strWhereCond1 = " ( upper(partymast.partyname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'   or   upper(hotelchainmaster.hotelchainname)  LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'     or   upper(sectormaster.sectorname)  LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'   or   upper(citymast.cityname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(catmast.catname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                        Else
                            strWhereCond1 = strWhereCond1 & " or ( upper(partymast.partyname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'   or   upper(hotelchainmaster.hotelchainname)  LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'     or   upper(sectormaster.sectorname)  LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'   or   upper(citymast.cityname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(catmast.catname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  ) "
                        End If
                    End If
                Next
                If Trim(strWhereCond) = "" Then
        ...
        'End If
        FillCheckbox()
        'myDS.Tables(0).DefaultView.RowFilter = "sortorder LIKE '1'"
    ...
    Protected Sub txtGroupTagName_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtGroupTagName.TextChanged
        ...
        If hdOPMode.Value = "E" Or hdOPMode.Value = "D" Or hdOPMode.Value = "S" Then
            ...
            strSqlQry = "select hotelchainmaster.hotelchaincode, hotelchainmaster.hotelchainname,partymast.partycode,isnull(hotelchainmaster.active,0)active,partymast.partyname from hotelchainmaster inner join partymast on  hotelchainmaster.hotelchaincode=partymast.hotelchaincode and  hotelchainmaster.hotelchainname='" & (Trim(txtGroupTagName.Text.Trim)).Replace("(HC)", "") & "'"
            SqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))                             'Open connection
            '  SqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))                             'Open connection
            myDataAdapter = New SqlDataAdapter(strSqlQry, SqlConn)
            ...
            If dt.Rows.Count > 0 Then
                For i As Integer = 0 To dt.Rows.Count - 1
                    txtGroupCode.Text = dt.Rows(i)("hotelchaincode").ToString

                    dtsHotelGroupDetails.NewRow()
                    ' dtsHotelGroupDetails.Rows.Add("HC", txtGroupTagName.Text, dt.Rows(i)("hotelchaincode").ToString)
                    dtsHotelGroupDetails.Rows.Add("HC", txtGroupTagName.Text, dt.Rows(i)("partycode").ToString, dt.Rows(i)("partyname").ToString)
                ...
                If txtGroupTagName.Text.Contains("(HC)") Then
                    Dim dtt As DataTable
                    Dim iFlag As Integer = 0
                    dtt = Session("sDtDynamic")
                    If dtt.Rows.Count >= 0 Then
                        ...
                        If iFlag = 0 Then
                            dtt.NewRow()
                            dtt.Rows.Add("HC", txtGroupTagName.Text)
                            Session("sDtDynamic") = dtt
                            dlList.DataSource = dtt
                            dlList.DataBind()
                        End If
    ...
    Private Sub FillGridForEdit(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        Try
            ...
            strSqlQry = " select partymast.partycode, partymast.partyname,(select catname from catmast where catmast.catcode=partymast.catcode)catname,(select cityname from citymast where citymast.citycode=partymast.citycode)cityname, (select sectorname from sectormaster where sectormaster.sectorcode=partymast.sectorcode)sectorname,hotelchainmaster.hotelchainname  ,partymast.tel1, partymast.contact1,0 sortorder  from   partymast inner join hotelchainmaster on hotelchainmaster.hotelchaincode=partymast.hotelchaincode where  partymast.sptypecode='HOT' "
            ' hotelchainmaster.hotelchaincode = hotelchain_detail.hotelchaincode and hotelchainname='check'   ORDER BY partymast.partyname ASC

            ' strSqlQry = "SELECT partymast.partycode, partymast.partyname,(select catname from catmast where catmast.catcode=partymast.catcode)catname,(select cityname from citymast where citymast.citycode=partymast.citycode)cityname,(select sectorname from sectormaster where sectormaster.sectorcode=partymast.sectorcode)sectorname, hotelchainmaster.hotelchainname,partymast.tel1, partymast.contact1,0 sortorder from hotelchainmaster,hotelchain_detail,partymastwhere hotelchainmaster.hotelchaincode = hotelchain_detail.hotelchaincode and hotelchainname='' "
            If txtGroupTagName.Text.Contains("(HC)") Then
                Dim strlbValue As String = ""
                strlbValue = (((((((Trim(txtGroupTagName.Text.Trim).Replace("(C)", "")).Replace("(S)", "")).Replace("(G)", "")).Replace("(T)", "")).Replace("(CT)", "")).Replace("(HC)", "")).Replace("(H)", "")).Replace("(CTG)", "")
                strlbValue = "'" & strlbValue & "'"
                If Trim(strWhereCond) = "" Then


                    strWhereCond = "hotelchainname=" & Trim(strlbValue) & ""
                Else

                    strWhereCond = strWhereCond & "hotelchainname=" & Trim(strlbValue) & ""
                End If
            End If
    ...
    Protected Sub btnView_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnView.Click
        lblHeading.Text = "View Hotel Chain"
        btnNew.Enabled = False
        btnEdit.Enabled = False
        btnDelete.Enabled = False
        btnCancel.Enabled = True
    ...
    Private Sub FillGridNew()
        ...
        Try
            ...
            strSqlQry = "SELECT partymast.partycode, partymast.partyname,catmast.catname,citymast.cityname,sectormaster.sectorname,  hotelchainmaster.hotelchainname,partymast.tel1, partymast.contact1 FROM partymast INNER JOIN  citymast ON partymast.citycode = citymast.citycode INNER JOIN  catmast ON partymast.catcode = catmast.catcode left outer JOIN  hotelchainmaster ON partymast.hotelchaincode = hotelchainmaster.hotelchaincode INNER  JOIN  sectormaster ON partymast.sectorcode = sectormaster.sectorcode  where partymast.sptypecode='HOT'"
            'If strCountryValue <> "" Then
            '    '    If Trim(strWhereCond) = "" Then
            ...
            If strHotelGroupValue <> "" Then
                If Trim(strWhereCond) = "" Then
                    strWhereCond = " upper(hotelchainmaster.hotelchainname) IN ( " & Trim(strHotelGroupValue) & ")"
                Else

                    strWhereCond = strWhereCond & " AND  upper(hotelchainmaster.hotelchainname) IN ( " & Trim(strHotelGroupValue) & ")"
                End If
            End If
            ...
            If strTextValue <> "" Then
                ...
                For i = 0 To lsMainArr.GetUpperBound(0)
                    ...
                    If strValue <> "" Then
                        ...
                        Else
                            strWhereCond1 = strWhereCond1 & " OR   (upper(partymast.partyname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'    or   upper(sectormaster.sectorname)  LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'   or   upper(citymast.cityname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(catmast.catname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(hotelchainmaster.hotelchainname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                        End If
                    End If
                Next
                If Trim(strWhereCond) = "" Then
...
#End Region
    ...
    Private Sub FillGridByType(ByVal strType As String, ByVal lsProcessValue As String, ByVal strMode As String)
        ...
        strSqlQry = ""
        Try
            strSqlQry = "SELECT partymast.partycode, partymast.partyname,catmast.catname,citymast.cityname,sectormaster.sectorname, hotelchainmaster.hotelchainname ,partymast.tel1, partymast.contact1,0 sortorder  FROM partymast INNER JOIN  citymast ON partymast.citycode = citymast.citycode   INNER JOIN  catmast ON partymast.catcode = catmast.catcode INNER JOIN  ctrymast ON partymast.ctrycode = ctrymast.ctrycode   INNER  JOIN  sectormaster ON partymast.sectorcode = sectormaster.sectorcode left outer join hotelchainmaster ON partymast.hotelchaincode = hotelchainmaster.hotelchaincode    where partymast.sptypecode='HOT' and (hotelchainname is null or hotelchainname='" & txtGroupTagName.Text.Trim.Replace("(HC)", "") & "')"
            ' strSqlQry = "select partymast.partycode, partymast.partyname,(select catname from catmast where catmast.catcode=partymast.catcode)catname,(select cityname from citymast where citymast.citycode=partymast.citycode)cityname, (select sectorname from sectormaster where sectormaster.sectorcode=partymast.sectorcode)sectorname, hotelchainmaster.hotelchainname,partymast.tel1, partymast.contact1,0 sortorder  from hotelchainmaster,hotelchain_detail,partymast  where  partymast.partycode=hotelchain_detail.partycode and hotelchainmaster.hotelchaincode = hotelchain_detail.hotelchaincode "
            ...
            If lsProcessValue.Trim <> "" Then
                lsProcessValue = (((((((Trim(lsProcessValue.Trim).Replace("(C)", "")).Replace("(S)", "")).Replace("(G)", "")).Replace("(T)", "")).Replace("(CT)", "")).Replace("(HC)", "")).Replace("(H)", "")).Replace("(CTG)", "")
    ...
    Private Sub FilterGrid()
        ...
        ElseIf hdOPMode.Value = "N" Or hdOPMode.Value = "E" Then
            If txtGroupTagName.Text = "" Then
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Please enter Hotel Chain name.');", True)
                txtGroupTagName.Focus()
                Exit Sub
            End If
            '    hdOPMode.Value = "N"
            ...
            For i = 0 To lsMainArr.GetUpperBound(0)
                Select Case lsMainArr(i).Split(":")(0).ToString.ToUpper.Trim
                    ...
                    Case "HOTELCHAIN"
                        lsProcessHotelGroup = lsMainArr(i).Split(":")(1) & "(HC)"
                        txtNameNew.Text = lsProcessHotelGroup
                        ' If hdOPMode.Value = "E" Then
                        FillGridByType("HC", lsProcessHotelGroup, hdOPMode.Value)
                        '   End If
                        ...
                        If dtt.Rows.Count >= 0 Then
                            ...
                            If iFlag = 0 Then
                                dtt.NewRow()
                                dtt.Rows.Add("HC", lsProcessHotelGroup)
                            End If
    ...
    Protected Sub btnHotelReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnHotelReport.Click
        Try
            ...
            Dim strpop As String = ""
            strpop = "window.open('rptReportNew.aspx?Pageame=Hotelchain&BackPageName=HotelChainMaster.aspx&HotelchainCode=" + txtGroupCode.Text.Trim + "&HotelchainName=" + txtName.Text.Trim + "','RepHotelchain');"
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
    ...
    Protected Sub txtName_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtName.TextChanged
        Session("hotelchaincode") = tCode.Text()
    End Sub
                ...
                If dtDynamics.Rows.Count > 0 Then
                    ...
                    For j = 0 To dtDynamics.Rows.Count - 1
                        ...
                        If "HC" = dtDynamics.Rows(j)("code").ToString.Trim.ToUpper Then
                            ...
                            lsSearchTextHotelGroup = lsSearchTextHotelGroup.Replace("(HC)", "")
                        End If
