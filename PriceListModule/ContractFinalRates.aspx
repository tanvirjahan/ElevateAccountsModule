<%@ Page Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="ContractFinalRates.aspx.vb" Inherits="ContractFinalRates" %>
                ...
                <tbody>
                    <tr>
                        <td valign="top" align="center" width="150px" colspan="4">
                            <asp:Label ID="lblHeading" runat="server" Text="Show Markup Rates" CssClass="field_heading"
                            ...
                            <table style="width: 100%">
                                <tr>
                                    <td align="left" class="td_cell" valign="top">
                                        <asp:Panel ID="Panelsearch" runat="server" Font-Bold="true" GroupingText="Markup Rate Details"
                                            Width="100%">
                                            <table style="width: 100%">
                                                <tr>
                                                    <td>
                                                    <table>
                                                        <tr>
                                                             ...
                                                             <td>
                                                               <asp:Label ID="lblctry" runat="server" Style="vertical-align: bottom;" Text="Select Country"
                                                            ...
                                                            <td>
                                                               ...
                                                               <asp:TextBox ID="txtctryname" runat="server" AutoPostBack="True" CssClass="field_input"
                                                                ...
                                                                <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" CompletionInterval="1"
                                                                    ...
                                                                    ServiceMethod="Getctrylist" OnClientItemSelected="ctryautocompleteselected" TargetControlID="txtctryname"
                                                                    UseContextKey="true">
                                                ...
                                                <td>
                                                   <table>
                                                        <tr>
                                                             ...
                                                             <td>
                                                               <asp:Label ID="lblagent" runat="server" Style="vertical-align: bottom;" Text="Select Agent"
                                                                            Width="110px"></asp:Label>
                                                             </td>
                                                            ...
                                                            <td>
                                                               ...
                                                               <asp:TextBox ID="txtagentname" runat="server" AutoPostBack="True" CssClass="field_input"
                                                                   TabIndex="2" Width="258px"  ></asp:TextBox>
                                                                ...
                                                                <asp:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" CompletionInterval="1"
                                                                    ...
                                                                    CompletionListItemCssClass="autocomplete_listItem" CompletionSetCount="1" DelimiterCharacters=""
                                                                    EnableCaching="false" Enabled="True" FirstRowSelected="false" MinimumPrefixLength="0"
                                                                    ServiceMethod="Getagentlist" OnClientItemSelected="agentautocompleteselected" TargetControlID="txtagentname"
                                                                    UseContextKey="true">
                                                                </asp:AutoCompleteExtender>
                                                             ...
                                                             <td>
                                                            <asp:Button ID="btnrates" runat="server" Text="Print Rates With Markup" Font-Bold="False" CssClass="btn" OnClientClick="ShowProgess();"   />
                                                             <asp:Button ID="btnratesothermeal" runat="server" Text="OtherMealPlan Rates With Markup" Font-Bold="False" CssClass="btn" OnClientClick="ShowProgess();"   />
                                                             <asp:Button ID="btnOfferRates" runat="server" Text="Base MealPlan Rates With Markup" Font-Bold="False" CssClass="btn" OnClientClick="ShowProgess();"   />
                                                             <asp:Button ID="btnofferothermeal" runat="server" Text="OtherMealPlan Rates With Markup" Font-Bold="False" CssClass="btn" OnClientClick="ShowProgess();"   />
                                                          </td>
                                                   ...
                                                   <tr> <td style="display:none">
                                                    <asp:Button ID="btnAddNew" runat="server" Text="Add" Font-Bold="False" CssClass="btn">
                                                        </asp:Button>
                                                        <asp:Button ID="btnExportToExcel" runat="server" Text="Add" Font-Bold="False" CssClass="btn">
                                                        </asp:Button>
                                                    </td>
                                                </tr>
