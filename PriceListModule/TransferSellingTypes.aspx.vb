    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            Try
                ...
                ViewState.Add("trfServiceSelltypeState", Request.QueryString("State"))
                ViewState.Add("trfServiceSelltypeRefCode", Request.QueryString("RefCode"))

            


                If ViewState("trfServiceSelltypeState") = "New" Then
                    ...
                    'End If
                    lblHeading.Text = "Add New - Transfer  Selling Types"
                    Page.Title = Page.Title + " " + "New Transfer Services Selling Types"
                    btnSave.Text = "Save"

                    'btnSave.Attributes.Add("onclick", "javascript:if(confirm('Are you sure you want to save Transfer Selling Types?')==false)return false;")
                    btnSave.Attributes.Add("onclick", "return FormValidation('New')")
                ElseIf ViewState("trfServiceSelltypeState") = "Edit" Then
                    ...
                    'End If
                    lblHeading.Text = "Edit -Transfer Selling Types"
                    Page.Title = Page.Title + " " + "Edit Transfer Service Selling Types"
                    btnSave.Text = "Update"
                    DisableControl()

                    ShowRecord(CType(ViewState("trfServiceSelltypeRefCode"), String))
                ...
                ElseIf ViewState("trfServiceSelltypeState") = "View" Then
                    SetFocus(btnCancel)
                    ...
                    'End If
                    lblHeading.Text = "View - Transfer Selling Types"
                    Page.Title = Page.Title + " " + "View Transfer Services  Selling Types"
                ...
                ElseIf ViewState("trfServiceSelltypeState") = "Delete" Then
                    SetFocus(btnSave)
                    ...
                    btnSave.Attributes.Add("onclick", "javascript:if(confirm('Are you sure you want to delete Transfer Selling Types?')==false)return false;")
                End If
...
#Region "Private Sub DisableControl()"
    Private Sub DisableControl()
        If ViewState("trfServiceSelltypeState") = "View" Or ViewState("trfServiceSelltypeState") = "Delete" Then
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            If Page.IsValid = True Then
                If ViewState("trfServiceSelltypeState") = "New" Or ViewState("trfServiceSelltypeState") = "Edit" Then
                    ...
                    If ViewState("trfServiceSelltypeState") = "New" Then
                        mySqlCmd = New SqlCommand("sp_add_trfsell", mySqlConn, sqlTrans)
                        frmmode = 1
                    ElseIf ViewState("trfServiceSelltypeState") = "Edit" Then
                        mySqlCmd = New SqlCommand("sp_mod_trfsell", mySqlConn, sqlTrans)
                        frmmode = 2
                    End If
                    mySqlCmd.CommandType = CommandType.StoredProcedure

                    mySqlCmd.Parameters.Add(New SqlParameter("@trfsellcode", SqlDbType.VarChar, 20)).Value = CType(TxtOtherServiceCode.Value.Trim, String)
                    mySqlCmd.Parameters.Add(New SqlParameter("@trfsellname", SqlDbType.VarChar, 100)).Value = CType(txtOtherServiceSelling.Value.Trim, String)
                ...
                ElseIf ViewState("trfServiceSelltypeState") = "Delete" Then
                    ...
                    sqlTrans = mySqlConn.BeginTransaction           'SQL  Trans start
                    frmmode = 3
                    mySqlCmd = New SqlCommand("sp_del_trfsell", mySqlConn, sqlTrans)
                    mySqlCmd.CommandType = CommandType.StoredProcedure
                    mySqlCmd.Parameters.Add(New SqlParameter("@trfsellcode", SqlDbType.VarChar, 20)).Value = CType(TxtOtherServiceCode.Value.Trim, String)
                    mySqlCmd.ExecuteNonQuery()
                End If
        ...
        Catch ex As Exception
            ...
            End If
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            objUtils.WritErrorLog("TransferSellingTypes.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        End Try
...
#Region " Private Sub ShowRecord(ByVal RefCode As String)"
    Private Sub ShowRecord(ByVal RefCode As String)
        Try
            mySqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))           'connection open
            mySqlCmd = New SqlCommand("Select * from trfsellmast Where trfsellcode='" & RefCode & "'", mySqlConn)
            mySqlReader = mySqlCmd.ExecuteReader(CommandBehavior.CloseConnection)
            If mySqlReader.HasRows Then
                If mySqlReader.Read() = True Then
                    If IsDBNull(mySqlReader("trfsellcode")) = False Then
                        Me.TxtOtherServiceCode.Value = CType(mySqlReader("trfsellcode"), String)
                    Else
                        Me.TxtOtherServiceCode.Value = ""
                    End If
                    If IsDBNull(mySqlReader("trfsellname")) = False Then
                        Me.txtOtherServiceSelling.Value = CType(mySqlReader("trfsellname"), String)
                    Else
...
#Region "Public Function checkForDuplicate() As Boolean"
    Public Function checkForDuplicate() As Boolean
        If ViewState("trfServiceSelltypeState") = "New" Then
            If objUtils.isDuplicatenew(Session("dbconnectionName"), "trfsellmast ", "trfsellcode", CType(TxtOtherServiceCode.Value.Trim, String)) Then
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('This Selling Types code is already present.');", True)
                SetFocus(TxtOtherServiceCode)
                checkForDuplicate = False
                Exit Function
            End If
            If objUtils.isDuplicatenew(Session("dbconnectionName"), "trfsellmast", "trfsellname", txtOtherServiceSelling.Value.Trim) Then
