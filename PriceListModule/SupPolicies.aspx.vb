...
#Region "Private Sub ShowRecord(ByVal RefCode As String)"
    Private Sub ShowRecord(ByVal RefCode As String)
        Try
            ...
            If mySqlReader.HasRows Then
                If mySqlReader.Read() = True Then
                    ...
                    '---------  General Details ------------------------------------
                    If IsDBNull(mySqlReader("generalpolicy")) = False Then
                        txtGenpolicy.Text = mySqlReader("generalpolicy")
                    Else
                        txtGenpolicy.Text = ""
                    End If

                    If IsDBNull(mySqlReader("cencelpolicy")) = False Then
                        txtcancelpolicy.Text = mySqlReader("cencelpolicy")
                    Else
                        txtcancelpolicy.Text = ""
                    End If
                End If
            End If
            mySqlCmd.Dispose()
        ...
        Catch ex As Exception
            ...
            objUtils.WritErrorLog("SupPolicies.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        Finally
        ...
        Try
            If Page.IsValid = True Then
                ...
                ElseIf Session("SupState") = "Edit" Then
                    ...
                    If Session("SupState") = "New" Then
                        mySqlCmd = New SqlCommand("sp_updatepolicy_partymast", mySqlConn, sqlTrans)
                    ElseIf Session("SupState") = "Edit" Then
                        mySqlCmd = New SqlCommand("sp_updatepolicy_partymast", mySqlConn, sqlTrans)
                    End If
                    ...
                    mySqlCmd.Parameters.Add(New SqlParameter("@genpolicy", SqlDbType.Text)).Value = CType(txtGenpolicy.Text.Trim, String)
                    mySqlCmd.Parameters.Add(New SqlParameter("@cencelpolicy", SqlDbType.Text)).Value = CType(txtcancelpolicy.Text.Trim, String)
...
#End Region
    ...
    Protected Sub btnhelp_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=SupPolicies','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    End Sub
