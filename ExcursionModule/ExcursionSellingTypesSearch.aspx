<%@ Page Language="VB" MasterPageFile="~/ExcursionMaster.master" AutoEventWireup="false" CodeFile="ExcursionSellingTypesSearch.aspx.vb" Inherits="Other_Services_Selling_Types_Search"  %>
...
function  GetValueCode()
{
   ...
   <table>
        <tr>
            <td >
                <table id="TABLE1"  style="border-right: gray 2px solid;border-top: gray 2px solid; border-left: gray 2px solid; width: 100%; border-bottom: gray 2px solid;">
                    <tr>
                        <td class="td_cell" colspan="1" >
                            <table >
                                <tr align=center>
                                    <td align="center" class="field_heading">
                                    <asp:Label runat="server" ID="Lblselltypes" Text="Excursion  Selling Types List"></asp:Label>
                                        &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp; &nbsp;</td>
                                </tr>
                                <tr align=center >
...
<asp:TemplateField Visible="False" HeaderText="Selling Code"><EditItemTemplate>
      <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("excsellcode") %>'></asp:TextBox>
                                        
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblothsellcode" runat="server" Text='<%# Bind("excsellcode") %>' __designer:wfdid="w1"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField="excsellcode" SortExpression="excsellcode" HeaderText="Excursion Selling Code">
<ItemStyle HorizontalAlign="Left"></ItemStyle>

<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
</asp:BoundField>
<asp:BoundField DataField="excsellname" SortExpression="excsellname" HeaderText="Excursion Selling Name">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
