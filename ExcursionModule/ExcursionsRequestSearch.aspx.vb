...
Partial Class ExcursionModule_ExcursionsRequestSearch
        ...
        If Page.IsPostBack = False Then
            Try
                ...
                Else
                    ...
                    'CType(strappname, String), "ExcursionModule\ExcursionsRequestSearch.aspx?appid=11", btnAddNew, btnExportToExcel, _
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        'strpop = "window.open('ExcursionRequestEntry.aspx?State=New','ExcursionRequestEntry','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
        strpop = "window.open('ExcursionRequestEntry.aspx?State=New','ExcursionRequestEntry');"
...
#End Region
    ...
    Private Function ChkAdjusted(ByVal requestid As String) As String
        ...
        Dim bookuser As String
        bookuser = objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select 't' from  booking_access(nolock)  where  usercode='" & CType(Session("GlobalUserName"), String) & "' ")
        ...
        Else
            If bookuser <> "" Then
                '   ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Already Allocated this booking Please inform Accounts After you Amend');", True)
                strError = ""
...
#Region "Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand"
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            If e.CommandName = "EditRow" Then
                ...
                intGroupID = GetGroupId(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String))
                If intGroupID = 8 Then
                    ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Booking Cant Edit');", True)
                    Return
                End If
                ...
                InsertExcursionCostTemp(lblId.Text)
                If sqlreader.Read = True Then
                    'Session("ExcursionCostDetailTable") = Nothing
                    'Session("TempMultiCostGrid") = Nothing  'Changed by Riswan on 12/04/2015
                    ...
                    ElseIf sqlreader("invno") <> "" Then
                        ...
                        Session("RowState") = ""
                        Dim strpop As String = ""
                        'strpop = "window.open('ExcursionRequestEntry.aspx?State=EditRow&IsView=1&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionRequestEntry','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                        strpop = "window.open('ExcursionRequestEntry.aspx?State=EditRow&IsView=1&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionRequestEntry');"
                        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Already Allocated this booking Please inform Accounts After you Amend');", True)
                        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)

                        'strpop = "ExcursionRequestEntry.aspx?State=EditRow&IsView=1&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionRequestEntry','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes"
                    ...
                    Else
                        ...
                        Dim strpop As String = ""
                        'strpop = "window.open('ExcursionRequestEntry.aspx?State=EditRow&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionRequestEntry','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                        strpop = "window.open('ExcursionRequestEntry.aspx?State=EditRow&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionRequestEntry');"
                        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
                    End If
                End If
            ...
            ElseIf e.CommandName = "ViewRow" Then
                ...
                Dim strpop As String = ""
                'strpop = "window.open('ExcursionRequestEntry.aspx?State=ViewRow&IsView=1&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionRequestEntry','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('ExcursionRequestEntry.aspx?State=ViewRow&IsView=1&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionRequestEntry');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
    ...
    Private Sub InsertExcursionCostTemp(ByVal excID As String)
        Try
            ...
            mySqlCmd = New SqlCommand(lsTempInsertQry, mySqlConn, sqlTrans)
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        Try
            ...
            If rbNormalRequest.Checked = True Then
                'strpop = "window.open('rptReportNew.aspx?Pageame=Ex_NormalRequest&BackPageName=ExcursionsRequestSearch.aspx&Refcode=" & Session("Excursion_ID") & "','RepPrint','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('rptReportNew.aspx?Pageame=Ex_NormalRequest&BackPageName=ExcursionsRequestSearch.aspx&Refcode=" & Session("Excursion_ID") & "','RepPrint');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If

            If rbBurjAlArabRequest.Checked = True Then
                'strpop = "window.open('rptReportNew.aspx?Pageame=Ex_BurjAlArabRequest&BackPageName=ExcursionsRequestSearch.aspx&Refcode=" & Session("Excursion_ID") & "&pcotel=" & cotel & "&pcofax=" & cofax & "&pcoemail=" & coemail & "&pcoweb=" & coweb & "&pcoadd2=" & coadd2 & "&pcocmt=" & strtemp & "','RepPrint','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('rptReportNew.aspx?Pageame=Ex_BurjAlArabRequest&BackPageName=ExcursionsRequestSearch.aspx&Refcode=" & Session("Excursion_ID") & "&pcotel=" & cotel & "&pcofax=" & cofax & "&pcoemail=" & coemail & "&pcoweb=" & coweb & "&pcoadd2=" & coadd2 & "&pcocmt=" & strtemp & "','RepPrint');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If


            If rbDowCruiseRequest.Checked = True Then
                'strpop = "window.open('rptReportNew.aspx?Pageame=Ex_DowCruiseRequest&BackPageName=ExcursionsRequestSearch.aspx&Refcode=" & Session("Excursion_ID") & "&pcotel=" & cotel & "&pcofax=" & cofax & "&pcoemail=" & coemail & "&pcoweb=" & coweb & "&pcoadd2=" & coadd2 & "&pcocmt=" & strtemp & "','RepPrint','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('rptReportNew.aspx?Pageame=Ex_DowCruiseRequest&BackPageName=ExcursionsRequestSearch.aspx&Refcode=" & Session("Excursion_ID") & "&pcotel=" & cotel & "&pcofax=" & cofax & "&pcoemail=" & coemail & "&pcoweb=" & coweb & "&pcoadd2=" & coadd2 & "&pcocmt=" & strtemp & "','RepPrint');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If
            ...
            If rbRentCarRequest.Checked = True Then
                ...
                strpop = "window.open('rptReportNew.aspx?Pageame=Ex_RentCarRequest&BackPageName=ExcursionsRequestSearch.aspx&Refcode=" & Session("Excursion_ID") & "&pcotel=" & cotel & "&pcofax=" & cofax & "&pcoemail=" & coemail & "&pcoweb=" & coweb & "&pcoadd2=" & coadd2 & "&pcocmt=" & strtemp & "','RepPrint');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If


            If radexcdet.Checked = True Then
                'strpop = "window.open('rptReportNew.aspx?Pageame=Ex_det&BackPageName=ExcursionsRequestSearch.aspx&Refcode=" & Session("Excursion_ID") & "&rlineno=" & Session("Rlineno") & "&pcotel=" & cotel & "&pcofax=" & cofax & "&pcoemail=" & coemail & "&pcoweb=" & coweb & "&pcoadd2=" & coadd2 & "&pcocmt=" & strtemp & "','RepPrint','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('rptReportNew.aspx?Pageame=Ex_det&BackPageName=ExcursionsRequestSearch.aspx&Refcode=" & Session("Excursion_ID") & "&rlineno=" & Session("Rlineno") & "&pcotel=" & cotel & "&pcofax=" & cofax & "&pcoemail=" & coemail & "&pcoweb=" & coweb & "&pcoadd2=" & coadd2 & "&pcocmt=" & strtemp & "','RepPrint');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If


            If rbTicket.Checked = True Then
                'strpop = "window.open('rptReportNew.aspx?Pageame=Ex_Ticket&BackPageName=ExcursionsRequestSearch.aspx&Refcode=" & Session("Excursion_ID") & "&pcotel=" & cotel & "&pcofax=" & cofax & "&pcoemail=" & coemail & "&rlineno=" & Session("Rlineno") & "&pcoweb=" & coweb & "&pcopobox=" & strtemp & "&pcoadd1=" & coadd1 & "&pcoadd2=" & coadd2 & "','RepPrint','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('rptReportNew.aspx?Pageame=Ex_Ticket&BackPageName=ExcursionsRequestSearch.aspx&Refcode=" & Session("Excursion_ID") & "&pcotel=" & cotel & "&pcofax=" & cofax & "&pcoemail=" & coemail & "&rlineno=" & Session("Rlineno") & "&pcoweb=" & coweb & "&pcopobox=" & strtemp & "&pcoadd1=" & coadd1 & "&pcoadd2=" & coadd2 & "','RepPrint');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If

            If rbInvoice.Checked = True Then
                'strpop = "window.open('rptReportNew.aspx?Pageame=Ex_Invoice&BackPageName=ExcursionsRequestSearch.aspx&tranid=" & Session("Excursion_ID") & "&trantype=" & strtemp & "&amtinwrds=" & strtemp & "&divid=" & strtemp & "&rephead=" & strtemp & "&repfilter=" & strtemp & "&pcoweb=" & coweb & "&pcoemail=" & coemail & "&pcofax=" & cofax & "&pcotel=" & cotel & "','RepPrint','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('rptReportNew.aspx?Pageame=Ex_Invoice&BackPageName=ExcursionsRequestSearch.aspx&tranid=" & Session("Excursion_ID") & "&trantype=" & strtemp & "&amtinwrds=" & strtemp & "&divid=" & strtemp & "&rephead=" & strtemp & "&repfilter=" & strtemp & "&pcoweb=" & coweb & "&pcoemail=" & coemail & "&pcofax=" & cofax & "&pcotel=" & cotel & "','RepPrint');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If

            If rbrequest.Checked = True Then
                'strpop = "window.open('rptReportNew.aspx?Pageame=Ex_request&BackPageName=ExcursionsRequestSearch.aspx&tranid=" & Session("Excursion_ID") & "&trantype=" & strtemp & "&amtinwrds=" & strtemp & "&divid=" & strtemp & "&rephead=" & strtemp & "&repfilter=" & strtemp & "&pcoweb=" & coweb & "&rlineno=" & Session("Rlineno") & " & pcoemail = " & coemail & " & pcofax = " & cofax & " & pcotel = " & cotel & " ','RepPrint','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('rptReportNew.aspx?Pageame=Ex_request&BackPageName=ExcursionsRequestSearch.aspx&tranid=" & Session("Excursion_ID") & "&trantype=" & strtemp & "&amtinwrds=" & strtemp & "&divid=" & strtemp & "&rephead=" & strtemp & "&repfilter=" & strtemp & "&pcoweb=" & coweb & "&rlineno=" & Session("Rlineno") & " & pcoemail = " & coemail & " & pcofax = " & cofax & " & pcotel = " & cotel & " ','RepPrint');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If

            If rbproforma.Checked = True Then
                'strpop = "window.open('rptReportNew.aspx?Pageame=Ex_ProformaInvoice&BackPageName=ExcursionsRequestSearch.aspx&tranid=" & Session("Excursion_ID") & "&trantype=" & strtemp & "&amtinwrds=" & strtemp & "&divid=" & strtemp & "&rephead=" & strtemp & "&repfilter=" & strtemp & "&pcoweb=" & coweb & "&pcoemail=" & coemail & "&pcofax=" & cofax & "&pcotel=" & cotel & "','RepPrint','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('rptReportNew.aspx?Pageame=Ex_ProformaInvoice&BackPageName=ExcursionsRequestSearch.aspx&tranid=" & Session("Excursion_ID") & "&trantype=" & strtemp & "&amtinwrds=" & strtemp & "&divid=" & strtemp & "&rephead=" & strtemp & "&repfilter=" & strtemp & "&pcoweb=" & coweb & "&pcoemail=" & coemail & "&pcofax=" & cofax & "&pcotel=" & cotel & "','RepPrint');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If
