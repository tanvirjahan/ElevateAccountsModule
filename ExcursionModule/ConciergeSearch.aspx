<%@ Page Language="VB" MasterPageFile="~/MainPageMaster.master" AutoEventWireup="false"  EnableEventValidation="false"  CodeFile="ConciergeSearch.aspx.vb" Inherits="CitiesSearch"  %>
        ...
        <tr>
            <td style="width: 100px; height: 11px">
                <table style="width: 918px">
                    <tr>
                        <td align="center" class="field_heading" style="width: 5968px; height: 1px">
                Concierge List</td>
                    </tr>
                    <tr>
...
<SELECT style="WIDTH: 269px" id="ddldeptname" class="drpdown" tabIndex=4 
        onchange="CallWebMethod('ctryname')" runat="server" Visible="false"> <OPTION selected></OPTION></SELECT></TD><TD style="WIDTH: 63px; HEIGHT: 22px"></TD><TD style="WIDTH: 100px; HEIGHT: 22px"></TD></TR></TBODY></TABLE>
                ...
                <asp:UpdatePanel id="UpdatePanel2" runat="server">
                    <contenttemplate>
<asp:GridView id="gv_SearchResult" tabIndex=10 runat="server" Font-Size="10px" Width="914px" CssClass="grdstyle" __designer:wfdid="w50" GridLines="Vertical" CellPadding="3" BorderWidth="1px" BorderStyle="None" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True">
<FooterStyle CssClass="grdfooter"></FooterStyle>
<Columns>
<asp:TemplateField Visible="False" HeaderText="Sperson Code"><EditItemTemplate>
...
</asp:GridView> <asp:Label id="lblMsg" runat="server" Text="Records not found. Please redefine search criteria" Font-Size="8pt" Font-Names="Verdana" ForeColor="#084573" Font-Bold="True" Width="357px" __designer:wfdid="w51" Visible="False"></asp:Label> 
</contenttemplate>
                </asp:UpdatePanel></td>
                    </tr>
                </table>
