    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            Try
                ...
                txtRemarks.text = "Assign Drivers for Excursions"
...
#Region "Private Sub FillGrid()"
    Private Sub FillGrid()
        ...
        Try
            ...
            Dim ds As DataSet = objUtils.ExecuteQuerynew(Session("dbconnectionName"), "sp_get_excursions_assign", parms)
        ...
        Try
            ...
            If e.CommandName = "Assign" Then
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    End If
                    driverCode = ds.Tables(0).Rows(0)(1).ToString
                    adddriverCode = driverCode.Split(",")
                End If
                ...
                Else
                    ...
                    divassigntransfer.Style("visibility") = "visibile"
                    ModalPopupDays.Show()
                    If adddriverCode.Length > 5 Then
                        fillDategrd(Gv_DriverName, False, adddriverCode.Length)
                    Else
            ...
            If e.CommandName = "Remove Assign" Then
                ...
                myCommand = New SqlCommand("sp_update_excursions_detail", SqlConn)
        ...
        Try
            ...
            If mySqlReader.HasRows Then
                If mySqlReader.Read() = True Then
                    ...
                    If IsDBNull(mySqlReader("drivercode")) = False And mySqlReader("drivercode") <> "" Then
