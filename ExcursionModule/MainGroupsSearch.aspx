<%@ Page Title="" Language="VB" MasterPageFile="~/ExcursionMaster.master" AutoEventWireup="false" CodeFile="MainGroupsSearch.aspx.vb" Inherits="ExcursionModule_MainGroupsSearch" %>
...
<asp:Button id="BtnSearch" tabIndex=1  runat="server" Text="Search" Width="64px" CssClass="search_button"></asp:Button>&nbsp;
 ...
 <TR><TD style="WIDTH: 127px" class="td_cell">Main Group &nbsp;Code</TD><TD style="WIDTH: 128px; HEIGHT: 7px"><INPUT style="WIDTH: 194px" id="txtcode" tabIndex=6 type=text runat="server" class="txtbox" /></TD><TD class="td_cell">Main Group Name</TD><TD><INPUT style="WIDTH: 294px" id="txtName" tabIndex=7 type=text class="txtbox" runat="server" /></TD>
 
 <td style="width=50px" class="td_cell"><asp:label ID="lblOrderBy" runat="server" Text="Order By" ForeColor ="Black" Width="50px" CssClass ="field_caption"></asp:label></td><td style="width:137px" class="td_cell"><asp:DropDownList ID="ddlOrderBy" tabindex="8" runat="server" Width="130px" CssClass="drpdown" AutoPostBack ="true"></asp:DropDownList></td>
...
<asp:TextBox id="txtmaingrpcode" runat="server" Text='<%# Bind("othmaingrpcode") %>'></asp:TextBox> 
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblCode" runat="server" Text='<%# Bind("othmaingrpcode") %>'></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField="othmaingrpcode" SortExpression="othmaingrpcode" HeaderText="Main Group Code"></asp:BoundField>
<asp:BoundField DataField="othmaingrpname" SortExpression="othmaingrpname" HeaderText="Main Group Name"></asp:BoundField>
