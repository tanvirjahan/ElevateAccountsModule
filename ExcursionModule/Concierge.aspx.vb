        ...
        If Page.IsPostBack = False Then
            Try
                ...
                If ViewState("excServiceSelltypeState") = "New" Then
                    ...
                    lblHeading.Text = "Add New - Concierge "
                    Page.Title = Page.Title + " " + "New Concierge"
                    btnSave.Text = "Save"
                ...
                ElseIf ViewState("excServiceSelltypeState") = "Edit" Then
                    ...
                    Page.Title = Page.Title + " " + "Edit Concierge"
                    btnSave.Text = "Update"
                    DisableControl()
                ...
                ElseIf ViewState("excServiceSelltypeState") = "View" Then
                    ...
                    Page.Title = Page.Title + " " + "View Concierge"
                ...
                ElseIf ViewState("excServiceSelltypeState") = "Delete" Then
                    SetFocus(btnSave)
                    lblHeading.Text = "Delete - Concierge"
          ...
          Try
            If Page.IsValid = True Then
                If ViewState("excServiceSelltypeState") = "New" Or ViewState("excServiceSelltypeState") = "Edit" Then
                    ...
                    If ViewState("excServiceSelltypeState") = "New" Then
                        mySqlCmd = New SqlCommand("sp_add_concierge", mySqlConn, sqlTrans)
                        frmmode = 1
                    ElseIf ViewState("excServiceSelltypeState") = "Edit" Then
                        mySqlCmd = New SqlCommand("sp_mode_concierge", mySqlConn, sqlTrans)
                        frmmode = 2
                    End If
                    ...
                    mySqlCmd.Parameters.Add(New SqlParameter("@commperc", SqlDbType.Decimal, 18, 4)).Value = CType(txtcommi.Value.Trim, Decimal)
                ...
                ElseIf ViewState("excServiceSelltypeState") = "Delete" Then
                    ...
                    sqlTrans = mySqlConn.BeginTransaction           'SQL  Trans start
                    frmmode = 3
                    mySqlCmd = New SqlCommand("sp_del_concierge", mySqlConn, sqlTrans)
                    mySqlCmd.CommandType = CommandType.StoredProcedure
                    mySqlCmd.Parameters.Add(New SqlParameter("@spersoncode", SqlDbType.VarChar, 20)).Value = CType(txtcode.Value.Trim, String)
                    mySqlCmd.ExecuteNonQuery()
                End If
...
#Region " Private Sub ShowRecord(ByVal RefCode As String)"
    Private Sub ShowRecord(ByVal RefCode As String)
        Try
            mySqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))           'connection open
            mySqlCmd = New SqlCommand("Select * from spersonmast Where spersoncode='" & RefCode & "'", mySqlConn)
...
#Region "Public Function checkForDuplicate() As Boolean"
    Public Function checkForDuplicate() As Boolean
        If ViewState("excServiceSelltypeState") = "New" Then
            If objUtils.isDuplicatenew(Session("dbconnectionName"), "spersonmast ", "spersoncode", CType(txtcode.Value.Trim, String)) Then
