...
Partial Class ExcursionMulticostSearch
            ...
            Try
                ...
                Else
                    ...
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                             CType(strappname, String), "ExcursionModule\ExcursionMulticostSearch.aspx?appid=" + strappid + "&Type=" + Session("OthPListFilter"), btnAddNew, btnExportToExcel, _
                ...
                ViewState("strMultisortExpression") = "h.eplistcode"
                Session.Add("strMultisortExpression", "h.eplistcode")
                Session.Add("strMultisortdirection", SortDirection.Ascending)
                '  charcters(TxtPLCD)
                ...
                Session("sDtDynamic_Exec_Search_Plist_multicost") = Nothing
                ...
                Session("sDtDynamic_Exec_Search_Plist_multicost") = dtDynamic
                '--------end
...
#Region "  Private Function BuildCondition() As String"
    Private Function BuildCondition() As String
        ...
        If txtSupName.Text.Trim <> "" Then
            If Trim(strWhereCond) = "" Then
                strWhereCond = " upper(othtypname) = '" & Trim(txtSupName.Text.Trim.ToUpper) & "'"
            Else
                strWhereCond = strWhereCond & " AND upper(othtypname) = '" & Trim(txtSupName.Text.Trim.ToUpper) & "'"
            End If
        End If
    ...
    Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        Try
            ...
            strSqlQry = "select h.eplistcode,h.exctypcode,c.exctypname exctypname,h.vehiclecode othcatcode,t.othcatname, h.currcode,h.applicableto,status=	case when isnull(approved,0)=1 then 'Yes' else 'No' End, " _
                & " h.frmdate,h.todate,h.adddate,h.adduser,h.moddate,h.moduser,h.sectorgroupcode,(select distinct stuff((select  ',' + u.othtypname   from othtypmast u(nolock)  where u.othtypcode =othtypcode and u.othtypcode in ( select distinct mktcode from dbo.splitallotmkt(h.sectorgroupcode,',')dd)   group by othtypname    for xml path('')),1,1,'')  othtypname)  sectorgroupName from excmulticplist_header h,view_excursiontypes c ,othcatmast t  where h.exctypcode=c.exctypcode and  h.vehiclecode=t.othcatcode  " _
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        strpop = "window.open('ExcursionMulticost.aspx?State=New&costtype=S','ExcursionMulticost');"
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            If e.CommandName = "Editrow" Then
                ...
                strpop = "window.open('ExcursionMulticost.aspx?State=Edit&costtype=S&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionsuppliercostPriceList');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ElseIf e.CommandName = "View" Then
                ...
                strpop = "window.open('ExcursionMulticost.aspx?State=View&costtype=S&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionsuppliercostPriceList');"
            ...
            ElseIf e.CommandName = "Deleterow" Then
                ...
                strpop = "window.open('ExcursionMulticost.aspx?State=Delete&costtype=S&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionsuppliercostPriceList');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ...
            ElseIf e.CommandName = "Copy" Then
                ...
                strpop = "window.open('ExcursionMulticost.aspx?State=Copy&costtype=S&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionsuppliercostPriceList');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
...
#End Region
    Protected Sub btnResetSelection_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnResetSelection.Click
        ...
        dtt = Session("sDtDynamic_Exec_Search_Plist_multicost")
        If dtt.Rows.Count > 0 Then
            dtt.Clear()
        End If
        Session("sDtDynamic_Exec_Search_Plist_multicost") = dtt
...
#Region " Protected Sub gv_SearchResult_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gv_SearchResult.Sorting"
    ...
    Protected Sub gv_SearchResult_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gv_SearchResult.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            dtDynamics = Session("sDtDynamic_Exec_Search_Plist_multicost")
            If Session("sDtDynamic_Exec_Search_Plist_multicost") IsNot Nothing Then
    ...
    Protected Sub gv_SearchResult_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gv_SearchResult.Sorting
        ...
        Session.Add("strMultisortExpression", e.SortExpression)
...
#Region "Public Sub SortGridColoumn_click()"
    Public Sub SortGridColoumn_click()
        ...
        Dim myDS As New DataSet
        FillGrid(ViewState("strMultisortExpression"), "")

        myDS = gv_SearchResult.DataSource
        DataTable = myDS.Tables(0)
        If IsDBNull(DataTable) = False Then
            Dim dataView As DataView = DataTable.DefaultView
            Session.Add("strMultisortdirection", objUtils.SwapSortDirection(Session("strMultisortdirection")))
            dataView.Sort = ViewState("strMultisortExpression") & " " & objUtils.ConvertSortDirectionToSql(Session("strMultisortdirection"))
    ...
    Protected Sub btnExportToExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExportToExcel.Click
        ...
        Try
            If gv_SearchResult.Rows.Count <> 0 Then
                ...
                strSqlQry = "select h.eplistcode,h.exctypcode,c.exctypname exctypname,h.vehiclecode othcatcode,t.othcatname, h.currcode,h.applicableto,status=	case when isnull(approved,0)=1 then 'Yes' else 'No' End, " _
                 & " h.frmdate,h.todate,h.adddate,h.adduser,h.moddate,h.moduser from excmulticplist_header h,view_excursiontypes c ,othcatmast t  where h.exctypcode=c.exctypcode and  h.vehiclecode=t.othcatcode  " _
                 & " and isnull(c.multicost,'')='YES'  "
    ...
    Protected Sub lbClose_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            If dtDynamics.Rows.Count > 0 Then
                ...
                Next
            End If
            Session("sDtDynamic_Exec_Search_Plist_multicost") = dtDynamics
...
#End Region
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If Not Session("sDtDynamic_Exec_Search_Plist_multicost") Is Nothing Then
            FillGridNew()
        Else
            Select Case ddlOrderBy.SelectedIndex
                Case 0
    ...
    Protected Sub btnHelp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnHelp.Click
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=ExcMultiCostSearch','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    End Sub
        ...
        For i = 0 To lsMainArr.GetUpperBound(0)
            Select Case lsMainArr(i).Split(":")(0).ToString.ToUpper.Trim
                ...
                Case "EXCURSIONS"
                    ...
                    sbAddToDataTable("EXCURSIONS", lsProcesssupplier, "EXCURSIONS")
                Case "VEHICLE"
                    lsProcessCountry = lsMainArr(i).Split(":")(1)
                    sbAddToDataTable("VEHICLE", lsProcessCountry, "VEHICLE")
                    'Case "CLASSIFICATION"
        ...
        Try
            ...
            If dtt.Rows.Count > 0 Then
                For i As Integer = 0 To dtt.Rows.Count - 1
                    If dtt.Rows(i)("Code").ToString = "EXCURSIONS" Then
                        ...
                        End If
                    End If
                    If dtt.Rows(i)("Code").ToString = "VEHICLE" Then
            ...
            End If
            strSqlQry = ""
            Dim strorderby As String = ViewState("strMultisortExpression") 'Session("strMultisortExpression")
    ...
    Private Function BuildConditionNew(ByVal strCountryValue As String, ByVal strCityValue As String, ByVal strSectorValue As String, ByVal strSectorGroupValue As String, ByVal strTextValue As String, ByVal strSuppvalue As String) As String
        ...
        If strSectorValue.Trim <> "" Then
            If Trim(strWhereCond) = "" Then
                ...
                strWhereCond = " upper(exctypname) IN (" & Trim(strSectorValue.Trim.ToUpper) & ")"
            Else
                strWhereCond = strWhereCond & " AND upper(exctypname) IN (" & Trim(strSectorValue.Trim.ToUpper) & ")"
            End If
        End If
        ...
        If strCountryValue <> "" Then
            If Trim(strWhereCond) = "" Then
                strWhereCond = " upper(exctypname) IN (" & Trim(strCountryValue.Trim.ToUpper) & ")"
            Else
                strWhereCond = strWhereCond & " AND  upper(exctypname) IN (" & Trim(strCountryValue.Trim.ToUpper) & ")"
            End If
        End If

        If strSuppvalue <> "" Then
            If Trim(strWhereCond) = "" Then
                strWhereCond = " upper(othcatname) IN (" & Trim(strSuppvalue.Trim.ToUpper) & ")"
            Else
                strWhereCond = strWhereCond & " AND  upper(othcatname) IN (" & Trim(strSuppvalue.Trim.ToUpper) & ")"
            End If
        End If
            ...
            For i = 0 To lsMainArr.GetUpperBound(0)
                ...
                If strValue <> "" Then
                    If Trim(strWhereCond1) = "" Then
                        strWhereCond1 = " (upper(eplistcode) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(othcatname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(exctypname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(approved) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    Else
                        strWhereCond1 = strWhereCond1 & " OR  (upper(eplistcode) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(othcatname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(exctypname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(approved) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    End If
                End If
            Next
            If Trim(strWhereCond) = "" Then
