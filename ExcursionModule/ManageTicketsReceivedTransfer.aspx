<%@ Page Title="Manage TicketsReceived Transfer" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="ManageTicketsReceivedTransfer.aspx.vb" Inherits="ExcursionModule_ManageTicketsReceivedTransfer" %>
...
<asp:Label id="lblHeading" runat="server" Text="Agent Transfer" CssClass="field_heading" Width="300px"></asp:Label></TD>
</TR>
<TR>
...
<ItemTemplate>
<asp:TextBox id="txtTicketDate" Readonly="True" Text='<%# Bind("ticketdate","{0:dd/MM/yyyy }") %>'  runat="server" CssClass="field_input" Width="80px"  ></asp:TextBox>&nbsp;
</ItemTemplate>
 <HeaderStyle BackColor="#06788B" />
  </asp:TemplateField>  
...
<ItemTemplate>
<SELECT style="WIDTH: 200px" id="ddlCustomerAssigned"  disabled="disabled" class="field_input MyDropDownListCustValue"     runat="server"> <OPTION selected></OPTION></SELECT>
</ItemTemplate>
      <HeaderStyle BackColor="#06788B" />
</asp:TemplateField>                                          
                                             
<asp:TemplateField  HeaderText="Trasfer To" HeaderStyle-BackColor="#06788B">
<ItemTemplate>
...
<HeaderStyle BackColor="#009999" ForeColor="White" Font-Bold="True" CssClass="gg"></HeaderStyle>
...
<asp:Label id="lblMsg" runat="server" Text="Records not found. Please redefine search criteria" Font-Size="8pt" Font-Names="Verdana" Font-Bold="True" Width="357px" Visible="False" CssClass="lblmsg"></asp:Label> 
    ...
    &nbsp;&nbsp<asp:Button id="btnCopy" Width="20%" TabIndex="2"  runat="server" Visible="false" Text="Copy To All Rows" 
