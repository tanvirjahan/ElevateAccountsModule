<%@ Page Title="" Language="VB" MasterPageFile="~/ExcursionMaster.master" AutoEventWireup="false" CodeFile="ExcursionStopSalesSearch.aspx.vb" Inherits="ExcursionModule_ExcursionStopSalesSearch" %>
    ...
    <table style="border-right: gray 2px solid; border-top: gray 2px solid;
        ...
        <tr>
            <td align="center" class="field_heading">
                <asp:Label ID="Label1" runat="server" CssClass="field_heading" Height="18px" Text="Excursion - Stop Sale"
...
<asp:Button id="btnAddNew" tabIndex=15 onclick="btnAddNew_Click" runat="server" 
        Text="Add New" Font-Bold="True" CssClass="field_button"></asp:Button></TD></TR><TR><TD style="WIDTH: 60px" class="td_cell">&nbsp;Stop ID</TD><TD style="WIDTH: 51px"><INPUT style="WIDTH: 194px" id="txtAllotmentID" class="field_input" tabIndex=1 type=text maxLength=20 runat="server" /></TD><TD>Order By</TD><TD style="WIDTH: 305px"><asp:DropDownList id="ddlOrderBy" runat="server" CssClass="field_input" AutoPostBack="True"><asp:ListItem Value="0">Stop Id Desc</asp:ListItem>
<asp:ListItem Value="1">Stop Id Asc</asp:ListItem>
...
<TR><TD style="WIDTH: 60px; HEIGHT: 22px" class="td_cell">&nbsp;<asp:Label 
            ...
            CssClass="field_caption"></asp:Label></TD><TD style="WIDTH: 51px; HEIGHT: 22px">
        ...
        <asp:Label id="Label5" runat="server" Text="Excursion Group Name" Width="120px" 
            CssClass="field_caption"></asp:Label></TD><TD style="WIDTH: 305px; HEIGHT: 22px">
    ...
    <asp:Panel id="Panel1" runat="server" Height="130px" Width="759px"><TABLE><TBODY><TR><TD style="WIDTH: 107px" class="td_cell">
        <asp:Label id="Label2" runat="server" Text="Excursion Type Code" Width="111px" 
            CssClass="field_caption"></asp:Label></TD><TD style="WIDTH: 208px">
        ...
        <asp:Label id="Label3" runat="server" Text="Excursion Type Name" Width="120px" 
            CssClass="field_caption" ToolTip="Excursion Type Code"></asp:Label></TD><TD>
        ...
        <TR><TD style="WIDTH: 107px" class="td_cell">From Date</TD><TD style="WIDTH: 208px">
            ...
            <ews:DatePicker id="dpToDate" tabIndex=8 runat="server" Width="185px" 
                CssClass="field_input" 
                RegExErrorMessage="Please enter a date in the format: dd/mm/yyyy" 
                DateFormatString="dd/MM/yyyy"></ews:DatePicker></TD></TR><TR>
            <TD style="WIDTH: 119px; height: 17px;" class="td_cell">
    <input id="txtconnection" runat="server" style="visibility: hidden; width: 12px;
        height: 9px" type="text" /></TD><TD style="height: 17px"></TD>
            <td style="height: 17px"> Remarks</td><td style="height: 17px">
            <INPUT style="WIDTH: 299px" 
                        id="txtremarks" class="field_input" tabIndex=1 type=text maxLength=20 
                        runat="server" />
...
<ItemTemplate>
<asp:Label id="lblmstopid" runat="server" Text='<%# Bind("mstopid") %>'></asp:Label> 
</ItemTemplate>
    <ItemStyle VerticalAlign="Top" />
</asp:TemplateField>
<asp:BoundField DataField="mstopid" SortExpression="mstopid" HeaderText="Stop ID">
