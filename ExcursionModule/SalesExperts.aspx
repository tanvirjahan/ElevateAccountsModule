<%@ Page Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="SalesExperts.aspx.vb" Inherits="Other_Services_Selling_Types"  %>
...
<TABLE style="BORDER-RIGHT: gray 2px solid; BORDER-TOP: gray 2px solid; BORDER-LEFT: gray 2px solid; WIDTH: 700px; BORDER-BOTTOM: gray 2px solid"><TBODY><TR><TD class="td_cell" align=center colSpan=4>
    <asp:Label id="lblHeading" runat="server" Text="Add New Sales Experts" 
    ...
    <TD style="HEIGHT: 22px; width: 487px;" align=left>
     ...
     <tr>
         <td class="td_cell" visible =false style="WIDTH: 549px; HEIGHT: 29px">
             </td>
         <td align="left" style="HEIGHT: 29px; width: 487px;">
             <INPUT style="WIDTH: 90px; height: 20px;" visible =false id="txtcommi" class="txtbox" 
                 tabIndex=2 type=text 
    ...
    <TR><TD style="WIDTH: 549px; HEIGHT: 24px" visible =false class="td_cell"></TD>
        <TD style="HEIGHT: 24px; width: 487px;">
        <INPUT id="chkActive" tabIndex=5  visible =false type=checkbox CHECKED runat="server" /></TD></TR>
        <TR>
