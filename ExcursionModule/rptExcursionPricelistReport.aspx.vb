...
Partial Class rptPricelistReport
    ...
    Private Sub BindReport()
        Try
            ...
            rep.Load(Server.MapPath("~\Report\oplistwithcost.rpt"))
            ...
            pname = pnames.Item("@groupcode")
            'paramvalue.Value = Session("repfilter")
            paramvalue.Value = Request.QueryString("groupcode")
            param = pname.CurrentValues
            param.Add(paramvalue)
            pname.ApplyCurrentValues(param)

            pname = pnames.Item("@subgroupcode")
            'paramvalue.Value = Session("repfilter")
            paramvalue.Value = Request.QueryString("subcode")
            param = pname.CurrentValues
            param.Add(paramvalue)
            pname.ApplyCurrentValues(param)
