<%@ Page Language="VB" MasterPageFile="~/ExcursionMaster.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="ExcursionsectorwisePriceListSearch.aspx.vb" Inherits="ExcursionsectorwisePriceListSearch"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('PRICELIST:" " SECTOR:" " CLASSIFICATION:" " APPROVEDSTATUS:" " TEXT:" "');
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      ...
                      switch (category) {
                          case 'PRICELIST':
                              ...
                              var asSqlqry = "select ltrim(rtrim(eplistcode)) PRICELIST  from excplist_header(nolock) WHERE isnull(sectoryesno,0)=1  order by eplistcode";
                              glcallback = callback;
                    ...
                    <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
                        ...
                        <tr>
                            <td style="text-align: center; width: 100%;" align="center" class="field_heading">
                                <asp:label id="Label1" runat="server" cssclass="field_heading" text="Excursion SectorWise Pricelist Search">
                                </asp:label>
                            </td>
                        </tr>
                        <tr>
