...
Partial Class ExcursionPriceListSearch
            ...
            Try
                ...
                Else
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                             CType(strappname, String), "ExcursionModule\ExcursionPriceListSearch.aspx?appid=" + strappid + "&Type=" + Session("OthPListFilter"), btnAddNew, btnExportToExcel, _
                ...
                Session("sDtDynamic_Exec_Search_Plist") = Nothing
                ...
                Session("sDtDynamic_Exec_Search_Plist") = dtDynamic
                '--------end
...
#Region "Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = 'ASC')"
    Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        Try
            ...
            strSqlQry = "select h.eplistcode,h.classcode,c.classificationname classname,h.currcode,h.applicableto,status=	case when isnull(approved,0)=1 then 'Yes' else 'No' End,h.frmdate, " _
                & " h.todate,h.adddate,h.adduser,h.moddate,h.moduser from excplist_header h,excclassification_header c where h.classcode=c.classificationcode and isnull(h.sectoryesno,0)=0 "
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        strpop = "window.open('OthPriceList1.aspx?State=New&costtype=N','OthPriceList1');"
...
#Region "Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand"
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            '' If we select particular Pricelist click edit not opening page
            ...
            If e.CommandName = "Editrow" Then
                ...
                strpop = "window.open('OthPriceList1.aspx?State=Edit&costtype=N&RefCode=" + CType(lblId.Text.Trim, String) + "','OthPriceList1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ElseIf e.CommandName = "View" Then
                ...
                strpop = "window.open('OthPriceList1.aspx?State=View&costtype=N&RefCode=" + CType(lblId.Text.Trim, String) + "','OthPriceList1');"
            ...
            ElseIf e.CommandName = "Deleterow" Then
                ...
                strpop = "window.open('OthPriceList1.aspx?State=Delete&costtype=N&RefCode=" + CType(lblId.Text.Trim, String) + "','OthPriceList1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ...
            ElseIf e.CommandName = "Copy" Then
                ...
                strpop = "window.open('OthPriceList1.aspx?State=Copy&costtype=N&RefCode=" + CType(lblId.Text.Trim, String) + "','OthPriceList1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
...
#End Region
    Protected Sub btnResetSelection_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnResetSelection.Click
        ...
        dtt = Session("sDtDynamic_Exec_Search_Plist")
        If dtt.Rows.Count > 0 Then
            dtt.Clear()
        End If
        Session("sDtDynamic_Exec_Search_Plist") = dtt
...
#Region " Protected Sub gv_SearchResult_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gv_SearchResult.Sorting"
    ...
    Protected Sub gv_SearchResult_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gv_SearchResult.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            dtDynamics = Session("sDtDynamic_Exec_Search_Plist")
            If Session("sDtDynamic_Exec_Search_Plist") IsNot Nothing Then
    ...
    Protected Sub lbClose_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            If dtDynamics.Rows.Count > 0 Then
                ...
                Next
            End If
            Session("sDtDynamic_Exec_Search_Plist") = dtDynamics
...
#End Region
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If Not Session("sDtDynamic_Exec_Search_Plist") Is Nothing Then
            FillGridNew()
        Else
            Select Case ddlOrderBy.SelectedIndex
                Case 0
    ...
    Protected Sub btnHelp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnHelp.Click
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=ExcPriceList','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    End Sub
        ...
        For i = 0 To lsMainArr.GetUpperBound(0)
            Select Case lsMainArr(i).Split(":")(0).ToString.ToUpper.Trim
                ...
                Case "CURRENCY"
                    ...
                    sbAddToDataTable("CURRENCY", lsProcessCountry, "CURRENCY")
                Case "CLASSIFICATION"
    ...
    Private Sub FillGridNew()
        ...
        Try
            ...
            strSqlQry = "select h.eplistcode,h.classcode,c.classificationname classname,h.currcode,h.applicableto,status=	case when isnull(approved,0)=1 then 'Yes' else 'No' End,h.frmdate,h.todate,h.adddate, " _
                 & "	h.adduser,h.moddate,h.moduser from excplist_header h,excclassification_header c where h.classcode=c.classificationcode and isnull(h.sectoryesno,0)=0 "
    ...
    Private Function BuildConditionNew(ByVal strCountryValue As String, ByVal strCityValue As String, ByVal strSectorValue As String, ByVal strSectorGroupValue As String, ByVal strTextValue As String) As String
        ...
        If strSectorGroupValue <> "" Then
            ...
            Else
                ...
                Else
                    strWhereCond = strWhereCond & " AND  snull(approved,0) IN (0,1)"
                End If
            ...
            For i = 0 To lsMainArr.GetUpperBound(0)
                ...
                If strValue <> "" Then
                    If Trim(strWhereCond1) = "" Then
                        strWhereCond1 = " (upper(eplistcode) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(currcode) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(classificationname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(approved) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    Else
                        strWhereCond1 = strWhereCond1 & " OR  (upper(eplistcode) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(currcode) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(classificationname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(approved) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    End If
                End If
            Next
            If Trim(strWhereCond) = "" Then
