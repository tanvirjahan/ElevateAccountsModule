...
Partial Class ExcSuppCtryGroups
...
#Region "Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            Me.SubMenuUserControl1.menuidval = objUser.GetMenuId(Session("dbconnectionName"), CType("ExcursionModule\ExcursionGroups.aspx?appid=" + CType(Request.QueryString("appid"), String), String), CType(Request.QueryString("appid"), Integer))
...
#Region "Protected Sub BtnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)"
    Protected Sub BtnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        'Session("CountrySelected_Sess") = wucCountrygroup.checkcountrylist
        'Session("AgentSelected_Sess") = wucCountrygroup.checkagentlist
...
#End Region
    ...
    Protected Sub BtnCancel_Click(sender As Object, e As System.EventArgs) Handles btnreset.Click
