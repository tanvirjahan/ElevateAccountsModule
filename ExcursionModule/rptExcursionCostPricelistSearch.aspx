<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptExcursionCostPricelistSearch.aspx.vb" Inherits="NewclientsSearch"  MasterPageFile="~/ExcursionMaster.master" Strict="true"  %>
                ...
                <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
                    ...
                    <tr>
                        <td class="field_heading" style="text-align: center; width: 100%;">
                            Report - Excursion Cost PriceList</td>
                    </tr>
                    <tr>
...
<TBODY>
    ...
    <tr>
        ...
        <td>
            <select id="ddlpartycode" runat="server" class="field_input" 
        ...
        <td>
            <select id="ddlpartyname" runat="server" class="field_input" 
