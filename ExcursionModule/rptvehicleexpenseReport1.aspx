<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptvehicleexpenseReport1.aspx.vb" Inherits="rptPricelistReport"  MasterPageFile="~/SubPageMaster.master" Strict="true"  %>
...
<script language="javascript" type="text/javascript" >
    ...
    <asp:Button ID="btnBack" runat="server" CssClass="field_button" 
                    Text="Back To Vehicle Expense " Width="180px" />&nbsp;<asp:Button ID="btnPrint" runat="server" CssClass="field_button"
            Text="Print" /></td>
                    </tr>
    </table>
