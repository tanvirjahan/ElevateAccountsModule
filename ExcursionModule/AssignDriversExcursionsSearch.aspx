<%@ Page Title="" Language="VB" MasterPageFile="~/ExcursionMaster.master" AutoEventWireup="false" CodeFile="AssignDriversExcursionsSearch.aspx.vb" Inherits="ExcursionModule_AssignDriversExcursionsSearch" %>
...
<table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;width:100%; border-bottom: gray 2px solid" class="td_cell" align="left">
 <TR style="COLOR: #000000">
              ...
              <asp:Label id="lblHeading" runat="server" Text="Assign Drivers for Excursions" CssClass="field_heading" Width="100%"></asp:Label>
              </TD>
              </TR>
...
<tr>
  <td>
          ...
          <td>
            <table style="width:990;">
              <tr>
                        ...
                        <td style="width:100px" align="left" class="td_cell">From Tour Date</td>
                        <td style="width:100px" align="left" class="td_cell"><asp:TextBox ID="fromdate" runat="server" AutoPostBack="false" CssClass="fiel_input" Width="60px"></asp:TextBox>
                        ...
                        <asp:ImageButton ID="ImgPBtnFrmDt" runat="server" 
                                ImageUrl="~/Images/Calendar_scheduleHS.png" Height="15px" TabIndex="1" /><cc1:MaskedEditValidator ID="MEVPFromDate" runat="server" ControlExtender="MEPFromDate" ControlToValidate="fromdate" CssClass="field_error" Display="Dynamic" EmptyValueBlurredText="Date is required" EmptyValueMessage="Date is required" ErrorMessage="MEPFromDate" InvalidValueBlurredMessage="Invalid Date" InvalidValueMessage="Invalid Date" TabIndex="-1" TooltipMessage="Date in dd/mm/yyyy format"> </cc1:MaskedEditValidator>
                        </td>
                        <td style="width:100px" align="left" class="td_cell">To Tour Date</td>
                        <td style="width:100px" align="left" class="td_cell"> <asp:TextBox ID="txtodate" 
                                runat="server" AutoPostBack="false" CssClass="fiel_input" Width="60px" 
                                Height="15px" TabIndex="2"></asp:TextBox>
                        ...
                        <cc1:MaskedEditValidator ID="MEVPToDate" runat="server" ControlExtender="MEPToDate" ControlToValidate="txtodate"  CssClass="field_error" Display="Dynamic" EmptyValueBlurredText="Date is required" EmptyValueMessage="Date is required" ErrorMessage="MEPToDate" InvalidValueBlurredMessage="Invalid Date" InvalidValueMessage="Invalid Date" TabIndex="-1" TooltipMessage="Date in dd/mm/yyyy format">
                         ...
                         <TD style="width:100px" align="left" class="td_cell">Excursion Type</td>
                        <td style="width:80px"><asp:DropDownList ID="ddlTransferType" runat="server" 
                                class="field_input" style="WIDTH:150px;" TabIndex="4"></asp:DropDownList></td> 
                        <td style="width: 22px"><asp:checkbox  ID="chkDate" runat="server" 
                                AutoPostBack="True" Width="20px" TabIndex="5"/></td>
                        <td  rowspan="2" style="width:200px">
                            <asp:TextBox id="txtRemarks" runat="server" 
                                CssClass="field_input" Width="260px" Height="50px"  
                                Font-Bold="True" Font-Size="Large" TextMode="MultiLine" TabIndex="6" 
              ...
              <tr>
                    <TD style="WIDTH:120px;" align="left" class="td_cell">From Request Date</td>
                   ...
                   <TD style="WIDTH:110px;" align="left" class="td_cell">To Request Date</td>
                   <td style="width:100px" align="left" class="td_cell">
              ...
              <tr>
                     <TD style="width:50px" align="left" class="td_cell">Hotel</td>
                      ...
                      <input type="text"  class="field_input MyAutoCompleteHotelClass MyAutoCompleteHotelTypeClass"     id="txthotelName"  runat="server"  style="width:245px" tabindex="12"/>
                      <SELECT  id="ddlHotelName" class="field_input MyDropDownListsuppValue" runat="server" style="width:250px" tabindex="13"></SELECT>
                      </td>
                  ...
                  <td style="width:180px">Excursion Id</td>
                  <TD style="width:140px" class="td_cell">
                  <asp:TextBox id="txtExcursionId" runat="server" CssClass="field_input" 
                          Width="200px" Enabled="True" TabIndex="15"></asp:TextBox> </td>
              </tr>
             
               <tr>
                 <TD style="width:50px" align="left" class="td_cell">Client</td>
                  <td  class="td_cell" style="width:350px">
                  <input type="text"  class="field_input MyAutoCompleteClass"  id="txtagent"  runat="server"  style="width:245px" tabindex="16"/>
                  <SELECT  id="ddlAgent" class="field_input  MyDropDownListCustValue" runat="server" style="width:250px" tabindex="17"></SELECT>
                  </td>

                  <td style="width:140px">Ticket No</td>
                  <TD style="width:140px" class="td_cell">
                  <asp:TextBox id="txtTicketNo" runat="server" CssClass="field_input" Width="200px" 
                          Enabled="True" TabIndex="18"></asp:TextBox> </td>
              </tr>
    ...
    <%--<asp:Panel ID="pngv" runat="server"  Width="900px" Height="300px"  scrollbars="Auto">--%>
        <asp:GridView id="gv_SearchResult" Width="100%" tabIndex=9 runat="server" 
                      Font-Size="10px" CssClass="grdstyle" GridLines="Vertical"  CellPadding="3" 
                      BorderWidth="1px" BorderStyle="None" AutoGenerateColumns="False" 
                      AllowPaging ="true" PageSize="20">
        <FooterStyle CssClass="grdfooter"></FooterStyle>
        <Columns>
             
               <asp:TemplateField Visible="false" HeaderText="RequestLineNo"><EditItemTemplate><asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("rlineno") %>' ReadOnly="true"></asp:TextBox></EditItemTemplate>
               <ItemTemplate><asp:Label id="lblCode" runat="server" Text='<%# Bind("rlineno") %>' ReadOnly="true"></asp:Label></ItemTemplate></asp:TemplateField>
              ...
              <asp:BoundField HtmlEncode="False"  DataField="othtypname"  HeaderText="Excursion" ReadOnly ="true">
                  <HeaderStyle Width="20%" Wrap="true" />
                 <ItemStyle Width="20%" Wrap="true" />
              </asp:BoundField>
                 <asp:BoundField HtmlEncode="False" DataFormatString="{00:dd/MM/yyyy}"   DataField="tourdate"  HeaderText="Tour Date" ReadOnly ="true">
               ...
               <asp:BoundField DataField="drivername" HeaderText="Driver Name" ReadOnly="True"></asp:BoundField>
              ...
              <HeaderStyle Width="15%" Wrap="true" />
               <Itemstyle ForeColor ="Blue" width="15%" Wrap="false" ></itemstyle></asp:ButtonField>
               <asp:TemplateField Visible="false" HeaderText="Driver Code">
               <ItemTemplate><asp:Label id="lblsdrivercode" runat="server" Text='<%# Bind("drivercode") %>' ReadOnly="true"></asp:Label></ItemTemplate></asp:TemplateField>
         </Columns>
  ...
  <%-- </asp:Panel>--%>
               ...
               <div ID="divassigntransfer" runat="server" style="border: 3px solid #04a205; background-color: #FFFFFF; width: 900px">
               <table style="width:900px;">
                   <tr>
                      <td style="width:110px" class="td_cell">Excursion Id</td>
                      <td><asp:TextBox ID="txtTransferIDvalue" runat="server" ReadOnly="true" CssClass ="fiel_input" Width="100px"></asp:TextBox> </td>
                      <td style="width:130px" class="td_cell">Excursion Type</td>
                     <td><asp:TextBox ID="txtTransferTypevalue" runat="server" ReadOnly="true" CssClass ="fiel_input" Width="150px"></asp:TextBox> </td>
                      <td style="width:70px" class="td_cell">Agent Name</td>
                     <td><asp:TextBox ID="txtagentName" runat="server" readonly=true CssClass ="fiel_input" Width="150px"></asp:TextBox> </td>
                      <td style="width:80px" class="td_cell">Ticket No</td>
                     <td><asp:TextBox ID="txtclientRefvalue" runat="server" ReadOnly="true" CssClass ="fiel_input" Width="100px"></asp:TextBox> </td>
                   </tr>
                   <tr>
                     <td style="width:95px" class="td_cell">Tour Date</td>
                     <td><asp:TextBox ID="txtTransferDatevalue" runat="server" ReadOnly="true" CssClass ="fiel_input" Width="100px"></asp:TextBox> </td>
                     <td id="Td1" style="width:70px" runat="server" class="td_cell">Hotel Name</td>
                     <td><asp:TextBox ID="txtHotelNameValue" runat="server" ReadOnly="true" CssClass ="fiel_input" Width="150px" TextMode="MultiLine"></asp:TextBox> </td>
                     <td id="Td6" runat="server" class="td_cell" style="width:120px"> Guest Name</td>
                     <td><asp:TextBox ID="txtGuestNameValue" runat="server" CssClass="fiel_input" ReadOnly="true" Width="150px"></asp:TextBox></td>
                  </tr>
                  <tr>

                             <td style="width:75px"> Driver Name</td>
                             <td><select ID="ddlDriverName" runat="server" class="field_input" onchange="gettelehpone();" style="WIDTH: 100px;" tabindex="19"></select></td>
                             <td style="width:80px">Driver Tel No</td>
                             <td><asp:TextBox ID="txtTelephone" runat="server" CssClass="fiel_input" Width="100px" ReadOnly="true" TabIndex="20"></asp:TextBox></td>
                </tr>
                          ...
                          <table>
                              <tr>
                                  <td style="WIDTH: 100px">
                                      <asp:GridView ID="Gv_DriverName" runat="server" AutoGenerateColumns="False" 
                                          Width="300px">
                                          <Columns>
                                              ...
                                              <asp:TemplateField HeaderText="Driver Name">
                                                  <ItemTemplate>
                                                      <select ID="ddldrivernamevalue" runat="server" class="field_input" 
                                                          style="WIDTH: 115px">
                                              ...
                                              <asp:TemplateField HeaderText="Tele Phone">
                                                  <ItemTemplate>
                                                      <asp:TextBox ID="txttelephonevalue" runat="server" CssClass="field_input" 
                              ...
                              <tr>
                                  <td>
                                      <asp:Button ID="btnAddRow" runat="server" CssClass="field_button" 
                                          Text="Add Row" />
                                      &nbsp;
                                      <asp:Button ID="btnDeleteRow" runat="server" CssClass="field_button" 
                                          Text="Delete Row" />
                                  </td>
                              </tr>
                          </table>
...
<cc1:modalpopupextender id="ModalPopupDays" runat="server" BehaviorID="ModalPopupDays"
	...
	targetcontrolid="btnInvisibleGuest" popupcontrolid="divassigntransfer"
