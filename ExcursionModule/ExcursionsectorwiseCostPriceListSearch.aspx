<%@ Page Language="VB" MasterPageFile="~/ExcursionMaster.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="ExcursionsectorwiseCostPriceListSearch.aspx.vb" Inherits="ExcursionsectorwiseCostPriceListSearch"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('PRICELIST:" " SUPPLIER:"  " SECTOR:" " CLASSIFICATION:" " APPROVEDSTATUS:" " TEXT:" "');
          window.visualSearch = VS.init({
            ...
            'access'
              ...
              callbacks: {
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      ...
                      switch (category) {
                          case 'PRICELIST':
                              ...
                              var asSqlqry = "select ltrim(rtrim(eplistcode)) PRICELIST  from exccplist_header(nolock) WHERE isnull(sectoryesno,0)=1  order by eplistcode";
                              glcallback = callback;
                              ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                              break;
                          case 'SUPPLIER':

                              var asSqlqry = 'select ltrim(rtrim(partyname)) partyname  from  partymast where active=1 and sptypecode in (select option_selected from reservation_parameters where param_id=1033)  order by partyname ';
                              glcallback = callback;
                              //fnTestCallback();
                              ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                          ...
                          case 'SECTOR':
                              ...
                              var asSqlqry = 'select ltrim(rtrim(othtypname)) SECTOR  from  othtypmast where active=1 and othgrpcode in (select option_selected from reservation_parameters where param_id=1001)  order by othtypname ';
                              glcallback = callback;
                              //fnTestCallback();
                              ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                ...
                { label: 'PRICELIST', category: 'Sector' },
                 { label: 'SUPPLIER', category: 'Sector' },
                { label: 'SECTOR', category: 'Sector' },
                { label: 'CLASSIFICATION', category: 'Sector' },
                ...
                <div style="margin-top: -6px; margin-left: 13px;">
                    <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
                        ...
                        <tr>
                            <td style="text-align: center; width: 100%;" align="center" class="field_heading">
                                <asp:label id="Label1" runat="server" cssclass="field_heading" text="Excursion Sectorwise Cost Pricelist Search">
                                </asp:label>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <td class ="td_cell">
                        <asp:DropDownList ID="ddlOrder" runat="server">
                            ...
                            <asp:ListItem Value="P">Price List Date</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class ="td_cell">
                    ...
                    <td class ="td_cell">  <asp:Label ID="RowSelectss" runat="server" CssClass="field_caption" 
                                        ...
                                        BorderStyle="Solid">
                                            <FooterStyle CssClass="grdfooter"></FooterStyle>
                                                        <Columns>
                                                          ...
                                                          <asp:TemplateField  HeaderText="PricelistCode" Visible ="false" >
                                                        <ItemTemplate>
                                                        <asp:Label id="lblplistcodenew" runat="server" Text='<%# Bind("eplistcode") %>'></asp:Label> 
                                                        </ItemTemplate>
                                                        </asp:TemplateField >

                                                        <asp:TemplateField  HeaderText="PricelistCode" >
                                                        <ItemTemplate>
                                                        <asp:Label id="lblplistcode" runat="server" Text='<%# Bind("eplistcode") %>'></asp:Label> 
                                                        </ItemTemplate>
                                                        </asp:TemplateField >

                                                        <asp:TemplateField HeaderText="classcode" visible="false" >
                                                        <ItemTemplate>
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblpartycode" runat="server" Text='<%# Bind("partycode") %>' ></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                         ...
                                                         <asp:TemplateField HeaderText="Sectorcode" visible="false" >
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblsectorcode" runat="server" Text='<%# Bind("othtypcode") %>' ></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Sector">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblsectorname" runat="server" Text='<%# Bind("othtypname") %>' ></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
