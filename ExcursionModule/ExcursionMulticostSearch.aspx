<%@ Page Language="VB" MasterPageFile="~/ExcursionMaster.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="ExcursionMulticostSearch.aspx.vb" Inherits="ExcursionMulticostSearch"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('PRICELIST:" " EXCURSIONS:" " VEHICLE:" " APPROVEDSTATUS:" " TEXT:" "');
            ...
            'access'
              ...
              callbacks: {
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      ...
                      switch (category) {
                          case 'PRICELIST':
                              ...
                              var asSqlqry = "select ltrim(rtrim(eplistcode)) PRICELIST  from excmulticplist_header(nolock)    order by eplistcode";
                              glcallback = callback;
                              ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                              break;
                          case 'EXCURSIONS':

                              var asSqlqry = "select exctypname  EXCURSIONS  from  view_excursiontypes where active=1 and multicost='YES'  order by exctypname ";
                              glcallback = callback;
                              //fnTestCallback();
                              ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                          ...
                          case 'VEHICLE':
                              ...
                              var asSqlqry = 'select othcatname  from  othcatmast where active=1 and  othgrpcode in (select option_selected from reservation_parameters where param_id=564) order by othcatname ';
                              glcallback = callback;
                              //fnTestCallback();
                              ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                ...
                { label: 'PRICELIST', category: 'Sector' },
                 { label: 'EXCURSIONS', category: 'Sector' },
                { label: 'VEHICLE', category: 'Sector' },
                    ...
                    <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
                        ...
                        <tr>
                            <td style="text-align: center; width: 100%;" align="center" class="field_heading">
                                <asp:label id="Label1" runat="server" cssclass="field_heading" text="Excursion Multicost Search">
                                </asp:label>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        BorderStyle="Solid">
                                            <FooterStyle CssClass="grdfooter"></FooterStyle>
                                                        ...
                                                        <ItemTemplate>
                                                           ...
                                                           <asp:TemplateField HeaderText="Excursion">
                                                        <ItemTemplate>
                                                          ...
                                                          <asp:TemplateField HeaderText="othcatcode" visible="false" >
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblothcatcode" runat="server" Text='<%# Bind("othcatcode") %>' ></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                          <asp:TemplateField HeaderText="Vehicle Name"  >
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblothcatname" runat="server" Text='<%# Bind("othcatname") %>' ></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Applicable To">
                                                         ...
                                                         <asp:TemplateField HeaderText="Sector Groups" >
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblSectorGroup" runat="server" Text='<%# Bind("sectorgroupName") %>' ></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
