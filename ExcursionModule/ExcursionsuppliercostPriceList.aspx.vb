...
Partial Class ExcursionsuppliercostPriceList
...
#Region "Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Try
            ...
            If IsPostBack = False Then
                ...
                If Request.QueryString("State") = "New" Then
                    Page.Title = Page.Title + " " + "New " + strtitle + IIf(ViewState("costtype") = "N", "Excursion Supplier CostPrice List", "Excursion Supplier SectorCost Price List")
                    lblHeading.Text = IIf(ViewState("costtype") = "N", "New Excursion Supplier Cost Price List", "New Excursion Supplier Sector Cost Price List")
                ...
                ElseIf Request.QueryString("State") = "Copy" Then
                    Page.Title = Page.Title + " " + "Copy " + strtitle + IIf(ViewState("costtype") = "N", "Excursion Supplier CostPrice List", "Excursion Supplier SectorCost Price List")
                    lblHeading.Text = IIf(ViewState("costtype") = "N", "Copy Excursion Supplier Cost Price List", "Copy Excursion Supplier Sector Cost Price List")
                ElseIf Request.QueryString("State") = "Edit" Then
                    Page.Title = Page.Title + " " + "Edit " + strtitle + IIf(ViewState("costtype") = "N", "Excursion Supplier CostPrice List", "Excursion Supplier SectorCost Price List")
                    lblHeading.Text = IIf(ViewState("costtype") = "N", "Edit Excursion Supplier Cost Price List", "Edit Excursion Supplier Sector Cost Price List")
                ElseIf Request.QueryString("State") = "View" Then
                    Page.Title = Page.Title + " " + "View" + strtitle + IIf(ViewState("costtype") = "N", "Excursion Supplier CostPrice List", "Excursion Supplier SectorCost Price List")
                    lblHeading.Text = IIf(ViewState("costtype") = "N", "View Excursion Supplier Cost Price List", "View Excursion Supplier Sector Cost Price List")
                ElseIf Request.QueryString("State") = "Delete" Then
                    Page.Title = Page.Title + " " + "Delete " + strtitle + IIf(ViewState("costtype") = "N", "Excursion Supplier CostPrice List", "Excursion Supplier SectorCost Price List")
                    lblHeading.Text = IIf(ViewState("costtype") = "N", "Delete Excursion Supplier Cost Price List", "Delete Excursion Supplier Sector Cost Price List")
                End If
        ...
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            objUtils.WritErrorLog("Excursionsupplliercostpricelist.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        End Try
    End Sub
#End Region
...
#Region "Private Sub ShowRecord(ByVal RefCode As String)"
    Private Sub ShowRecord(ByVal RefCode As String)
        Try
            ...
            mySqlCmd = New SqlCommand("Select h.*,c.classificationname from exccplist_header h, excclassification_header c Where h.classcode=c.classificationcode and  h.eplistcode='" & RefCode & "'", mySqlConn)
...
#Region "Protected Sub btnGenerate_Click(ByVal sender As Object, ByVal e As System.EventArgs)"
    Protected Sub btnGenerate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        Try
            ...
            If ViewState("costtype") = "N" Then
                strSqlQry = "select  h.exctypcode,h.exctypname,h.ratebasis,d.seniorallowed ,0 Adult,0 Child,0 Senior,0 Unit, 0 Half,0 FullDay from view_excursiontypes h (nolock) left join excursiontypes_occupancy  d on h.exctypcode=d.exctypcode " _
                    & " inner join  excursiontypes_suppliers es on h.exctypcode =es.exctypcode  where active=1 and h.classificationcode='" & txtgroupcode.Text & "' and es.partycode='" & txtsuppcode.Text & "'and  isnull(h.sectorwiserates,'')='NO'  and isnull(h.multicost,'') ='NO'"
            Else
                ...
                & " and active=1 and ec.sectorgrpcode in (" & strCondition1 & ") and  h.classificationcode='" & txtgroupcode.Text & "' and es.partycode='" & txtsuppcode.Text & "'   and isnull(h.multicost,'') ='NO'"
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack() = False Then
            ...
            wucCountrygroup.sbSetPageState("", "EXCCOSTPLIST", CType(ViewState("pricelistState"), String))
    ...
    Private Sub Showdetailsgrid(ByVal RefCode As String)
        Try
            ...
            Else
             ...
             & " inner join  excursiontypes_suppliers es on h.exctypcode =es.exctypcode inner join exctypes_sectorgrp ec on h.exctypcode=ec.exctypcode  where  isnull(h.sectorwiserates,'')='YES' " _
             & " and active=1 and  ec.sectorgrpcode in (" & Session("sectors") & ")  and  h.classificationcode='" & txtgroupcode.Text & "' and es.partycode='" & txtsuppcode.Text & "'   and isnull(h.multicost,'') ='NO'"
            ...
            If cnt > 0 Then
                ...
                If ViewState("costtype") = "N" Then
                    ...
                    strSqlQry = "select  * from (select  h.exctypcode,h.exctypname,h.ratebasis,isnull(d.seniorallowed,'') seniorallowed, 0 Adult,0 Child,0 Senior,0 Unit, 0 Half,0 FullDay from view_excursiontypes h (nolock) left join excursiontypes_occupancy  d on h.exctypcode=d.exctypcode  " _
                                    & " inner join  excursiontypes_suppliers es on h.exctypcode =es.exctypcode  where active=1 and classificationcode='" & txtgroupcode.Text & "' and es.partycode='" & txtsuppcode.Text & "' and isnull(h.sectorwiserates,'') ='NO'  and   isnull(h.multicost,'') ='NO'  and h.exctypcode not in (select exccode from exccplist_detail where eplistcode='" & RefCode & "') union all " _
                                    ...
                                    & "  from exccplist_header eh, exccplist_detail a inner join  view_excursiontypes h (nolock) on a.exccode=h.exctypcode left join excursiontypes_occupancy  d on h.exctypcode=d.exctypcode  inner join  excursiontypes_suppliers es on h.exctypcode =es.exctypcode  " _
                                    & " where  eh.eplistcode=a.eplistcode  and active=1 and classificationcode='" & txtgroupcode.Text & "' and es.partycode='" & txtsuppcode.Text & "'  and " _
                                    & "   isnull(h.sectorwiserates,'') ='NO' and  isnull(h.multicost,'') ='NO'  and a.eplistcode='" & RefCode & "' group by h.exctypcode,h.exctypname,h.ratebasis,d.seniorallowed) rs  order by  rs.exctypcode "

                Else

                    strSqlQry = "select  distinct * from (select  h.exctypcode,h.exctypname,h.ratebasis,isnull(d.seniorallowed,'') seniorallowed, 0 Adult,0 Child,0 Senior,0 Unit, 0 Half,0 FullDay from view_excursiontypes h (nolock) left join excursiontypes_occupancy  d on h.exctypcode=d.exctypcode  " _
                      & " inner join  excursiontypes_suppliers es on h.exctypcode =es.exctypcode  inner join exctypes_sectorgrp ec on h.exctypcode=ec.exctypcode    where es.partycode='" & txtsuppcode.Text & "' and  " _
                      & " ec.sectorgrpcode in (" & Session("sectors") & ")  and active=1 and classificationcode='" & txtgroupcode.Text & "' and isnull(h.sectorwiserates,'') ='YES'  and isnull(h.multicost,'')='NO'  and h.exctypcode not in (select exccode from exccplist_detail where eplistcode='" & RefCode & "') union all " _
                      & "  select  h.exctypcode,h.exctypname,h.ratebasis,isnull(d.seniorallowed,'') seniorallowed ,   max(case when a.adttype ='Adult' then round(a.price,2) else 0 end) Adult,  	max(case when a.adttype ='Child' then a.price else 0 end) Child,  " _
                      & " max(case when a.adttype ='Senior' then a.price else 0 end) Senior, max(case when a.adttype ='Unit' then a.price else 0 end) Unit, max(case when a.adttype ='Half' then a.price else 0 end) Half, max(case when a.adttype ='Full' then a.price else 0 end) FullDay  " _
                      & "  from exccplist_header eh cross apply dbo.splitallotmkt(eh.sectorgroupcode,',') esc, exccplist_detail a inner join  view_excursiontypes h (nolock) on a.exccode=h.exctypcode left join excursiontypes_occupancy  d on h.exctypcode=d.exctypcode   where eh.eplistcode=a.eplistcode and isnull(eh.sectoryesno,0)=1  and   esc.mktcode in (" & Session("sectors") & ") and active=1 and classificationcode='" & txtgroupcode.Text & "'  and " _
                      & " isnull(h.sectorwiserates,'') ='YES' and isnull(h.multicost,'') ='NO' and a.eplistcode='" & RefCode & "' group by h.exctypcode,h.exctypname,h.ratebasis,d.seniorallowed) rs  order by  rs.exctypcode "
    ...
    Private Sub ShowDates(ByVal RefCode As String)
        Try
            ...
            strSqlQry = "select count( distinct frmdate) from exccplist_dates(nolock) where eplistcode='" & RefCode & "'" '" ' and subseasnname = '" & subseasonname & "'"
            ...
            Dim dpTDate As TextBox
            mySqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))           'connection open            
            mySqlCmd = New SqlCommand("Select * from exccplist_dates(nolock) Where eplistcode='" & RefCode & "'", mySqlConn)
            mySqlReader = mySqlCmd.ExecuteReader(CommandBehavior.CloseConnection)
            If mySqlReader.HasRows Then
    ...
    Protected Sub btnhelp_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        If ViewState("costtype") = "N" Then
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=ExcSupplierPriceEntry','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
        ElseIf ViewState("costtype") = "S" Then
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=ExcSuppSecWisePriceEntry','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
        End If
    End Sub
            ...
            For Each gvRow1 In grdDates.Rows
                ...
                If txtfromdate.Text <> "" And txttodate.Text <> "" Then
                    ...
                    For Each gvRow In grdExrates.Rows
                        ...
                        parm3(12) = New SqlParameter("@partycode", CType(txtsuppcode.Text, String))
                        parm3(13) = New SqlParameter("@sectorcode", CType(txtsectorcode.Text, String))
                        ...
                        ds1 = New DataSet()
                        If ViewState("costtype") = "N" Then
                            ds1 = objUtils.ExecuteQuerynew(Session("dbconnectionName"), "sp_chkexc_costplist", parms3)
                        Else
                            ds1 = objUtils.ExecuteQuerynew(Session("dbconnectionName"), "sp_chkexc_sectorcostplist", parms3)
                        End If
                        ...
                        If ds1.Tables.Count > 0 Then
                            If ds1.Tables(0).Rows.Count > 0 Then
                                If IsDBNull(ds1.Tables(0).Rows(0)("eplistcode")) = False Then
                                    ...
                                    strMsg = "Excursion Price List already exists For this  Dates   " + " - Pricelist Id " + ds1.Tables(0).Rows(0)("eplistcode") + " - Country " + ds1.Tables(0).Rows(0)("ctryname") + " - Agent - " + ds1.Tables(0).Rows(0)("agentname")
            ...
            If Page.IsValid = True Then
                If ViewState("pricelistState") = "New" Or ViewState("pricelistState") = "Edit" Or ViewState("pricelistState") = "Copy" Then
                    ...
                    If ViewState("pricelistState") = "New" Or ViewState("pricelistState") = "Copy" Then
                        ...
                        If ViewState("costtype") = "N" Then
                            optionName = "EXCCPLIST"
                        Else
                            optionName = "EXSECCPIST"
                        End If
                        ...
                        mySqlCmd = New SqlCommand("sp_add_exccostPListh", mySqlConn, sqlTrans)
                    ElseIf ViewState("pricelistState") = "Edit" Then
                        'Inserting Into Logs
                        mySqlCmd = New SqlCommand("sp_excursioncostpriceslist_logs", mySqlConn, sqlTrans)
                        ...
                        mySqlCmd = New SqlCommand("sp_mod_exccostPListh", mySqlConn, sqlTrans)
                    End If
                    ...
                    mySqlCmd.Parameters.Add(New SqlParameter("@partycode", SqlDbType.VarChar, 20)).Value = CType(txtsuppcode.Text.Trim, String)
                    ...
                    Else
                        ...
                        mySqlCmd.Parameters.Add(New SqlParameter("@sectorgroupcode", SqlDbType.Text)).Value = ""

                    End If
                    If txtVAT.Text <> "" Then 'Added by abin on 20180529
                    ...
                    mySqlCmd = New SqlCommand("DELETE FROM exccplist_countries  Where eplistcode='" & CType(txtPlcCode.Value.Trim, String) & "'", mySqlConn, sqlTrans)
                    mySqlCmd.CommandType = CommandType.Text
                    mySqlCmd.ExecuteNonQuery()

                    mySqlCmd = New SqlCommand("DELETE FROM exccplist_agents  Where eplistcode='" & CType(txtPlcCode.Value.Trim, String) & "'", mySqlConn, sqlTrans)
                    mySqlCmd.CommandType = CommandType.Text
                    mySqlCmd.ExecuteNonQuery()


                    mySqlCmd = New SqlCommand("DELETE FROM exccplist_detail  Where eplistcode='" & CType(txtPlcCode.Value.Trim, String) & "'", mySqlConn, sqlTrans)
                    mySqlCmd.CommandType = CommandType.Text
                    mySqlCmd.ExecuteNonQuery()

                    mySqlCmd = New SqlCommand("DELETE FROM exccplist_dates  Where eplistcode='" & CType(txtPlcCode.Value.Trim, String) & "'", mySqlConn, sqlTrans)
                    mySqlCmd.CommandType = CommandType.Text
                    mySqlCmd.ExecuteNonQuery()
                    ...
                    For Each GvRow In grdDates.Rows
                        ...
                        If dpFDate.Text <> "" And dpTDate.Text <> "" Then
                            mySqlCmd = New SqlCommand("sp_add_exccostplisth_dates", mySqlConn, sqlTrans)
                            mySqlCmd.CommandType = CommandType.StoredProcedure
                    ...
                    mySqlCmd = New SqlCommand("sp_upd_min_max_dates_exccost", mySqlConn, sqlTrans)
                    mySqlCmd.CommandType = CommandType.StoredProcedure
                    mySqlCmd.Parameters.Add(New SqlParameter("@eplistcode", SqlDbType.VarChar, 20)).Value = CType(txtPlcCode.Value.Trim, String)
                    mySqlCmd.ExecuteNonQuery()
                    ...
                    For Each GvRow In grdExrates.Rows
                        ...
                        mySqlCmd = New SqlCommand("sp_add_exccostplistdetail", mySqlConn, sqlTrans)
                        mySqlCmd.CommandType = CommandType.StoredProcedure
                    ...
                    If wucCountrygroup.checkcountrylist.ToString <> "" Then
                        ...
                        For i = 0 To arrcountry.Length - 1
                            ...
                            If arrcountry(i) <> "" Then
                                ...
                                mySqlCmd = New SqlCommand("sp_add_exccplist_countries", mySqlConn, sqlTrans)
                                mySqlCmd.CommandType = CommandType.StoredProcedure
                    ...
                    If wucCountrygroup.checkagentlist.ToString <> "" Then
                        ...
                        For i = 0 To arragents.Length - 1
                            ...
                            If arragents(i) <> "" Then
                                ...
                                mySqlCmd = New SqlCommand("sp_add_exccplist_agents", mySqlConn, sqlTrans)
                                mySqlCmd.CommandType = CommandType.StoredProcedure
                ...
                ElseIf ViewState("pricelistState") = "Delete" Then
                    ...
                    mySqlCmd = New SqlCommand("sp_del_excplisth_cost", mySqlConn, sqlTrans)
                    mySqlCmd.CommandType = CommandType.StoredProcedure
                    mySqlCmd.Parameters.Add(New SqlParameter("@eplistcode", SqlDbType.VarChar, 20)).Value = CType(txtPlcCode.Value.Trim, String)
                    mySqlCmd.ExecuteNonQuery()
...
<System.Web.Services.WebMethod()> _
    ...
    Private Sub ChkExistingValdiscount(ByVal prm_strChkdVal As String)
        ...
        End If
    End Sub
    Function Validatesector() As Boolean
        Validatesector = True
    ...
    Protected Sub btnoksector_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnoksector.Click
        ...
        If (CType(ViewState("pricelistState"), String) = "Edit" Or CType(ViewState("pricelistState"), String) = "Copy") Then
            ...
            For Each grdRow As DataListItem In gvSectors.Items
                ...
                If chkairportSelect.Checked = True Then
                    strQry = "select count(distinct h.exctypcode)  from view_excursiontypes h (nolock) left join excursiontypes_occupancy  d on h.exctypcode=d.exctypcode " _
                       & " inner join exccplist_detail e on h.exctypcode=e.exccode inner join  excursiontypes_suppliers es on h.exctypcode =es.exctypcode inner join exctypes_sectorgrp ec on h.exctypcode=ec.exctypcode  where  isnull(h.sectorwiserates,'')='YES' " _
                       & " and active=1 and  ec.sectorgrpcode='" & lblsector.Text & "'  and  h.classificationcode='" & txtgroupcode.Text & "' and es.partycode='" & txtsuppcode.Text & "'   and isnull(h.multicost,'') ='NO'"

                    cnt = objUtils.ExecuteQueryReturnSingleValuenew(Session("dbconnectionName"), strQry)

                    If cnt = 0 Then
                        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('In this Sector Not Assigned Any Excursion For this Supplier " + lblsectorname.Text + "');", True)
                        ModalSelectsector.Show()
                        Exit Sub
                    End If
                End If
        ...
        If applies.Length > 0 Then
            ...
            If txtsectorcode.Text <> Right(applies, Len(applies) - 1) And (CType(ViewState("pricelistState"), String) = "Edit" Or CType(ViewState("pricelistState"), String) = "Copy") Then

                Showdetailsgrid(txtPlcCode.Value)
            End If
