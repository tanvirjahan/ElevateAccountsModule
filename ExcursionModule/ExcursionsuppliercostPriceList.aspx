<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="ExcursionsuppliercostPriceList.aspx.vb" Inherits="ExcursionsuppliercostPriceList" %>
                ...
                <tbody>
                    <tr>
                        <td style="height: 18px; text-align: center" class="field_heading" align="left" colspan="4">
                            <asp:Label ID="lblHeading" runat="server" Text="Add New Excursion price List" CssClass="field_heading"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtCurrName" runat="server" CssClass="field_input" TabIndex="1"
                                Width="258px"></asp:TextBox>
                            <asp:TextBox ID="txtCurrCode" runat="server" Style="display: none" Width="194px"></asp:TextBox>
                            <asp:AutoCompleteExtender ID="txtCurrName_AutoCompleteExtender" runat="server" CompletionInterval="10"
                                ...
                                OnClientItemSelected="CurrNameautocompleteselected" ServiceMethod="Getcurrlist"
                                TargetControlID="txtCurrName">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:AutoCompleteExtender ID="txtgroupname_AutoCompleteExtender" runat="server" CompletionInterval="10"
                                CompletionListCssClass="autocomplete_completionListElement" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                                CompletionListItemCssClass="autocomplete_listItem" CompletionSetCount="1" DelimiterCharacters=""
                                EnableCaching="false" Enabled="True" FirstRowSelected="True" MinimumPrefixLength="0"
                                OnClientItemSelected="groupnameautocompleteselected" ServiceMethod="Getgrouplist"
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <%--  <asp:TextBox ID="txtsectorname" runat="server" ReadOnly ="true"  AutoPostBack="True" CssClass="field_input"
                                MaxLength="500" TabIndex="3" Width="258px" Height="48px" TextMode="MultiLine"></asp:TextBox>
                  ...
                  <asp:Button ID="btnselect" runat="server" CssClass="field_button" 
                    ...
                    <tr style="display: none">
                        ...
                        <td style="width: 122px; height: 3px">
                            <select style="width: 200px" id="ddlSPType" class="field_input" tabindex="2" onchange="CallWebMethod('sptypecode');"
                                runat="server" onclick="return ddlSPType_onclick()">
                        ...
                        <td style="height: 3px">
                            <select style="width: 300px" id="ddlSPTypeName" class="field_input" tabindex="3"
                                onchange="CallWebMethod('sptypename');" runat="server">
                                <option selected></option>
                            </select>
                        </td>
                    </tr>
                    <tr style="display: none">
                        ...
                        <td style="width: 122px; height: 3px">
                            <select id="ddlGroupCode" runat="server" class="field_input" name="D1" onchange="CallWebMethod('groupcd');"
                                style="width: 200px" tabindex="10">
                                <option selected=""></option>
                            </select>
                        </td>
                        <td style="height: 3px">
                            <select id="ddlGroupName" runat="server" class="field_input" name="D2" onchange="CallWebMethod('groupnm');"
                    ...
                    <tr id="airport" style="visibility: visible">
                        <td align="left" class="td_cell" style="width: 201px;">
                            <span style="font-family: Arial;">
                                <asp:Label ID="airportcode" runat="server" Text="Excursion Code" Visible="false"></asp:Label>
                            </span>
                        </td>
                        <td style="width: 122px;">
                            <select id="ddlexccode" runat="server" class="field_input" onchange="CallWebMethod('airportcd');"
                        ...
                        <td>
                            <select id="ddlexcname" runat="server" class="field_input" onchange="CallWebMethod('airportnm');"
                                style="width: 300px" tabindex="5" onclick="return ddlAirportnm_onclick()" visible="false">
                                <option selected=""></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td valign="top">
                            <div id="dv_SearchResult" runat="server" style="max-height: 250px; overflow: auto;">
                                <asp:GridView ID="grdDates" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    Font-Size="12px" GridLines="Vertical" TabIndex="5">
                                    <FooterStyle CssClass="grdfooter" />
                                    <Columns>
                        ...
                        <td align="left" class="td_cell" style="height: 22px">
                            <asp:Button ID="btnGenerate" runat="server" CssClass="field_button" OnClick="btnGenerate_Click"
                                ...
                                <asp:Button ID="btnhelp" runat="server" CssClass="field_button" Height="20px" OnClick="btnhelp_Click"
                                TabIndex="22" Text="Help" />
                        </td>
                    </tr>
                </tbody>
                <caption>
                    ...
                    <tr>
                        <td style="display: none">
                            &nbsp;
                            <asp:Button ID="btnCancel1" runat="server" CssClass="field_button" TabIndex="21"
                 ...
                 <td>
                     ...
                     &nbsp;<asp:CheckBox ID="chkPriceWithTax" runat="server" 
                         Text="All price are including tax" AutoPostBack="True" />
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="grdExrates" runat="server" AutoGenerateColumns="False" 
                                                    BackColor="White" BorderColor="#999999" BorderStyle="Solid" CellPadding="3" 
                                                    CssClass="td_cell" Font-Size="10px" GridLines="Vertical" TabIndex="10" 
                                                    Width="100%">
                                                    <FooterStyle CssClass="grdfooter" />
                                                    <Columns>
                                                        <asp:TemplateField HeaderText=" ">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="chkSelect" runat="server" CssClass="field_input" />
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="left" />
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="exctypcode" HeaderText="ExcursionTypecode" 
                                                            Visible="false" />
                                                        <asp:BoundField DataField="exctypname" HeaderText="ExcursionType" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Adult   <br />TV VAT">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtadult" runat="server" CssClass="field_input" 
                                                                    Style="text-align: left" Width="80px"></asp:TextBox>
                                                                <asp:AutoCompleteExtender ID="txtadult_AutoCompleteExtender" runat="server" 
                                                                    ...
                                                                    ServiceMethod="getFillRateType" TargetControlID="txtadult" UseContextKey="true">
                                                                </asp:AutoCompleteExtender>
                                                                  <br />
                                                         <div style="padding-top:3px;width:83px;">
                                                         <asp:TextBox ID="txtAdultTV"  AutoComplete="off"  CssClass="field_input" placeholder="&nbsp;&nbsp;TV"  onkeydown="fnReadOnly(event)"   runat="server" Width="36px"></asp:TextBox>
                                                         <asp:TextBox ID="txtAdultVAT"  AutoComplete="off"  CssClass="field_input" placeholder="&nbsp;VAT"  onkeydown="fnReadOnly(event)"  runat="server" Width="36px"></asp:TextBox>
                                                         </div>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Child   <br />TV VAT">
                                                            <HeaderStyle HorizontalAlign="Left" Width="60px" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtchild" runat="server" CssClass="field_input" 
                                                                    Style="text-align: left" Width="80px"></asp:TextBox>
                                                                <asp:AutoCompleteExtender ID="txtchild_AutoCompleteExtender" runat="server" 
                                                                    CompletionInterval="10" 
                                                                    CompletionListCssClass="autocomplete_completionListElement" 
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" 
                                                                    CompletionListItemCssClass="autocomplete_listItem" CompletionSetCount="1" 
                                                                    DelimiterCharacters="" EnableCaching="false" Enabled="True" 
                                                                    FirstRowSelected="false" MinimumPrefixLength="1" 
                                                                    ServiceMethod="getFillRateType" TargetControlID="txtchild" UseContextKey="true">
                                                                </asp:AutoCompleteExtender>
                                                                     <br />
                                                         <div style="padding-top:3px;width:83px;">
                                                         <asp:TextBox ID="txtChildTV"  AutoComplete="off"   CssClass="field_input" placeholder="&nbsp;&nbsp;TV"  onkeydown="fnReadOnly(event)"   runat="server" Width="36px"></asp:TextBox>
                                                         <asp:TextBox ID="txtChildVAT"  AutoComplete="off"  CssClass="field_input" placeholder="&nbsp;VAT"  onkeydown="fnReadOnly(event)"  runat="server" Width="36px"></asp:TextBox>
                                                         </div>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Senior   <br />TV VAT">
                                                            <HeaderStyle HorizontalAlign="Left" Width="60px" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtsenior" runat="server" CssClass="field_input" 
                                                                    Style="text-align: left" Width="80px"></asp:TextBox>
                                                                <asp:AutoCompleteExtender ID="txtsenior_AutoCompleteExtender" runat="server" 
                                                                    CompletionInterval="10" 
                                                                    CompletionListCssClass="autocomplete_completionListElement" 
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" 
                                                                    CompletionListItemCssClass="autocomplete_listItem" CompletionSetCount="1" 
                                                                    DelimiterCharacters="" EnableCaching="false" Enabled="True" 
                                                                    FirstRowSelected="false" MinimumPrefixLength="1" 
                                                                    ServiceMethod="getFillRateType" TargetControlID="txtsenior" 
                                                                    UseContextKey="true">
                                                                </asp:AutoCompleteExtender>
                                                                  <br />
                                                         <div style="padding-top:3px;width:83px;">
                                                         <asp:TextBox ID="txtSeniorTV"   AutoComplete="off" CssClass="field_input" placeholder="&nbsp;&nbsp;TV"  onkeydown="fnReadOnly(event)"  runat="server" Width="36px"></asp:TextBox>
                                                         <asp:TextBox ID="txtSeniorVAT"  AutoComplete="off"  CssClass="field_input" placeholder="&nbsp;VAT"  onkeydown="fnReadOnly(event)"  runat="server" Width="36px"></asp:TextBox>
                                                         </div>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Unit   <br />TV VAT">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtunit" runat="server" CssClass="field_input" 
                                                                    Style="text-align: left" Width="80px"></asp:TextBox>
                                                                <asp:AutoCompleteExtender ID="txtunit_AutoCompleteExtender" runat="server" 
                                                                    CompletionInterval="10" 
                                                                    CompletionListCssClass="autocomplete_completionListElement" 
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" 
                                                                    CompletionListItemCssClass="autocomplete_listItem" CompletionSetCount="1" 
                                                                    DelimiterCharacters="" EnableCaching="false" Enabled="True" 
                                                                    FirstRowSelected="false" MinimumPrefixLength="1" 
                                                                    ServiceMethod="getFillRateType" TargetControlID="txtunit" UseContextKey="true">
                                                                </asp:AutoCompleteExtender>
                                                                  <br />
                                                         <div style="padding-top:3px;width:83px;">
                                                         <asp:TextBox ID="txtUnitTV"  AutoComplete="off"  CssClass="field_input" placeholder="&nbsp;&nbsp;TV"  onkeydown="fnReadOnly(event)"   runat="server" Width="36px"></asp:TextBox>
                                                         <asp:TextBox ID="txtUnitVAT"  AutoComplete="off"  CssClass="field_input" placeholder="&nbsp;VAT"  onkeydown="fnReadOnly(event)"  runat="server" Width="36px"></asp:TextBox>
                                                         </div>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Half Day  <br />TV VAT">
                                                            <HeaderStyle HorizontalAlign="Left" Width="60px" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txthalf" runat="server" CssClass="field_input" 
                                                                    Style="text-align: left" Width="80px"></asp:TextBox>
                                                                <asp:AutoCompleteExtender ID="txthalf_AutoCompleteExtender" runat="server" 
                                                                    CompletionInterval="10" 
                                                                    CompletionListCssClass="autocomplete_completionListElement" 
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" 
                                                                    CompletionListItemCssClass="autocomplete_listItem" CompletionSetCount="1" 
                                                                    DelimiterCharacters="" EnableCaching="false" Enabled="True" 
                                                                    FirstRowSelected="false" MinimumPrefixLength="1" 
                                                                    ServiceMethod="getFillRateType" TargetControlID="txthalf" UseContextKey="true">
                                                                </asp:AutoCompleteExtender>
                                                                   <br />
                                                         <div style="padding-top:3px;width:83px;">
                                                         <asp:TextBox ID="txtHalfTV"   AutoComplete="off" CssClass="field_input" placeholder="&nbsp;&nbsp;TV"  onkeydown="fnReadOnly(event)"   runat="server" Width="36px"></asp:TextBox>
                                                         <asp:TextBox ID="txtHalfVAT"   AutoComplete="off" CssClass="field_input" placeholder="&nbsp;VAT"  onkeydown="fnReadOnly(event)"  runat="server" Width="36px"></asp:TextBox>
                                                         </div>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Full Day  <br />TV VAT">
                                                            <HeaderStyle HorizontalAlign="Left" Width="60px" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtfull" runat="server" CssClass="field_input" 
                                                                    Style="text-align: left" Width="80px"></asp:TextBox>
                                                                <asp:AutoCompleteExtender ID="txtfull_AutoCompleteExtender" runat="server" 
                                                                    CompletionInterval="10" 
                                                                    CompletionListCssClass="autocomplete_completionListElement" 
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" 
                                                                    CompletionListItemCssClass="autocomplete_listItem" CompletionSetCount="1" 
                                                                    DelimiterCharacters="" EnableCaching="false" Enabled="True" 
                                                                    FirstRowSelected="false" MinimumPrefixLength="1" 
                                                                    ServiceMethod="getFillRateType" TargetControlID="txtfull" UseContextKey="true">
                                                                </asp:AutoCompleteExtender>
                                                                   <br />
                                                         <div style="padding-top:3px;width:83px;">
                                                         <asp:TextBox ID="txtFullTV"   AutoComplete="off" CssClass="field_input" placeholder="&nbsp;&nbsp;TV"  onkeydown="fnReadOnly(event)"   runat="server" Width="36px"></asp:TextBox>
                                                         <asp:TextBox ID="txtFullVAT"   AutoComplete="off" CssClass="field_input" placeholder="&nbsp;VAT"   onkeydown="fnReadOnly(event)"  runat="server" Width="36px"></asp:TextBox>
                                                         </div>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                            <ItemStyle HorizontalAlign="Left" />
