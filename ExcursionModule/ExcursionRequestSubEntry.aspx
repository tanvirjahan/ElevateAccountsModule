<%@ Page Title="Excursion Request Sub Entry" Language="VB" MasterPageFile="~/SubPageMaster.master"
    EnableEventValidation="true" AutoEventWireup="false" CodeFile="ExcursionRequestSubEntry.aspx.vb"
    Inherits="ExcursionModule_ExcursionRequestSubEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function FormValidation(state) {
            ...
            //Sorur asked to comment 6/01/16
            ...
            if (chkFreeToCustomer.checked == false &&  parseFloat(txtAdultRate.value) == 0.00) {
                alert("Adult Rate cannot be 0");
                return false;
            }

            if (parseFloat(txtChildRate.value) == 0.00 && parseFloat(txtChild.value) != 0.00) {
        ...
        function calculateAdultChildCostRate() {
            ...
            var hdnmulticostcheck = document.getElementById("<%=hdnmulticostcheck.ClientID%>");
            ...
            if (parseInt(txtAdult.value) == 0) {
                ...
                if (hdnIsMultipleCost.value == 0 || hdnIsMultipleCost.value == "") {
                    if (parseFloat(txtAdultCostRate.value) == 0 && parseFloat(txtChildCostRate.value) == 0 && parseFloat(txtCostAmount.value) > 0) {
            ...
            <table style="border: gray 2px solid; width: 1000px">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td_cell">
                            <asp:CheckBox ID="chkFreeToCustomer" Text="Free to Customer" runat="server" TabIndex="30" />
                        </td>
                        <td class="td_cell">
                            <asp:CheckBox ID="chkFreeFromSupplier" Text="Free From Supplier" runat="server" TabIndex="31" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td_cell">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtRoomNo" runat="server" CssClass="txtbox" TabIndex="34" Width="120px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td_cell">
                        ...
                        <td>
                            <asp:TextBox ID="txtChild" runat="server" CssClass="txtbox TextBoxRightAlign" TabIndex="20"
                                Width="120px" />
                        </td>
                        <td class="td_cell">
                            Attention
                        ...
                        <td>
                            <asp:TextBox ID="txtAttention" runat="server" CssClass="txtbox" TabIndex="35" Width="120px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td_cell">
                    ...
                    <tr>
                        ...
                        <td class="td_cell">
                            <asp:Label id="lblAmountAED" runat="server" Text="Amount(AED)"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="td_cell">
                            <asp:Label id="lblCostAmountAED" runat="server" Text="Cost Amt(AED)"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="td_cell">
                            <asp:Label id="lblTotalAmountAED" runat="server" Text="Total Amount(AED)"></asp:Label>
                        </td>
                        <td>
    ...
    <asp:UpdatePanel ID="upnlHidden" runat="server">
        <ContentTemplate>
           ...
           <!--  Added shahul 13/10/2015 -->
            <asp:HiddenField ID="hdnmulticostcheck" runat="server" />
            <!--  -->
