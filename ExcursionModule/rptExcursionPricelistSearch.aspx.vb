            ...
            Try
                ...
                Else
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                                       CType(strappname, String), "ExcursionModule\rptExcursionPricelistSearch.aspx?appid=" + strappid, btnadd, Button1, BtnPrint, gv_SearchResult)
                End If
                ...
                objutils.FillDropDownListHTMLNEW(Session("dbconnectionName"), ddlsellcode, "excsellcode", "excsellname", "select excsellcode,excsellname from excsellmast where active=1 order by excsellcode", True)
                objutils.FillDropDownListHTMLNEW(Session("dbconnectionName"), ddlsellname, "excsellname", "excsellcode", "select excsellcode,excsellname from excsellmast where active=1 order by excsellname", True)
...
#End Region
    ...
    Protected Sub BtnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            If ValidatePage() = True Then
                ...
                strreportfilter()
                strReportTitle = " Excursion Pricelist"
               
                Dim strpop As String = ""
                '    strpop = "window.open('rptexcursionPricelistReport.aspx?Pageame=TranferPricelist&BackPageName=rptTransferPricelistReport.aspx&sellcode=" & strsellcode & "&airportcode=" & strsectorcode _
    ...
    Private Function strreportfilter()
        ...
        Try
            ...
            If ddlsellcode.Items(ddlsellcode.SelectedIndex).Text <> "[Select]" Then
                strnew = strnew + " Selling Code :" & ddlsellcode.Items(ddlsellcode.SelectedIndex).Text
            End If
