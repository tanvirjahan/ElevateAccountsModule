<%@ Page Title="" Language="VB" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="OthPriceCostList2.aspx.vb" Inherits="TransportModule_OthPriceList2" %>
     ...
     <tr><td style="width: 442px" class="td_cell" align=left>
        <SPAN style="FONT-FAMILY: Arial">PL Code</SPAN></TD><TD style="WIDTH: 122px">
            ...
            <TD></TD></TR><TR><TD style="WIDTH: 442px; HEIGHT: 3px" class="td_cell" 
             align=left>
            Party
            <SPAN style="FONT-FAMILY: Arial">Code&nbsp;<SPAN style="COLOR: #ff0000">* </SPAN></SPAN></TD>
            ...
            <td style="WIDTH: 190px; HEIGHT: 3px" class="td_cell" align=left>Party<SPAN style="FONT-FAMILY: Arial">
                Name</SPAN></TD>
