...
Partial Class ExcursionModule_ExcursionStopSalesSearch
        ...
        If Page.IsPostBack = False Then
            Try
                ...
                Else
                    ...
                    '                         'CType(strappname, String), "ExcursionModule\ExcursionStopSalesSearch.aspx?appid=11", btnAddNew, btnExportToExcel, _
    ...
    Private Function BuildCondition() As String
        ...
        If txtAllotmentID.Value.Trim <> "" Then
            If Trim(strWhereCond) = "" Then
                ...
                strWhereCond = " upper(mstopid) LIKE '" & Trim(txtAllotmentID.Value.Trim.ToUpper) & "%'"
            Else
                strWhereCond = strWhereCond & " AND upper(mstopid) LIKE '" & Trim(txtAllotmentID.Value.Trim.ToUpper) & "%'"
            End If
        End If
        ...
        If txtremarks.Value.Trim <> "" Then
            If Trim(strWhereCond) = "" Then
                ...
                strWhereCond = " remarks LIKE '%" & Trim(txtremarks.Value.Trim.ToUpper) & "%'"
            Else
                strWhereCond = strWhereCond & " AND remarks LIKE '%" & Trim(txtremarks.Value.Trim.ToUpper) & "%'"
            End If
        End If
...
#Region "Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = 'ASC')"
    Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        Try
            ...
            'strSqlQry = "select a.mstopid,b.othgrpname,c.othtypname,b.othgrpcode,c.othtypcode," & _
            '            "dbo.fn_get_excur_stopsale_marketstring(a.mstopid) plgrpcode," & _
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        'strpop = "window.open('ExcursionStopSales.aspx?State=New','MainAllotmentStopSales','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
        strpop = "window.open('ExcursionStopSales.aspx?State=New','MainAllotmentStopSales');"
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            If e.CommandName = "View" Then
                ...
                Dim strpop As String = ""
                'strpop = "window.open('ExcursionStopSales.aspx?State=View&RefCode=" + CType(lblId.Text.Trim, String) + "','MainAllotmentStopSales','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('ExcursionStopSales.aspx?State=View&RefCode=" + CType(lblId.Text.Trim, String) + "','MainAllotmentStopSales');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ElseIf e.CommandName = "Editrow" Then
                Dim strpop As String = ""
                ' strpop = "window.open('ExcursionStopSales.aspx?State=Edit&RefCode=" + CType(lblId.Text.Trim, String) + "','MainAllotmentStopSales','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('ExcursionStopSales.aspx?State=Edit&RefCode=" + CType(lblId.Text.Trim, String) + "','MainAllotmentStopSales');"

                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ElseIf e.CommandName = "Deleterow" Then
                Dim strpop As String = ""
                'strpop = "window.open('ExcursionStopSales.aspx?State=Delete&RefCode=" + CType(lblId.Text.Trim, String) + "','MainAllotmentStopSales','width=1000,height=620 left=20,top=20 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
                strpop = "window.open('ExcursionStopSales.aspx?State=Delete&RefCode=" + CType(lblId.Text.Trim, String) + "','MainAllotmentStopSales');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
    ...
    Protected Sub btnExportToExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExportToExcel.Click
        ...
        Try
            If gv_SearchResult.Rows.Count <> 0 Then
                'strSqlQry = "select a.mstopid as [Stop ID],b.othgrpname as [Excursion Group Name],c.othtypname as [Excursion Type Name],b.othgrpcode as [Excursion Group Code],c.othtypcode as [Excursion Type Code]," & _
                '                      "dbo.fn_get_excur_stopsale_marketstring(a.mstopid) as [Market]," & _
                ...
                '                      "a.adddate as [Added Date],a.adduser as [Added User] from stopsaleexc_header a " & _
                '                      "inner join othgrpmast b on a.othgrpcode=b.othgrpcode " & _
                '                      "inner join othtypmast c on a.othtypcode=c.othtypcode"

                strSqlQry = "select mstopid as [Stop ID],othgrpname as [Excursion Group Name],othtypname as [Excursion Type Name],othgrpcode as [Excursion Group Code],othtypcode as [Excursion Type Code]," & _
                                      "plgrpcode as [Market]," & _
                                      "frmdate  as [From Date]," & _
                                      "todate as [To Date]," & _
                                      "adddate as [Added Date],adduser as [Added User] from view_stopSale "
...
#End Region
    ...
    Private Sub FillGridWithOrderByValues()
        Select Case ddlOrderBy.SelectedIndex
            Case 0
                FillGrid("mstopid", "DESC")
            Case 1
                FillGrid("a.mstopid", "ASC")
            Case 2
    ...
    Private Function ExportWithOrderByValues() As String
        ...
        Select Case ddlOrderBy.SelectedIndex
            Case 0
                ExportWithOrderByValues = "mstopid DESC"
            Case 1
                ExportWithOrderByValues = "mstopid ASC"
            Case 2
