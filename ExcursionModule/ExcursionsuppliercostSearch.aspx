<%@ Page Language="VB" MasterPageFile="~/ExcursionMaster.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="ExcursionsuppliercostSearch.aspx.vb" Inherits="ExcursionsuppliercostSearch"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('PRICELIST:" " SUPPLIER:" " CLASSIFICATION:" " APPROVEDSTATUS:" " TEXT:" "');
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      ...
                      switch (category) {
                          case 'PRICELIST':
                              ...
                              var asSqlqry = "select ltrim(rtrim(eplistcode)) PRICELIST  from exccplist_header(nolock) where isnull(sectoryesno,0)=0    order by eplistcode";
                              glcallback = callback;
                              ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                              break;
                          case 'SUPPLIER':

                              var asSqlqry = 'select ltrim(rtrim(partyname)) SUPPLIER   from  partymast where active=1 and sptypecode  in (select option_selected from reservation_parameters where param_id=1033)  order by partyname ';
                              glcallback = callback;
                              //fnTestCallback();
                              ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                    ...
                    <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
                        ...
                        <tr>
                            <td style="text-align: center; width: 100%;" align="center" class="field_heading">
                                <asp:label id="Label1" runat="server" cssclass="field_heading" text="Excursion Supplier Cost Pricelist Search">
                                </asp:label>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <contenttemplate>
                                        ...
                                        BorderStyle="Solid">
                                            <FooterStyle CssClass="grdfooter"></FooterStyle>
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblsectorcode" runat="server" Text='<%# Bind("partycode") %>' ></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Supplier">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblsectorname" runat="server" Text='<%# Bind("partyname") %>' ></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
