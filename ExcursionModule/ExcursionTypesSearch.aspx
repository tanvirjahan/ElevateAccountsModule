<%@ Page Language="VB" MasterPageFile="~/ExcursionMaster.master" AutoEventWireup="false" CodeFile="ExcursionTypesSearch.aspx.vb" Inherits="Other_Services_Selling_Types_Search"  %>
                        ...
                        <td class="td_cell" colspan="1" >
                            <table >
                                <tr align=center>
                                    ...
                                    <asp:Label runat="server" ID="Lblselltypes" Text="Excursion  Types List"></asp:Label>
                                        &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp; &nbsp;</td>
                                </tr>
                                <tr align=center >
...
<TD style="TEXT-ALIGN: center" class="td_cell" align=center colSpan=7>&nbsp; &nbsp;&nbsp;
 ...
 <TR><TD class="td_cell" colSpan=4 style="height: 53px">
     <asp:Panel id="PnlCustSect" runat="server" 
         __designer:wfdid="w55" Height="91px" Width="808px"><TABLE ><TBODY><TR><TD >
 ...
 <TD style="height: 29px"></TD><TD style="height: 29px" ></TD></TR>
             <tr  >
                 <td style="height: 29px">
                     <asp:Label ID="lbltktreq" runat="server" __designer:wfdid="w68" 
                         Text="Tickets Required"  Visible="False"></asp:Label>
                 </td>
                 <td style="height: 29px" >

                       <asp:DropDownList id="ddltktreq" runat="server" Width="189px" 
                CssClass="drpdown" Visible =false >
                ...
                <asp:ListItem Value="2">No</asp:ListItem>
                 ...
                 <td style="height: 29px" align =left>
                     <asp:Label ID="lbluponreq" runat="server" __designer:wfdid="w68" 
                         Text="Upon Request" Visible="False" ></asp:Label>
                 </td>
                 <td style="height: 29px" >

                  

                        <asp:DropDownList id="ddluponreq" runat="server" Width="250px" 
                CssClass="drpdown" Visible =false>
                <asp:ListItem Value="0">All</asp:ListItem>
                <asp:ListItem Value="1">Yes</asp:ListItem>
                <asp:ListItem Value="2">No</asp:ListItem>
...
<asp:BoundField DataField="ticketsreqd" SortExpression="ticketsreqd" HeaderText="Tickets Required"></asp:BoundField>
<asp:BoundField DataField="uponrequest" SortExpression="uponrequest" HeaderText="Upon Request"></asp:BoundField>
<asp:BoundField DataField="daysofweek" SortExpression="daysofweek" HeaderText="Days of  Week"></asp:BoundField>
