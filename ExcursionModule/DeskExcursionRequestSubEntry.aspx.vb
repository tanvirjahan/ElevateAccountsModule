...
Partial Class ExcursionModule_DeskExcursionRequestSubEntry
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            'ddlExcursionGroup.Visible = False 'Added by Archana on 08/03/2015 as ddlexcursion group should be hidden
            'ddlExcursionSubGroup.Visible = False 'Added by Archana on 08/03/2015 as ddlExcursionSubGroup should be hidden

            ddlExcursionGroup.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as ddlexcursion group should be hidden
            ddlExcursionSubGroup.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as ddlExcursionSubGroup should be hidden
            txtSPersonComPer.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as txtSPersonComPer should be hidden
            txtSPersonCom.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as txtSPersonCom should be hidden
            ddlExcursionProvider.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as ddlExcursionProvider should be hidden
            txtCostCurr.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as txtCostCurr should be hidden
            txtAdultCostRate.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as txtAdultCostRate should be hidden
            txtCostAmount.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as txtCostAmount should be hidden
            btnMultipleCost.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as btnMultipleCost should be hidden
            txtChildCostRate.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as txtChildCostRate should be hidden
            txtCostAmountAED.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as txtCostAmountAED should be hidden
            txtCostConvRate.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as txtCostConvRate should be hidden
            txtprotktno.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as txtprotktno should be hidden
            btnselect.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as btnselect should be hidden
            txtCancelReason.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as txtCancelReason should be hidden
            chkFreeToCustomer.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as chkFreeToCustomer should be hidden
            chkFreeFromSupplier.Attributes.Add("style", "display:none") 'Added by Archana on 08/03/2015 as chkFreeFromSupplier should be hidden
            ...
            'If Request.QueryString("IsView") = "1" Then
            '    btnMCSave.Enabled = False
            'End If
...
#End Region
    ...
    Private Sub SaveMultiCostTemp()
        ...
        grdMultipleCost = Session("TempMultiCostGrid")
        ...
        Try
            ...
            SqlCmd = New SqlCommand("sp_InsertExcursionCostDetailsTemp", SqlConn)
    ...
    Private Sub AddRows(ByVal RLineNo As Integer)
        Try
            ...
            End If
            dtExcursionDetails.Rows.Add(RLineNo, 1, "", txtTourDate.Text, hdnExcursionSubGroupCode.Value,
           hdnExcursionSubGroupCode.Value, txtGuestName.Text, Val(txtAdult.Text), Val(txtChild.Text), Val(txtAdultRate.Text),
           ...
           txtDebitNoteNo.Text, ddlExcursionProvider.Value, ddlExcursionType.Value, IIf(ddlConfirmed.Value = "1", 1, 0), hdnExcursionGroupCode.Value,
           txtCostCurr.Text.Trim, IIf(Val(txtCostConvRate.Text) = 0, 1, Val(txtCostConvRate.Text)), ddlExcursionType.Items(ddlExcursionType.SelectedIndex).Text, IIf(chksupconf.Checked = True, 1, 0), txtexctime.Text, txttrfno.Text, txtsupconfno.Text, txtprotktno.Text, txtreminder.Text)
    ...
    Protected Sub btnMultipleCost_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If ddlExcursionProvider.Value <> "[Select]" Then
            'ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Please select excursion Type');", True)
    ...
    Protected Sub btnSubEntryClose_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubEntryClose.Click
        ...
        wucExcSumSubEntry.SaveMultipleCost()
    End Sub
