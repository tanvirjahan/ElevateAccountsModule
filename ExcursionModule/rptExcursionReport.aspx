<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptExcursionReport.aspx.vb" Inherits="rptPricelistReport"  MasterPageFile="~/SubPageMaster.master" Strict="true"  %>
...
<script language="javascript" type="text/javascript" >
    ...
    <asp:Button ID="btnBack" runat="server" CssClass="field_button" 
                    Text="Back To Excursion Report" Width="180px" />&nbsp;<asp:Button ID="btnPrint" runat="server" CssClass="field_button"
            Text="Print" /></td>
                    </tr>
    </table>
