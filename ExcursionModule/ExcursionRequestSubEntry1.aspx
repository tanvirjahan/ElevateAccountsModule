<%@ Page Title="Excursion Request Sub Entry" Language="VB" MasterPageFile="~/SubPageMaster.master"
    AutoEventWireup="false" CodeFile="ExcursionRequestSubEntry1.aspx.vb" Inherits="ExcursionModule_ExcursionRequestSubEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function showcollectamtExcConf() {
        ...
        function validatemulticost() {
            ...
            if(ddlExcursionProvider.value != "[Select]"){
                alert('Cost value sholud be zero, Please choose [Select] from the excursion provider.');                
                return false;
            }
        }
        ...
        function CallWebMethod(methodType) {
            switch (methodType) {
                ...
                case "ExcursionProvider":
                    ...
                    var hdnTotalMC = document.getElementById("<%=hdnTotalMC.ClientID%>");
                    var hdnCostAmount = document.getElementById("<%=hdnCostAmount.ClientID%>");
                    var hdnCostAmountAED = document.getElementById("<%=hdnCostAmountAED.ClientID%>");

                    var hdnAdultCostRate = document.getElementById("<%=hdnAdultCostRate.ClientID%>");
                    var hdnChildCostRate = document.getElementById("<%=hdnChildCostRate.ClientID%>");
                    ...
                    if (select.value == '[Select]') {
                        txtAdultCostRate.disabled = true;
                        txtChildCostRate.disabled = true;
                        ...
                        hdnAdultCostRate.value = 0;
                        hdnChildCostRate.value = 0;
                        txtCostAmountAED.value = 0;
                        txtCostAmount.value = 0;
                        txtCostConvRate.value = "1.0000000"
                        hdnCostCurrConvRate.value = "1.0000000"
                    }
                    else {
                        txtAdultCostRate.disabled = false;
                        txtChildCostRate.disabled = false;
                    }
...
//                hdnCostAmountAED.value = txtCostAmountAED.value;
                ...
                if (hdnIsMultipleCost.value == 0 || hdnIsMultipleCost.value == "") {
                    ...
                    txtCostAmount.value = DecRound(txtCostAmount.value);
                    hdnCostAmount.value = txtCostAmount.value;
                    hdnAdultCostRate.value = txtAdultCostRate.value;
                    hdnChildCostRate.value = txtChildCostRate.value;
                    txtCostAmountAED.value = (parseFloat(txtCostAmount.value) * parseFloat(txtCostConvRate.value))
            ...
            <table style="border: gray 2px solid; width: 1000px">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtTourDate" runat="server" CssClass="txtbox" TabIndex="1" ValidationGroup="MKE"
                                Width="80px" />
                            <asp:ImageButton Style="display: none" ID="ImgBtnTourDate" runat="server" ImageUrl="~/Images/Calendar_scheduleHS.png"
                                TabIndex="54" />
                            <cc1:MaskedEditValidator ID="MEVTourDate" runat="server" Style="display: none" ControlExtender="MEETourDate"
                        ...
                        <td class="td_cell">
                            <asp:CheckBox ID="chkAmendment" Text="Amendment" runat="server" TabIndex="18" />
                        </td>
                        <td class="td_cell">
                            <asp:CheckBox ID="chkCancel" Text="Cancel" runat="server" TabIndex="19" />
                        </td>
                        <td class="td_cell">
                            Cancel Reason
                        </td>
                        <td>
                            <asp:TextBox ID="txtCancelReason" runat="server" CssClass="txtbox" TabIndex="29"
                                Width="120px" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select style="width: 250px" id="ddlExcursionGroup" class="field_input" onchange="CallWebMethod('FilterSubGroup')"
                                disabled="disabled" runat="server" tabindex="1">
                        ...
                        <td class="td_cell">
                            <asp:CheckBox ID="chkFreeToCustomer" disabled="disabled" Text="Free to Customer"
                                runat="server" TabIndex="30" />
                        </td>
                        <td class="td_cell">
                            <asp:CheckBox ID="chkFreeFromSupplier" disabled="disabled" Text="Free From Supplier"
                    ...
                    <tr>
                        ...
                        <td>
                            <select style="width: 250px" id="ddlExcursionSubGroup" onchange="CallWebMethod('ExcursionSubGroup')"
                                class="field_input" disabled="disabled" runat="server" tabindex="2">
                                <option selected="selected"></option>
                            </select>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtSPersonComPer" Text="0" runat="server" disabled="disabled" CssClass="txtbox TextBoxRightAlign"
                    ...
                    <tr>
                        ...
                        <td>
                            <select style="width: 250px" id="ddlExcursionType" disabled="disabled" onchange="CallWebMethod('ExcursionType')"
                                class="field_input" runat="server" tabindex="3">
                                <option selected="selected"></option>
                            </select>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtSPersonCom" runat="server" ReadOnly="true" disabled="disabled"
                                CssClass="txtbox TextBoxRightAlign" Text="0" TabIndex="33" Width="120px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td_cell">
                        ...
                        <td colspan="1">
                            <asp:TextBox ID="txtGuestName" runat="server" CssClass="txtbox" disabled="disabled"
                        ...
                        <td>
                            <asp:TextBox ID="txtRoomNo" runat="server" CssClass="txtbox" TabIndex="34" disabled="disabled"
                                Width="120px" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtAdult" runat="server" disabled="disabled" CssClass="txtbox TextBoxRightAlign"
                                TabIndex="5" Text="1" Width="120px" />
                        </td>
                        <td class="td_cell">
                            Child
                        </td>
                        <td>
                            <asp:TextBox ID="txtChild" runat="server" disabled="disabled" CssClass="txtbox TextBoxRightAlign"
                                TabIndex="20" Width="120px" />
                        </td>
                        <td class="td_cell">
                            Attention
                        </td>
                        <td>
                            <asp:TextBox ID="txtAttention" runat="server" disabled="disabled" CssClass="txtbox"
                                TabIndex="35" Width="120px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td_cell">
                        ...
                        <td>
                            <asp:TextBox ID="txtAdultRate" runat="server" Text="0" disabled="disabled" CssClass="txtbox TextBoxRightAlign"
                                TabIndex="6" Width="120px" />
                        </td>
                        <td class="td_cell">
                            Child Rate
                        </td>
                        <td>
                            <asp:TextBox ID="txtChildRate" runat="server" disabled="disabled" CssClass="txtbox TextBoxRightAlign"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtAmount" ReadOnly="true" runat="server" Text="0" disabled="disabled"
                                CssClass="txtbox TextBoxRightAlign" TabIndex="7" Width="120px" />
                        </td>
                        <td class="td_cell">
                            Amount(AED)
                        </td>
                        <td>
                            <asp:TextBox ID="txtAmountAED" ReadOnly="true" runat="server" Text="0" disabled="disabled"
                                CssClass="txtbox TextBoxRightAlign" TabIndex="22" Width="120px" />
                        </td>
                        <td class="td_cell">
                        </td>
                        <td style="display: none">
                            <asp:TextBox ID="txtArrivalDate" runat="server" CssClass="txtbox" TabIndex="37" ValidationGroup="MKE"
                                Width="80px" />
                    ...
                    <tr>
                        ...
                        <td>
                            <select style="width: 250px" id="ddlExcursionProvider" onchange="CallWebMethod('ExcursionProvider')"
                                class="field_input" runat="server" tabindex="8">
                                <option selected="selected"></option>
                            </select>
                        </td>
                        <td>
                        ...
                        <td style="display: none">
                            <asp:TextBox ID="txtDepartureDate" runat="server" CssClass="txtbox" TabIndex="38"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtCostCurr" runat="server" ReadOnly="true" CssClass="txtbox" TabIndex="9"
                                Width="120px" />
                        </td>
                        <td class="td_cell">
                            Cost Conv Rate
                        ...
                        <td>
                            <asp:TextBox ID="txtCostConvRate" runat="server" CssClass="txtbox TextBoxRightAlign"
                                ReadOnly="true" TabIndex="23" Width="120px" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Button ID="btnMultipleCost" runat="server" UseSubmitBehavior="false" OnClientClick="validatemulticost()" OnClick="btnMultipleCost_Click"
                                Text="Multiple Cost" CssClass="field_button" Width="90px" />
                        </td>
                        <td class="td_cell">
                            Cost Amt(AED)
                        </td>
                        ...
                        <td>
                            <asp:TextBox ID="txtPickTime" runat="server" CssClass="txtbox" TabIndex="39" Width="120px" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="1">
                            <input type="text" class="field_input MyAutoCompleteHotelClass MyAutoCompleteHotelTypeClass"
                                id="txthotel" tabindex="12" runat="server" style="width: 250px;" />
                        </td>
                        ...
                        <td style="width: 100px">
                            <asp:TextBox Style="display: none" ID="txttrfno" runat="server" CssClass="txtbox"
                                TabIndex="26" ReadOnly="true" Width="100px" />
                        </td>
                        <td class="td_cell" style="width: 170px">
                            Excursion Time
                        </td>
                        <td style="width: 100px">
                            <asp:TextBox ID="txtexctime" runat="server" CssClass="txtbox" TabIndex="40" Width="100px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td_cell" style="width: 160px">
                        ...
                        <td class="td_cell">
                            <asp:CheckBox ID="chksupconf" Text=" " runat="server" onclick="disconfno();" TabIndex="27" />
                        </td>
                        <td class="td_cell">
                            Transfer Required.
                        </td>
                        <td class="td_cell">
                            <asp:CheckBox ID="chktrfreq" Text=" " runat="server" TabIndex="27" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td_cell" style="width: 160px">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="txtprotktno" runat="server" ReadOnly="true" CssClass="txtbox" TextMode="MultiLine"
                                        TabIndex="26" Width="180px" Height="56px" />&nbsp
                        ...
                        <td> <asp:TextBox ID="txtwaiting" runat="server"  CssClass="txtbox" TextMode="MultiLine"
                                        TabIndex="26" Width="180px" Height="56px" />
                        </td>
                        <td class="td_cell">
                            <asp:Label ID="lblsupconf" runat="server" TabIndex="26" Text="Sup.Conf No." Style="display: none"
                                Width="100px" />
                        </td>
                        <td class="td_cell">
                            <asp:TextBox ID="txtsupconfno" Style="display: none" runat="server" CssClass="txtbox"
                                TabIndex="26" Width="100px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td_cell">
                        ...
                        <td rowspan="2">
                            <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" CssClass="txtbox"
                                TabIndex="41" Width="200px" Height="50px" />
                        </td>
                    </tr>
                    <tr>                        
                        <td class="td_cell">
                        ...
                        <td>
                            <select style="width: 200px" id="ddlPayment" class="field_input" runat="server" onchange="showcollectamtExcConf()">
                                <option selected="selected"></option>
                            </select>
                        </td>
                        <td class="td_cell">
                    ...
                    <tr>
                        ...
                        <td>
                        <asp:TextBox ID="txtcaneldeadline" runat="server" MaxLength="100" CssClass="txtbox"
                                TabIndex="28" Width="220px" />
                        </td>
                        <td class="td_cell" style="width: 160px">
                            Cancellation Charges
                        </td>
                        <td>
                            <asp:TextBox ID="txtcancelcharges" runat="server" MaxLength="100" CssClass="txtbox"
                                TabIndex="28" Width="220px" />
                        </td>
                        <td class="td_cell">
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtIncomeInvoiceNo" runat="server" CssClass="txtbox" TabIndex="14"
                                Width="120px" />
                        </td>
                         <td class="td_cell" style="width: 160px">
                            No Show Charges
                       ...
                       <td>
                            <asp:TextBox ID="txtnoshowcharges" runat="server" CssClass="txtbox" TabIndex="14"
                                Width="220px" />
                        </td>
                        <td class="td_cell">
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDebitNoteNo" runat="server" CssClass="txtbox" TabIndex="15" Width="120px" />
                        </td>
                        <td class="td_cell">
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtreminder" runat="server" CssClass="txtbox" TabIndex="1" ValidationGroup="MKE"
                                Width="80px" />
        ...
        <ContentTemplate>
            <asp:UpdatePanel ID="upnlHidden" runat="server">
                <ContentTemplate>
                    ...
                    <asp:HiddenField ID="hdnTotalMC" runat="server" />
                    ...
                    <asp:HiddenField ID="hdnAdultCostRate" runat="server" />
                    <asp:HiddenField ID="hdnChildCostRate" runat="server" />
                    ...
                    <asp:HiddenField ID="hdnCollectAmount" runat="server" />
                    <asp:HiddenField ID="txtdecimal" runat="server" />
                    <input type="text" value="" style="display: none" id="hdnValidate" runat="server" />
                </ContentTemplate>
            </asp:UpdatePanel>
