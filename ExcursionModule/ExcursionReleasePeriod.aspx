<%@ Page Title="Excursion Release Period" Language="VB" EnableViewState="true" MasterPageFile="~/SubPageMaster.master" AutoEventWireup="false" CodeFile="ExcursionReleasePeriod.aspx.vb" Inherits="ExcursionModule_ExcursionReleasePeriod" %>
...
<script language="javascript" type="text/javascript">
    ...
    function FormValidation(state) {
        ...
        if (document.getElementById("<%=ddlExGrpCode.ClientID%>").value == "[Select]") {
            ...
            if (state == 'New') { if (confirm('Are you sure you want to save Excursion Release Period ?') == false) return false; }

            if (state == 'Delete') { if (confirm('Are you sure you want to Delete Excursion Release Period ?') == false) return false; }
...
<asp:Label id="lblHeading" runat="server" Text="Add New Excursion Release Period" CssClass="field_heading" Width="300px"></asp:Label></TD>
</TR>
<TR>
...
<TD><INPUT id="txtAllotmentID" disabled type=text runat="server" />
    ...
    <tr>
        <td colspan="4">
            ...
            <SELECT style="WIDTH: 131px" id="ddlFillValues" 
        class="field_input" runat="server" clientidmode="Inherit"> <OPTION value="Release Period" selected>Release Period</OPTION>
</SELECT>&nbsp; <INPUT style="WIDTH: 33px; TEXT-ALIGN: right" id="txtFillValues" class="field_input" type=text maxLength=4 runat="server" />&nbsp; 
    <asp:Button id="btnFill" onclick="btnFill_Click" runat="server" Text="...Fill" 
        CssClass="field_button" OnClientClick="return iconvisible();"></asp:Button>  &nbsp;  &nbsp;<IMG style="WIDTH: 264px; display:none" id="imgicon" height="20" src="../Images/loading.gif" runat="server" />

            <asp:Button ID="btnStopAll" visible="false" runat="server" CssClass="field_button" 
                onclick="btnStopAll_Click" tabIndex="-1" Text="Stop All" />
            &nbsp;
            <asp:Button ID="btnRemoveStopAll" visible="false" runat="server" CssClass="field_button" 
    ...
    <DIV style="WIDTH: 420px; HEIGHT: 300px" class="container">
    <asp:GridView id="gv_allotment" tabIndex=11 runat="server" Font-Size="10px" 
            CssClass="td_cell" Width="380px" Visible="False" GridLines="Vertical" 
...
<Columns>
    ...
    <asp:TextBox id="TextBox8" runat="server" Text='<%# Bind("lineno") %>' Width="35px"></asp:TextBox> 
    </EditItemTemplate>
    ...
    <ItemTemplate>
    <asp:Label id="lblLineno" runat="server" Text='<%# Bind("lineno") %>' Width="35px"></asp:Label> 
    </ItemTemplate>
    </asp:TemplateField>

    <asp:TemplateField Visible="False" HeaderText="RowID"><EditItemTemplate>
    <asp:TextBox id="TextBox11" runat="server" Width="35px"></asp:TextBox> 
    </EditItemTemplate>
    <ItemTemplate>
    <asp:Label id="lblrowid" runat="server" Width="35px" Text='<%# Bind("Rowid") %>'></asp:Label> 
    </ItemTemplate>
    </asp:TemplateField>

        <asp:BoundField DataField="plgrpcode" HeaderText="Market">
        <ItemStyle HorizontalAlign="Left"></ItemStyle>
    ...
    <ItemStyle HorizontalAlign="Left"></ItemStyle>
        ...
        <asp:TemplateField HeaderText="Release Period"><EditItemTemplate>
        <asp:TextBox style="TEXT-ALIGN: right" id="TextBox1" runat="server" Text='<%# Bind("ReleasePeriod") %>' Width="35px"></asp:TextBox> 
        </EditItemTemplate>
        ...
        <ItemTemplate>
        <asp:TextBox style="TEXT-ALIGN: right" id="txtRelease" runat="server" Text='<%# Bind("ReleasePeriod") %>' CssClass="field_input" Width="35px" MaxLength="4"></asp:TextBox> 
        </ItemTemplate>
        </asp:TemplateField>
        ...
        <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
        <ItemTemplate>
        <asp:label style="TEXT-ALIGN: right" id="lblstopsale" runat="server" Text='<%# Bind("stopsale") %>' CssClass="field_input" Width="35px"  />
        </ItemTemplate>
        </asp:TemplateField>
...
<AlternatingRowStyle CssClass="grdAternaterow" Font-Size="10px"></AlternatingRowStyle>
    ...
    <input id="txtconnection" runat="server" style="visibility: hidden; width: 12px;
        height: 9px" type="text" />
            <asp:CheckBox ID="chkapprove" runat="server" Font-Bold="True" Text="Approve" />
    ...
    <asp:Button id="btnHelp" tabIndex=20 style="display:none" onclick="btnHelp_Click" runat="server" Text="Help" CssClass="field_button"></asp:Button></TD></TR></TBODY></TABLE>
