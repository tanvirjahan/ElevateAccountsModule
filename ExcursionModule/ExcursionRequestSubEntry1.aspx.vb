...
#Region "Global Declarations"
    ...
    Public totalValue As Decimal = 0.0
        ...
        Try
            If Page.IsPostBack = False Then
                Try
                    ...
                    agentcode = objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select agentcode from reservation_headernew(nolock) where requestid='" & Request.QueryString("RefCode") & "'")
                    lang = objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select ltrim(rtrim(nationlanguage)) from nationality_master  where nationalitycode in (select ctrycode from agentmast where agentcode='" & agentcode & "')")
                    ...
                    lang1 = objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select nationalitycode from nationality_master where nationalityname='" & lang & "'")
                    ...
                    objUtils.FillDropDownListHTMLNEW(Session("dbconnectionName"), ddlHotel, "partyname", "partycode", "select ltrim(rtrim(partycode))partycode,ltrim(rtrim(partyname))partyname from partymast  where  active=1 order by partyname ", True)
                    ...
                    objUtils.FillDropDownListHTMLNEW(Session("dbconnectionName"), ddlLanguage, "nationalityname", "nationalitycode", " select ltrim(rtrim(nationalitycode))nationalitycode,ltrim(rtrim(nationalityname))nationalityname from nationality_master where showinexcursions=1 and active=1 order by nationalityname", True, lang1)


                    

                    If ddlLanguage.Value = "[Select]" Then
                        ...
                        '  ddlLanguage.Items(ddlLanguage.SelectedIndex).Value = lang
                        ' objUtils.FillDropDownListHTMLNEW(Session("dbconnectionName"), ddlLanguage, "nationalityname", "nationalitycode", " select ltrim(rtrim(nationalitycode))nationalitycode,ltrim(rtrim(nationalityname))nationalityname from nationality_master where showinexcursions=1 and active=1 order by nationalityname", True) ', lang)
                    End If
                    ...
                    NumbersForTextbox(txtCostConvRate)
                    NumbersForTextbox(txtCostConvRate)
                    NumbersForTextbox(txtcollectamt)
                    ...
                    If CType(Session("ExcursionRequestSubEntryState"), String) = "AddRow" Then
                        ...
                        objUtils.FillDropDownListHTMLNEW(Session("dbconnectionName"), ddlPayment, "payname", "paycode", "  select ltrim(rtrim(paycode))paycode, ltrim(rtrim(payname))payname from paymentmodemaster order by payname", True)
                        hdnCollectAmount.Value = 0
                        hdnPaymentMode.Value = "[Select]"
                    ...
                    ElseIf CType(Session("ExcursionRequestSubEntryState"), String) = "EditRow" Then
                        ...
                        'End If
                    ElseIf CType(Session("ExcursionRequestSubEntryState"), String) = "CancelRow" Then
                        ...
                        btnSave.Text = "Update"
                        ShowRecord(RefCode, LineNo)
                        CancelDisablecontrols()
                        'ShowRecordFromDt(RefCode, LineNo)
                        'btnResetAll.Enabled = False
                        lblHeading.Text = "Cancel Excursion Sub Entry"
                        Page.Title = Page.Title + " " + "Cancel Excursion Sub Entry"
            ...
            If ddlPayment.Value = "COL" Then
                lblcollectamt.Style.Add("display", "block")
                txtcollectamt.Style.Add("display", "block")
            Else
                lblcollectamt.Style.Add("display", "none")
                txtcollectamt.Style.Add("display", "none")
            End If
            ...
            If CType(Session("ExcursionRequestSubEntryState"), String) = "CancelRow" Then
                CancelDisablecontrols()
            End If
            If CType(Session("ExcursionRequestSubEntryState"), String) <> "CancelRow" Then
            ...
            ' If ddlExcursionProvider.Value <> "[Select]" Then
            txtAdultCostRate.Text = hdnAdultCostRate.Value
            txtChildCostRate.Text = hdnChildCostRate.Value
            txtCostAmount.Text = hdnCostAmount.Value
            txtCostAmountAED.Text = hdnCostAmountAED.Value
            'End If

            If hdnIsMultipleCost.Value > 0 Then ddlExcursionProvider.Disabled = True Else ddlExcursionProvider.Disabled = False
...
#End Region
            ...
            If Page.IsValid = True Then
                ...
                Else
                    If hdnValidate.Value = 1 Then
                        If ddlExcursionProvider.Value <> "[Select]" Then
                            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Cost value has entered from multiple cost. you cant change the excursion provider. The value of adult cost rate and child cost rate should be zero.');", True)
                            Exit Sub
                        End If
                ...
                If CType(Session("ExcursionRequestSubEntryState"), String) = "EditRow" Then
                    ...
                    SqlCmd = New SqlCommand("sp_update_pending_exc_detail", mySqlConn, sqlTrans)
                    SqlCmd.CommandType = CommandType.StoredProcedure
                    SqlCmd.Parameters.Add(New SqlParameter("@excid", SqlDbType.VarChar, 20)).Value = Request.QueryString("RefCode")
                    SqlCmd.Parameters.Add(New SqlParameter("@rlineno", SqlDbType.Int)).Value = Request.QueryString("LineNo")
                    SqlCmd.Parameters.Add(New SqlParameter("@othtypcode", SqlDbType.VarChar, 20)).Value = hdnExcursionTypeCode.Value 'IIf(dtExcursionDetails.Rows(i)("othtypcode").ToString = "[Select]", DBNull.Value, dtExcursionDetails.Rows(i)("othtypcode").ToString)

                    SqlCmd.Parameters.Add(New SqlParameter("@confno", SqlDbType.VarChar, 100)).Value = txtConfirmationNo.Text  'dtExcursionDetails.Rows(i)("confno").ToString
                    SqlCmd.Parameters.Add(New SqlParameter("@pickuptime", SqlDbType.VarChar, 20)).Value = txtPickTime.Text 'dtExcursionDetails.Rows(i)("pickuptime").ToString
                    SqlCmd.Parameters.Add(New SqlParameter("@hotel", SqlDbType.VarChar, 20)).Value = ddlHotel.Items(ddlHotel.SelectedIndex).Value 'dtExcursionDetails.Rows(i)("hotel").ToString

                    SqlCmd.Parameters.Add(New SqlParameter("@confirmed", SqlDbType.Int)).Value = ddlConfirmed.Value   'dtExcursionDetails.Rows(i)("confirmed").ToString
                    SqlCmd.Parameters.Add(New SqlParameter("@costpricea", SqlDbType.Decimal, 18, 4)).Value = Val(txtAdultCostRate.Text)  'Val(dtExcursionDetails.Rows(i)("costRateAdult"))
                    SqlCmd.Parameters.Add(New SqlParameter("@costpriceb", SqlDbType.Decimal, 18, 4)).Value = Val(txtChildCostRate.Text)  'Val(dtExcursionDetails.Rows(i)("costRateChild"))
                    SqlCmd.Parameters.Add(New SqlParameter("@costcurrency", SqlDbType.Decimal, 18, 4)).Value = Val(hdnCostAmount.Value) ' txtCostAmountAED.Text 'Val(dtExcursionDetails.Rows(i)("costAmountAED"))

                    SqlCmd.Parameters.Add(New SqlParameter("@costvalue", SqlDbType.Decimal, 18, 4)).Value = Val(hdnCostAmountAED.Value) 'txtCostAmount.Text  'Val(dtExcursionDetails.Rows(i)("costAmount"))

                    SqlCmd.Parameters.Add(New SqlParameter("@guide", SqlDbType.VarChar, 20)).Value = IIf(ddlTourGuide.Items(ddlTourGuide.SelectedIndex).Value = "[Select]", DBNull.Value, ddlTourGuide.Items(ddlTourGuide.SelectedIndex).Value)
                    ...
                    SqlCmd.Parameters.Add(New SqlParameter("@partycode", SqlDbType.VarChar, 20)).Value = ddlHotel.Items(ddlHotel.SelectedIndex).Value  'dtExcursionDetails.Rows(i)("hotel").ToString

                    SqlCmd.Parameters.Add(New SqlParameter("@total_amount", SqlDbType.Money)).Value = Val(txtTotalAmountAED.Text)
                    SqlCmd.Parameters.Add(New SqlParameter("@incominginvno", SqlDbType.VarChar, 20)).Value = txtIncomeInvoiceNo.Text 'dtExcursionDetails.Rows(i)("incominginvno").ToString
                    SqlCmd.Parameters.Add(New SqlParameter("@debitnoteno", SqlDbType.VarChar, 100)).Value = txtDebitNoteNo.Text  'dtExcursionDetails.Rows(i)("debitnoteno").ToString
                    SqlCmd.Parameters.Add(New SqlParameter("@epartycode", SqlDbType.VarChar, 20)).Value = IIf(ddlExcursionProvider.Items(ddlExcursionProvider.SelectedIndex).Value = "[Select]", DBNull.Value, ddlExcursionProvider.Items(ddlExcursionProvider.SelectedIndex).Value)  'dtExcursionDetails.Rows(i)("epartycode").ToString

                    SqlCmd.Parameters.Add(New SqlParameter("@costCurrencyName", SqlDbType.VarChar, 10)).Value = txtCostCurr.Text    'dtExcursionDetails.Rows(i)("costCurrencyName").ToString
                    SqlCmd.Parameters.Add(New SqlParameter("@costConvRate", SqlDbType.Decimal, 18, 12)).Value = IIf(txtCostConvRate.Text = "", 0, Val(txtCostConvRate.Text))  'Val(dtExcursionDetails.Rows(i)("costConvRate"))
                    SqlCmd.Parameters.Add(New SqlParameter("@remarks", SqlDbType.VarChar)).Value = txtRemarks.Text  'dtExcursionDetails.Rows(i)("remarks").ToString

                    SqlCmd.Parameters.Add(New SqlParameter("@supconf", SqlDbType.Int)).Value = IIf(chksupconf.Checked = True, 1, 0)  'CType(IIf(IsDBNull(dtExcursionDetails.Rows(i)("supconf")) = True, 0, dtExcursionDetails.Rows(i)("supconf")), Integer)

                    SqlCmd.Parameters.Add(New SqlParameter("@exctime", SqlDbType.VarChar, 20)).Value = txtexctime.Text  'CType(IIf(IsDBNull(dtExcursionDetails.Rows(i)("exctime")) = True, "", dtExcursionDetails.Rows(i)("exctime")), String)

                    SqlCmd.Parameters.Add(New SqlParameter("@trfno", SqlDbType.VarChar, 20)).Value = txttrfno.Text  'CType(IIf(IsDBNull(dtExcursionDetails.Rows(i)("trfno")) = True, "", dtExcursionDetails.Rows(i)("trfno")), String)

                    SqlCmd.Parameters.Add(New SqlParameter("@supconfno", SqlDbType.VarChar, 20)).Value = txtsupconfno.Text  'CType(dtExcursionDetails.Rows(i)("supconfno"), String)

                    SqlCmd.Parameters.Add(New SqlParameter("@protktno", SqlDbType.VarChar, 20)).Value = txtprotktno.Text  'CType(dtExcursionDetails.Rows(i)("protktno"), String)

                    SqlCmd.Parameters.Add(New SqlParameter("@reminderdt", SqlDbType.DateTime)).Value = txtreminder.Text  'IIf(dtExcursionDetails.Rows(i)("reminderdt").ToString = "", Date.Now, dtExcursionDetails.Rows(i)("reminderdt").ToString)

                    SqlCmd.Parameters.Add(New SqlParameter("@trfreq", SqlDbType.Int)).Value = IIf(chktrfreq.Checked = True, 1, 0)

                    SqlCmd.Parameters.Add(New SqlParameter("@userlogged", SqlDbType.VarChar, 20)).Value = Session("GlobalUserName")
                    SqlCmd.Parameters.Add(New SqlParameter("@lang", SqlDbType.VarChar, 50)).Value = ddlLanguage.Items(ddlLanguage.SelectedIndex).Text  'dtExcursionDetails.Rows(i)("hotel").ToString

                    'Added By riswan - Adding payment mode and collect amount                    
                    If ddlPayment.Value <> "[Select]" Then
                        SqlCmd.Parameters.Add(New SqlParameter("@paymode", SqlDbType.VarChar, 40)).Value = ddlPayment.Value
                        If ddlPayment.Value = "COL" Then
                            SqlCmd.Parameters.Add(New SqlParameter("@collectamount", SqlDbType.Decimal)).Value = txtcollectamt.Text
                        Else
                            SqlCmd.Parameters.Add(New SqlParameter("@collectamount", SqlDbType.Decimal)).Value = 0
                            txtcollectamt.Text = 0
                        End If
                    End If

                    SqlCmd.Parameters.Add(New SqlParameter("@cancelcharges", SqlDbType.VarChar, 250)).Value = Trim(txtcancelcharges.Text)
                    SqlCmd.Parameters.Add(New SqlParameter("@noshowcharges", SqlDbType.VarChar, 250)).Value = (txtnoshowcharges.Text)
                    SqlCmd.Parameters.Add(New SqlParameter("@canceldeadline", SqlDbType.VarChar, 250)).Value = (txtcaneldeadline.Text)
                    SqlCmd.Parameters.Add(New SqlParameter("@waitingpolicy", SqlDbType.VarChar, 500)).Value = (txtwaiting.Text)
                    ...
                    If grdMultipleCost.Rows.Count > 0 Then
                        ...
                        SqlCmd = New SqlCommand("sp_DeleteExcursionCostDetails", mySqlConn, sqlTrans)
                        SqlCmd.CommandType = CommandType.StoredProcedure
                        SqlCmd.Parameters.Add(New SqlParameter("@excid", SqlDbType.VarChar, 20)).Value = CType(Request.QueryString("RefCode"), String)
                        SqlCmd.Parameters.Add(New SqlParameter("@rlineno", SqlDbType.VarChar, 20)).Value = CType(Request.QueryString("LineNo"), String)
                        SqlCmd.ExecuteNonQuery()
                        ...
                        For i = 0 To grdMultipleCost.Rows.Count - 1
                            Dim mRowId = 0
                            Dim GrdhdnRowId = CType(grdMultipleCost.Rows(i).FindControl("hdnRowID"), HiddenField)
                            Dim GrdddlSupplier = CType(grdMultipleCost.Rows(i).FindControl("ddlSupplier"), DropDownList)
                            Dim GrdddlExcType = CType(grdMultipleCost.Rows(i).FindControl("ddlExcType"), DropDownList)
                            Dim GrdtxtAdultCostRate = CType(grdMultipleCost.Rows(i).FindControl("txtAdultCostRate"), TextBox)
                            Dim GrdtxtChildCostRate = CType(grdMultipleCost.Rows(i).FindControl("txtChildCostRate"), TextBox)
                            Dim GrdtxtCostCurrency = CType(grdMultipleCost.Rows(i).FindControl("txtCostCurrency"), TextBox)
                            Dim GrdtxtConversionRate = CType(grdMultipleCost.Rows(i).FindControl("txtConversionRate"), TextBox)
                            Dim GrdtxtCostValue = CType(grdMultipleCost.Rows(i).FindControl("txtCostValue"), TextBox)
                            Dim Grdtxtnoofunits = CType(grdMultipleCost.Rows(i).FindControl("txtnoofunits"), TextBox)
                            Dim GrdtxtRemarks = CType(grdMultipleCost.Rows(i).FindControl("txtRemarks"), TextBox)
                            ...
                            If GrdddlSupplier.SelectedValue <> "[Select]" Then
                                SqlCmd = New SqlCommand("sp_InsertorUpdateExcursionCostDetails", mySqlConn, sqlTrans)
                                SqlCmd.CommandType = CommandType.StoredProcedure
                                SqlCmd.Parameters.Add(New SqlParameter("@RowId", SqlDbType.Int)).Value = mRowId
                                SqlCmd.Parameters.Add(New SqlParameter("@excid", SqlDbType.VarChar, 20)).Value = CType(Request.QueryString("RefCode"), String)
                                SqlCmd.Parameters.Add(New SqlParameter("@rlineno", SqlDbType.Int)).Value = CType(Request.QueryString("LineNo"), Integer)
                    ...
                    'SaveExcursionCostDetails(Request.QueryString("RefCode"), CType(Request.QueryString("LineNo"), Integer))

                    '25082014
                    If chktrfreq.Checked = True Then
                        ' SendMailtotrfdept(Request.QueryString("RefCode"))
                    End If
                ...
                ElseIf CType(Session("ExcursionRequestSubEntryState"), String) = "CancelRow" Then
                    If chkCancel.Checked = True Then
                        ...
                        SqlCmd = New SqlCommand("sp_excdet_cancel", mySqlConn, sqlTrans)
                        SqlCmd.CommandType = CommandType.StoredProcedure

                        SqlCmd.Parameters.Add(New SqlParameter("@excid", SqlDbType.VarChar, 20)).Value = Request.QueryString("RefCode")
                        SqlCmd.Parameters.Add(New SqlParameter("@rlineno", SqlDbType.Int)).Value = Request.QueryString("LineNo")
                        SqlCmd.Parameters.Add(New SqlParameter("@cancelreason", SqlDbType.VarChar)).Value = txtCancelReason.Text
                        SqlCmd.Parameters.Add(New SqlParameter("@userlogged", SqlDbType.VarChar, 20)).Value = Session("GlobalUserName")
                        SqlCmd.ExecuteNonQuery()
                        ...
                        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Excursion Cancelled Sucessfully');", True)
                    Else
                        mySqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))           'connection open
                        sqlTrans = mySqlConn.BeginTransaction

                        SqlCmd = New SqlCommand("sp_excdet_undocancel", mySqlConn, sqlTrans)
                        SqlCmd.CommandType = CommandType.StoredProcedure
                        ...
                        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Excursion Undo Cancelled Sucessfully');", True)
                    End If
                End If
            End If
    ...
    Private Function ValidateCostValue() As Boolean
        Try
            If hdnTotalMC.Value = "" Then hdnTotalMC.Value = 0
            If Session("TempMultiCostGrid") Is Nothing Then
    ...
    Private Sub AddRows(ByVal RLineNo As Integer)
        Try
            ...
            dtExcursionDetails.Rows.Add(NewRLineNo, 1, "", txtTourDate.Text, ddlExcursionSubGroup.Items(ddlExcursionSubGroup.SelectedIndex).Value,
           ...
           Val(txtAdultCostRate.Text), Val(txtChildCostRate.Text), Val(txtCostAmount.Text), Val(txtCostAmountAED.Text), txtCancelReason.Text,
           ...
           0, 0, "", Val(txtTotalAmountAED.Text), txtIncomeInvoiceNo.Text,
           ...
           txtCostCurr.Text.Trim, Val(txtCostConvRate.Text), ddlExcursionType.Items(ddlExcursionType.SelectedIndex).Text, IIf(chksupconf.Checked = True, 1, 0), txtexctime.Text, txttrfno.Text, txtsupconfno.Text, txtprotktno.Text, txtreminder.Text)
    ...
    Private Sub ShowRecord(ByVal RefCode As String, ByVal LineNo As Integer)
        Try
            'Commented and updated by riswan 20/04/2015
            ...
            strSqlQry = "select *,othgrpmast.othmaingrpcode,excursions_header.paycode,excursions_header.collectedamt from excursions_detail INNER JOIN excursions_header ON excursions_detail.excid = excursions_header.excid inner join othgrpmast on excursions_detail.othgrpcode = othgrpmast.othgrpcode where excursions_detail.excid='" & RefCode & "' and rlineno=" & LineNo
            ...
            If mySqlReader.Read = True Then
                ...
                'Added By Riswan 20/04/2015 - Load and bind paymentmode and collectamount                
                If IsDBNull(mySqlReader("paycode")) = False Then
                    hdnPaymentMode.Value = mySqlReader("paycode")
                Else
                    hdnPaymentMode.Value = "[Select]"
                End If
                objUtils.FillDropDownListHTMLNEW(Session("dbconnectionName"), ddlPayment, "payname", "paycode", "  select ltrim(rtrim(paycode))paycode, ltrim(rtrim(payname))payname from paymentmodemaster order by payname", True, hdnPaymentMode.Value)

                If IsDBNull(mySqlReader("collectedamt")) = False Then
                    hdnCollectAmount.Value = mySqlReader("collectedamt")
                Else
                    hdnCollectAmount.Value = 0                    
                End If
                txtcollectamt.Text = hdnCollectAmount.Value
                'Added Shahul 14/06/15
                Dim nationcode As String
                If IsDBNull(mySqlReader("nationalitycode")) = False Then
                    nationcode = mySqlReader("nationalitycode")
                Else
                    nationcode = "[Select]"
                End If
                objUtils.FillDropDownListHTMLNEW(Session("dbconnectionName"), ddlLanguage, "nationalityname", "nationalitycode", " select ltrim(rtrim(nationalitycode))nationalitycode,ltrim(rtrim(nationalityname))nationalityname from nationality_master where showinexcursions=1 and active=1 order by nationalityname", True, nationcode)
                '''''''''''''''
                ...
                If Request.QueryString("hotel") <> "" Then
                    ddlHotel.Value = Request.QueryString("hotel")
                ...
                Else
                    If IsDBNull(mySqlReader("hotel")) = False Then
                        ...
                        txthotel.Value = ddlHotel.Items(ddlHotel.SelectedIndex).Text
                    Else
                        htlcode = objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select a.partycode from meetassist a,excursions_detail d where a.requestid =d.excid and  d.excid ='" & RefCode & "'")
                        If htlcode <> "" Then
                            ddlHotel.Value = htlcode.Trim
                            txthotel.Value = ddlHotel.Items(ddlHotel.SelectedIndex).Text
                        Else
                            strqry = "select top 1 d.partycode from reservation_detailnew d  where d.requestid='" & RefCode & "'  and  ISNULL(d.cancelled,0)=0 "
                            htlcode = objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), strqry)
                            If htlcode <> "" Then
                                ddlHotel.Value = htlcode.Trim
                                txthotel.Value = ddlHotel.Items(ddlHotel.SelectedIndex).Text
                ...
                If IsDBNull(mySqlReader("costpricea")) = False Then
                    ...
                    hdnAdultCostRate.Value = txtAdultCostRate.Text
                End If

                If IsDBNull(mySqlReader("costpriceb")) = False Then
                    txtChildCostRate.Text = mySqlReader("costpriceb")
                    hdnChildCostRate.Value = txtChildCostRate.Text
                End If

                If IsDBNull(mySqlReader("costvalue")) = False Then
                    txtCostAmount.Text = mySqlReader("costvalue")
                    hdnCostAmountAED.Value = mySqlReader("costvalue")
                End If

                If IsDBNull(mySqlReader("costcurrency")) = False Then
                    txtCostAmountAED.Text = mySqlReader("costcurrency")
                    hdnCostAmount.Value = mySqlReader("costcurrency")
                ...
                If IsDBNull(mySqlReader("supconf")) = False Then
                    If mySqlReader("supconf") = 1 Then
                        chksupconf.Checked = True
                        txtsupconfno.Style("display") = "block"
                        lblsupconf.Style("display") = "block"
                        txtsupconfno.Text = mySqlReader("supconfno")
                    ElseIf mySqlReader("supconf") = 0 Then
                ...
                If IsDBNull(mySqlReader("trf_required")) = False Then
                    If mySqlReader("trf_required") = 1 Then
                ...
                txtprotktno.Text = mySqlReader("protktno").ToString 'IIf(IsDBNull(mySqlReader("protktno").ToString = True), "", mySqlReader("protktno"))
                ...
                If IsDBNull(mySqlReader("exctime")) = False Then
                    txtexctime.Text = mySqlReader("exctime")
                End If

                If IsDBNull(mySqlReader("trfno")) = False Then
                    If mySqlReader("trfno") <> "" Then
                        txttrfno.Style("display") = "block"
                        lbltransferid.Style("display") = "block"
                        txttrfno.Text = mySqlReader("trfno")
                    End If
                ...
                If IsDBNull(mySqlReader("salecurrency")) = False Then
                    txtAmount.Text = Math.Round(mySqlReader("salecurrency"), CType(txtdecimal.Value, Integer))
                    'hdnAmountAED.Value = Math.Round(mySqlReader("amountAED"), CType(txtdecimal.Value, Integer))
                End If

                If IsDBNull(mySqlReader("salevalue")) = False Then
                    txtAmountAED.Text = Math.Round(mySqlReader("salevalue"), CType(txtdecimal.Value, Integer))
                    'hdnAmount.Value = Math.Round(showDataRow(0)("amount"), CType(txtdecimal.Value, Integer))
                End If


                If IsDBNull(mySqlReader("costCurrencyName")) = False Then
                    txtCostCurr.Text = mySqlReader("costCurrencyName")
                    hdnCostCurr.Value = mySqlReader("costCurrencyName")
                End If

                If IsDBNull(mySqlReader("costConvRate")) = False Then
                    txtCostConvRate.Text = mySqlReader("costConvRate")
                    hdnCostCurrConvRate.Value = mySqlReader("costConvRate")
                End If
    ...
    Private Sub CancelDisablecontrols()
        txtTourDate.ReadOnly = True
        ImgBtnTourDate.Enabled = False
        ImgBtnArrivalDate.Enabled = False
        ImgBtnDepartureDate.Enabled = False
        txtTourDate.Enabled = False
        ...
        txtCancelReason.ReadOnly = False
        txthotel.Disabled = True
    End Sub
            ...
            If showDt.Rows.Count > 0 Then
                ...
                If showDataRow.Length = 1 Then
                    ...
                    If IsDBNull(showDataRow(0)("costAmount")) = False Then
                        txtCostAmount.Text = Math.Round(showDataRow(0)("costAmount"), CType(txtdecimal.Value, Integer))
                        hdnCostAmount.Value = Math.Round(showDataRow(0)("costAmount"), CType(txtdecimal.Value, Integer))
                    End If

                    If IsDBNull(showDataRow(0)("costAmountAED")) = False Then
                        txtCostAmountAED.Text = Math.Round(showDataRow(0)("costAmountAED"), CType(txtdecimal.Value, Integer))
                        hdnCostAmountAED.Value = Math.Round(showDataRow(0)("costAmountAED"), CType(txtdecimal.Value, Integer))
                    End If
    ...
    Private Sub Fillticket_Details()
        Try
            ...
            strSqlQry = "sp_show_selec_ticket '" & str & "','" & txtSearch1.Text & "'"
    ...
    Public Function SendMailtotrfdept(ByVal requestid As String) As Boolean
        ...
        Try
            ...
            strSql = "SELECT trf_required,excid,rlineno,othtypcode,guestname,partyname FROM  excursions_detail inner join partymast on partymast.partycode=excursions_detail.hotel where excid='" & requestid & "' and trf_required = 1"
            ...
            If ds.Tables.Count > 0 Then
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    For i = 0 To ds.Tables(0).Rows.Count - 1
                        ...
                        strcust = "<table style='font-family: Verdana'><tr><td> There is a request for transfer in Excursion Booking –" + requestid + "  Hotel.-" + CType(ds.Tables(0).Rows(i)("partyname"), String) + "  Guest Name.-" + CType(ds.Tables(0).Rows(i)("guestname"), String) + "</td></tr>"
                        'strcust += "<td>Line No." + CType(ds.Tables(0).Rows(i)("rlineno"), String) + "</td></tr>"
                        strcust += " <br /><br />Thanks and best regards<br /><br />" + Session("GlobalUserName")
                        strcust += " <br /><br />Excursions Dept.</table>"

                        fromMail = objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select option_value from reservation_parameters where param_id =1114")
                        toMail = objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select option_value from reservation_parameters where param_id =1113")
                        subject = "Request from Excursion for Transfers -" & requestid

                        blnMailSend = objEmail.SendEmailCC(fromMail, toMail, toCC, subject, strcust)
                    Next
    ...
    Protected Sub btnMCSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        '        ModalPopupMultipleCost.Hide()
        '    Else
        '        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Unable to save excursion cost details due to some issue');", True)
        '        ModalPopupMultipleCost.Show()
        '    End If
        'Else
        '    ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Please select supplier from any one of these rows');", True)
        '    ModalPopupMultipleCost.Show()
        'End If
    End Sub
    ...
    'Private Function SaveExcursionCostDetails(ByVal excId As String, ByVal rlineno As Integer) As Boolean
    '    Try
    '        If Not Session("ExcursionCostDetailTable") Is Nothing Then
    '            Dim flag As Boolean = False
    '            Dim dtExcCostDetails As New DataTable
    '            SqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))
    '            SqlCmd = New SqlCommand("[dbo].[sp_DeleteExcursionCostDetails]", SqlConn)
    '            SqlCmd.CommandType = CommandType.StoredProcedure
    ...
    '                    SqlCmd.CommandType = CommandType.StoredProcedure
    '                    SqlCmd.Parameters.Add(New SqlParameter("@RowId", SqlDbType.Int)).Value = CType(row.Item("rowid"), Integer)
    '                    SqlCmd.Parameters.Add(New SqlParameter("@excid", SqlDbType.VarChar, 20)).Value = CType(excId, String)
    '                    SqlCmd.Parameters.Add(New SqlParameter("@rlineno", SqlDbType.VarChar, 20)).Value = CType(rlineno, String)
    ...
    '                    SqlCmd.Parameters.Add(New SqlParameter("@costrate", SqlDbType.Decimal)).Value = CType(row.Item("costrate"), Decimal)
    ...
    Private Function SaveExcursionCostDetails(ByVal excId As String, ByVal rlineno As Integer) As Boolean
        Try
            ...
            'SqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))
            SqlCmd = New SqlCommand("sp_DeleteExcursionCostDetails", SqlConn)
            SqlCmd.CommandType = CommandType.StoredProcedure
            SqlCmd.Parameters.Add(New SqlParameter("@excid", SqlDbType.VarChar, 20)).Value = CType(excId, String)
            SqlCmd.Parameters.Add(New SqlParameter("@rlineno", SqlDbType.VarChar, 20)).Value = CType(rlineno, String)
            SqlCmd.ExecuteNonQuery()
    ...
    Protected Sub btnSubEntryClose_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubEntryClose.Click        
        'If ddlExcursionProvider.Value = "[Select]" Then
        '    hdnCostAmountAED.Value = 0
        '    txtCostAmountAED.Text = 0
        '    hdnCostAmount.Value = 0
        '    txtCostAmount.Text = 0            
        'End If
    End Sub
End Class
