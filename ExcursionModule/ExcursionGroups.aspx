<%@ Page Language="VB"  MasterPageFile="~/ExcursionMaster.master" AutoEventWireup="false" CodeFile="ExcursionGroups.aspx.vb" Inherits="ExcursionGroups" %>
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          if (ValueRetrieval.value == "S") {
              //               $txtvsprocess.val('EXCURSIONGROUP:" "EXCURSIONTYPE:" "CLASSIFICATION:" " RATEBASIS:" " Text:" "');
              $txtvsprocess.val('EXCURSIONGROUP:" "EXCURSIONTYPE:" " CLASSIFICATION:" " RATEBASIS:" " SIC/PRIVATE:" " SECTORWISERATES:" " MULTIPLECOST:" " COMBO: " " Text:" "');

          }
          if (ValueRetrieval.value !== "S") {
              $txtvsprocess.val('EXCURSIONTYPE:" "CLASSIFICATION:" " RATEBASIS:" "Text:" "');
          }
            ...
            'access'
              ...
              callbacks: {
                      ...
                      if (ValueRetrieval.value == "S") {
                          switch (category) {
                              ...
                              case 'SIC/PRIVATE':
                                  ...
                                  var asSqlqry = "select 'SIC' union select 'PRIVATE' ";
                                  glcallback = callback;
                              ...
                              case 'SECTORWISERATES':
                                  ...
                                  var asSqlqry = "select 'YES' union select 'NO' ";
                                  glcallback = callback;
                                  //ColServices.clsSectorServices.GetListOfTranDocVisualSearchStrNew(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                  ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                  break;
                  ...
                  facetMatches: function (callback) {
                      callback([
 { label: 'EXCURSIONGROUP', category: 'EXCURSION' },
                { label: ' EXCURSIONTYPE', category: 'EXCURSION' },
                 { label: ' CLASSIFICATION', category: 'EXCURSION' },
...
<TABLE style="BORDER-RIGHT: gray 2px solid; BORDER-TOP: gray 2px solid; BORDER-LEFT: gray 2px solid; WIDTH: 100%px; BORDER-BOTTOM: gray 2px solid;margin-left:35px;vertical-align:top;"  ><TBODY><TR>
    <TD style="HEIGHT: 15px" class="field_heading" align=center colSpan=4 
        width="10">
    <asp:Label id="lblHeading" runat="server" Text="Excursion Groups" 
    ...
    <tr>
        <td align="center" colspan="4" style="HEIGHT: 3px; text-align: center;">
            ...
            &nbsp;<asp:Button ID="btnAddHotel" runat="server" CssClass="btn" Font-Bold="False" 
                tabIndex="4" Text="Add New Excursion" />
            &nbsp;<asp:Button ID="btnHotelReport" runat="server" CssClass="btn" 
                Font-Bold="False" tabIndex="4" Text="Excursion Report" />
        </td>
    </tr>
            ...
            <table class="style1">
                ...
                <tr runat="server" id="trNameAndCode">
                    ...
                    <td colspan="2">
                       ...
                       <td colspan="2">
                        <asp:Label ID="Label7" runat="server" Text="Excursion Group"></asp:Label>
                        &nbsp;&nbsp;<asp:TextBox ID="txtGroupTagName" runat="server" AutoPostBack="True" 
                            ...
                            FirstRowSelected="false" MinimumPrefixLength="0" ServiceMethod="GetExcursionGroup" 
     ...
     <asp:UpdatePanel ID="UpdatePanel4" runat="server">
      ...
      <asp:UpdatePanel ID="UpdatePanel5" runat="server">
        <ContentTemplate>
            <asp:GridView ID="gv_SearchResult" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField Visible="False" HeaderText="Selling Code">
                        <ItemTemplate>
                            <asp:Label ID="lblHotelName" runat="server" Text='<%# Bind("exctypname") %>' __designer:wfdid="w1"></asp:Label>
                            <asp:Label ID="lblHotelCode" runat="server" Text='<%# Bind("exctypcode") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="exctypcode" HeaderText="ExcursionType Code">
                        <ItemStyle HorizontalAlign="Left" />
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="Excursion Type">
                        <ItemTemplate>
                            <asp:Label ID="lblothtyp" runat="server" Text='<%# Bind("exctypname") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Excursion Group Name">
                        <ItemTemplate>
                            <asp:Label ID="lblexcursiongroup" runat="server" Text='<%# Bind("excursiongroup") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Classification Name">
                        <ItemTemplate>
                            <asp:Label ID="lblclassificationname" runat="server" Text='<%# Bind("classificationname") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
                    ...
                    <asp:BoundField DataField="tktbasedontime" HeaderText="Ticket Based On Time"></asp:BoundField>
                    <asp:BoundField DataField="autoconfirm" HeaderText="Auto Confirm"></asp:BoundField>
            ...
            <asp:GridView ID="gvSearchGrid" TabIndex="10" runat="server" Font-Size="10px" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Excursion Type Name">
                        <ItemTemplate>
                            <asp:Label ID="lblothtypname" runat="server" Text='<%# Bind("exctypname") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:BoundField DataField="excursiongroupcode" HeaderText="Group Code" Visible="false">
                    ...
                    <asp:TemplateField HeaderText="Rate Basis">
                      ...
                      <%-- <asp:BoundField DataField="sicpvt" HeaderText="SIC/PVT"></asp:BoundField>--%>
                        <asp:TemplateField HeaderText="SIC/PVT">
                        <ItemTemplate>
                            <asp:Label ID="lblsicpvt" runat="server" Text='<%# Bind("sicpvt") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Sector Wise Rates">
                        <ItemTemplate>
                            <asp:Label ID="lblsectorwiserates" runat="server" Text='<%# Bind("sectorwiserates") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
                               <%--     <asp:BoundField DataField="sectorwiserates" HeaderText="Sector Wise Rates"></asp:BoundField>--%>
                               
                                                                       <asp:TemplateField HeaderText="Multi cost">
                        <ItemTemplate>
                            <asp:Label ID="lblmulticost" runat="server" Text='<%# Bind("multicost") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
                                                   
                                              <%--   <asp:BoundField DataField="multicost" HeaderText="Multi cost"></asp:BoundField>--%>

                                                                       <asp:TemplateField HeaderText="Combo">
                        <ItemTemplate>
                            <asp:Label ID="lblCombo" runat="server" Text='<%# Bind("combo") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
