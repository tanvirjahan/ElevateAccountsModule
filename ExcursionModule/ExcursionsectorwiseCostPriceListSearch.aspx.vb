...
Partial Class ExcursionsectorwiseCostPriceListSearch
...
#Region "Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            Try
                ...
                If CType(Session("GlobalUserName"), String) = Nothing Or CType(Session("Userpwd"), String) = Nothing Then
                    ...
                    Exit Sub
                Else
                    '' Added shahul appid 04/08/18
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                             CType(strappname, String), "ExcursionModule\ExcursionsectorwiseCostPriceListSearch.aspx?appid=" + strappid + "&Type=" + Session("OthPListFilter"), btnAddNew, btnExportToExcel, _
                ...
                ViewState("strExcostsortExpression") = "h.eplistcode"
                Session.Add("strExcostsortExpression", "h.eplistcode")
                Session.Add("strExcsortdirection", SortDirection.Ascending)
                '  charcters(TxtPLCD)
                ...
                Session("sDtDynamicEXCsecortcost") = Nothing
                ...
                Session("sDtDynamicEXCsecortcost") = dtDynamic
                '--------end
        ...
        If (Me.IsPostBack And Me.Request("__EVENTTARGET") = "ExcursionwiseCostPriceListWindowPostBack") Then
...
#Region "Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = 'ASC')"
    Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        Try
            ...
            strSqlQry = "select h.eplistcode,h.classcode,c.classificationname classname,h.partycode,p.partyname,  " _
                   & " othtypname=(select distinct stuff((select  ',' + u2.othtypname from exccplist_header h2 cross apply dbo.splitallotmkt(h2.sectorgroupcode,',') ah2 left join othtypmast u2 on  ah2.mktcode= u2.othtypcode    where h2.eplistcode=h.eplistcode  " _
                  & " and u2.othgrpcode in (select option_selected from reservation_parameters where param_id=1001)  for xml path('')),1,1,'')),isnull(h.sectorgroupcode,'') othtypcode , h.currcode,h.applicableto,status=	case when isnull(approved,0)=1 then 'Yes' else 'No' End, " _
                & " h.frmdate,h.todate,h.adddate,h.adduser,h.moddate,h.moduser from exccplist_header h,excclassification_header c,partymast p  where h.partycode=p.partycode   " _
                & " and isnull(h.sectoryesno,0)=1 and h.classcode=c.classificationcode "
            ...
            If myDS.Tables(0).Rows.Count > 0 Then
                ...
                'gv_SearchResult.PageIndex = 0  ''' Added shahul 22/05/18 need to first page
        ...
        Catch ex As Exception
            'ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            objUtils.WritErrorLog("ExcursionsectorwisePricelistSearch.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        Finally
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        strpop = "window.open('ExcursionsuppliercostPriceList.aspx?State=New&costtype=S','ExcursionsuppliercostPriceList');"
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            If e.CommandName = "Editrow" Then
                ...
                strpop = "window.open('ExcursionsuppliercostPriceList.aspx?State=Edit&costtype=S&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionsuppliercostPriceList');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ElseIf e.CommandName = "View" Then
                ...
                strpop = "window.open('ExcursionsuppliercostPriceList.aspx?State=View&costtype=S&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionsuppliercostPriceList');"
            ...
            ElseIf e.CommandName = "Deleterow" Then
                ...
                strpop = "window.open('ExcursionsuppliercostPriceList.aspx?State=Delete&costtype=S&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionsuppliercostPriceList');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ...
            ElseIf e.CommandName = "Copy" Then
                ...
                strpop = "window.open('ExcursionsuppliercostPriceList.aspx?State=Copy&costtype=S&RefCode=" + CType(lblId.Text.Trim, String) + "','ExcursionsuppliercostPriceList');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
...
#End Region
    Protected Sub btnResetSelection_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnResetSelection.Click
        ...
        dtt = Session("sDtDynamicEXCsecortcost")
        If dtt.Rows.Count > 0 Then
            dtt.Clear()
        End If
        Session("sDtDynamicEXCsecortcost") = dtt
...
#Region " Protected Sub gv_SearchResult_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gv_SearchResult.Sorting"
    ...
    Protected Sub gv_SearchResult_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gv_SearchResult.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim lblpartycode As Label = e.Row.FindControl("lblpartycode")
            ...
            dtDynamics = Session("sDtDynamicEXCsecortcost")
            If Session("sDtDynamicEXCsecortcost") IsNot Nothing Then
    ...
    Protected Sub gv_SearchResult_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gv_SearchResult.Sorting
        ...
        Session.Add("strExcostsortExpression", e.SortExpression)
...
#Region "Public Sub SortGridColoumn_click()"
    Public Sub SortGridColoumn_click()
        ...
        Dim myDS As New DataSet
        FillGrid(ViewState("strExcostsortExpression"), "")

        myDS = gv_SearchResult.DataSource
        DataTable = myDS.Tables(0)
        If IsDBNull(DataTable) = False Then
            Dim dataView As DataView = DataTable.DefaultView
            Session.Add("strExcsortdirection", objUtils.SwapSortDirection(Session("strExcsortdirection")))
            dataView.Sort = ViewState("strExcostsortExpression") & " " & objUtils.ConvertSortDirectionToSql(Session("strExcsortdirection"))
    ...
    Protected Sub btnExportToExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExportToExcel.Click
        ...
        Try
            If gv_SearchResult.Rows.Count <> 0 Then
                ...
                strSqlQry = "select h.eplistcode,h.classcode,c.classificationname classname,h.partycode,p.partyname, isnull(t.othtypname,'') othtypname,isnull(h.sectorgroupcode,'') othtypcode,  h.currcode,h.applicableto,status=	case when isnull(approved,0)=1 then 'Yes' else 'No' End, " _
           & " h.frmdate,h.todate,h.adddate,h.adduser,h.moddate,h.moduser from exccplist_header h,excclassification_header c ,othtypmast t,partymast p  where h.partycode=p.partycode   h.sectorgroupcode=t.othtypcode  " _
           & " and isnull(h.sectoryesno,0)=1 and h.classcode=c.classificationcode and t.othgrpcode in (select option_selected from reservation_parameters where param_id=1001) "
    ...
    Protected Sub lbClose_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            If dtDynamics.Rows.Count > 0 Then
                ...
                Next
            End If
            Session("sDtDynamicEXCsecortcost") = dtDynamics
...
#End Region
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If Not Session("sDtDynamicEXCsecortcost") Is Nothing Then
            FillGridNew()
        Else
            Select Case ddlOrderBy.SelectedIndex
                Case 0
    ...
    Protected Sub btnHelp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnHelp.Click
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=ExcSuppSecWisePrice','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    End Sub
    ...
    Protected Sub btnvsprocess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnvsprocess.Click
        ...
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            objUtils.WritErrorLog("ExcursionSectorwisePriceSearch.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        End Try
    ...
    Private Sub FillGridNew()
        ...
        Try
            ...
            End If
            strSqlQry = ""
            Dim strorderby As String = ViewState("strExcostsortExpression") 'Session("strExcostsortExpression")
            ...
            'strSqlQry = "select h.eplistcode,h.classcode,c.classificationname classname,h.currcode,h.applicableto,status=	case when isnull(approved,0)=1 then 'Yes' else 'No' End,h.frmdate,h.todate,h.adddate,	h.adduser,h.moddate,h.moduser from excplist_header h,excclassification_header c where h.classcode=c.classificationcode "
            strSqlQry = "select distinct h.eplistcode,h.classcode,c.classificationname classname,h.partycode,p.partyname,  " _
                  & " othtypname=(select distinct stuff((select  ',' + u2.othtypname from exccplist_header h2 cross apply dbo.splitallotmkt(h2.sectorgroupcode,',') ah2 left join othtypmast u2 on  ah2.mktcode= u2.othtypcode    where h2.eplistcode=h.eplistcode  " _
             & " and u2.othgrpcode in (select option_selected from reservation_parameters where param_id=1001)  for xml path('')),1,1,'')),isnull(h.sectorgroupcode,'') othtypcode , h.currcode,h.applicableto,status=	case when isnull(approved,0)=1 then 'Yes' else 'No' End, " _
& " h.frmdate,h.todate,h.adddate,h.adduser,h.moddate,h.moduser from exccplist_header h cross apply dbo.splitallotmkt(h.sectorgroupcode,',') s left join othtypmast t on  t.othtypcode=s.mktcode,excclassification_header c ,partymast p where h.partycode=p.partycode     " _
& " and isnull(h.sectoryesno,0)=1 and h.classcode=c.classificationcode and t.othgrpcode in (select option_selected from reservation_parameters where param_id=1001) "
    ...
    Private Function BuildConditionNew(ByVal strCountryValue As String, ByVal strCityValue As String, ByVal strSectorValue As String, ByVal strSectorGroupValue As String, ByVal strTextValue As String, ByVal strSuppvalue As String) As String
        ...
        If strCountryValue <> "" Then
            If Trim(strWhereCond) = "" Then
                strWhereCond = " upper(othtypname) IN (" & Trim(strCountryValue.Trim.ToUpper) & ")"
            Else
                strWhereCond = strWhereCond & " AND  upper(othtypname) IN (" & Trim(strCountryValue.Trim.ToUpper) & ")"
            End If
        End If

        If strSuppvalue <> "" Then
            If Trim(strWhereCond) = "" Then
                strWhereCond = " upper(partyname) IN (" & Trim(strSuppvalue.Trim.ToUpper) & ")"
            Else
                strWhereCond = strWhereCond & " AND  upper(partyname) IN (" & Trim(strSuppvalue.Trim.ToUpper) & ")"
            End If
        End If
            ...
            For i = 0 To lsMainArr.GetUpperBound(0)
                ...
                If strValue <> "" Then
                    If Trim(strWhereCond1) = "" Then
                        strWhereCond1 = " (upper(eplistcode) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(partyname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(othtypname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(classificationname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(approved) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    Else
                        strWhereCond1 = strWhereCond1 & " OR  (upper(eplistcode) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or upper(partyname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'   upper(othtypname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(classificationname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(approved) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    End If
                End If
            Next
            If Trim(strWhereCond) = "" Then
        ...
        If Page.IsPostBack = False Then
            If Request.QueryString("appid") Is Nothing = False Then
                ...
                Select Case appid
                    ...
                    Case 14, 16 'changed by mohamed on 08/09/2018 --added 16
                        Me.MasterPageFile = "~/AccountsMaster.master"
                    Case 13
