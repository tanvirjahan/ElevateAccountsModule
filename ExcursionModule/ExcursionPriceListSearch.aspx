<%@ Page Language="VB" MasterPageFile="~/ExcursionMaster.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="ExcursionPriceListSearch.aspx.vb" Inherits="ExcursionPriceListSearch"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
  ...
  <script type="text/javascript" charset="utf-8">
      ...
      function visualsearchbox() {
          ...
          $txtvsprocess.val('PRICELIST:" " CURRENCY:" " CLASSIFICATION:" " APPROVEDSTATUS:" " TEXT:" "');
                  ...
                  valueMatches: function (category, searchTerm, callback) {
                      ...
                      switch (category) {
                          case 'PRICELIST':
                              ...
                              var asSqlqry = "select ltrim(rtrim(eplistcode)) PRICELIST  from excplist_header(nolock)  order by eplistcode";
                              glcallback = callback;
                              ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                              break;
                          case 'CURRENCY':

                              var asSqlqry = 'select ltrim(rtrim(currcode)) currency  from currmast where active=1';
                              glcallback = callback;
                              //fnTestCallback();
                              ColServices.clsServices.GetListOfArrayVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
...
//                              ColServices.clsVisualSearchService.GetListOfExcursionTypeVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                ...
                { label: 'CURRENCY', category: 'Sector' },
                    ...
                    <table style="border-right: gray 2px solid; border-top: gray 2px solid; border-left: gray 2px solid;
                        ...
                        <tr>
                            <td style="text-align: center; width: 100%;" align="center" class="field_heading">
                                <asp:label id="Label1" runat="server" cssclass="field_heading" text="Excursion Pricelist Search">
                                </asp:label>
                            </td>
                        </tr>
                        <tr>
