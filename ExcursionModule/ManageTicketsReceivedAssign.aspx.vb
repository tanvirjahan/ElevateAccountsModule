...
Partial Class ExcursionModule_ManageTicketsReceivedAssign
            ...
            If Page.IsValid = True Then
                ...
                If CType(Session("ManageTicketState"), String) = "View" Then
                    ...
                    For Each GvRow In gv_row.Rows
                        ...
                        optionval = objUtils.GetAutoDocNo("EXASSIGN", mySqlConn, sqlTrans)
                        ...
                        SqlCmd = New SqlCommand("sp_add_excursion_tickets_assigned", mySqlConn, sqlTrans)
                        SqlCmd.CommandType = CommandType.StoredProcedure
                        SqlCmd.Parameters.Add(New SqlParameter("@assignid", SqlDbType.VarChar, 20)).Value = CType(txtAllotmentID.Value.Trim, String)
                        SqlCmd.Parameters.Add(New SqlParameter("@ticketid", SqlDbType.VarChar, 20)).Value = CType(Session("ManageTicketRefCode"), String)


                        SqlCmd.Parameters.Add(New SqlParameter("@assigneddate", SqlDbType.DateTime)).Value = DateTime.Now
                        SqlCmd.Parameters.Add(New SqlParameter("@assignedto", SqlDbType.VarChar, 20)).Value = IIf(ddlCustomer.Value.Trim = "[Select]", DBNull.Value, CType(ddlCustomer.Value.Trim, String))
                    ...
                    ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('Assigned To Agent Sucessfully. Click on OK to Return Search Page');", True)
...
#End Region
    ...
    Private Sub FillGridSubDetail()
        ...
        strSqlQry = ""
        Try
            strSqlQry = "Select * from excursion_tickets_subdetail Where ISNULL(usedinexcid,'')='' and ticketid='" & CType(Session("ManageTicketRefCode"), String) & "'"
    ...
    Protected Sub gv_row_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles gv_row.PageIndexChanging
        gv_row.PageIndex = e.NewPageIndex
        FillGridSubDetail()
    End Sub
    ...
    Protected Sub btnFillAllTickets_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFillAllTickets.Click
        ...
        FillGridSubDetail()
        ShowRecordAssigned(CType(Session("ManageTicketRefCode"), String))
