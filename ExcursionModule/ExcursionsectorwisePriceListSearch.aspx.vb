...
Partial Class ExcursionsectorwisePriceListSearch
            ...
            Try
                ...
                Else
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                             CType(strappname, String), "ExcursionModule\ExcursionsectorwisePriceListSearch.aspx?appid=" + strappid + "&Type=" + Session("OthPListFilter"), btnAddNew, btnExportToExcel, _
                ...
                Session("sDtDynamic_Exec_Search_Plist_sectorwise") = Nothing
                ...
                Session("sDtDynamic_Exec_Search_Plist_sectorwise") = dtDynamic
                '--------end
...
#Region "Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = 'ASC')"
    Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        Try
            ...
            'strSqlQry = "select h.eplistcode,h.classcode,c.classificationname classname,isnull(t.othtypname,'') othtypname,isnull(h.sectorgroupcode,'') othtypcode , h.currcode,h.applicableto,status=	case when isnull(approved,0)=1 then 'Yes' else 'No' End, " _
            '    & " h.frmdate,h.todate,h.adddate,h.adduser,h.moddate,h.moduser from excplist_header h,excclassification_header c ,othtypmast t where  h.sectorgroupcode=t.othtypcode  " _
            ...
            strSqlQry = "select h.eplistcode,h.classcode,c.classificationname classname," _
                & " othtypname=(select distinct stuff((select  ',' + u2.othtypname from excplist_header h2 cross apply dbo.splitallotmkt(h2.sectorgroupcode,',') ah2 left join othtypmast u2 on  ah2.mktcode= u2.othtypcode    where h2.eplistcode=h.eplistcode  " _
             ...
             & " h.frmdate,h.todate,h.adddate,h.adduser,h.moddate,h.moduser from excplist_header h,excclassification_header c  where  " _
             & "  isnull(h.sectoryesno,0)=1 and h.classcode=c.classificationcode  "
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        strpop = "window.open('OthPriceList1.aspx?State=New&costtype=S','OthPriceList1');"
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            If e.CommandName = "Editrow" Then
                ...
                strpop = "window.open('OthPriceList1.aspx?State=Edit&costtype=S&RefCode=" + CType(lblId.Text.Trim, String) + "','OthPriceList1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ElseIf e.CommandName = "View" Then
                ...
                strpop = "window.open('OthPriceList1.aspx?State=View&costtype=S&RefCode=" + CType(lblId.Text.Trim, String) + "','OthPriceList1');"
            ...
            ElseIf e.CommandName = "Deleterow" Then
                ...
                strpop = "window.open('OthPriceList1.aspx?State=Delete&costtype=S&RefCode=" + CType(lblId.Text.Trim, String) + "','OthPriceList1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            ...
            ElseIf e.CommandName = "Copy" Then
                ...
                strpop = "window.open('OthPriceList1.aspx?State=Copy&costtype=S&RefCode=" + CType(lblId.Text.Trim, String) + "','OthPriceList1');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
...
#End Region
    Protected Sub btnResetSelection_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnResetSelection.Click
        ...
        dtt = Session("sDtDynamic_Exec_Search_Plist_sectorwise")
        If dtt.Rows.Count > 0 Then
            dtt.Clear()
        End If
        Session("sDtDynamic_Exec_Search_Plist_sectorwise") = dtt
...
#Region " Protected Sub gv_SearchResult_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gv_SearchResult.Sorting"
    ...
    Protected Sub gv_SearchResult_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gv_SearchResult.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            dtDynamics = Session("sDtDynamic_Exec_Search_Plist_sectorwise")
            If Session("sDtDynamic_Exec_Search_Plist_sectorwise") IsNot Nothing Then
    ...
    Protected Sub lbClose_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            If dtDynamics.Rows.Count > 0 Then
                ...
                Next
            End If
            Session("sDtDynamic_Exec_Search_Plist_sectorwise") = dtDynamics
...
#End Region
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If Not Session("sDtDynamic_Exec_Search_Plist_sectorwise") Is Nothing Then
            FillGridNew()
        Else
            Select Case ddlOrderBy.SelectedIndex
                Case 0
    ...
    Protected Sub btnHelp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnHelp.Click
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=ExcSectorPriceList','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    End Sub
    ...
    Private Sub FillGridNew()
        ...
        Try
            ...
            strSqlQry = "select distinct h.eplistcode,h.classcode,c.classificationname classname," _
             & " othtypname=(select distinct stuff((select  ',' + u2.othtypname from excplist_header h2 cross apply dbo.splitallotmkt(h2.sectorgroupcode,',') ah2 left join othtypmast u2 on  ah2.mktcode= u2.othtypcode    where h2.eplistcode=h.eplistcode  " _
             & " and u2.othgrpcode in (select option_selected from reservation_parameters where param_id=1001)  for xml path('')),1,1,'')), isnull(h.sectorgroupcode,'') othtypcode , h.currcode,h.applicableto,status=	case when isnull(approved,0)=1 then 'Yes' else 'No' End, " _
          & " h.frmdate,h.todate,h.adddate,h.adduser,h.moddate,h.moduser from excplist_header h cross apply dbo.splitallotmkt(h.sectorgroupcode,',') s left join othtypmast t on  t.othtypcode=s.mktcode ,excclassification_header c    where  " _
          & "  isnull(h.sectoryesno,0)=1 and h.classcode=c.classificationcode  "
            ...
            For i = 0 To lsMainArr.GetUpperBound(0)
                ...
                If strValue <> "" Then
                    If Trim(strWhereCond1) = "" Then
                        strWhereCond1 = " (upper(eplistcode) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(othtypname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(classificationname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(approved) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    Else
                        strWhereCond1 = strWhereCond1 & " OR  (upper(eplistcode) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(othtypname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(classificationname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'  or  upper(approved) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' ) "
                    End If
                End If
            Next
            If Trim(strWhereCond) = "" Then
