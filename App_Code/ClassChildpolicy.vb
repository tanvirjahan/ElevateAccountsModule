...
Public Class ClassChildPolicy
        ...
        Select Case TemplateType
            Case ListItemType.Header
                ...
                Else
                    ...
                    If Field1 <> "Sr No" And Field1 <> "No.of.Nights Room Rate" And Field1 <> "Extra Person Supplement" And Field1 <> "Min Nights" And Field1 <> "Pkg" And Field1 <> "Remark" Then
                        lbl.Columns = 15 ' 15
                    Else
                        lbl.Columns = 10 ' 15
                    End If
            ...
            Case ListItemType.Item
                ...
                Else
                    ...
                    ajxacext.MinimumPrefixLength = 0
    ...
    Sub BindStringColumn(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Try
            If IsDBNull(DataBinder.Eval(Container.DataItem, Field1)) = True Then
                lbl2.Text = ""
            Else
