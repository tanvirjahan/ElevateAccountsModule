...
Public Class clsItineraryPageEvent : Implements IPdfPageEvent
    ...
    Public Sub OnEndPage(writer As iTextSharp.text.pdf.PdfWriter, document As iTextSharp.text.Document) Implements iTextSharp.text.pdf.IPdfPageEvent.OnEndPage
        ...
        Dim pageBorderRect = New Rectangle(document.PageSize)

        pageBorderRect.Left += document.LeftMargin + 23
        pageBorderRect.Right -= document.RightMargin + 23
        pageBorderRect.Top -= document.TopMargin
        pageBorderRect.Bottom += document.BottomMargin

        content.SetColorStroke(New BaseColor(21, 67, 96))
