...
Imports System.IO
Imports System.Linq
Public Class ClsCustomerGroupPdf
...
#Region "GenerateReport"
    Public Sub GenerateReport(ByRef bytes() As Byte, ByVal printMode As String, Optional ByVal fileName As String = "")
        ...
        Try
            ...
            sqlString = "SELECT Customergroup.customergroupname, Customergroup.active, agentmast.agentname FROM  dbo.agentmast agentmast INNER JOIN (Customergroup Customergroup INNER JOIN dbo.customergroup_detail customergroup_detail ON Customergroup.customergroupcode=customergroup_detail.customergroupcode) ON agentmast.agentcode=customergroup_detail.agentcode ORDER BY Customergroup.customergroupname"
            ...
            Using memoryStream As New System.IO.MemoryStream()
                ...
                tableTitle.SetWidths(New Single() {0.7F, 0.3F})
                arrHeaders = {"Customer Group", "Active"}
                ...
                If custdetailsdt.Rows.Count > 0 Then
                    ...
                    tableData.SetWidths(New Single() {0.7F, 0.3F})
                    tableData.SpacingBefore = 0

                    Dim groups As IEnumerable(Of IGrouping(Of String, DataRow)) = custdetailsdt.AsEnumerable.GroupBy(Function(g) g.Field(Of String)("customergroupname"))
                    ...
                    For Each grpby In groups
                        ...
                        For Each row As DataRow In grpby
                            arrHeaders = {row("agentname"), IIf(row("active") = 0, "No", "Yes")}
                            For i = 0 To arrHeaders.Length - 1
                                phrase = New Phrase()
