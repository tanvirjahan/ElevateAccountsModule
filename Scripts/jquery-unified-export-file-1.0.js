    ...
    $.UnifiedExportFile = function (options) {
        ...
        *********************************************/
        $.UnifiedExportFile.onSuccessDefaultCallBack = function () {
            var msg = 'The file downloaded successfully';
            console.log(msg);
            alert(msg);
        };
        ...
        *********************************************/
        $.UnifiedExportFile.onFailDefaultCallBack = function () {
            var msg = 'There is error occured while downloading file from the server';
            console.log(msg);
            alert(msg);
        };
        ...
        *********************************************/
        $.UnifiedExportFile.checkDownloadFileCompletely = function () {
            ...
            *********************************************/
            ...
            var ErrorInProcedure = $.UnifiedExportFile.getCookie('ErrorInProcedure');
            if (ErrorInProcedure == "True") {
                /********************************************
                Hide ajax loading element
                *********************************************/
                $(obj.ajaxLoadingSelector).hide();
                ...
                /********************************************
                Remove cookie "ErrorInProcedure=True"
                *********************************************/
                $.UnifiedExportFile.removeCookie('ErrorInProcedure');
