    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Page.IsPostBack = False Then
                ...
                intAppId = appidnew 'objUser.GetAppId(Session("dbconnectionName"), CType(Session("AppName"), String))
                ...
                ElseIf intAppId = "16" Then 'changed by mohamed on 27/08/2018
                    title.Text = "ELEVATE TOURISM L.L.C"
                    Me.Page.Title = hdnAppName.Value + " - :: " + "ELEVATE TOURISM L.L.C" + "::"
                Else
