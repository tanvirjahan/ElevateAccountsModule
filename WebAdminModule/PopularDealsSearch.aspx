<%@ Page Language="VB" MasterPageFile="~/WebAdminMaster.master" ValidateRequest="false"
    Strict="true" AutoEventWireup="false" CodeFile="PopularDealsSearch.aspx.vb" Inherits="PopularDealsSearch" %>
...
<script type="text/javascript" charset="utf-8">
    ...
    function visualsearchbox() {
        ...
        $txtvsprocess.val('DealId:" "Supplier:" "TEXT:" "');
        window.visualSearch = VS.init({
            ...
            callbacks: {
                ...
                valueMatches: function (category, searchTerm, callback) {
                    switch (category) {
                        case 'Supplier':
                            var asSqlqry = '';
                            glcallback = callback;
                            ColServices.clsSectorServices.GetListOfWebAdSupplierVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                            break;
                        case 'DealId':
                            var asSqlqry = '';
                            glcallback = callback;
                            ColServices.clsSectorServices.GetListOfDEALIDsVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                            break;
                ...
                facetMatches: function (callback) {
                    callback([
                { label: 'TEXT', category: 'DEAL' },
                 { label: 'DEALID', category: 'DEAL' },
                { label: 'SUPPLIER', category: 'DEAL' },
              ]);
                }
            }
        });
   ...
   function changelabels()
    {
     var ddlorder=document.getElementById("<%=ddlorder.ClientID%>")

     if (ddlorder.value=='C'    ||  ddlorder.value=='M')
     { 
    ...
    if (ddlorder.value == 'D' ) {
        document.getElementById("<%=lblfromdate.ClientID%>").innerHTML = 'Deal Start date';
        document.getElementById("<%=lblToDate.ClientID%>").innerHTML = 'Deal End date'
...
<TABLE style="WIDTH:100%"><TBODY><TR><TD style="TEXT-ALIGN: center" 
        class="field_heading">    <asp:Label id="lblHeading" runat="server" Text=" Upload Popular Deals" 
        Width="738px" CssClass=""></asp:Label></TD></TR>
        ...
        <td colspan="6">
            <table class="style1">
                ...
                <tr>
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOrder" runat="server"    ><%--onchange="changelabels()"--%>
 
                          <%--  <asp:ListItem Value="D"> Deal Dates</asp:ListItem>--%>
...
<asp:GridView ID="gv_SearchResult" TabIndex="10" runat="server" Font-Size="10px"
                            ...
                            <Columns>
                                <asp:TemplateField Visible="False" HeaderText="DealId">
<ItemTemplate>
<asp:Label id="lblDealId" runat="server" Text='<%# Bind("DealId") %>'></asp:Label> 
</ItemTemplate>
</asp:TemplateField> 
                               <asp:BoundField DataField="DealId" SortExpression="DealId" HeaderText="Deal ID">
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="Partycode" Visible="false"  SortExpression="partycode" HeaderText="Party Code">
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:BoundField>
                                <asp:TemplateField HeaderText=" Supplier" SortExpression="partyname">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Deal Start Date" SortExpression="DealStartDate" Visible ="false" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblDealStartDate" runat="server" Text='<%# Bind("DealStartDate") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ControlStyle />
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText=" Deal End Date" SortExpression="DealEndDate" Visible ="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDealEndDate" runat="server" Text='<%# Bind("DealEndDate") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ControlStyle />
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                ...
                                <asp:BoundField DataFormatString="{0:dd/MM/yyyy hh:mm:ss tt} " DataField="adddate"
                                    SortExpression="adddate" HeaderText="Date Created">
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:BoundField>
                                ...
                                <asp:BoundField DataFormatString="{0:dd/MM/yyyy hh:mm:ss tt} " DataField="moddate"
                                    SortExpression="moddate" HeaderText="Date Modified">
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:BoundField>
