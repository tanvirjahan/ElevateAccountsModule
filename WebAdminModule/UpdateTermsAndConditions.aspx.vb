    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            ...
            Try
                ...
                mySqlCmd = New SqlCommand("select * from webdetails where divcode='" & ddlDivision.SelectedValue & "'", mySqlConn, sqlTrans)
                ...
                Else
                    ...
                    txtWebDetailId.Text = objUtils.ExecuteQueryReturnStringValuenew(Session("dbconnectionName"), "select max(webdetailid)+1 from webdetails")
                    btnSave.Text = "Save"
                End If
...
#Region "Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click"
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            mySqlCmd.Parameters.Add(New SqlParameter("@detail_text", SqlDbType.Text)).Value = Editor1.Content
            mySqlCmd.Parameters.Add(New SqlParameter("@adduser", SqlDbType.VarChar, 10)).Value = CType(Session("GlobalUserName"), String)
            mySqlCmd.Parameters.Add(New SqlParameter("@divcode", SqlDbType.VarChar, 10)).Value = CType(ddlDivision.SelectedValue, String)
