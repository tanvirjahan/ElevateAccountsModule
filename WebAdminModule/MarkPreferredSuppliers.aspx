<%@ Page Language="VB" MasterPageFile="~/WebAdminMaster.master" AutoEventWireup="false" CodeFile="MarkPreferredSuppliers.aspx.vb" Inherits="MarkPreferredSuppliers" %>
...
<script type="text/javascript" charset="utf-8">
    ...
    function ErrorHandler(result) {
        ...
        function visualsearchbox() {
            ...
            $txtvsprocess.val('COUNTRY:" "CITY:" "SECTOR:" "CATEGORY:" "HOTELGROUP:" "HOTELCHAIN:" "HOTELSTATUS:" "TEXT:" "');
            ...
            'access'
                    ...
                    valueMatches: function (category, searchTerm, callback) {
                        switch (category) {
                            ...
                            case 'CATEGORY':
                                var asSqlqry = '';
                                glcallback = callback;
                                ColServices.clsSectorServices.GetListOfWebSupplierCategoryVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                                break;
                            case 'HOTELGROUP':
                                var asSqlqry = '';
                                glcallback = callback;
                ...
                { label: 'COUNTRY', category: 'BANKTYPE' },
                     { label: 'CITY', category: 'BANKTYPE' },
                          { label: 'CATEGORY', category: 'BANKTYPE' },
              ]);
                    }
                }
            });
   ...
   <TABLE style="BORDER-RIGHT: gray 2px solid; BORDER-TOP: gray 2px solid; BORDER-LEFT: gray 2px solid; WIDTH: 100%; BORDER-BOTTOM: gray 2px solid;vertical-align:top;"  ><TBODY>
    ...
    <TD style="HEIGHT: 15px" class="field_heading" align=center colSpan=4 
        width="10">
    <asp:Label id="lblHeading" runat="server" Text="  Preferred Suppliers" 
...
<ItemTemplate>
      ...
      <asp:Label ID="lblpartyCode" runat="server" Text='<%# Bind("partycode") %>'></asp:Label>
                               ...
                               <%--             <asp:BoundField DataField="partyname" HeaderText="Supplier Name">
                                            ...
                                            <ItemTemplate >
                                            <asp:Label ID="lblpartyname" Width="120px" runat="server" Text='<%#Bind("partyname")%>'></asp:Label>
                                            </ItemTemplate>
                                            </asp:TemplateField>
                                                                               <asp:TemplateField HeaderText ="Category">
                                            <ItemTemplate>
                                            <asp:Label ID="lblCategory"  Width="120px" runat="server" Text='<%#Bind("catname")%>'></asp:Label>
                                            </ItemTemplate>
                                            </asp:TemplateField>
                                                      <asp:TemplateField HeaderText ="Sector">
                                            <ItemTemplate>
                                            <asp:Label ID="lblSector"   Width="130px" runat="server" Text='<%#Bind("sectorname")%>'></asp:Label>
                                            </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText ="City">
                                            <ItemTemplate >
                                            <asp:Label ID="lblCity" Width="120px" runat="server" Text='<%#Bind("cityname")%>'></asp:Label>
                                            </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <ItemTemplate >
                                            <asp:Label ID="lblcountry"  Width="130px" runat="server" Text='<%#Bind("ctryname")%>'></asp:Label>
                                            </ItemTemplate>
                                            </asp:TemplateField>                                   
                                                                                                           <asp:TemplateField HeaderText ="Hotel Group">
                                            <ItemTemplate>
                                            <asp:Label ID="lblhotelgroup" Width="130px" runat="server" Text='<%#Bind("hotelgroup")%>'></asp:Label>
                                            </ItemTemplate>
                                            </asp:TemplateField>
                                                                                                                                              <asp:TemplateField HeaderText ="Hotel Chain">
                                            <ItemTemplate>
                                            <asp:Label ID="lblhotelchainname" Width="130px" runat="server" Text='<%#Bind("hotelchainname")%>'></asp:Label>
                                            </ItemTemplate>
                                            </asp:TemplateField>
