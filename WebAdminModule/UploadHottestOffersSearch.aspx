...
<%@ Page Language="VB" MasterPageFile="~/WebAdminMaster.master" ValidateRequest="false"
    Strict="true" AutoEventWireup="false" CodeFile="UploadHottestOffersSearch.aspx.vb" Inherits="UploadHottestOffersSearch" %>
...
<script type="text/javascript" charset="utf-8">
    ...
    function visualsearchbox() {
        ...
        $txtvsprocess.val('OfferId:" "Supplier:" "TEXT:" "');
        window.visualSearch = VS.init({
            ...
            callbacks: {
                ...
                valueMatches: function (category, searchTerm, callback) {
                    switch (category) {
                        ...
                        case 'OfferId':
                            ...
                            var asSqlqry = '';
                            glcallback = callback;
                            ColServices.clsSectorServices.GetListOfOfferIDsVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                            break;
                ...
                facetMatches: function (callback) {
                    callback([
                { label: 'TEXT', category: 'OFFERS' },
                 { label: 'OFFERID', category: 'OFFERS' },
                { label: 'SUPPLIER', category: 'OFFERS' },
              ]);
                }
            }
        });
    ...
    function changelabels() {
        ...
        if (ddlorder.value == 'D') {
            document.getElementById("<%=lblfromdate.ClientID%>").innerHTML = 'Offer Start date';
            document.getElementById("<%=lblToDate.ClientID%>").innerHTML = 'Offer End date'
...
<TABLE style="WIDTH: 100%"><TBODY><TR><TD style="TEXT-ALIGN: center" 
        class="field_heading">    <asp:Label id="lblHeading" runat="server" Text=" Upload Hottest Offers" 
        ...
        <td colspan="6">
            <table class="style1">
                ...
                <tr>
                    ...
                    &nbsp;<asp:DropDownList ID="ddlOrder" runat="server"   ><%--OnSelectedIndexChanged ="ddlOrderBy_SelectedIndexChanged" onchange="changelabels()" --%>
...
<asp:GridView ID="gv_SearchResult" TabIndex="10" runat="server" Font-Size="10px"
                            ...
                            <Columns>
                                <asp:TemplateField  HeaderText="Offerid" SortExpression="Offerid" >
<ItemTemplate>
<asp:Label id="lblOfferId" runat="server" Text='<%# Bind("OfferId") %>'></asp:Label> 
                                ...
                                <asp:TemplateField HeaderText="Offer Start Date" SortExpression="OfferStartDate" Visible ="false" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblDealStartDate" runat="server" Text='<%# Bind("OfferStartDate") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ControlStyle />
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText=" Offer End Date" SortExpression="OfferEndDate" Visible ="false" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblDealEndDate" runat="server" Text='<%# Bind("OfferEndDate") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ControlStyle />
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
