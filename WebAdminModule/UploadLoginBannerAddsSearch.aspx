<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UploadLoginBannerAddsSearch.aspx.vb" Inherits="UploadLoginBannerAddsSearch"  MasterPageFile="~/WebAdminMaster.master" Strict="true"%>
    ...
    <table style="width: 936px">
        <tr>
            <td class="field_heading" style="text-align: center">
                Upload Login Banner Ads List</td>
        </tr>
        <tr>
...
<asp:BoundField DataField="Imagename" SortExpression="Imagename" HeaderText="Image Url"></asp:BoundField>
