    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            Try
                ...
                '     ddlemailtextfor.SelectedIndex = 0
                ShowRecord("0")
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            If Page.IsValid = True Then
                ...
                mySqlCmd.Parameters.Add(New SqlParameter("@emailtext", SqlDbType.VarChar, 1250)).Value = CType(txtEmailText.Content.Trim, String)
                mySqlCmd.Parameters.Add(New SqlParameter("@subject", SqlDbType.VarChar, 500)).Value = CType(txtSubject.Text.Trim, String)
                mySqlCmd.Parameters.Add(New SqlParameter("@footertext", SqlDbType.VarChar, 1250)).Value = CType(txtFooterText.Content, String)
                mySqlCmd.Parameters.Add(New SqlParameter("@fromemailid", SqlDbType.VarChar, 100)).Value = CType(txtFromEmailId.Text.Trim, String)
                mySqlCmd.Parameters.Add(New SqlParameter("@emailtextfor", SqlDbType.Int)).Value = ddlemailtextfor.SelectedIndex
...
#End Region
    ...
    Private Sub cleartext()
        ...
        txtFooterText.Content = ""
        txtFromEmailId.Text = ""
    End Sub
#Region " Private Sub ShowRecord(ByVal RefCode As integer)"

    Private Sub ShowRecord(ByVal RefCode As Integer)
        Try
            mySqlConn = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))           'connection open

            mySqlCmd = New SqlCommand("Select * from email_text where emailtextfor='" & RefCode & "' ", mySqlConn)
            ...
            If mySqlReader.HasRows Then
                If mySqlReader.Read() = True Then
                    ...
                    If IsDBNull(mySqlReader("emailtext")) = False Then
                        Me.txtEmailText.Content = CType(mySqlReader("emailtext"), String)
                    Else
                        Me.txtEmailText.Content = ""
                    End If

                    If IsDBNull(mySqlReader("footertext")) = False Then
                        Me.txtFooterText.Content = CType(mySqlReader("footertext"), String)
                    Else
                        Me.txtFooterText.Content = ""
                    End If
...
#End Region
    ...
    Protected Sub ddlemailtextfor_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlemailtextfor.SelectedIndexChanged
        ShowRecord(ddlemailtextfor.SelectedIndex)
    End Sub
    ...
    Protected Sub btnHelp_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=Email','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    End Sub
