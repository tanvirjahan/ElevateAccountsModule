...
Partial Class UpdateLoginSignInTerms
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            ...
            Try
                ...
                mySqlCmd = New SqlCommand("select * from webdetails where webdetailid=3", mySqlConn, sqlTrans)
            ...
            Catch ex As Exception
                ...
                objUtils.WritErrorLog("UpdateLoginSignInTerms.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
            End Try
        End If
    End Sub
#End Region
...
#End Region
    ...
    Protected Sub btnHelp_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=UpdateLoginSignInTerms','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    End Sub
End Class
