...
Partial Class UploadHottestOffersSearch
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            Try
                ...
                Else
                    objUser.CheckUserRight(Session("dbconnectionName"), CType(Session("GlobalUserName"), String), CType(Session("Userpwd"), String), _
                                                       CType(strappname, String), "WebAdminModule\UploadHottestOffersSearch.aspx?appid=" + strappid, btnAddNew, BtnExportToExcel, _
                                                       btnPrint, gv_SearchResult, GridCol.Edit, GridCol.Delete, GridCol.View)



                End If
                Session.Add("strsortExptype", "OfferId")
                Session.Add("strsortdirectiontype", SortDirection.Ascending)

                Session("sDtDynamicHotOffer") = Nothing
                ...
                Session("sDtDynamicHotOffer") = dtDynamic
            ...
            Catch ex As Exception
                ...
                objUtils.WritErrorLog("HottestOffersSearch.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
            End Try
        End If
        ...
        If (Me.IsPostBack And Me.Request("__EVENTTARGET") = "OtherServicesPLTypesWindowPostBack") Then
...
#Region "Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = 'ASC')"
    Private Sub FillGrid(ByVal strorderby As String, Optional ByVal strsortorder As String = "ASC")
        ...
        Try
            ...
            strSqlQry = " select  TblHottestOffers.Offerid,partymast.PartyCode,partymast.PartyName,convert(varchar(10),TblHottestOffers.offerstartdate,103)  OfferStartDate,convert(varchar(10),TblHottestOffers.offerenddate,103)  OfferEndDate," & _
"case when isnull( TblHottestOffers.active,0)=1 then 'Active' when isnull( TblHottestOffers.active,0)=0 then 'InActive' else 'InActive' end Active , " & _
"TblHottestOffers.adddate,TblHottestOffers.adduser,TblHottestOffers.moddate,TblHottestOffers.moduser from TblHottestOffers   join partymast   on TblHottestOffers.partycode=partymast.partycode and partymast.active=1  "
        ...
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            objUtils.WritErrorLog("UploadHottestOffersSearch.aspx?Type=" + Session("OthTypeFilter"), Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        Finally
...
#Region "Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click"
    Protected Sub btnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        strpop = "window.open('UploadHottestOffers.aspx?State=New','UploadHottestOffers');"  ','width='+screen.availWidth+' height='+screen.availHeight+' left=0,top=0 status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=yes');"
...
#Region "Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand"
    ...
    Protected Sub gv_SearchResult_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gv_SearchResult.RowCommand
        Try
            ...
            lblId = gv_SearchResult.Rows(CType(e.CommandArgument.ToString, String)).FindControl("lblOfferId")

            If e.CommandName = "EditRow" Then
                Dim strpop As String = ""
                strpop = "window.open('UploadHottestOffers.aspx?State=Edit&RefCode=" + CType(lblId.Text.Trim, String) + "','UploadHottestOffers');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)

            ElseIf e.CommandName = "View" Then
                Dim strpop As String = ""
                strpop = "window.open('UploadHottestOffers.aspx?State=View&RefCode=" + CType(lblId.Text.Trim, String) + "','UploadHottestOffers');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)

            ElseIf e.CommandName = "DeleteRow" Then
                Dim strpop As String = ""
                strpop = "window.open('UploadHottestOffers.aspx?State=Delete&RefCode=" + CType(lblId.Text.Trim, String) + "','UploadHottestOffers');"
                ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "popup", strpop, True)
            End If
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            objUtils.WritErrorLog("UploadHottestOfferSEarch.aspx?", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        End Try
    End Sub
#End Region
...
#Region " Protected Sub gv_SearchResult_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gv_SearchResult.Sorting"
    ...
    Protected Sub gv_SearchResult_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gv_SearchResult.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            dtDynamics = Session("sDtDynamicHotOffer")
            If Session("sDtDynamicHotOffer") IsNot Nothing Then
    ...
    Protected Sub gv_SearchResult_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gv_SearchResult.Sorting
        ...
        Session.Add("strsortExptype", e.SortExpression)
...
#Region "Public Sub SortGridColoumn_click()"
    Public Sub SortGridColoumn_click()
        ...
        Dim myDS As New DataSet
        FillGrid(Session("strsortExptype"), "")
        ...
        If IsDBNull(DataTable) = False Then
            ...
            dataView.Sort = Session("strsortExptype") & " " & objUtils.ConvertSortDirectionToSql(Session("strsortdirectiontype"))
    ...
    Protected Sub btnExportToExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnExportToExcel.Click
        ...
        Try
            If gv_SearchResult.Rows.Count <> 0 Then
                ...
                '   strSqlQry = "SELECT  dbo.othtypmast.othtypcode [Type Code], dbo.othtypmast.othtypname[Type Name],  dbo.othtypmast.othgrpcode[Group Code], dbo.othgrpmast.othgrpname[Group Name] , " & _
                '" dbo.othtypmast.partycode[Supplier Code],dbo.partymast.partyname[Supplier Name],case when isnull(dbo.othtypmast.active,0)=1 then 'Active' when isnull(dbo.othtypmast.active,0)=0 then 'InActive' else 'InActive' end Active ," & _
                '" dbo.othtypmast.adddate[Date Created], dbo.othtypmast.adduser[User Created], dbo.othtypmast.moddate[Date Modified], dbo.othtypmast.moduser[User Modified] FROM  othtypmast   INNER JOIN   dbo.othgrpmast ON " & _
                ...
                strSqlQry = " select  TblHottestOffers.Offerid [ Offer ID],partymast.PartyCode [Party Code],partymast.PartyName[Party Name]," & _
     "case when isnull(TblHottestOffers.active,0)=1 then 'Active' when isnull(TblHottestOffers.active,0)=0 then 'InActive' else 'InActive' end Active  , " & _
     "TblHottestOffers.adddate[Date Created],TblHottestOffers.adduser[User Created],TblHottestOffers.moddate[Date Modified],TblHottestOffers.moduser[User Modified] from TblHottestOffers   join partymast   on TblHottestOffers.partycode=partymast.partycode and partymast.active=1  "


                con = clsDBConnect.dbConnectionnew(Session("dbconnectionName"))

                DA = New SqlDataAdapter(strSqlQry, con)
                DA.Fill(DS, "hottestoffers")
...
#Region "Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click"
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
            ...
            Dim strpop As String = ""
            strpop = "window.open('rptReportNew.aspx?Pageame=Upload Hottest Offers&BackPageName=UploadHottestOffersSearch.aspx""','RepOthGrp');"
...
#End Region
    ...
    Protected Sub btnHelp_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "window.open('../Help.aspx?hi=HottestDealSearch','_blank','status=1,scrollbars=1,top=135,left=760,width=250,height=500');", True)
    End Sub

    Private Sub FillGridNew()
        Dim dtt As DataTable
        dtt = Session("sDtDynamicHotOffer")
        ...
        Try
            If dtt.Rows.Count > 0 Then
                For i As Integer = 0 To dtt.Rows.Count - 1
                    If dtt.Rows(i)("Code").ToString = "OFFERID" Then
                        If strCarValue <> "" Then
 ...
 "case when isnull( TblHottestOffers.active,0)=1 then 'Active' when isnull( TblHottestOffers.active,0)=0 then 'InActive' else 'InActive' end Active , " & _
 "TblHottestOffers.adddate,TblHottestOffers.adduser,TblHottestOffers.moddate,TblHottestOffers.moduser from TblHottestOffers   join partymast   on TblHottestOffers.partycode=partymast.partycode and partymast.active=1  "
            Dim strorderby As String = Session("strsortExptype")
        ...
        Catch ex As Exception
            ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "", "alert('" & "Error Description " + ex.Message.Replace("'", " ") & "' );", True)
            objUtils.WritErrorLog("UploadHottestOffersSearch.aspx", Server.MapPath("ErrorLog.txt"), ex.Message.ToString, Session("GlobalUserName"))
        Finally
            'clsDBConnect.dbAdapterClose(myDataAdapter)                       'Close adapter
            'clsDBConnect.dbConnectionClose(SqlConn)                          'Close connection
        End Try
    ...
    Private Function BuildConditionNew(ByVal strCarValue As String, ByVal strsuppliervalue As String, ByVal strTextValue As String) As String
        ...
        If strCarValue.Trim <> "" Then
            If Trim(strWhereCond) = "" Then
                strWhereCond = "upper(tblhottestoffers.Offerid) IN (" & Trim(strCarValue.Trim.ToUpper) & ")"
            Else
                strWhereCond = strWhereCond & " AND upper((tblhottestoffers.Offerid) IN (" & Trim(strCarValue.Trim.ToUpper) & ")"
            End If
            ...
            For i = 0 To lsMainArr.GetUpperBound(0)
                ...
                If strValue <> "" Then
                    If Trim(strWhereCond1) = "" Then
                        ...
                        strWhereCond1 = " (upper(tblhottestoffers.Offerid) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or upper(tblhottestoffers.active) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%'or upper(partymast.partyname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%')"
                    Else
                        strWhereCond1 = strWhereCond1 & " OR  (upper(tblhottestoffers.Offerid) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%' or  upper(partymast.partyname) LIKE '%" & Trim(strValue.Trim.ToUpper) & "%') "
                    End If
                End If
        ...
        If txtFromDate.Text.Trim <> "" And txtToDate.Text <> "" Then
            ...
            If ddlOrder.SelectedValue = "C" Then
                If Trim(strWhereCond) = "" Then
                    ...
                    strWhereCond = " (CONVERT(datetime, convert(varchar(10),tblhottestoffers.adddate,103),103)  between CONVERT(datetime, '" + txtFromDate.Text + "',103) and CONVERT(datetime,  '" + txtToDate.Text + "',103)) "
                Else
                    strWhereCond = strWhereCond & "  and (CONVERT(datetime, convert(varchar(10),tblhottestoffers.adddate,103),103)  between CONVERT(datetime, '" + txtFromDate.Text + "',103) and CONVERT(datetime,  '" + txtToDate.Text + "',103)) "
                End If
            ElseIf ddlOrder.SelectedValue = "M" Then
                If Trim(strWhereCond) = "" Then

                    strWhereCond = " (CONVERT(datetime, convert(varchar(10),tblhottestoffers.moddate,103),103)  between CONVERT(datetime, '" + txtFromDate.Text + "',103) and CONVERT(datetime,  '" + txtToDate.Text + "',103)) "
                Else
                    strWhereCond = strWhereCond & "  and (CONVERT(datetime, convert(varchar(10),tblhottestoffers.moddate,103),103)  between CONVERT(datetime, '" + txtFromDate.Text + "',103) and CONVERT(datetime,  '" + txtToDate.Text + "',103)) "
                End If
            ElseIf ddlOrder.SelectedValue = "D" Then
                If Trim(strWhereCond) = "" Then

                    strWhereCond = " (CONVERT(datetime, convert(varchar(10),tblhottestoffers.offerStartDate,103),103)  between CONVERT(datetime, '" + txtFromDate.Text + "',103) and CONVERT(datetime,  '" + txtToDate.Text + "',103) and CONVERT(datetime, convert(varchar(10),tblhottestoffers.OfferEndDate,103),103)  between CONVERT(datetime, '" + txtFromDate.Text + "',103) and CONVERT(datetime,  '" + txtToDate.Text + "',103)) "
                Else
                    strWhereCond = strWhereCond & "  and (CONVERT(datetime, convert(varchar(10),tblhottestoffers.OfferStartDate,103),103)  between CONVERT(datetime, '" + txtFromDate.Text + "',103) and CONVERT(datetime,  '" + txtToDate.Text + "',103) and CONVERT(datetime, convert(varchar(10),tblhottestoffers.OfferEndDate,103),103)  between CONVERT(datetime, '" + txtFromDate.Text + "',103) and CONVERT(datetime,  '" + txtToDate.Text + "',103)) "
                End If
            End If
        End If
    ...
    Protected Sub lbClose_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            If dtDynamics.Rows.Count > 0 Then
                ...
                Next
            End If
            Session("sDtDynamicHotOffer") = dtDynamics
        ...
        For i = 0 To lsMainArr.GetUpperBound(0)
            Select Case lsMainArr(i).Split(":")(0).ToString.ToUpper.Trim
                Case "OFFERID"
                    ...
                    sbAddToDataTable("OFFERID", lsProcessCity, "ID")
                    'Case "GROUP"
    ...
    Function sbAddToDataTable(ByVal lsName As String, ByVal lsValue As String, ByVal lsShortCode As String) As Boolean
        ...
        If dtt.Rows.Count >= 0 Then
            ...
            If iFlag = 0 Then
                ...
                Session("sDtDynamicHotOffer") = dtt
            End If
        End If
        Return True
    End Function
