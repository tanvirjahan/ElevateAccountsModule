(function () {
    ...
    VS.model.SearchQuery = Backbone.Collection.extend({
        ...
        // to split - Turns all of the facets into a single serialized string.
        serializetosplit: function () {
            return this.map(function (facet) { return facet.serializetosplit(); }).join('|~,');
        },
