...
function LoadPriceCode(MyLeft1, MyTop) {
    var MyXStr = '';
    var MyYStr = '';
    var MyHeight = $(".ShowPriceCode").height();
    if (MyHeight < 100) {
        MyXStr = parseInt(MyTop) - parseInt(120);
        MyHeight = 100;
    }
    else {
        MyXStr = parseInt(MyTop) - parseInt(MyHeight) - 20;
    }
    MyYStr = MyLeft1;
    ...
    $(".ShowPriceCode").fadeIn("fast");

}


function ShowPriceCode(PriceCode, MyId) {

    jQuery(".ShowPriceCode").html('');

    jQuery(".ShowPriceCode").html('<p>' + PriceCode + '</p>');


    var MyLeft = ($("#" + MyId).offset().left) + 'px'
    var MyTop = ($("#" + MyId).offset().top +50) + 'px'


    LoadPriceCode(MyLeft, MyTop);


}

function HidePriceCode() {
    $(".ShowPriceCode").fadeOut("fast");
