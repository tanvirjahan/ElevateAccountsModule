<%@ Page Language="VB" MasterPageFile="~/MainPageMaster.master" AutoEventWireup="false" CodeFile="DepartmentMasterSearch.aspx.vb" Inherits="DepartmentMasterSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
 ...
 <script type="text/javascript" charset="utf-8">
     ...
     function visualsearchbox() {
         ...
         $txtvsprocess.val('DEPARTMENTNAME:" "  DEPARTMENTHEAD:" " TEXT:" " ');
                 ...
                 valueMatches: function (category, searchTerm, callback) {
                     ...
                     switch (category) {
                         case 'DEPARTMENTNAME':
                             ...
                             ColServices.clsVisualSearchService.GetListOfRdeptNameVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                             break;
                         ...
                         case 'DEPARTMENTHEAD':
                             ...
                             ColServices.clsVisualSearchService.GetListOfRdeptheadVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                             break;
                     }
                 },
                 facetMatches: function (callback) {
                     callback([
                { label: 'DEPARTMENTNAME', category: 'DEPARTMENT' },
                 { label: 'DEPARTMENTHEAD', category: 'DEPARTMENT' },
              { label: 'TEXT', category: 'DEPARTMENT' },
...
function CallWebMethod(methodType)
    {
       switch(methodType)
        ...
        case "usercode":
                var select=document.getElementById("<%=ddlDeptheadcode.ClientID%>");
                var codeid=select.options[select.selectedIndex].text;
                var selectname=document.getElementById("<%=ddlDeptheadname.ClientID%>");
                selectname.value=select.options[select.selectedIndex].text;
                break;
            case "username":
                var select=document.getElementById("<%=ddlDeptheadname.ClientID%>");
                var codeid=select.options[select.selectedIndex].value;
                var selectname=document.getElementById("<%=ddlDeptheadcode.ClientID%>");
                selectname.value=select.options[select.selectedIndex].text;
                break;
...
<script type="text/javascript">
    ...
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
<TABLE><TBODY><TR><TD class=" " align=center colSpan=4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
<asp:Button id="btnhelp" tabIndex=10 onclick="BtnClear_Click" runat="server" Text="Help" Width="51px" CssClass="search_button" __designer:wfdid="w5"></asp:Button>&nbsp;
 <asp:Button id="BtnAddNew" tabIndex=7 runat="server" Text="Add New" __designer:dtid="20829148276588558" Width="90px" CssClass="btn" __designer:wfdid="w6"></asp:Button> &nbsp;
 <asp:Button id="BtnPrint" tabIndex=9 runat="server" Text="Report" __designer:dtid="20829148276588560" Width="57px" CssClass="btn" __designer:wfdid="w7"></asp:Button></TD></TR>
 
 
 <TR><TD style="display:none"><INPUT style="WIDTH: 194px" id="txtcode" tabIndex=1 type=text runat="server" /></TD>
 <TD style="display:none"><INPUT style="WIDTH: 294px" id="txtName" tabIndex=2 type=text runat="server" /></TD></TR>
 <TR><TD style="display:none"><asp:Label id="lblcode" runat="server" Text="Department Head Code" Width="120px" CssClass="field_caption" __designer:wfdid="w13"></asp:Label></TD>
 <TD style="display:none"><SELECT style="WIDTH: 200px" id="ddlDeptheadcode" class="drpdown" tabIndex=3 onchange="CallWebMethod('usercode');" runat="server"> <OPTION selected></OPTION></SELECT></TD>
 <TD style="display:none">
 <asp:Label id="lblname" runat="server" Text="Department Head Name" Width="113px" CssClass="field_caption" __designer:wfdid="w14"></asp:Label></TD><TD><SELECT style="WIDTH: 300px" id="ddlDeptheadname" class="drpdown" tabIndex=4 onchange="CallWebMethod('username');" runat="server"> <OPTION selected></OPTION></SELECT></TD></TR></TBODY></TABLE>
    ...
    <asp:UpdatePanel id="UpdatePanel2" runat="server">
        <contenttemplate>
<asp:GridView id="gv_SearchResult" tabIndex=10 runat="server" Font-Size="10px" Width="100%" CssClass="grdstyle" __designer:wfdid="w19" GridLines="Vertical" CellPadding="3" BorderWidth="1px" BorderStyle="None" BorderColor="#999999" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True">
<FooterStyle CssClass="grdfooter"></FooterStyle>
<Columns>
<asp:TemplateField Visible="False" HeaderText="Department Code"><EditItemTemplate>
<asp:TextBox id="TextBox1" runat="server" Text='<%# Bind("deptcode") %>' __designer:wfdid="w22"></asp:TextBox> 
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblCode" runat="server" Text='<%# Bind("deptcode") %>' __designer:wfdid="w21"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:BoundField DataField="deptcode" SortExpression="deptcode" HeaderText="Department Code"></asp:BoundField>
<asp:BoundField DataField="deptname" SortExpression="deptname" HeaderText="Department Name"></asp:BoundField>
<asp:BoundField DataField="DeptHead" SortExpression="DeptHead" HeaderText="Dept Head"></asp:BoundField>
...
<asp:BoundField DataField="email" SortExpression="email" HeaderText="Email ID"></asp:BoundField>
<asp:BoundField DataField="URL" SortExpression="URL" HeaderText="URL"></asp:BoundField>
<asp:BoundField DataField="ShowinReservation" SortExpression="ShowinReservation" HeaderText="Showin Reservation"></asp:BoundField>
...
<AlternatingRowStyle CssClass="grdAternaterow"></AlternatingRowStyle>
                ...
                Font-Names="Verdana" Font-Bold="True" __designer:dtid="1970324836974605" 
                Width="333px" CssClass="lblmsg" __designer:wfdid="w20" Visible="False"></asp:Label> 
</contenttemplate>
    </asp:UpdatePanel></td>
        </tr>
