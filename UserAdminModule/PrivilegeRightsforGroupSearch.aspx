<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PrivilegeRightsforGroupSearch.aspx.vb" Inherits="PrivilegeRightsforGroupSearch" MasterPageFile="~/UserAdminMaster.master" Strict="true" %>
...
<script type="text/javascript" charset="utf-8">
    ...
    function visualsearchbox() {
        ...
        $txtvsprocess.val('GroupName:" "ApplicationName:" " TEXT:" "');
                ...
                valueMatches: function (category, searchTerm, callback) {
                    switch (category) {
                        ...
                        case 'ApplicationName':
                            var asSqlqry = '';
                            glcallback = callback;
                            ColServices.clsSectorServices.GetListOfArrayApplicationsTypeVisualSearch(asSqlqry, fnFillSearchVS, ErrorHandler, TimeOutHandler);
                            break;
                    }
                },
                facetMatches: function (callback) {
                    callback([
                { label: 'TEXT', category: 'GroupName' },
                { label: 'GroupName', category: 'GroupName' },
                { label: 'ApplicationName', category: 'GroupName' },
              ]);
                }
            }
        });
...
<TABLE style="WIDTH: 944px"><TBODY><TR><TD style="TEXT-ALIGN: center" 
        class="field_heading">Privilege Rights List</TD></TR>
...
<tr>
 ...
 <asp:UpdatePanel id="UpdatePanel2" runat="server">
                    <contenttemplate>
<asp:GridView id="gv_SearchResult" tabIndex=10 runat="server" Font-Size="10px" Width="100%" CssClass="grdstyle" __designer:wfdid="w16" GridLines="Vertical" CellPadding="3" BorderWidth="1px" BorderStyle="None" BorderColor="#999999" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True">
...
<ItemTemplate>
<asp:Label id="lblCode" runat="server" Text='<%# Bind("groupid") %>' _></asp:Label> 
</ItemTemplate>
</asp:TemplateField>

<asp:BoundField DataField="groupid" SortExpression="groupid" HeaderText="Group ID"></asp:BoundField>

<asp:TemplateField  SortExpression="groupname"   HeaderText="Group Name"><EditItemTemplate>
 
</EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblgroupname" runat="server" Text='<%# Bind("groupname") %>' _></asp:Label> 
</ItemTemplate>
</asp:TemplateField>

<asp:BoundField DataField="appid" SortExpression="appid" HeaderText="App ID"></asp:BoundField>
<asp:TemplateField   SortExpression="appname" HeaderText="App Name"><EditItemTemplate>
 </EditItemTemplate>
<ItemTemplate>
<asp:Label id="lblappname" runat="server" Text='<%# Bind("appname") %>' _></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
...
<asp:ButtonField Text="Copy" Visible="False"></asp:ButtonField>
</Columns>
...
<AlternatingRowStyle CssClass="grdAternaterow"></AlternatingRowStyle>
                            ...
                            __designer:wfdid="w17" Visible="False"></asp:Label> 
</contenttemplate>
                </asp:UpdatePanel></td>
        </tr>
    </table>
