<%@ Page Language="VB" MasterPageFile="~/UserAdminMaster.master" AutoEventWireup="false" CodeFile="GroupRightSearch.aspx.vb" Inherits="GroupRightSearch"  %>
...
<script type="text/javascript" charset="utf-8">
    ...
    function visualsearchbox() {
        ...
        $txtvsprocess.val('Group:" "Application:" " TEXT:" "');
...
<TABLE style="WIDTH: 944px"><TBODY><TR><TD style="TEXT-ALIGN: center" 
        class="field_heading">Group Rights List</TD></TR>
...
<tr>
  <td>
    ...
    <asp:UpdatePanel id="UpdatePanel2" runat="server">
        <contenttemplate>
<asp:GridView id="gv_SearchResult" tabIndex=10 runat="server" Font-Size="10px" Width="100%" CssClass="grdstyle"
...
<Columns>
<asp:TemplateField Visible="False" HeaderText="Appid"><EditItemTemplate>
<asp:TextBox runat="server" Text='<%# Bind("Appid") %>' id="TextBox2"></asp:TextBox>
</EditItemTemplate>
<ItemTemplate>
<asp:Label runat="server" Text='<%# Bind("Appid") %>' id="lblAppid"></asp:Label>
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField Visible="False" HeaderText="groupid"><EditItemTemplate>
<asp:TextBox runat="server" Text='<%# Bind("groupid") %>' id="TextBox1"></asp:TextBox>
</EditItemTemplate>
<ItemTemplate>
<asp:Label runat="server" Text='<%# Bind("groupid") %>' id="lblgroupid"></asp:Label>
</ItemTemplate>
</asp:TemplateField>
...
<asp:BoundField DataField="appid" SortExpression="appid" HeaderText="Application id"></asp:BoundField>
<asp:TemplateField   SortExpression="appname" HeaderText="Application Name"><EditItemTemplate>
 </EditItemTemplate>
<ItemTemplate>
