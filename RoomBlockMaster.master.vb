    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Page.IsPostBack = False Then
                ...
                intAppId = 2     'objUser.GetAppId(Session("dbconnectionName"),CType(Session("AppName"), String))
        ...
        Try
            ...
            If dsMainMenu.Tables(0).Rows.Count > 0 Then
                ...
                For Each drSubMenu In tblMainMenu.Rows
                    ...
                    '                lblMenus.InnerHtml = "<li class='type-1 active'>" & _
                    ' "<a href='#'>home<span class='fa fa-angle-down'></span></a>" & _
                    ' "<ul class='dropmenu'>" & _
                    '  "<li><a href='index.html'>Homepage 1</a></li>" & _
                    '                      " <li><a href='index_2.html'>Homepage 2</a></li>" & _
                    '    "</ul>" & _
                    '"</li>" & _
                    '"<li class='type-1'><a href='#'>Hotels<span class='fa fa-angle-down'></span></a>" & _
                    ' "<ul class='dropmenu'>" & _
                    '  "<li><a href='index_2.html'>Home Hotels</a></li>" & _
                    '                      " <li><a href='hotel_list.html'>List View</a></li>" & _
                    ' "</ul>" & _
                    '"</li>"


                    strMenuHtml = strMenuHtml & "<li class='type-3'>"

                    '  Dim childmenu As New System.Web.UI.WebControls.MenuItem
                    If IsDBNull(drSubMenu("menudesc")) = False Then
                        ' childmenu.Text = CStr(drSubMenu("menudesc"))
                        If IsDBNull(drSubMenu("pageName")) = False Then
                            strMenuHtml = strMenuHtml & "<a href=" & drSubMenu("pagename") & " target='_blank' >" & CStr(drSubMenu("menudesc")) & "<span class='fa fa-angle-down'></span></a>"
                        Else
                            strMenuHtml = strMenuHtml & "<a href='#'>" & CStr(drSubMenu("menudesc")) & "<span class='fa fa-angle-down'></span></a>"
                        End If
                ...
                Next
                lblMenus.InnerHtml = strMenuHtml
            End If
        ...
        Try
            ...
            If dsSubMenu.Tables(0).Rows.Count > 0 Then
                ...
                For Each drSubMenu In tblSubMenu.Rows
                    '  Dim childmenu As New System.Web.UI.WebControls.MenuItem
                    If IsDBNull(drSubMenu("menudesc")) = False Then
                        strMenuHtml = strMenuHtml & "<ul class='dropmenu'>"
                        strMenuHtml = strMenuHtml & "<li><a href=" & drSubMenu("pagename") & ">" & drSubMenu("menudesc") & "</a></li>"
